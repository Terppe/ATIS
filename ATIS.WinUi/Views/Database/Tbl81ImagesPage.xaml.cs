...
//  Tbl81ImagesPage.xaml.cs Skriptdatum:  21.04.2023  10:32     
...
/// </summary>
public sealed partial class Tbl81ImagesPage : Page
{
    #region [Private Data Members]
    public Tbl81ImagesViewModel ViewModel { get; } = null!;
    private readonly AllDialogs _allDialogs = new();
    #endregion [Private Data Members]

    public Tbl81ImagesPage()
    {
        //  var permis = new Permission();
        if (Permission.RolePermission())
        {
            ViewModel = App.GetService<Tbl81ImagesViewModel>();
            InitializeComponent();
        }
        else
        {
    ...
    private void ImageSearchAutoSuggestBox_OnLoaded(object sender, RoutedEventArgs e)
    {
        ImageSearchAutoSuggestBox.Visibility = Visibility.Visible;
        ImageSearchAutoSuggestBox.Focus(FocusState.Programmatic);
    }


    private void TabView_OnSelectionChanged(object sender, SelectionChangedEventArgs e)
    {
        switch (ImageTabView.SelectedIndex)
        {
            case 0:
                {
