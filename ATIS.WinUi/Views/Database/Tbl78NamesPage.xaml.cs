...
//  Tbl78NamesPage.xaml.cs Skriptdatum:  15.04.2023  10:32     
...
/// </summary>
public sealed partial class Tbl78NamesPage : Page
{
    #region [Private Data Members]
    public Tbl78NamesViewModel ViewModel { get; } = null!;
    private readonly AllDialogs _allDialogs = new();
    #endregion [Private Data Members]

    public Tbl78NamesPage()
    {
        //  var permis = new Permission();
        if (Permission.RolePermission())
        {
            ViewModel = App.GetService<Tbl78NamesViewModel>();
            InitializeComponent();
        }
        else
        {
    ...
    private void NameSearchAutoSuggestBox_OnLoaded(object sender, RoutedEventArgs e)
    {
        NameSearchAutoSuggestBox.Visibility = Visibility.Visible;
        NameSearchAutoSuggestBox.Focus(FocusState.Programmatic);
    }

    private void TabView_OnSelectionChanged(object sender, SelectionChangedEventArgs e)
    {
        switch (NameTabView.SelectedIndex)
        {
            case 0:
            {
    ...
    private void NameClearMethod()
    {
        ...
        FiSpeciesCombo.Text = string.Empty;
        PlSpeciesCombo.Text = string.Empty;
