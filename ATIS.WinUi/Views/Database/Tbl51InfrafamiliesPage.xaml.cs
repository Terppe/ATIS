...
//  Tbl51InfrafamiliesPage.xaml.cs Skriptdatum:  31.03.2023  10:32     
...
/// </summary>
public sealed partial class Tbl51InfrafamiliesPage : Page
{
    #region [Private Data Members]
    public Tbl51InfrafamiliesViewModel ViewModel { get; } = null!;
    private readonly AllDialogs _allDialogs = new();
    #endregion [Private Data Members]

    public Tbl51InfrafamiliesPage()
    {
        //  var permis = new Permission();
        if (Permission.RolePermission())
        {
            ViewModel = App.GetService<Tbl51InfrafamiliesViewModel>();
            InitializeComponent();
        }
        else
        {
    ...
    private void InfrafamilySearchAutoSuggestBox_OnLoaded(object sender, RoutedEventArgs e)
    {
        InfrafamilySearchAutoSuggestBox.Visibility = Visibility.Visible;
        InfrafamilySearchAutoSuggestBox.Focus(FocusState.Programmatic);
    }

    private void TabView_OnSelectionChanged(object sender, SelectionChangedEventArgs e)
    {
        switch (InfrafamilyTabView.SelectedIndex)
        {
            case 0:
            {
    ...
    private void InfrafamilyClearMethod()
    {
        ...
        //   SubfamilyCombo.Text = string.Empty;
    ...
    private void SupertribusClearMethod()
    {
        ...
        //  InfrafamilyCombo1.Text = string.Empty;
