...
//  Tbl30LegiosPage.xaml.cs Skriptdatum:  31.03.2023  10:32     
...
/// </summary>
public sealed partial class Tbl30LegiosPage : Page
{
    #region [Private Data Members]
    public Tbl30LegiosViewModel ViewModel { get; } = null!;
    private readonly AllDialogs _allDialogs = new();
    #endregion [Private Data Members]

    public Tbl30LegiosPage()
    {
        //  var permis = new Permission();
        if (Permission.RolePermission())
        {
            ViewModel = App.GetService<Tbl30LegiosViewModel>();
            InitializeComponent();
        }
        else
        {
    ...
    private void LegioSearchAutoSuggestBox_OnLoaded(object sender, RoutedEventArgs e)
    {
        LegioSearchAutoSuggestBox.Visibility = Visibility.Visible;
        LegioSearchAutoSuggestBox.Focus(FocusState.Programmatic);
    }

    private void TabView_OnSelectionChanged(object sender, SelectionChangedEventArgs e)
    {
        switch (LegioTabView.SelectedIndex)
        {
            case 0:
            {
    ...
    private void LegioClearMethod()
    {
        ...
        //   InfraclassCombo.Text = string.Empty;
