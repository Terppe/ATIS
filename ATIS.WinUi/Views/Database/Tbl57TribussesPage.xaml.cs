...
//  Tbl57TribussesPage.xaml.cs Skriptdatum:  01.04.2023  10:32     
...
/// </summary>
public sealed partial class Tbl57TribussesPage : Page
{
    #region [Private Data Members]
    public Tbl57TribussesViewModel ViewModel { get; } = null!;
    private readonly AllDialogs _allDialogs = new();
    #endregion [Private Data Members]

    public Tbl57TribussesPage()
    {
        //  var permis = new Permission();
        if (Permission.RolePermission())
        {
            ViewModel = App.GetService<Tbl57TribussesViewModel>();
            InitializeComponent();
        }
        else
        {
    ...
    private void TribusSearchAutoSuggestBox_OnLoaded(object sender, RoutedEventArgs e)
    {
        TribusSearchAutoSuggestBox.Visibility = Visibility.Visible;
        TribusSearchAutoSuggestBox.Focus(FocusState.Programmatic);
    }

    private void TabView_OnSelectionChanged(object sender, SelectionChangedEventArgs e)
    {
        switch (TribusTabView.SelectedIndex)
        {
            case 0:
            {
    ...
    private void TribusClearMethod()
    {
        ...
        //   SupertribusCombo.Text = string.Empty;
    ...
    private void SubtribusClearMethod()
    {
        ...
        //  TribusCombo1.Text = string.Empty;
