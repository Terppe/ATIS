...
//    Tbl57TribussesDocumentDataSourceSkriptdatum:  16.06.2023  10:32    

namespace ATIS.WinUi.Views.Report.Pdf.Tbl57Tribusses;

public abstract class Tbl57TribussesDocumentDataSource : ObservableObject
{
    ...
    public static Tbl57TribussesPdfModel GetTribusDetails(int tribusId)
    {
        #region [Private Data Members]
        ...
        //direct children
        SubtribussesCollection = dataService.CollSubtribussesByTribusIdAndHash(tribusId);

        //-----------------------------------------------------------------------------
        ExpertsCollection = dataService.CollExpertsByTribusId(tribusId);
        SourcesCollection = dataService.CollSourcesByTribusId(tribusId);
        AuthorsCollection = dataService.CollAuthorsByTribusId(tribusId);
        //------------------------------------------------------------------------------
        CommentsCollection = dataService.CollCommentsByTribusId(tribusId);
        ...
        {
            TribusName = _tribusSingle.TribusName,
            CountId = _tribusSingle.CountId,
            Synonym = _tribusSingle.Synonym,
            Author = _tribusSingle.Author,
            AuthorYear = _tribusSingle.AuthorYear,
            Info = _tribusSingle.Info,
            Valid = _tribusSingle.Valid,
            ValidYear = _tribusSingle.ValidYear,
            EngName = _tribusSingle.EngName,
            GerName = _tribusSingle.GerName,
            FraName = _tribusSingle.FraName,
            PorName = _tribusSingle.PorName,
            Memo = _tribusSingle.Memo,
            WriterDate = _tribusSingle.WriterDate,
            UpdaterDate = _tribusSingle.UpdaterDate,
            //------------------------------- 
