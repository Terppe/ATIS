...
internal class Tbl72PlSpeciesSubsDocument : IDocument
{
    private Tbl72PlSpeciesSubsPdfModel Model
    {
        get;
    }
    ...
    public Tbl72PlSpeciesSubsDocument(Tbl72PlSpeciesSubsPdfModel model)
    {
        Model = model;
    }
    ...
    {
        if (Tbl72PlSpeciesSubsDocumentDataSource.SynonymsCollection.Count == 0)
        {
        }
        else
        {
    ...
    private void ComposeSynonymContent(IContainer container)
    {
        ...
        {
            foreach (var item in Tbl72PlSpeciesSubsDocumentDataSource.SynonymsCollection)
            {
    ...
    {
        if (Tbl72PlSpeciesSubsDocumentDataSource.NamesCollection.Count == 0)
        {
        }
        else
        {
    ...
    private void ComposeNameContent(IContainer container)
    {
        ...
        container.Table(table =>
        {
            foreach (var item in Tbl72PlSpeciesSubsDocumentDataSource.NamesCollection)
            {
                table.ColumnsDefinition(columns =>
                {
                    columns.ConstantColumn(TabLeftRel8);
    ...
    {
        if (Tbl72PlSpeciesSubsDocumentDataSource.ExpertsCollection.Count == 0)
        {
            return;
        }
        ...
        container.Table(table =>
        {
            foreach (var item in Tbl72PlSpeciesSubsDocumentDataSource.ExpertsCollection)
            {
                for (var i = 0; i < 4; i++)
                {
                    if (i == 0)
    ...
    {
        if (Tbl72PlSpeciesSubsDocumentDataSource.SourcesCollection.Count == 0)
        {
            return;
        }
        ...
        container.Table(table =>
        {
            foreach (var item in Tbl72PlSpeciesSubsDocumentDataSource.SourcesCollection)
            {
                for (var i = 0; i < 5; i++)
                {
                    if (i == 0)
    ...
    {
        if (Tbl72PlSpeciesSubsDocumentDataSource.AuthorsCollection.Count == 0)
        {
            return;
        }
        ...
        container.Table(table =>
        {
            foreach (var item in Tbl72PlSpeciesSubsDocumentDataSource.AuthorsCollection)
            {
                for (var i = 0; i < 11; i++)
                {
                    if (i == 0)
    ...
    {
        if (Tbl72PlSpeciesSubsDocumentDataSource.GeographicsCollection.Count == 0)
        {
            return;
        }
        ...
        container.Table(table =>
        {
            foreach (var item in Tbl72PlSpeciesSubsDocumentDataSource.GeographicsCollection)
            {
                for (var i = 0; i < 10; i++)
                {
                    if (i == 0)
    ...
    {
        if (Tbl72PlSpeciesSubsDocumentDataSource.ImagesCollection.Count == 0)
        {
            return;
        }
        ...
        container.Table(table =>
        {
            foreach (var item in Tbl72PlSpeciesSubsDocumentDataSource.ImagesCollection)
            {
                for (var i = 0; i < 6; i++)
                {
                    if (i == 0)
    ...
    {
        if (Tbl72PlSpeciesSubsDocumentDataSource.CommentsCollection.Count == 0)
        {
            return;
        }
        ...
        container.Table(table =>
        {
            foreach (var item in Tbl72PlSpeciesSubsDocumentDataSource.CommentsCollection)
            {
                for (var i = 0; i < 3; i++)
                {
                    if (i == 0)
