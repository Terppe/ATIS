...
public class Tbl69FiSpeciessesDocument : IDocument
{
    private Tbl69FiSpeciessesPdfModel Model
    {
        get;
    }
    ...
    public Tbl69FiSpeciessesDocument(Tbl69FiSpeciessesPdfModel model)
    {
        Model = model;
    }
    ...
    {
        if (Tbl69FiSpeciessesDocumentDataSource.SynonymsCollection.Count == 0)
        {
        }
        else
        {
    ...
    private void ComposeSynonymContent(IContainer container)
    {
        ...
        {
            foreach (var item in Tbl69FiSpeciessesDocumentDataSource.SynonymsCollection)
            {
    ...
    {
        if (Tbl69FiSpeciessesDocumentDataSource.NamesCollection.Count == 0)
        {
        }
        else
        {
    ...
    private void ComposeNameContent(IContainer container)
    {
        ...
        container.Table(table =>
        {
            foreach (var item in Tbl69FiSpeciessesDocumentDataSource.NamesCollection)
            {
                table.ColumnsDefinition(columns =>
                {
                    columns.ConstantColumn(TabLeftRel8);
    ...
    {
        if (Tbl69FiSpeciessesDocumentDataSource.ExpertsCollection.Count == 0)
        {
            return;
        }
        ...
        container.Table(table =>
        {
            foreach (var item in Tbl69FiSpeciessesDocumentDataSource.ExpertsCollection)
            {
                for (var i = 0; i < 4; i++)
                {
                    if (i == 0)
    ...
    {
        if (Tbl69FiSpeciessesDocumentDataSource.SourcesCollection.Count == 0)
        {
            return;
        }
        ...
        container.Table(table =>
        {
            foreach (var item in Tbl69FiSpeciessesDocumentDataSource.SourcesCollection)
            {
                for (var i = 0; i < 5; i++)
                {
                    if (i == 0)
    ...
    {
        if (Tbl69FiSpeciessesDocumentDataSource.AuthorsCollection.Count == 0)
        {
            return;
        }
        ...
        container.Table(table =>
        {
            foreach (var item in Tbl69FiSpeciessesDocumentDataSource.AuthorsCollection)
            {
                for (var i = 0; i < 11; i++)
                {
                    if (i == 0)
    ...
    {
        if (Tbl69FiSpeciessesDocumentDataSource.GeographicsCollection.Count == 0)
        {
            return;
        }
        ...
        container.Table(table =>
        {
            foreach (var item in Tbl69FiSpeciessesDocumentDataSource.GeographicsCollection)
            {
                for (var i = 0; i < 10; i++)
                {
                    if (i == 0)
    ...
    {
        if (Tbl69FiSpeciessesDocumentDataSource.ImagesCollection.Count == 0)
        {
            return;
        }
        ...
        container.Table(table =>
        {
            foreach (var item in Tbl69FiSpeciessesDocumentDataSource.ImagesCollection)
            {
                for (var i = 0; i < 6; i++)
                {
                    if (i == 0)
    ...
    {
        if (Tbl69FiSpeciessesDocumentDataSource.CommentsCollection.Count == 0)
        {
            return;
        }
        ...
        container.Table(table =>
        {
            foreach (var item in Tbl69FiSpeciessesDocumentDataSource.CommentsCollection)
            {
                for (var i = 0; i < 3; i++)
                {
                    if (i == 0)
