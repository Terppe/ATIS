...
internal class Tbl69FiSpeciesSubsDocument : IDocument
{
    private Tbl69FiSpeciesSubsPdfModel Model
    {
        get;
    }
    ...
    public Tbl69FiSpeciesSubsDocument(Tbl69FiSpeciesSubsPdfModel model)
    {
        Model = model;
    }
    ...
    {
        if (Tbl69FiSpeciesSubsDocumentDataSource.SynonymsCollection.Count == 0)
        {
        }
        else
        {
    ...
    private void ComposeSynonymContent(IContainer container)
    {
        ...
        {
            foreach (var item in Tbl69FiSpeciesSubsDocumentDataSource.SynonymsCollection)
            {
    ...
    {
        if (Tbl69FiSpeciesSubsDocumentDataSource.NamesCollection.Count == 0)
        {
        }
        else
        {
    ...
    private void ComposeNameContent(IContainer container)
    {
        ...
        container.Table(table =>
        {
            foreach (var item in Tbl69FiSpeciesSubsDocumentDataSource.NamesCollection)
            {
                table.ColumnsDefinition(columns =>
                {
                    columns.ConstantColumn(TabLeftRel8);
    ...
    private void ComposeHeaderTaxoNomen(IContainer container)
    {
        container.Row(row =>
        {
            row.RelativeItem().Column(column =>
            {
                ...
                column.Item().Text(text =>
                {
                    text.Span($"{Model.GenusTree?.GenusName} {Model.FiSpeciesTree?.FiSpeciesName} {Model.FiSpeciesTree?.Subspecies}" +
                              $"{Model.FiSpeciesTree?.Divers}").FontSize(TextHight).SemiBold().Italic().WrapAnywhere();
                    text.Span($" {Model.FiSpeciesTree?.Author} {Model.FiSpeciesTree?.AuthorYear}").FontSize(TextHight).SemiBold().WrapAnywhere();
                });
                column.Item().Text(text =>
                {
        ...
        container.Row(row =>
        {
            row.RelativeItem().Column(column =>
            {
                ...
                column.Item().Table(table =>
                {
                    ...
                    table.Cell().Text("");
                    table.Cell().Text(CultRes.StringsRes.ReportLNumberLOrigin);
                    table.Cell().Text($"{Model.LNumber} {Model.LOrigin}");
                });
                column.Item().Table(table =>
                {
                    table.ColumnsDefinition(columns =>
                    ...
                    table.Cell().Text("");
                    table.Cell().Text(CultRes.StringsRes.ReportLdaNumberLdaOrigin);
                    table.Cell().Text($"{Model.LdaNumber} {Model.LdaNumber}");
                });
                column.Item().Table(table =>
                {
                    table.ColumnsDefinition(columns =>
                    ...
                    table.Cell().Text("");
                    table.Cell().Text(CultRes.StringsRes.ReportBasinLength);
                    table.Cell().Text($"{Model.BasinLength}");
                });
                column.Item().Table(table =>
                {
                    table.ColumnsDefinition(columns =>
                    ...
                    table.Cell().Text("");
                    table.Cell().Text(CultRes.StringsRes.ReportFishLength);
                    table.Cell().Text($"{Model.FishLength}");
                });
                column.Item().Table(table =>
                {
                    table.ColumnsDefinition(columns =>
                    ...
                    table.Cell().Text($"{Model.MemoRegion}");
                });
    ...
    private void ComposeTaxoHieraContent(IContainer container)
    {
        container.Row(row =>
        {
            row.RelativeItem().Column(column =>
            {
                ...
                if (Model.FiSpeciesTree != null)
                {
                    _tabLeftRel += 4;
                    _tabRightRel -= 4;

                    CompTaxoHieras.ComposeTaxoHierFiSpecies(column, _tabLeftRel, _tabRightRel, Model.FiSpeciesTree);
                }
            });
    ...
    //    if (string.IsNullOrEmpty(Model.FiSpeciesTree?.Subspecies))
    //    {
    //        return;
    //    }
    ...
    //    container.Table(table =>
    //    {
    //        foreach (var item in Tbl69FiSpeciessesDocumentDataSource.FiSpeciessesCollection)
    //        {
    //            table.ColumnsDefinition(columns =>
    //            {
    ...
    //            table.Cell().Text($"{item.Tbl66Genusses.GenusName} {item.FiSpeciesName}" +
    ...
    {
        if (Tbl69FiSpeciesSubsDocumentDataSource.ExpertsCollection.Count == 0)
        {
            return;
        }
        ...
        container.Table(table =>
        {
            foreach (var item in Tbl69FiSpeciesSubsDocumentDataSource.ExpertsCollection)
            {
                for (var i = 0; i < 4; i++)
                {
                    if (i == 0)
    ...
    {
        if (Tbl69FiSpeciesSubsDocumentDataSource.SourcesCollection.Count == 0)
        {
            return;
        }
        ...
        container.Table(table =>
        {
            foreach (var item in Tbl69FiSpeciesSubsDocumentDataSource.SourcesCollection)
            {
                for (var i = 0; i < 5; i++)
                {
                    if (i == 0)
    ...
    {
        if (Tbl69FiSpeciesSubsDocumentDataSource.AuthorsCollection.Count == 0)
        {
            return;
        }
        ...
        container.Table(table =>
        {
            foreach (var item in Tbl69FiSpeciesSubsDocumentDataSource.AuthorsCollection)
            {
                for (var i = 0; i < 11; i++)
                {
                    if (i == 0)
    ...
    {
        if (Tbl69FiSpeciesSubsDocumentDataSource.GeographicsCollection.Count == 0)
        {
            return;
        }
        ...
        container.Table(table =>
        {
            foreach (var item in Tbl69FiSpeciesSubsDocumentDataSource.GeographicsCollection)
            {
                for (var i = 0; i < 10; i++)
                {
                    if (i == 0)
    ...
    {
        if (Tbl69FiSpeciesSubsDocumentDataSource.ImagesCollection.Count == 0)
        {
            return;
        }
        ...
        container.Table(table =>
        {
            foreach (var item in Tbl69FiSpeciesSubsDocumentDataSource.ImagesCollection)
            {
                for (var i = 0; i < 6; i++)
                {
                    if (i == 0)
    ...
    {
        if (Tbl69FiSpeciesSubsDocumentDataSource.CommentsCollection.Count == 0)
        {
            return;
        }
        ...
        container.Table(table =>
        {
            foreach (var item in Tbl69FiSpeciesSubsDocumentDataSource.CommentsCollection)
            {
                for (var i = 0; i < 3; i++)
                {
                    if (i == 0)
        ...
        container.Row(row =>
        {
            row.RelativeItem().Column(column =>
            {
                ...
                column.Item().Table(table =>
                {
                    ...
                    table.Cell().Text("");
                    table.Cell().Text(CultRes.StringsRes.ReportLdaNumberLdaOrigin);
                    table.Cell().Text($"{Model.LdaNumber}/{Model.LdaOrigin}");
                });
                column.Item().Table(table =>
                {
                    table.ColumnsDefinition(columns =>
                ...
                column.Item().Table(table =>
                {
                    ...
                    table.Cell().Text("");
                    table.Cell().Text(CultRes.StringsRes.ReportGu).SemiBold();
                });
                column.Item().Table(table =>
                {
                    table.ColumnsDefinition(columns =>
                    ...
                    table.Cell().Text("");
                    table.Cell().Text(CultRes.StringsRes.ReportMemo);
                    table.Cell().Text($"{Model.MemoDomorphism}");
                });
                column.Item().Table(table =>
                {
                    table.ColumnsDefinition(columns =>
                    ...
                    table.Cell().Text("");
                    table.Cell().Text(CultRes.StringsRes.ReportSozial).SemiBold();
                });
                column.Item().Table(table =>
                {
                    table.ColumnsDefinition(columns =>
                    ...
                    table.Cell().Text("");
                    table.Cell().Text(CultRes.StringsRes.ReportMemo);
                    table.Cell().Text($"{Model.MemoSozial}");
                });
                column.Item().Table(table =>
                {
                    table.ColumnsDefinition(columns =>
                    ...
                    table.Cell().Text("");
                    table.Cell().Text(CultRes.StringsRes.ReportHusbandry).SemiBold();
                });
                column.Item().Table(table =>
                {
                    table.ColumnsDefinition(columns =>
                    ...
                    table.Cell().Text("");
                    table.Cell().Text(CultRes.StringsRes.ReportMemo);
                    table.Cell().Text($"{Model.MemoHusbandry}");
                });
                column.Item().Table(table =>
                {
                    table.ColumnsDefinition(columns =>
                    ...
                    table.Cell().Text("");
                    table.Cell().Text(CultRes.StringsRes.ReportReproduction).SemiBold();
                });
                column.Item().Table(table =>
                {
                    table.ColumnsDefinition(columns =>
                    ...
                    table.Cell().Text("");
                    table.Cell().Text(CultRes.StringsRes.ReportMemo);
                    table.Cell().Text($"{Model.MemoBreeding}");
                });
                column.Item().Table(table =>
                {
                    table.ColumnsDefinition(columns =>
                    ...
                    table.Cell().Text("");
                    table.Cell().Text(CultRes.StringsRes.ReportFood).SemiBold();
                });
                column.Item().Table(table =>
                {
                    table.ColumnsDefinition(columns =>
                    ...
                    table.Cell().Text("");
                    table.Cell().Text(CultRes.StringsRes.ReportMemo);
                    table.Cell().Text($"{Model.MemoFoods}");
                });
                column.Item().Table(table =>
                {
                    table.ColumnsDefinition(columns =>
                    ...
                    table.Cell().Text("");
                    table.Cell().Text(CultRes.StringsRes.ReportSpecial).SemiBold();
                });
                column.Item().Table(table =>
                {
                    table.ColumnsDefinition(columns =>
                    ...
                    table.Cell().Text("");
                    table.Cell().Text(CultRes.StringsRes.ReportMemo);
                    table.Cell().Text($"{Model.MemoSpecial}");
                });
            });
        });
    }
