...
//    Tbl39InfraordosViewModel Skriptdatum:  31.03.2023  10:32    

namespace ATIS.WinUi.ViewModels.Database;

public class Tbl39InfraordosViewModel : ObservableObject
{
    ...
    #region [Constructor]
    public Tbl39InfraordosViewModel(IDataService dataService)
    {
    ...
    public ICommand GetInfraordosByNameOrIdCommand => new RelayCommand(execute: delegate
    {
        var task = GetInfraordosByNameOrId_Executed(SearchInfraordoName);
    });
    ...
    public ICommand DeleteInfraordoCommand => new RelayCommand(execute: delegate { DeleteInfraordo_Executed(SearchInfraordoName); });

    public ICommand SaveInfraordoCommand => new RelayCommand(execute: delegate { var task = SaveInfraordo_Executed(SearchInfraordoName); });
    public ICommand RefreshInfraordoServerCommand => new RelayCommand(execute: delegate { RefreshInfraordoServer_Executed(SearchInfraordoName); });

    #endregion [Commands Infraordo]       

    #region [Methods Tbl39Infraordo]

    private async Task GetInfraordosByNameOrId_Executed(string? parm)
    {
        IsLoading = true;
        ...
        if (Tbl39InfraordosList is { Count: 0 })
        {
    ...
    private async void AddInfraordo_Executed(string? parm)
    {
        InfraordoStartEdit();
        InfraordoStartNew();

        //Id search for first Dataset of Tbl36SubordosList
        var single = await _dataService.GetSubordoSingleFirstDataset();
        var id = single.SubordoId;

        Tbl39InfraordosList ??= new ObservableCollection<Tbl39Infraordo>();
        Tbl39InfraordosList.Insert(index: 0, item: new Tbl39Infraordo { InfraordoName = "New", SubordoId = id });
    ...
    private async void DeleteInfraordo_Executed(string? parm)
    {
        ...
        if (await _allDialogs.DeleteDatasetQuestionConfirmationDialogAsync(InfraordoSelected!.InfraordoName!))
        {
            //necessary to delete before
            await _dataService.DeleteConnectedSuperfamilies(InfraordoSelected);
            await _dataService.DeleteConnectedInfraordoReferences(InfraordoSelected);
            await _dataService.DeleteConnectedInfraordoComments(InfraordoSelected);
    ...
    private async Task SaveInfraordo_Executed(string? parm)
    {
    ...
    #endregion [Methods Tbl39Infraordo]    
    ...
    public ICommand RefreshSubordoServerCommand => new RelayCommand(execute: delegate { RefreshSubordoServer_Executed(SearchInfraordoName); });
    ...
    public ICommand DeleteSuperfamilyCommand => new RelayCommand<string>(DeleteSuperfamily_Executed);
    public ICommand SaveSuperfamilyCommand => new RelayCommand<string>(SaveSuperfamily_Executed);
    public ICommand RefreshSuperfamilyServerCommand => new RelayCommand(execute: delegate { RefreshSuperfamilyServer_Executed(SuperfamilySelected!.InfraordoId); });

    #endregion [Public Commands Connect ==> Tbl42Superfamily]    

    #region [Public Methods Connect ==> Tbl42Superfamily]                   

    private void AddSuperfamily_Executed(string? parm)
    {
        SuperfamilyStartEdit();
        SuperfamilyStartNew();
        Tbl42SuperfamiliesList.Insert(0, new Tbl42Superfamily { SuperfamilyName = "New", InfraordoId = InfraordoSelected.InfraordoId });
    ...
    private async void CopySuperfamily_Executed(string? parm)
    {
        SuperfamilyStartEdit();
        SuperfamilyStartNew();
        SuperfamilySelected.InfraordoId = InfraordoSelected.InfraordoId;  //combo vorbelegen
    ...
    private async void DeleteSuperfamily_Executed(string? parm)
    {
        ...
        Tbl42SuperfamiliesList = _dataService.GetTbl42SuperfamiliesCollectionOrderBySuperfamilyNameFromInfraordoId(SuperfamilySelected.InfraordoId);
    ...
    {
        if (SuperfamilySelected != null && string.IsNullOrEmpty(SuperfamilySelected.SuperfamilyName))
        {
            await _allDialogs.NameRequiredWarnMessageDialogAsync();
            return;
        }
        if (Tbl42SuperfamiliesList != null)
        {
            var indx = Tbl42SuperfamiliesList.IndexOf(Tbl42SuperfamiliesList.First(t =>
              SuperfamilySelected != null && t.SuperfamilyName == SuperfamilySelected.SuperfamilyName));

            if (SuperfamilySelected != null)
            {
                if (InfraordoSelected != null)
                {
                    SuperfamilySelected.InfraordoId = InfraordoSelected.InfraordoId;
                    ...
                    {
                        Tbl42SuperfamiliesList = _dataService.GetTbl42SuperfamiliesCollectionOrderBySuperfamilyNameFromInfraordoId(InfraordoSelected.InfraordoId);
                        //   Index Position ?
                        if (indx < Tbl42SuperfamiliesList.Count)
                        {
                            ...
                            SuperfamilySelected = Tbl42SuperfamiliesList[indx];  //Index
                        }
                    }
                }
            }
    ...
    private void RefreshSuperfamilyServer_Executed(int id)
    {
        Tbl42SuperfamiliesList ??= new ObservableCollection<Tbl42Superfamily>();
        Tbl42SuperfamiliesList = _dataService.GetTbl42SuperfamiliesCollectionOrderBySuperfamilyNameFromInfraordoId(id);
    ...
    private void AddReferenceAuthor_Executed(string? parm)
    {
        ...
        Tbl90ReferenceAuthorsList.Insert(index: 0, item: new Tbl90Reference { Info = "New", InfraordoId = InfraordoSelected!.InfraordoId });
    ...
    private async void CopyReferenceAuthor_Executed(string? parm)
    {
        ReferenceAuthorStartEdit();
        ReferenceAuthorStartNew();
        ReferenceAuthorSelected.InfraordoId = InfraordoSelected.InfraordoId; //combo vorbelegen

        Tbl90ReferenceAuthorsList = await _dataService.CopyReferenceInfraordo(ReferenceAuthorSelected, "Author");
    ...
    private async void DeleteReferenceAuthor_Executed(string? parm)
    {
        ...
        Tbl90ReferenceAuthorsList = _dataService.GetTbl90ReferenceAuthorsCollectionOrderByInfoFromInfraordoIdAndRefSourceIdIsNullAndRefExpertIdIsNull(ReferenceAuthorSelected.InfraordoId);
        ReferenceAuthorDataSetCount = Tbl90ReferenceAuthorsList.Count;
        RefreshReferenceAuthorItems();
    }
    ...
    private async void SaveReferenceAuthor_Executed(string? parm)
    {
        ...
        if (Tbl90ReferenceAuthorsList != null)
        {
            ...
            if (InfraordoSelected != null)
            {
                ReferenceAuthorSelected.InfraordoId = InfraordoSelected.InfraordoId;
            }
    ...
    private void RefreshReferenceAuthorServer_Executed(string? parm)
    {
        ...
        Tbl90ReferenceAuthorsList = _dataService.GetTbl90ReferenceAuthorsCollectionOrderByInfoFromInfraordoIdAndRefSourceIdIsNullAndRefExpertIdIsNull(InfraordoSelected.InfraordoId);
    ...
    private void AddReferenceSource_Executed(string? parm)
    {
        ...
        Tbl90ReferenceSourcesList.Insert(index: 0, item: new Tbl90Reference { Info = "New", InfraordoId = InfraordoSelected!.InfraordoId });
    ...
    private async void CopyReferenceSource_Executed(string? parm)
    {
        ...
        if (InfraordoSelected != null)
        {
            ReferenceSourceSelected.InfraordoId = InfraordoSelected.InfraordoId; //combo vorbelegen
        }
        Tbl90ReferenceSourcesList = await _dataService.CopyReferenceInfraordo(ReferenceSourceSelected, "Source");
        ReferenceSourceDataSetCount = Tbl90ReferenceSourcesList.Count;
    ...
    private async void DeleteReferenceSource_Executed(string? parm)
    {
        ...
        Tbl90ReferenceSourcesList = _dataService.GetTbl90ReferenceSourcesCollectionOrderByInfoFromInfraordoIdAndRefAuthorIdIsNullAndRefExpertIdIsNull(ReferenceSourceSelected.InfraordoId);
        ReferenceSourceDataSetCount = Tbl90ReferenceSourcesList.Count;
        RefreshReferenceSourceItems();
    }
    ...
    private async void SaveReferenceSource_Executed(string? parm)
    {
        ...
        if (Tbl90ReferenceSourcesList != null)
        {
            ...
            if (InfraordoSelected != null)
            {
                ReferenceSourceSelected.InfraordoId = InfraordoSelected.InfraordoId;
            }
    ...
    private void RefreshReferenceSourceServer_Executed(string? parm)
    {
        ...
        Tbl90ReferenceSourcesList = _dataService.GetTbl90ReferenceSourcesCollectionOrderByInfoFromInfraordoIdAndRefAuthorIdIsNullAndRefExpertIdIsNull(InfraordoSelected.InfraordoId);
    ...
    private void AddReferenceExpert_Executed(string? parm)
    {
        ...
        Tbl90ReferenceExpertsList.Insert(index: 0, item: new Tbl90Reference { Info = "New", InfraordoId = InfraordoSelected!.InfraordoId });
    ...
    private async void CopyReferenceExpert_Executed(string? parm)
    {
        ...
        if (InfraordoSelected != null)
        {
            ReferenceExpertSelected.InfraordoId = InfraordoSelected.InfraordoId; //combo vorbelegen
        }
        Tbl90ReferenceExpertsList = await _dataService.CopyReferenceInfraordo(ReferenceExpertSelected, "Expert");
        ReferenceExpertDataSetCount = Tbl90ReferenceExpertsList.Count;
    ...
    private async void DeleteReferenceExpert_Executed(string? parm)
    {
        ...
        Tbl90ReferenceExpertsList = _dataService.GetTbl90ReferenceExpertsCollectionOrderByInfoFromInfraordoIdAndRefAuthorIdIsNullAndRefSourceIdIsNull(ReferenceExpertSelected.InfraordoId);
        ReferenceExpertDataSetCount = Tbl90ReferenceExpertsList.Count;
        RefreshReferenceExpertItems();
    }
    ...
    private async void SaveReferenceExpert_Executed(string? parm)
    {
        ...
        if (Tbl90ReferenceExpertsList != null)
        {
            ...
            if (InfraordoSelected != null)
            {
                ReferenceExpertSelected.InfraordoId = InfraordoSelected.InfraordoId;
            }
    ...
    private void RefreshReferenceExpertServer_Executed(string? parm)
    {
        ...
        Tbl90ReferenceExpertsList = _dataService.GetTbl90ReferenceExpertsCollectionOrderByInfoFromInfraordoIdAndRefAuthorIdIsNullAndRefSourceIdIsNull(InfraordoSelected.InfraordoId);
    ...
    private void AddComment_Executed(string? parm)
    {
        CommentStartEdit();
        CommentStartNew();
        Tbl93CommentsList.Insert(0, new Tbl93Comment { Info = "New", InfraordoId = InfraordoSelected!.InfraordoId });
    ...
    private async void CopyComment_Executed(string? parm)
    {
        ...
        if (InfraordoSelected != null)
        {
            CommentSelected.InfraordoId = InfraordoSelected.InfraordoId;  //combo vorbelegen
        }
    ...
    private async void DeleteComment_Executed(string? parm)
    {
        ...
        Tbl93CommentsList = _dataService.GetTbl93CommentsCollectionOrderByInfoFromInfraordoId(CommentSelected.InfraordoId);
        CommentDataSetCount = Tbl93CommentsList.Count;
        RefreshCommentItems();
    }
    ...
    private async void SaveComment_Executed(string? parm)
    {
        ...
        if (Tbl93CommentsList != null)
        {
            ...
            if (CommentSelected != null)
            {
                if (InfraordoSelected != null)
                {
                    CommentSelected.InfraordoId = InfraordoSelected.InfraordoId;
                    ...
                    {
                        Tbl93CommentsList = _dataService.GetTbl93CommentsCollectionOrderByInfoFromInfraordoId(InfraordoSelected.InfraordoId);
                        //   Index Position ?
        ...
        set
        {
            ...
            if (_selectedMainDetailTabIndex == 0)
            {
                if (InfraordoSelected != null)
                {
                    ...
                    Tbl36SubordosList = _dataService.GetTbl36SubordosCollectionOrderBySubordoNameFromSubordoId(InfraordoSelected.SubordoId);
    ...
    public string SearchInfraordoName { get; set; } = null!;
