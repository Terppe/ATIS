...
public class EditingSample : IMapControlSample
{
    ...
    private static readonly Color PointLayerColor = new(240, 240, 240, 240);
    private static readonly Color LineLayerColor = new(150, 150, 150, 240);
    private static readonly Color PolygonLayerColor = new(20, 20, 20, 240);


    private static readonly SymbolStyle? SelectedStyle = new()
    {
        Fill = null,
    ...
    private static readonly SymbolStyle? DisableStyle = new() { Enabled = false };
