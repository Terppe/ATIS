...
$(function()   {
    $('#]]><xsl:value-of select="IDFK1"/><![CDATA[').focus();
});
</script> 
]]>      
</xsl:when>
...
<xsl:when test="Table ='aspnet_Applications'">  
         <![CDATA[            <tr>
                        ...
                        <td>@Html.TextBoxFor(m => m.]]><xsl:value-of select="Name"/><![CDATA[, new { @class = "textbox72" }) 
          ...
          <![CDATA[          <tr>
                        ...
                        <td>@Html.TextBoxFor(m => m.LoweredApplicationName, new { @class = "textbox72" }) 
                        @Html.ValidationMessageFor(m => m.LoweredApplicationName) </td>
                    </tr>   ]]>
          <![CDATA[          <tr>
                        <td>@]]><xsl:value-of select="Table"/><![CDATA[Res.StringsRes.Description </td>
                        <td>@Html.TextBoxFor(m => m.Description, new { @class = "textbox72" }) 
                        @Html.ValidationMessageFor(m => m.Description) </td>
                    </tr>   ]]>
</xsl:when>
<xsl:when test="Table ='aspnet_Memberships'">  
         <![CDATA[            <tr>
                        <td>@]]><xsl:value-of select="Table"/><![CDATA[Res.StringsRes.Password </td>
                        <td>@Html.TextBoxFor(m => m.Password, new { @class = "textbox36" }) 
                        @Html.ValidationMessageFor(m => m.Password) </td>
                    </tr>  ]]>  
          <![CDATA[          <tr>
                        <td>@]]><xsl:value-of select="Table"/><![CDATA[Res.StringsRes.PasswordFormat </td>
                        <td>@Html.TextBoxFor(m => m.PasswordFormat, new { @class = "textbox36" }) 
                        @Html.ValidationMessageFor(m => m.PasswordFormat) </td>
                    </tr>   ]]>
          <![CDATA[          <tr>
                        <td>@]]><xsl:value-of select="Table"/><![CDATA[Res.StringsRes.PasswordSalt </td>
                        <td>@Html.TextBoxFor(m => m.PasswordSalt, new { @class = "textbox36" }) 
                        @Html.ValidationMessageFor(m => m.PasswordSalt) </td>
                    </tr>   ]]>
          <![CDATA[          <tr>
                        <td>@]]><xsl:value-of select="Table"/><![CDATA[Res.StringsRes.MobilePIN </td>
                        <td>@Html.TextBoxFor(m => m.MobilePIN, new { @class = "textbox20" }) 
                        @Html.ValidationMessageFor(m => m.MobilePIN) </td>
                    </tr>   ]]>
          <![CDATA[          <tr>
                        <td>@]]><xsl:value-of select="Table"/><![CDATA[Res.StringsRes.Email </td>
                        <td>@Html.TextBoxFor(m => m.Email, new { @class = "textbox72" }) 
                        @Html.ValidationMessageFor(m => m.Email) </td>
                    </tr>   ]]>
          <![CDATA[          <tr>
                        <td>@]]><xsl:value-of select="Table"/><![CDATA[Res.StringsRes.LoweredEmail </td>
                        <td>@Html.TextBoxFor(m => m.LoweredEmail, new { @class = "textbox72" }) 
                        @Html.ValidationMessageFor(m => m.LoweredEmail) </td>
                    </tr>   ]]>
         <![CDATA[            <tr>
                        <td>@]]><xsl:value-of select="Table"/><![CDATA[Res.StringsRes.PasswordQuestion </td>
                        <td>@Html.TextBoxFor(m => m.PasswordQuestion, new { @class = "textbox72" }) 
                        @Html.ValidationMessageFor(m => m.PasswordQuestion) </td>
                    </tr>  ]]>  
         <![CDATA[            <tr>
                        <td>@]]><xsl:value-of select="Table"/><![CDATA[Res.StringsRes.PasswordAnswer </td>
                        <td>@Html.TextBoxFor(m => m.PasswordAnswer, new { @class = "textbox72" }) 
                        @Html.ValidationMessageFor(m => m.PasswordAnswer) </td>
                    </tr>  ]]>  
         <![CDATA[            <tr>
                        <td>@]]><xsl:value-of select="Table"/><![CDATA[Res.StringsRes.IsApproved </td>
                        <td>@Html.EditorFor(m => m.IsApproved) 
                        @Html.ValidationMessageFor(m => m.IsApproved) </td>
                    </tr>  ]]>  
         <![CDATA[            <tr>
                        <td>@]]><xsl:value-of select="Table"/><![CDATA[Res.StringsRes.IsLockedOut </td>
                        <td>@Html.EditorFor(m => m.IsLockedOut) 
                        @Html.ValidationMessageFor(m => m.IsLockedOut) </td>
                    </tr>  ]]>  
         <![CDATA[            <tr>
                        <td>@]]><xsl:value-of select="Table"/><![CDATA[Res.StringsRes.CreateDate </td>
                        <td>@Html.TextBoxFor(m => m.CreateDate, new { @class = "textbox20" }) 
                        @Html.ValidationMessageFor(m => m.CreateDate) </td>
                    </tr>  ]]>  
         <![CDATA[            <tr>
                        <td>@]]><xsl:value-of select="Table"/><![CDATA[Res.StringsRes.LastLoginDate </td>
                        <td>@Html.TextBoxFor(m => m.LastLoginDate, new { @class = "textbox20" })
                        @Html.ValidationMessageFor(m => m.LastLoginDate) </td>
                    </tr>  ]]>  
         <![CDATA[            <tr>
                        <td>@]]><xsl:value-of select="Table"/><![CDATA[Res.StringsRes.LastPasswordChangedDate </td>
                        <td>@Html.TextBoxFor(m => m.LastPasswordChangedDate, new { @class = "textbox20" })
                        @Html.ValidationMessageFor(m => m.LastPasswordChangedDate) </td>
                    </tr>  ]]>  
         <![CDATA[            <tr>
                        <td>@]]><xsl:value-of select="Table"/><![CDATA[Res.StringsRes.LastLockoutDate </td>
                        <td>@Html.TextBoxFor(m => m.LastLockoutDate, new { @class = "textbox20" }) 
                        @Html.ValidationMessageFor(m => m.LastLockoutDate) </td>
                    </tr>  ]]>  
         <![CDATA[            <tr>
                        <td>@]]><xsl:value-of select="Table"/><![CDATA[Res.StringsRes.FailedPasswordAttemptCount </td>
                        <td>@Html.TextBoxFor(m => m.FailedPasswordAttemptCount, new { @class = "textbox20" }) 
                        @Html.ValidationMessageFor(m => m.FailedPasswordAttemptCount) </td>
                    </tr>  ]]>  
         <![CDATA[            <tr>
                        <td>@]]><xsl:value-of select="Table"/><![CDATA[Res.StringsRes.FailedPasswordAttemptWindowStart </td>
                        <td>@Html.TextBoxFor(m => m.FailedPasswordAttemptWindowStart, new { @class = "textbox20" }) 
                        @Html.ValidationMessageFor(m => m.FailedPasswordAttemptWindowStart) </td>
                    </tr>  ]]>  
         <![CDATA[            <tr>
                        <td>@]]><xsl:value-of select="Table"/><![CDATA[Res.StringsRes.FailedPasswordAnswerAttemptCount </td>
                        <td>@Html.TextBoxFor(m => m.FailedPasswordAnswerAttemptCount, new { @class = "textbox20" }) 
                        @Html.ValidationMessageFor(m => m.FailedPasswordAnswerAttemptCount) </td>
                    </tr>  ]]>  
         <![CDATA[            <tr>
                        <td>@]]><xsl:value-of select="Table"/><![CDATA[Res.StringsRes.FailedPasswordAnswerAttemptWindowStart </td>
                        <td>@Html.TextBoxFor(m => m.FailedPasswordAnswerAttemptWindowStart, new { @class = "textbox20" }) 
                        @Html.ValidationMessageFor(m => m.FailedPasswordAnswerAttemptWindowStart) </td>
                    </tr>  ]]>  
           <![CDATA[          <tr>
                        <td>@]]><xsl:value-of select="Table"/><![CDATA[Res.StringsRes.Comment </td>
                        <td>@Html.TextAreaFor(m => m.Comment, 6, 108, new { @class = "textbox" }) 
                        @Html.ValidationMessageFor(m => m.Comment) </td>
                    </tr>   ]]>
</xsl:when>
<xsl:when test="Table ='aspnet_Users'">  
         <![CDATA[            <tr>
          ...
          <![CDATA[          <tr>
                        ...
                        <td>@Html.TextBoxFor(m => m.LoweredUserName, new { @class = "textbox72" }) 
                        @Html.ValidationMessageFor(m => m.LoweredUserName) </td>
                    </tr>   ]]>
          <![CDATA[          <tr>
                        <td>@]]><xsl:value-of select="Table"/><![CDATA[Res.StringsRes.MobileAlias </td>
                        <td>@Html.TextBoxFor(m => m.MobileAlias, new { @class = "textbox36" }) 
...
<xsl:otherwise> 
  <xsl:if test="TableFK1 !='NULL'">
    <![CDATA[     <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisFK1"/><![CDATA[Left, "Index", "]]><xsl:value-of select="TableFK1"/><![CDATA[")</li>       ]]> 
  </xsl:if> 
  <xsl:if test="TableFK2 !='NULL'">
    <![CDATA[     <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisFK2"/><![CDATA[Left, "Index", "]]><xsl:value-of select="TableFK2"/><![CDATA[")</li>     ]]> 
  </xsl:if> 
</xsl:otherwise>    
</xsl:choose>
...
<xsl:when test="Table ='Tbl03Regnums'"> 
  <xsl:if test="TableTK1 !='NULL'">
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK1"/><![CDATA[CreateRight, "Create", "]]><xsl:value-of select="TableTK1"/><![CDATA[", new { regnumId = Model.RegnumID }, null)</li>     ]]> 
  </xsl:if> 
  <xsl:if test="TableTK2 !='NULL'">
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK2"/><![CDATA[CreateRight, "Create", "]]><xsl:value-of select="TableTK2"/><![CDATA[", new { regnumId = Model.RegnumID }, null)</li>     ]]> 
  </xsl:if>        
</xsl:when>
<xsl:when test="Table ='Tbl06Phylums'"> 
  <xsl:if test="TableTK1 !='NULL'">
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK1"/><![CDATA[CreateRight, "Create", "]]><xsl:value-of select="TableTK1"/><![CDATA[", new { phylumId = Model.PhylumID }, null)</li>     ]]> 
  </xsl:if> 
</xsl:when>
<xsl:when test="Table ='Tbl09Divisions'"> 
  <xsl:if test="TableTK1 !='NULL'">
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK2"/><![CDATA[CreateRight, "Create", "]]><xsl:value-of select="TableTK1"/><![CDATA[", new { divisionId = Model.DivisionID }, null)</li>     ]]> 
  </xsl:if> 
</xsl:when>
<xsl:when test="Table ='Tbl12Subphylums'"> 
  <xsl:if test="TableTK1 !='NULL'">
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK1"/><![CDATA[CreateRight, "Create", "]]><xsl:value-of select="TableTK1"/><![CDATA[", new { subphylumId = Model.SubphylumID, subdivisionId = 0 }, null)</li>     ]]> 
  </xsl:if> 
</xsl:when>
<xsl:when test="Table ='Tbl15Subdivisions'"> 
  <xsl:if test="TableTK1 !='NULL'">
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK1"/><![CDATA[CreateRight, "Create", "]]><xsl:value-of select="TableTK1"/><![CDATA[", new { subphylumId = 0, subdivisionId = Model.SubdivisionID }, null)</li>     ]]> 
  </xsl:if> 
</xsl:when>
<xsl:when test="Table ='Tbl66Genusses'"> 
  <xsl:if test="TableTK1 !='NULL'">
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK1"/><![CDATA[CreateRight, "Create", "]]><xsl:value-of select="TableTK1"/><![CDATA[", new { genusId = Model.GenusID }, null)</li>     ]]> 
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK2"/><![CDATA[CreateRight, "Create", "]]><xsl:value-of select="TableTK2"/><![CDATA[", new { genusId = Model.GenusID }, null)</li>     ]]> 
  </xsl:if> 
</xsl:when>
<xsl:when test="Table ='Tbl69FiSpeciesses'"> 
  <xsl:if test="TableTK1 !='NULL'">
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK1"/><![CDATA[CreateRight, "Create", "]]><xsl:value-of select="TableTK1"/><![CDATA[", new { fispeciesId = Model.FiSpeciesID, plspeciesId = 0 }, null)</li>     ]]> 
  </xsl:if> 
  <xsl:if test="TableTK2 !='NULL'">
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK2"/><![CDATA[CreateRight, "Create", "]]><xsl:value-of select="TableTK2"/><![CDATA[", new { fispeciesId = Model.FiSpeciesID, plspeciesId = 0 }, null)</li>     ]]> 
  </xsl:if>        
  <xsl:if test="TableTK3 !='NULL'">
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK3"/><![CDATA[CreateRight, "Create", "]]><xsl:value-of select="TableTK3"/><![CDATA[", new { fispeciesId = Model.FiSpeciesID, plspeciesId = 0 }, null)</li>     ]]> 
  </xsl:if>        
  <xsl:if test="TableTK4 !='NULL'">
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK4"/><![CDATA[CreateRight, "Create", "]]><xsl:value-of select="TableTK4"/><![CDATA[", new { fispeciesId = Model.FiSpeciesID, plspeciesId = 0 }, null)</li>     ]]> 
  </xsl:if>        
</xsl:when>
<xsl:when test="Table ='Tbl72PlSpeciesses'"> 
  <xsl:if test="TableTK1 !='NULL'">
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK1"/><![CDATA[CreateRight, "Create", "]]><xsl:value-of select="TableTK1"/><![CDATA[", new { fispeciesId = 0, plspeciesId = Model.PlSpeciesID }, null)</li>     ]]> 
  </xsl:if> 
  <xsl:if test="TableTK2 !='NULL'">
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK2"/><![CDATA[CreateRight, "Create", "]]><xsl:value-of select="TableTK2"/><![CDATA[", new { fispeciesId = 0, plspeciesId = Model.PlSpeciesID }, null)</li>     ]]> 
  </xsl:if>        
  <xsl:if test="TableTK3 !='NULL'">
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK3"/><![CDATA[CreateRight, "Create", "]]><xsl:value-of select="TableTK3"/><![CDATA[", new { fispeciesId = 0, plspeciesId = Model.PlSpeciesID }, null)</li>     ]]> 
  </xsl:if>        
  <xsl:if test="TableTK4 !='NULL'">
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK4"/><![CDATA[CreateRight, "Create", "]]><xsl:value-of select="TableTK4"/><![CDATA[", new { fispeciesId = 0, plspeciesId = Model.PlSpeciesID }, null)</li>     ]]> 
  </xsl:if>        
</xsl:when>
<xsl:when test="Table ='Tbl78Names'"> 
  <xsl:if test="TableTK1 !='NULL'">
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK1"/><![CDATA[CreateRight, "Create", "]]><xsl:value-of select="TableTK1"/><![CDATA[", new { fispeciesId = Model.FiSpeciesID, plspeciesId = Model.PlSpeciesID }, null)</li>     ]]> 
  </xsl:if> 
  <xsl:if test="TableTK2 !='NULL'">
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK2"/><![CDATA[CreateRight, "Create", "]]><xsl:value-of select="TableTK2"/><![CDATA[", new { fispeciesId = Model.FiSpeciesID, plspeciesId = Model.PlSpeciesID }, null)</li>     ]]> 
  </xsl:if>        
  <xsl:if test="TableTK3 !='NULL'">
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK3"/><![CDATA[CreateRight, "Create", "]]><xsl:value-of select="TableTK3"/><![CDATA[", new { fispeciesId = Model.FiSpeciesID, plspeciesId = Model.PlSpeciesID }, null)</li>     ]]> 
  </xsl:if>        
</xsl:when>
<xsl:when test="Table ='Tbl81Images'"> 
  <xsl:if test="TableTK1 !='NULL'">
...
<xsl:when test="Table ='Tbl90RefAuthors'"> 
  <xsl:if test="TableTK1 !='NULL'">
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK1"/><![CDATA[Left, "Index", "]]><xsl:value-of select="TableTK1"/><![CDATA[")</li>     ]]> 
  </xsl:if> 
  <xsl:if test="TableTK2 !='NULL'">
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK2"/><![CDATA[Left, "Index", "]]><xsl:value-of select="TableTK2"/><![CDATA[")</li>     ]]> 
  </xsl:if>        
</xsl:when>
<xsl:when test="Table ='Tbl90References'"> 
</xsl:when>
...
<xsl:otherwise> 
  <xsl:if test="TableTK1 !='NULL'">
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK1"/><![CDATA[Right, "Index", "]]><xsl:value-of select="TableTK1"/><![CDATA[")</li>     ]]> 
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK1"/><![CDATA[CreateRight, "Create", "]]><xsl:value-of select="TableTK1"/><![CDATA[", new { ]]><xsl:value-of select="BasisSm"/><![CDATA[Id = 0 }, null)</li>  ]]>
  </xsl:if> 
</xsl:otherwise>    
</xsl:choose>

<xsl:choose>
<xsl:when test="Table ='Action Author, Expert, Source+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++'">        
</xsl:when>
<xsl:when test="Table ='Tbl90RefAuthors'">     
<![CDATA[        <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnkRefExpertCreateRight, "Create", "Tbl90RefExperts")</li>           ]]>   
<![CDATA[        <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnkRefSourceCreateRight, "Create", "Tbl90RefSources")</li>        ]]>   
</xsl:when>
<xsl:when test="Table ='Tbl90RefExperts'">     
<![CDATA[        <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnkRefAuthorCreateRight, "Create", "Tbl90RefAuthors")</li>           ]]>   
<![CDATA[        <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnkRefSourceCreateRight, "Create", "Tbl90RefSources")</li>           ]]>   
</xsl:when>
<xsl:when test="Table ='Tbl90RefSources'">     
<![CDATA[        <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnkRefAuthorCreateRight, "Create", "Tbl90RefAuthors")</li>           ]]>   
...
<xsl:otherwise>  
<![CDATA[                          
        <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnkReferenceCreateRight, "Create", "Tbl90References",       ]]>
<xsl:choose><xsl:when test="Basis ='Regnum'">    
       <![CDATA[new { ]]><xsl:value-of select="BasisSm"/><![CDATA[Id = Model.]]><xsl:value-of select="Basis"/><![CDATA[ID,     ]]>                       
</xsl:when>
<xsl:otherwise>  
       <![CDATA[new { regnumId = 0,   ]]>                     
</xsl:otherwise>    </xsl:choose>        
<xsl:choose><xsl:when test="Basis ='Phylum'">    
       <![CDATA[     ]]><xsl:value-of select="BasisSm"/><![CDATA[Id = Model.]]><xsl:value-of select="Basis"/><![CDATA[ID,     ]]>                       
</xsl:when>
<xsl:otherwise>  
       <![CDATA[     phylumId = 0,   ]]>                     
</xsl:otherwise>    </xsl:choose>        
<xsl:choose><xsl:when test="Basis ='Division'">    
       <![CDATA[     ]]><xsl:value-of select="BasisSm"/><![CDATA[Id = Model.]]><xsl:value-of select="Basis"/><![CDATA[ID,     ]]>                       
</xsl:when>
<xsl:otherwise>  
       <![CDATA[     divisionId = 0,   ]]>                     
</xsl:otherwise>    </xsl:choose>        
<xsl:choose><xsl:when test="Basis ='Subphylum'">    
       <![CDATA[     ]]><xsl:value-of select="BasisSm"/><![CDATA[Id = Model.]]><xsl:value-of select="Basis"/><![CDATA[ID,     ]]>                       
</xsl:when>
<xsl:otherwise>  
       <![CDATA[     subphylumId = 0,   ]]>                     
</xsl:otherwise>    </xsl:choose>        
<xsl:choose><xsl:when test="Basis ='Subdivision'">    
       <![CDATA[     ]]><xsl:value-of select="BasisSm"/><![CDATA[Id = Model.]]><xsl:value-of select="Basis"/><![CDATA[ID,     ]]>                       
</xsl:when>
<xsl:otherwise>  
       <![CDATA[     subdivisionId = 0,   ]]>                     
</xsl:otherwise>    </xsl:choose>        
<xsl:choose><xsl:when test="Basis ='Superclass'">    
       <![CDATA[     ]]><xsl:value-of select="BasisSm"/><![CDATA[Id = Model.]]><xsl:value-of select="Basis"/><![CDATA[ID,     ]]>                       
</xsl:when>
<xsl:otherwise>  
       <![CDATA[     superclassId = 0,   ]]>                     
</xsl:otherwise>    </xsl:choose>        
<xsl:choose><xsl:when test="Basis ='Class'">    
       <![CDATA[     ]]><xsl:value-of select="BasisSm"/><![CDATA[Id = Model.]]><xsl:value-of select="Basis"/><![CDATA[ID,     ]]>                       
</xsl:when>
<xsl:otherwise>  
       <![CDATA[     classId = 0,   ]]>                     
</xsl:otherwise>    </xsl:choose>        
<xsl:choose><xsl:when test="Basis ='Subclass'">    
       <![CDATA[     ]]><xsl:value-of select="BasisSm"/><![CDATA[Id = Model.]]><xsl:value-of select="Basis"/><![CDATA[ID,     ]]>                       
</xsl:when>
<xsl:otherwise>  
       <![CDATA[     subclassId = 0,   ]]>                     
</xsl:otherwise>    </xsl:choose>        
<xsl:choose><xsl:when test="Basis ='Infraclass'">    
       <![CDATA[     ]]><xsl:value-of select="BasisSm"/><![CDATA[Id = Model.]]><xsl:value-of select="Basis"/><![CDATA[ID,     ]]>                       
</xsl:when>
<xsl:otherwise>  
       <![CDATA[     infraclassId = 0,   ]]>                     
</xsl:otherwise>    </xsl:choose>        
<xsl:choose><xsl:when test="Basis ='Legio'">    
       <![CDATA[     ]]><xsl:value-of select="BasisSm"/><![CDATA[Id = Model.]]><xsl:value-of select="Basis"/><![CDATA[ID,     ]]>                       
</xsl:when>
<xsl:otherwise>  
       <![CDATA[     legioId = 0,   ]]>                     
</xsl:otherwise>    </xsl:choose>        
<xsl:choose><xsl:when test="Basis ='Ordo'">    
       <![CDATA[     ]]><xsl:value-of select="BasisSm"/><![CDATA[Id = Model.]]><xsl:value-of select="Basis"/><![CDATA[ID,     ]]>                       
</xsl:when>
<xsl:otherwise>  
       <![CDATA[     ordoId = 0,   ]]>                     
</xsl:otherwise>    </xsl:choose>        
<xsl:choose><xsl:when test="Basis ='Subordo'">    
       <![CDATA[     ]]><xsl:value-of select="BasisSm"/><![CDATA[Id = Model.]]><xsl:value-of select="Basis"/><![CDATA[ID,     ]]>                       
</xsl:when>
<xsl:otherwise>  
       <![CDATA[     subordoId = 0,   ]]>                     
</xsl:otherwise>    </xsl:choose>        
<xsl:choose><xsl:when test="Basis ='Infraordo'">    
       <![CDATA[     ]]><xsl:value-of select="BasisSm"/><![CDATA[Id = Model.]]><xsl:value-of select="Basis"/><![CDATA[ID,     ]]>                       
</xsl:when>
<xsl:otherwise>  
       <![CDATA[     infraordoId = 0,   ]]>                     
</xsl:otherwise>    </xsl:choose>        
<xsl:choose><xsl:when test="Basis ='Superfamily'">    
       <![CDATA[     ]]><xsl:value-of select="BasisSm"/><![CDATA[Id = Model.]]><xsl:value-of select="Basis"/><![CDATA[ID,     ]]>                       
</xsl:when>
<xsl:otherwise>  
       <![CDATA[     superfamilyId = 0,   ]]>                     
</xsl:otherwise>    </xsl:choose>        
<xsl:choose><xsl:when test="Basis ='Family'">    
       <![CDATA[     ]]><xsl:value-of select="BasisSm"/><![CDATA[Id = Model.]]><xsl:value-of select="Basis"/><![CDATA[ID,     ]]>                       
</xsl:when>
<xsl:otherwise>  
       <![CDATA[     familyId = 0,   ]]>                     
</xsl:otherwise>    </xsl:choose>        
<xsl:choose><xsl:when test="Basis ='Subfamily'">    
       <![CDATA[     ]]><xsl:value-of select="BasisSm"/><![CDATA[Id = Model.]]><xsl:value-of select="Basis"/><![CDATA[ID,     ]]>                       
</xsl:when>
<xsl:otherwise>  
       <![CDATA[     subfamilyId = 0,   ]]>                     
</xsl:otherwise>    </xsl:choose>        
<xsl:choose><xsl:when test="Basis ='Infrafamily'">    
       <![CDATA[     ]]><xsl:value-of select="BasisSm"/><![CDATA[Id = Model.]]><xsl:value-of select="Basis"/><![CDATA[ID,     ]]>                       
</xsl:when>
<xsl:otherwise>  
       <![CDATA[     infrafamilyId = 0,   ]]>                     
</xsl:otherwise>    </xsl:choose>        
<xsl:choose><xsl:when test="Basis ='Supertribus'">    
       <![CDATA[     ]]><xsl:value-of select="BasisSm"/><![CDATA[Id = Model.]]><xsl:value-of select="Basis"/><![CDATA[ID,     ]]>                       
</xsl:when>
<xsl:otherwise>  
       <![CDATA[     supertribusId = 0,   ]]>                     
</xsl:otherwise>    </xsl:choose>        
<xsl:choose><xsl:when test="Basis ='Tribus'">    
       <![CDATA[     ]]><xsl:value-of select="BasisSm"/><![CDATA[Id = Model.]]><xsl:value-of select="Basis"/><![CDATA[ID,     ]]>                       
</xsl:when>
<xsl:otherwise>  
       <![CDATA[     tribusId = 0,   ]]>                     
</xsl:otherwise>    </xsl:choose>        
<xsl:choose><xsl:when test="Basis ='Subtribus'">    
       <![CDATA[     ]]><xsl:value-of select="BasisSm"/><![CDATA[Id = Model.]]><xsl:value-of select="Basis"/><![CDATA[ID,     ]]>                       
</xsl:when>
<xsl:otherwise>  
       <![CDATA[     subtribusId = 0,   ]]>                     
</xsl:otherwise>    </xsl:choose>        
<xsl:choose><xsl:when test="Basis ='Infratribus'">    
       <![CDATA[     ]]><xsl:value-of select="BasisSm"/><![CDATA[Id = Model.]]><xsl:value-of select="Basis"/><![CDATA[ID,     ]]>                       
</xsl:when>
<xsl:otherwise>  
       <![CDATA[     infratribusId = 0,   ]]>                     
</xsl:otherwise>    </xsl:choose>        
<xsl:choose><xsl:when test="Basis ='Genus'">    
       <![CDATA[     ]]><xsl:value-of select="BasisSm"/><![CDATA[Id = Model.]]><xsl:value-of select="Basis"/><![CDATA[ID,     ]]>                       
</xsl:when>
<xsl:otherwise>  
       <![CDATA[     genusId = 0,   ]]>                     
</xsl:otherwise>    </xsl:choose>        
<xsl:choose><xsl:when test="Basis ='FiSpecies'">    
       <![CDATA[     ]]><xsl:value-of select="BasisSm"/><![CDATA[Id = Model.]]><xsl:value-of select="Basis"/><![CDATA[ID,     ]]>                       
</xsl:when>
<xsl:otherwise>  
       <![CDATA[     fispeciesId = 0,   ]]>                     
</xsl:otherwise>    </xsl:choose>        
<xsl:choose><xsl:when test="Basis ='PlSpecies'">    
       <![CDATA[     ]]><xsl:value-of select="BasisSm"/><![CDATA[Id = Model.]]><xsl:value-of select="Basis"/><![CDATA[ID     ]]>                       
</xsl:when>
<xsl:otherwise>  
       <![CDATA[     plspeciesId = 0   ]]>                     
...
<xsl:otherwise> 
<![CDATA[                            
        <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnkCommentCreateRight, "Create", "Tbl93Comments",     ]]>
<xsl:choose><xsl:when test="Basis ='Regnum'">    
       <![CDATA[new { ]]><xsl:value-of select="BasisSm"/><![CDATA[Id = Model.]]><xsl:value-of select="Basis"/><![CDATA[ID,     ]]>                       
</xsl:when>
<xsl:otherwise>  
