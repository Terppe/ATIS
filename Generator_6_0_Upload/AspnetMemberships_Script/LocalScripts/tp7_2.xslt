...
<xsl:when test="Table ='Tbl12Subphylums'"> 
 <![CDATA[ 
        <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnkCreate, "Create", "]]><xsl:value-of select="Table"/><![CDATA[", new { phylumId = 0, divisionId = 0 }, null)</li>   
    </ul> 
</div>  ]]> 
</xsl:when>
<xsl:when test="Table ='Tbl15Subdivisions'">   
...
<xsl:otherwise> 
 <![CDATA[ 
        <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnkCreate, "Create", "]]><xsl:value-of select="Table"/><![CDATA[", new { ]]><xsl:value-of select="BasisSmFK1"/><![CDATA[Id = 0 }, null)</li>   
    </ul> 
</div>  ]]> 
</xsl:otherwise>    
</xsl:choose> 
