...
using Microsoft.EntityFrameworkCore;          
         ...
         //    SuperfamiliesViewModel Skriptdatum:  08.11.2018  10:32    
...
{     
 ...
 //    Part 1    
        ...
        private void ExecuteGetSuperfamiliesByNameOrId(string searchName)
        {
            ...
            Tbl42SuperfamiliesList = _extGet.SearchNameAndIdReturnCollection<Tbl42Superfamily>(SearchSuperfamilyName, "superfamily");
 ...
 //    Part 4    
        ...
        private void ExecuteDeleteFamily(string searchName)
        {
            ...
            Tbl45FamiliesList = _extGet.GetFamiliesCollectionOrderByFromSuperfamilyId<Tbl45Family>(CurrentTbl45Family.SuperfamilyId);
 ...
 //    Part 8    
        ...
        public void ExecuteCopyReferenceAuthor(object o)
        {
            ...
            Tbl90ReferenceAuthorsList = _extCopy.CopyReferenceSuperfamily(CurrentTbl90ReferenceAuthor, "Author");
        ...
        public void ExecuteSaveReferenceAuthor(string searchName)
        {
            ...
            try
            {
                ...
                if (CurrentTbl90ReferenceAuthor.ReferenceId == 0)
                    reference = _extSave.ReferenceAuthorSuperfamilyAdd(CurrentTbl90ReferenceAuthor);

                else
                    reference = _extSave.ReferenceAuthorSuperfamilyUpdate(reference, CurrentTbl90ReferenceAuthor);
           ...
           Tbl90ReferenceAuthorsList = _extGet.GetReferenceAuthorsCollectionOrderByFromSuperfamilyIdAndRefSourceIdIsNullAndRefExpertIdIsNull<Tbl90Reference>(CurrentTbl42Superfamily.SuperfamilyId);            
        ...
        public void ExecuteCopyReferenceSource(object o)
        {
            ...
            Tbl90ReferenceAuthorsList = _extCopy.CopyReferenceSuperfamily(CurrentTbl90ReferenceSource, "Source");
        ...
        private void ExecuteDeleteReferenceSource(object o)
        {
           ...
           Tbl90ReferenceSourcesList = _extGet.GetReferenceSourcesCollectionOrderByFromSuperfamilyIdAndRefAuthorIdIsNullAndRefExpertIdIsNull<Tbl90Reference>(CurrentTbl42Superfamily.SuperfamilyId);          
           ...
           if (_genSourceMessageBoxes.NoDatasetSelectedInfoMessageBox(CurrentTbl90ReferenceSource)) return;
            ...
            try
            {
                ...
                if (CurrentTbl90ReferenceSource.ReferenceId == 0)
                    reference = _extSave.ReferenceSourceSuperfamilyAdd(CurrentTbl90ReferenceSource);
                else
                    reference = _extSave.ReferenceSourceSuperfamilyUpdate(reference, CurrentTbl90ReferenceSource);
        ...
        public void ExecuteCopyReferenceExpert(object o)
        {
            ...
            Tbl90ReferenceExpertsList = _extCopy.CopyReferenceSuperfamily(CurrentTbl90ReferenceExpert, "Expert");
        ...
        private void ExecuteDeleteReferenceExpert(object o)
        {
           ...
           Tbl90ReferenceExpertsList= _extGet.GetReferenceExpertsCollectionOrderByFromSuperfamilyIdAndRefAuthorIdIsNullAndRefSourceIdIsNull<Tbl90Reference>(CurrentTbl42Superfamily.SuperfamilyId);           
        ...
        public void ExecuteSaveReferenceExpert(object o)
        {
            ...
            try
            {
                ...
                if (CurrentTbl90ReferenceExpert.ReferenceId == 0)
                    reference = _extSave.ReferenceExpertSuperfamilyAdd(CurrentTbl90ReferenceExpert);
                else
                    reference = _extSave.ReferenceExpertSuperfamilyUpdate(reference, CurrentTbl90ReferenceExpert);
       ...
       #region [Methods Superfamily ==> Tbl93Comments]        
        ...
        private void ExecuteDeleteComment(object o)
        {
            ...
            Tbl93CommentsList = _extGet.GetCommentsCollectionOrderByFromSuperfamilyId<Tbl93Comment>(CurrentTbl93Comment.SuperfamilyId);
        ...
        private void ExecuteSaveComment(object o)
        {
            ...
            try
            {
                ...
                if (CurrentTbl93Comment.CommentId == 0)
                    comment = _extSave.CommentSuperfamilyAdd(CurrentTbl93Comment);
                else
                    comment = _extSave.CommentSuperfamilyUpdate(comment, CurrentTbl93Comment);
 ...
 //    Part 9    
        ...
        {           
Tbl39InfraordosList = _extGet.GetInfraordosCollectionOrderByFromInfraordoId<Tbl39Infraordo>(CurrentTbl42Superfamily.InfraordoId);

            Tbl36SubordosAllList = _extGet.AllCollection<Tbl36Subordo>("");
        ...
        public  int SelectedMainTabIndex
        {
            ...
            set
            {
                ...
                if (_selectedMainTabIndex == 1)
                {
                    if (CurrentTbl42Superfamily != null)
                    {
                        Tbl45FamiliesList = _extGet.GetFamiliesCollectionOrderByFromSuperfamilyId<Tbl45Family>(CurrentTbl42Superfamily.SuperfamilyId);
                ...
                if (_selectedMainTabIndex == 3)
                {
                    if (CurrentTbl42Superfamily != null)
                    {
                        Tbl93CommentsList = _extGet.GetCommentsCollectionOrderByFromSuperfamilyId<Tbl93Comment>(CurrentTbl42Superfamily.SuperfamilyId);
