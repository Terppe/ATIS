USE [ATIS34]
GO
/****** Object:  Table [dbo].[Tbl93Comments]    Script Date:  29.11.2018  10:32   ******/  
SET ANSI_NULLS ON
GO
...
(
 ...
 , 
CONSTRAINT [IX_Tbl93Comments_CountID] UNIQUE NONCLUSTERED 
(
	[CountID] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE = OFF,  IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON,  ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
...
ALTER TABLE [dbo].[Tbl93Comments]  WITH CHECK ADD  CONSTRAINT 
[FK_Tbl93Comments_Tbl69FiSpeciesses] FOREIGN KEY ([FiSpeciesID])
...
ALTER TABLE [dbo].[Tbl93Comments]  WITH CHECK ADD  CONSTRAINT 
[FK_Tbl93Comments_Tbl72PlSpeciesses] FOREIGN KEY ([PlSpeciesID])
...
ALTER TABLE [dbo].[Tbl93Comments]  WITH CHECK ADD  CONSTRAINT 
[FK_Tbl93Comments_Tbl66Genusses] FOREIGN KEY ([GenusID])
...
ALTER TABLE [dbo].[Tbl93Comments]  WITH CHECK ADD  CONSTRAINT 
[FK_Tbl93Comments_Tbl63Infratribusses] FOREIGN KEY ([InfratribusID])
...
ALTER TABLE [dbo].[Tbl93Comments]  WITH CHECK ADD  CONSTRAINT 
[FK_Tbl93Comments_Tbl60Subtribusses] FOREIGN KEY ([SubtribusID])
...
ALTER TABLE [dbo].[Tbl93Comments]  WITH CHECK ADD  CONSTRAINT 
[FK_Tbl93Comments_Tbl57Tribusses] FOREIGN KEY ([TribusID])
...
ALTER TABLE [dbo].[Tbl93Comments]  WITH CHECK ADD  CONSTRAINT 
[FK_Tbl93Comments_Tbl54Supertribusses] FOREIGN KEY ([SupertribusID])
...
ALTER TABLE [dbo].[Tbl93Comments]  WITH CHECK ADD  CONSTRAINT 
[FK_Tbl93Comments_Tbl51Infrafamilies] FOREIGN KEY ([InfrafamilyID])
...
ALTER TABLE [dbo].[Tbl93Comments]  WITH CHECK ADD  CONSTRAINT 
[FK_Tbl93Comments_Tbl48Subfamilies] FOREIGN KEY ([SubfamilyID])
...
ALTER TABLE [dbo].[Tbl93Comments]  WITH CHECK ADD  CONSTRAINT 
[FK_Tbl93Comments_Tbl45Families] FOREIGN KEY ([FamilyID])
...
ALTER TABLE [dbo].[Tbl93Comments]  WITH CHECK ADD  CONSTRAINT 
[FK_Tbl93Comments_Tbl42Superfamilies] FOREIGN KEY ([SuperfamilyID])
...
ALTER TABLE [dbo].[Tbl93Comments]  WITH CHECK ADD  CONSTRAINT 
[FK_Tbl93Comments_Tbl39Infraordos] FOREIGN KEY ([InfraordoID])
...
ALTER TABLE [dbo].[Tbl93Comments]  WITH CHECK ADD  CONSTRAINT 
[FK_Tbl93Comments_Tbl36Subordos] FOREIGN KEY ([SubordoID])
...
ALTER TABLE [dbo].[Tbl93Comments]  WITH CHECK ADD  CONSTRAINT 
[FK_Tbl93Comments_Tbl33Ordos] FOREIGN KEY ([OrdoID])
...
ALTER TABLE [dbo].[Tbl93Comments]  WITH CHECK ADD  CONSTRAINT 
[FK_Tbl93Comments_Tbl30Legios] FOREIGN KEY ([LegioID])
...
ALTER TABLE [dbo].[Tbl93Comments]  WITH CHECK ADD  CONSTRAINT 
[FK_Tbl93Comments_Tbl27Infraclasses] FOREIGN KEY ([InfraclassID])
...
ALTER TABLE [dbo].[Tbl93Comments]  WITH CHECK ADD  CONSTRAINT 
[FK_Tbl93Comments_Tbl24Subclasses] FOREIGN KEY ([SubclassID])
...
ALTER TABLE [dbo].[Tbl93Comments]  WITH CHECK ADD  CONSTRAINT 
[FK_Tbl93Comments_Tbl21Classes] FOREIGN KEY ([ClassID])
...
ALTER TABLE [dbo].[Tbl93Comments]  WITH CHECK ADD  CONSTRAINT 
[FK_Tbl93Comments_Tbl18Superclasses] FOREIGN KEY ([SuperclassID])
...
ALTER TABLE [dbo].[Tbl93Comments]  WITH CHECK ADD  CONSTRAINT 
[FK_Tbl93Comments_Tbl15Subdivisions] FOREIGN KEY ([SubdivisionID])
...
ALTER TABLE [dbo].[Tbl93Comments]  WITH CHECK ADD  CONSTRAINT 
[FK_Tbl93Comments_Tbl12Subphylums] FOREIGN KEY ([SubphylumID])
...
ALTER TABLE [dbo].[Tbl93Comments]  WITH CHECK ADD  CONSTRAINT 
[FK_Tbl93Comments_Tbl09Divisions] FOREIGN KEY ([DivisionID])
...
ALTER TABLE [dbo].[Tbl93Comments]  WITH CHECK ADD  CONSTRAINT 
[FK_Tbl93Comments_Tbl06Phylums] FOREIGN KEY ([PhylumID])
...
ALTER TABLE [dbo].[Tbl93Comments]  WITH CHECK ADD  CONSTRAINT 
[FK_Tbl93Comments_Tbl03Regnums] FOREIGN KEY ([RegnumID])
