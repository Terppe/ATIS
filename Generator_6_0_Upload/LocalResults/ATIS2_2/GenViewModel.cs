...
using MessageBoxImage = System.Windows.MessageBoxImage;      
         ...
         //    Tbl03RegnumsViewModel Skriptdatum:  09.11.2017  12:32      

namespace WPFUI.Views.Database
{     
    
    public partial class Tbl03RegnumsViewModel : ViewModelBase                     
    {     
...
phylum.PhylumName = CurrentTbl06Phylum.PhylumName;
                            phylum.RegnumID = CurrentTbl03Regnum.RegnumID;   
                    ...
                    }
                    {
                        ...
                        (from a in _tbl06PhylumsRepository.GetAll()
                         ...
                         a.RegnumID == CurrentTbl03Regnum.RegnumID
                         select a); 
            ...
            try
            {
                ...
                else
                {
                    if (CurrentTbl09Division.DivisionID!= 0)
                    {
                        ...
                        {   
  division.RegnumID= CurrentTbl03Regnum.RegnumID;            
                ...
                else
                {
                    if (CurrentTbl90RefAuthor.ReferenceID != 0 && CurrentTbl90RefAuthor.RefAuthorID != 0)
                    {
                        ...
                        {   
                            ...
                            refAuthor.RegnumID = CurrentTbl03Regnum.RegnumID;  
...
RegnumID = CurrentTbl03Regnum.RegnumID,              
                    ...
                    {
                        //RegnumID may be not 0
                        if (CurrentTbl03Regnum.RegnumID == 0 || CurrentTbl90RefAuthor.RefAuthorID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl90RefSource.ReferenceID != 0)
                    {
                        ...
                        {   
                            ...
                            refSource.RegnumID = CurrentTbl03Regnum.RegnumID;            
...
RegnumID = CurrentTbl03Regnum.RegnumID,              
                    ...
                    {
                        //RegnumID may be not 0
                        if (CurrentTbl03Regnum.RegnumID == 0 || CurrentTbl90RefSource.RefSourceID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,            
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl90RefExpert.ReferenceID != 0 && CurrentTbl90RefExpert.RefExpertID != 0)
                    {
                        ...
                        {   
                            ...
                            refExpert.RegnumID = CurrentTbl03Regnum.RegnumID;           
...
RegnumID = CurrentTbl03Regnum.RegnumID,              
                    ...
                    {
                        //RegnumID may be not 0
                        if (CurrentTbl03Regnum.RegnumID == 0 || CurrentTbl90RefExpert.RefExpertID == 0)   
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,          
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl93Comment.CommentID != 0)
                    {
                        ...
                        {   
                            ...
                            comment.RegnumID = CurrentTbl03Regnum.RegnumID;            
 ...
 //    Part 10    
        ...
        public int SelectedDetailThreeRefTabIndex
        {
            ...
            set
            {
                ...
                _selectedDetailThreeRefTabIndex = value; 
                RaisePropertyChanged();
