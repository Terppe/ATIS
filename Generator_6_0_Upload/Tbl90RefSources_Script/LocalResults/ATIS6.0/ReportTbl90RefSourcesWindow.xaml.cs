...
using MahApps.Metro.Controls;
   ...
   //  ReportRefSourceWindow.xaml.cs Skriptdatum:   29.11.2018  10:32     

namespace ATIS.Ui.Views.Report.ListDetails
{  

    /// <summary>
    /// Interactionslogic for ReportRefSourceWindow.xaml
    /// </summary>
    public partial class ReportRefSourceWindow : MetroWindow
   {

        public ReportRefSourceWindow(int un, string tab)
       {         
