...
RefSourcesView = CollectionViewSource.GetDefaultView(Tbl90RefSourcesList);
        ...
        private void ExecuteCopyRefSource(object o)
        {
            ...
            Tbl90RefSourcesList = _extCopy.CopyRefSource(CurrentTbl90RefSource);
        ...
        private void ExecuteDeleteRefSource(string searchName)
        {
            ...
            Tbl69FiSpeciessesList = _extDelete.SearchForConnectedDatasetsWithRefSourceIdInTableFiSpecies(CurrentTbl90RefSource);     
     
            if (_allMessageBoxes.DoNotDeleteDatasetInfoMessageBox(Tbl69FiSpeciessesList.Count, "FiSpecies")) return;

            //Delete all References Experts, Sources, Authors  ----------------------------------------------------
            Tbl90ReferencesList = _extDelete.DeleteDatasetsWithRefSourceIdInTableReference(CurrentTbl90RefSource);
            ...
            //Delete all Comments  ----------------------------------------------------
            Tbl93CommentsList = _extDelete.DeleteDatasetsWithRefSourceIdInTableComment(CurrentTbl90RefSource);
            ...
            try
            {
                ...
                if (refSource!= null)
                {
                    ...
                    _extDelete.DeleteRefSource(refSource);

                    _allMessageBoxes.InfoMessageBox(CultRes.StringsRes.DeleteSuccess, CurrentTbl90RefSource.RefSourceName);
                }
                else _allMessageBoxes.InfoMessageBox("Not To Delete", CultRes.StringsRes.DeleteCan + " " + CurrentTbl90RefSource.RefSourceName + " " + CultRes.StringsRes.DeleteCan1);
            }
            catch (Exception e)
            {
        ...
        private void ExecuteSaveRefSource(string searchName)
        {
            ...
            try
            {
                ...
                if (CurrentTbl90RefSource.RefSourceId == 0)
                    refSource = _extSave.RefSourceAdd(CurrentTbl90RefSource);
                else
                    refSource = _extSave.RefSourceUpdate(refSource, CurrentTbl90RefSource);

                _position = RefSourcesView.CurrentPosition;

                try
                {
                    _extSave.RefSourceSave(refSource, CurrentTbl90RefSource);
                }
        ...
        public  int SelectedMainTabIndex
        {
            ...
            set
            {
                ...
                if (_selectedMainTabIndex == 0)             
                {
                    ...
                    {
                        NULLList = _extGet.GetCollectionOrderByFromNULLId<NULL>(CurrentTbl90RefSource.NULLId);
                ...
                if (_selectedMainTabIndex == 1)
                {
                    if (CurrentTbl90RefSource != null)
                    {
                        Tbl69FiSpeciessesList = _extGet.GetCollectionOrderByFromRefSourceId<NULL>(CurrentTbl90RefSource.RefSourceId);

                        Tbl90RefSourcesAllList = _extGet.AllCollection<Tbl90RefSource>("refSource");
                ...
                if (_selectedMainTabIndex == 3)
                {
                    if (CurrentTbl90RefSource != null)
                    {
                        Tbl93CommentsList = _extGet.GetCommentsCollectionOrderByFromRefSourceId<Tbl93Comment>(CurrentTbl90RefSource.RefSourceId);
            ...
            set
            {
                ...
                if (_selectedDetailTabIndex == 3)
                {
                    if (CurrentTbl90RefSource != null)
                    {
                        ...
                        Tbl90ReferenceExpertsList = _extGet.GetReferenceExpertsCollectionOrderByFromRefSourceIdAndRefAuthorIdIsNullAndRefSourceIdIsNull<Tbl90Reference>(CurrentTbl90RefSource.RefSourceId);
                ...
                if (_selectedDetailTabIndex == 4)
                {
                    if (CurrentTbl90RefSource != null)
                    {
                        ...
                        Tbl90ReferenceSourcesList = _extGet.GetReferenceSourcesCollectionOrderByFromRefSourceIdAndRefAuthorIdIsNullAndRefExpertIdIsNull<Tbl90Reference>(CurrentTbl90RefSource.RefSourceId);
                ...
                if (_selectedDetailTabIndex == 5)
                {
                    if (CurrentTbl90RefSource != null)
                    {
                        ...
                        Tbl90ReferenceAuthorsList = _extGet.GetReferenceAuthorsCollectionOrderByFromRefSourceIdAndRefSourceIdIsNullAndRefExpertIdIsNull<Tbl90Reference>(CurrentTbl90RefSource.RefSourceId);
