...
using MahApps.Metro.Controls;
   ...
   //  ReportCountryWindow.xaml.cs Skriptdatum:   29.11.2018 12:32       

namespace ATIS.Ui.Views.Report.ListDetails
{  

    /// <summary>
    /// Interactionslogic for ReportCountryWindow.xaml
    /// </summary>
    public partial class ReportCountryWindow : MetroWindow
   {

        public ReportCountryWindow(int un, string tab)
       {         
