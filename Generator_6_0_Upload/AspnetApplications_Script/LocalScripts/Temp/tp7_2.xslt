...
<xsl:when test="Table ='AspnetMemberships'">  
<![CDATA[        <th>@Html.Partial("_SmartLink", Model, new ViewDataDictionary { { "ColumnName", "Password" }, { "DisplayName", ]]><xsl:value-of select="Table"/><![CDATA[Res.StringsRes.Password } })</th>   ]]>
<![CDATA[        <th>@Html.Partial("_SmartLink", Model, new ViewDataDictionary { { "ColumnName", "Email" }, { "DisplayName", ]]><xsl:value-of select="Table"/><![CDATA[Res.StringsRes.Email } })</th>   ]]>
<![CDATA[        <th>@Html.Partial("_SmartLink", Model, new ViewDataDictionary { { "ColumnName", "PasswordQuestion" }, { "DisplayName", ]]><xsl:value-of select="Table"/><![CDATA[Res.StringsRes.PasswordQuestion } })</th>   ]]>
<![CDATA[        <th>@Html.Partial("_SmartLink", Model, new ViewDataDictionary { { "ColumnName", "PasswordAnswer" }, { "DisplayName", ]]><xsl:value-of select="Table"/><![CDATA[Res.StringsRes.PasswordAnswer } })</th>   ]]>
<![CDATA[        <th>@Html.Partial("_SmartLink", Model, new ViewDataDictionary { { "ColumnName", "IsApproved" }, { "DisplayName", ]]><xsl:value-of select="Table"/><![CDATA[Res.StringsRes.IsApproved } })</th>   ]]>
<![CDATA[        <th>@Html.Partial("_SmartLink", Model, new ViewDataDictionary { { "ColumnName", "IsLockedOut" }, { "DisplayName", ]]><xsl:value-of select="Table"/><![CDATA[Res.StringsRes.IsLockedOut } })</th>   ]]>
<![CDATA[        <th>@Html.Partial("_SmartLink", Model, new ViewDataDictionary { { "ColumnName", "CreateDate" }, { "DisplayName", ]]><xsl:value-of select="Table"/><![CDATA[Res.StringsRes.CreateDate } })</th>   ]]>
<![CDATA[        <th>@Html.Partial("_SmartLink", Model, new ViewDataDictionary { { "ColumnName", "CreateLastLoginDate" }, { "DisplayName", ]]><xsl:value-of select="Table"/><![CDATA[Res.StringsRes.LastLoginDate } })</th>   ]]>
</xsl:when>
<xsl:when test="Table ='AspnetUsers'">  
...
<xsl:when test="Table ='AspnetMemberships'">  
        <![CDATA[                  
        <td class="left">@item.Password </td>   
        <td class="left">@item.Email </td>   
        <td class="left">@item.PasswordQuestion </td>   
        <td class="left">@item.PasswordAnswer </td>   
        <td class="left">@item.IsApproved</td>   
        <td class="left">@item.IsLockedOut </td>   
        <td class="left">@item.CreateDate </td>   
        <td class="left">@item.LastLoginDate </td>   ]]>
</xsl:when>
<xsl:when test="Table ='AspnetUsers'">  
        <![CDATA[<td class="left">@item.]]><xsl:value-of select="Name"/><![CDATA[ </td>                   
...
<xsl:when test="Table ='Tbl03Regnums'"> 
  ...
  <xsl:if test="TableTK2 !='NULL'">
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK2"/><![CDATA[Right, "Index", "]]><xsl:value-of select="TableTK2"/><![CDATA[")</li>     ]]> 
  </xsl:if>        
</xsl:when>
<xsl:when test="Table ='Tbl06Phylums'"> 
  <xsl:if test="TableTK1 !='NULL'">
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK1"/><![CDATA[Right, "Index", "]]><xsl:value-of select="TableTK1"/><![CDATA[")</li>     ]]> 
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK1"/><![CDATA[CreateRight, "Create", "]]><xsl:value-of select="TableTK1"/><![CDATA[", new { phylumId = 0 }, null)</li>     ]]> 
  </xsl:if> 
</xsl:when>
<xsl:when test="Table ='Tbl09Divisions'"> 
  <xsl:if test="TableTK1 !='NULL'">
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK2"/><![CDATA[Right, "Index", "]]><xsl:value-of select="TableTK1"/><![CDATA[")</li>     ]]> 
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK2"/><![CDATA[CreateRight, "Create", "]]><xsl:value-of select="TableTK1"/><![CDATA[", new { divisionId = 0 }, null)</li>     ]]> 
  </xsl:if> 
</xsl:when>
<xsl:when test="Table ='Tbl12Subphylums'"> 
  <xsl:if test="TableTK1 !='NULL'">
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK1"/><![CDATA[Right, "Index", "]]><xsl:value-of select="TableTK1"/><![CDATA[")</li>     ]]> 
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK1"/><![CDATA[CreateRight, "Create", "]]><xsl:value-of select="TableTK1"/><![CDATA[", new { subphylumId = 0, subdivisionId = 0 }, null)</li>     ]]> 
  </xsl:if> 
</xsl:when>
...
<xsl:when test="Table ='Tbl66Genusses'"> 
  <xsl:if test="TableTK1 !='NULL'">
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK1"/><![CDATA[Right, "Index", "]]><xsl:value-of select="TableTK1"/><![CDATA[")</li>     ]]> 
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK1"/><![CDATA[CreateRight, "Create", "]]><xsl:value-of select="TableTK1"/><![CDATA[", new { genusId = 0 }, null)</li>     ]]> 
  </xsl:if> 
</xsl:when>
<xsl:when test="Table ='Tbl68Speciesgroups'"> 
  <xsl:if test="TableTK1 !='NULL'">
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK1"/><![CDATA[Right, "Index", "]]><xsl:value-of select="TableTK1"/><![CDATA[")</li>     ]]> 
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK1"/><![CDATA[CreateRight, "Create", "]]><xsl:value-of select="TableTK1"/><![CDATA[", new { speciesgroupId = 0 }, null)</li>     ]]> 
  </xsl:if> 
  <xsl:if test="TableTK2 !='NULL'">
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK2"/><![CDATA[Right, "Index", "]]><xsl:value-of select="TableTK2"/><![CDATA[")</li>     ]]> 
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK2"/><![CDATA[CreateRight, "Create", "]]><xsl:value-of select="TableTK2"/><![CDATA[", new { speciesgroupId = 0 }, null)</li>     ]]> 
  </xsl:if> 
</xsl:when>
<xsl:when test="Table ='Tbl69FiSpeciesses'"> 
  <xsl:if test="TableTK1 !='NULL'">
  ...
  <xsl:if test="TableTK3 !='NULL'">
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK3"/><![CDATA[Right, "Index", "]]><xsl:value-of select="TableTK3"/><![CDATA[")</li>     ]]> 
  </xsl:if>        
  <xsl:if test="TableTK4 !='NULL'">
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK4"/><![CDATA[Right, "Index", "]]><xsl:value-of select="TableTK4"/><![CDATA[")</li>     ]]> 
  </xsl:if>        
</xsl:when>
<xsl:when test="Table ='Tbl72PlSpeciesses'"> 
  <xsl:if test="TableTK1 !='NULL'">
...
<xsl:when test="Table ='Tbl90References'"> 
  <xsl:if test="TableFK4 !='NULL'">
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisFK4"/><![CDATA[Right, "Index", "]]><xsl:value-of select="TableFK4"/><![CDATA[")</li>     ]]> 
  </xsl:if> 
  <xsl:if test="TableFK5 !='NULL'">
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisFK5"/><![CDATA[Right, "Index", "]]><xsl:value-of select="TableFK5"/><![CDATA[")</li>     ]]> 
  </xsl:if>        
  <xsl:if test="TableFK1 !='NULL'">
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisFK1"/><![CDATA[Right, "Index", "]]><xsl:value-of select="TableFK1"/><![CDATA[")</li>     ]]> 
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisFK1"/><![CDATA[CreateRight, "Create", "]]><xsl:value-of select="TableFK1"/><![CDATA[")</li>     ]]> 
  </xsl:if>        
  <xsl:if test="TableFK2 !='NULL'">
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisFK2"/><![CDATA[Right, "Index", "]]><xsl:value-of select="TableFK2"/><![CDATA[")</li>     ]]> 
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisFK2"/><![CDATA[CreateRight, "Create", "]]><xsl:value-of select="TableFK2"/><![CDATA[")</li>     ]]> 
  </xsl:if>        
  <xsl:if test="TableFK3 !='NULL'">
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisFK3"/><![CDATA[Right, "Index", "]]><xsl:value-of select="TableFK3"/><![CDATA[")</li>     ]]> 
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisFK3"/><![CDATA[CreateRight, "Create", "]]><xsl:value-of select="TableFK3"/><![CDATA[")</li>     ]]> 
  </xsl:if>        
</xsl:when>
<xsl:when test="Table ='Tbl90RefExperts'"> 
  <xsl:if test="TableTK1 !='NULL'">
...
<xsl:when test="Table ='Tbl93Comments'"> 
  <xsl:if test="TableFK4 !='NULL'">
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK4"/><![CDATA[Left, "Index", "]]><xsl:value-of select="TableTK4"/><![CDATA[")</li>     ]]> 
  </xsl:if> 
  <xsl:if test="TableFK5 !='NULL'">
    <![CDATA[    <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnk]]><xsl:value-of select="BasisTK5"/><![CDATA[Left, "Index", "]]><xsl:value-of select="TableTK5"/><![CDATA[")</li>     ]]> 
  </xsl:if>        
</xsl:when>
<xsl:otherwise> 
  <xsl:if test="TableTK1 !='NULL'">
...
<xsl:when test="Table ='Tbl90RefAuthors'">     
<![CDATA[        <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnkRefExpertRight, "Index", "Tbl90RefExperts")</li>      ]]>                 
<![CDATA[        <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnkRefSourceRight, "Index", "Tbl90RefSources")</li>     ]]>                  
</xsl:when>
<xsl:when test="Table ='Tbl90RefExperts'">     
<![CDATA[        <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnkRefAuthorRight, "Index", "Tbl90RefAuthors")</li>      ]]>                 
<![CDATA[        <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnkRefSourceRight, "Index", "Tbl90RefSources")</li>    ]]>                   
</xsl:when>
<xsl:when test="Table ='Tbl90RefSources'">     
<![CDATA[        <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnkRefAuthorRight, "Index", "Tbl90RefAuthors")</li>     ]]>                  
...
<xsl:otherwise>  
<![CDATA[        <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnkReferenceRight, "Index", "Tbl90References")</li>                       
...
<xsl:otherwise> 
<![CDATA[        <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnkCommentRight, "Index", "Tbl93Comments")</li>                       
...
<xsl:choose>
<xsl:when test="Table ='Action New++++++++++++++++++'">        
</xsl:when>
<xsl:when test="Table ='Tbl12Subphylums'"> 
 <![CDATA[ 
        <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnkCreate, "Create", "]]><xsl:value-of select="Table"/><![CDATA[", new { subphylumId = 0, subdivisionId = 0 }, null)</li>   
    </ul> 
</div>  ]]> 
</xsl:when>
<xsl:when test="Table ='Tbl15Subdivisions'">   
...
<xsl:otherwise> 
 <![CDATA[ 
        <li>@Html.ActionLink(SharedRes.StringsRes.ActionLnkCreate, "Create", "]]><xsl:value-of select="Table"/><![CDATA[", new { ]]><xsl:value-of select="BasisSm"/><![CDATA[Id = 0 }, null)</li>   
    </ul> 
</div>  ]]> 
</xsl:otherwise>    
</xsl:choose> 
