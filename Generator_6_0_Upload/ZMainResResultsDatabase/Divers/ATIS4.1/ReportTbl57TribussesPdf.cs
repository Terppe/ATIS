...
using Microsoft.Win32;   
         ...
         //    ReportTbl57TribussesPdf Skriptdatum:  19.06.2018  10:32    
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id)
        {
           ...
           var reportVm = new ReportViewModel();
            reportVm.GetTbl57TribussesById(id); 
        ...
        private static Document AddTbl57TribussesHaeder(Document doc)       
        {
            ...
            table.AddCell(new PdfPCell(new Phrase(_tribus.TribusName + "  " + _tribus.Author + "  " + _tribus.AuthorYear, LargeFont)) { Colspan = 4, Border = 0 });  // 1.-4. field
