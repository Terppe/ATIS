...
using Microsoft.Win32;   
         ...
         //    ReportTbl36SubordosPdf Skriptdatum:  19.06.2018  10:32    
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id)
        {
           ...
           var reportVm = new ReportViewModel();
            reportVm.GetTbl36SubordosById(id); 
        ...
        private static Document AddTbl36SubordosHaeder(Document doc)       
        {
            ...
            table.AddCell(new PdfPCell(new Phrase(_subordo.SubordoName + "  " + _subordo.Author + "  " + _subordo.AuthorYear, LargeFont)) { Colspan = 4, Border = 0 });  // 1.-4. field
