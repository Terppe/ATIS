...
using Microsoft.Win32;   
         ...
         //    ReportTbl60SubtribussesPdf Skriptdatum:  19.06.2018  10:32    
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id)
        {
           ...
           var reportVm = new ReportViewModel();
            reportVm.GetTbl60SubtribussesById(id); 
        ...
        private static Document AddTbl60SubtribussesHaeder(Document doc)       
        {
            ...
            table.AddCell(new PdfPCell(new Phrase(_subtribus.SubtribusName + "  " + _subtribus.Author + "  " + _subtribus.AuthorYear, LargeFont)) { Colspan = 4, Border = 0 });  // 1.-4. field
