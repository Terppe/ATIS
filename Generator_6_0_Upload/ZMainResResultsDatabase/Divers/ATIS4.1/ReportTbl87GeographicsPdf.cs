...
using Microsoft.Win32;   
         ...
         //    ReportTbl87GeographicsPdf Skriptdatum:  17.07.2018  10:32    
...
{     
 ...
 //    Part 1    
        ...
        private static Document AddTbl87GeographicsHaeder(Document doc)       
        {
            ...
            table.AddCell(new PdfPCell(new Phrase(_geographic.GeographicName + "  " + _geographic.Author + "  " + _geographic.AuthorYear, LargeFont)) { Colspan = 4, Border = 0 });  // 1.-4. field
