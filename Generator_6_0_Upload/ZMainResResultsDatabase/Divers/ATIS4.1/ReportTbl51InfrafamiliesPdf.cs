...
using Microsoft.Win32;   
         ...
         //    ReportTbl51InfrafamiliesPdf Skriptdatum:  19.06.2018  10:32    
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id)
        {
           ...
           var reportVm = new ReportViewModel();
            reportVm.GetTbl51InfrafamiliesById(id); 
        ...
        private static Document AddTbl51InfrafamiliesHaeder(Document doc)       
        {
            ...
            table.AddCell(new PdfPCell(new Phrase(_infrafamily.InfrafamilyName + "  " + _infrafamily.Author + "  " + _infrafamily.AuthorYear, LargeFont)) { Colspan = 4, Border = 0 });  // 1.-4. field
