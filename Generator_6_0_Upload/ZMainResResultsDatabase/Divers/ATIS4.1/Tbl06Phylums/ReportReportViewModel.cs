...
{       
    ...
    //------------------------------------------------------------------------------  		   
        ...
        IList<Tbl90Reference> ListTbl90RefAuthorsByPhylumId(int phylumId);
        IList<Tbl90Reference> ListTbl90RefSourcesByPhylumId(int phylumId);
        IList<Tbl90Reference> ListTbl90RefExpertsByPhylumId(int phylumId);
