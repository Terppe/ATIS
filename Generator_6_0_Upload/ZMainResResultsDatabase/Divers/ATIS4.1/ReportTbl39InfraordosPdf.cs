...
using Microsoft.Win32;   
         ...
         //    ReportTbl39InfraordosPdf Skriptdatum:  19.06.2018  10:32    
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id)
        {
          ...
          var reportVm = new ReportViewModel();
            reportVm.GetTbl39InfraordosById(id); 
        ...
        private static Document AddTbl39InfraordosHaeder(Document doc)       
        {
            ...
            table.AddCell(new PdfPCell(new Phrase(_infraordo.InfraordoName + "  " + _infraordo.Author + "  " + _infraordo.AuthorYear, LargeFont)) { Colspan = 4, Border = 0 });  // 1.-4. field
