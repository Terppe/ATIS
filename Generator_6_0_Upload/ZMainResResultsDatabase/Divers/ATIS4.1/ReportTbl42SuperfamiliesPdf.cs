...
using Microsoft.Win32;   
         ...
         //    ReportTbl42SuperfamiliesPdf Skriptdatum:  19.06.2018  10:32    
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id)
        {
           ...
           var reportVm = new ReportViewModel();
            reportVm.GetTbl42SuperfamiliesById(id); 
        ...
        private static Document AddTbl42SuperfamiliesHaeder(Document doc)       
        {
            ...
            table.AddCell(new PdfPCell(new Phrase(_superfamily.SuperfamilyName + "  " + _superfamily.Author + "  " + _superfamily.AuthorYear, LargeFont)) { Colspan = 4, Border = 0 });  // 1.-4. field
