...
using Microsoft.Win32;   
         ...
         //    ReportTbl72PlSpeciessesPdf Skriptdatum:  30.06.2018  12:32    

namespace Te.Atis.Ui.Desktop.Views.Report.PDF
{     
    
    public class ReportTbl72PlSpeciessesPdf : ViewModelBase
    {     
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id)
        {
           ...
           var reportVm = new ReportViewModel();
            reportVm.GetTbl72PlSpeciessesById(id); 

            //From Database Tbl72PlSpeciesses
            _plspecies = _businessLayer.SingleListTbl72PlSpeciessesByPlSpeciesId(id);
        ...
        private static Document AddTbl72PlSpeciessesHaeder(Document doc)       
        {
            ...
            table.AddCell(new PdfPCell(new Phrase(_plspecies.Tbl66Genusses.GenusName + "  " + _plspecies.PlSpeciesName + "  " + _plspecies.Subspecies + "  " + _plspecies.Divers + "  " + _plspecies.Author + "  " + _plspecies.AuthorYear, LargeFont)) { Colspan = 4, Border = 0 });  // 1.-4. field
