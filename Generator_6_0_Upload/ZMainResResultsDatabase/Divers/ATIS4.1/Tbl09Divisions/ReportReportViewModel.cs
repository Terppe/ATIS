...
{       
    ...
    //------------------------------------------------------------------------------  		   
        ...
        IList<Tbl90Reference> ListTbl90RefAuthorsByDivisionId(int divisionId);
        IList<Tbl90Reference> ListTbl90RefSourcesByDivisionId(int divisionId);
        IList<Tbl90Reference> ListTbl90RefExpertsByDivisionId(int divisionId);
