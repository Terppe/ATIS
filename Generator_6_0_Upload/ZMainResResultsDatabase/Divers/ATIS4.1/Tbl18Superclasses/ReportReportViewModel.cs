...
{       
    ...
    //------------------------------------------------------------------------------  		   
        ...
        IList<Tbl24Subclass> ListNULLBySuperclassIdAndHash(int superclassId);
		...
		public IList<Tbl24Subclass> ListNULLBySuperclassIdAndHash(int superclassId)
		{
			return Repository.ListWhereOrderByInclude(
				e => e.SuperclassID == superclassId &&
				e.SubclassName.Contains("#") == false,
				Repository.OrderBy(r => r.SubclassName),
				p => p.NULL, k => k.Tbl18Superclasses);
		}
