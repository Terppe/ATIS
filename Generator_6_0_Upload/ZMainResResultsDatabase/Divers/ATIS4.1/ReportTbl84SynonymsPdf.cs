...
using Microsoft.Win32;   
         ...
         //    ReportTbl84SynonymsPdf Skriptdatum:  17.07.2018  10:32    
...
{     
 ...
 //    Part 1    
        ...
        private static Document AddTbl84SynonymsHaeder(Document doc)       
        {
            ...
            table.AddCell(new PdfPCell(new Phrase(_synonym.SynonymName + "  " + _synonym.Author + "  " + _synonym.AuthorYear, LargeFont)) { Colspan = 4, Border = 0 });  // 1.-4. field
