...
// <!-- Interface Skriptdatum:  19.06.2018  18:32     -->  
...
{       
    ...
    //------------------------------------------------------------------------------  		   
        ...
        IList<Tbl21Class> ListTbl21ClassesByClassId(int classId);

        IList<Tbl24Subclass> ListTbl24SubclassesByClassIdAndHash(int classId);

        IList<Tbl90Reference> ListTbl90AuthorsByClassId(int classId);
        IList<Tbl90Reference> ListTbl90SourcesByClassId(int classId);
        IList<Tbl90Reference> ListTbl90ExpertsByClassId(int classId);

        IList<Tbl93Comment> ListTbl93CommentsByClassId(int classId);	   
           
		public IList<Tbl21Class> ListTbl21ClassesByClassId(int classId)
		{
			return _tbl21ClassesRepository.ListWhereOrderByInclude(
				e => e.ClassID == classId,
				_tbl21ClassesRepository.OrderBy(r => r.ClassName + r.Subregnum),
				p => p.Tbl24Subclasses, k => k.NULL);
		}

		public IList<Tbl24Subclass> ListTbl24SubclassesByClassIdAndHash(int classId)
		{
		...
		public IList<Tbl90Reference> ListTbl90AuthorsByClassId(int classId)
		{
			return _tbl90ReferencesRepository.ListWhereOrderByInclude(
				e => e.RefAuthorID == e.Tbl90RefAuthors.RefAuthorID && e.ClassID == classId,
		...
		public IList<Tbl90Reference> ListTbl90SourcesByClassId(int classId)
		{
			return _tbl90ReferencesRepository.ListWhereOrderByInclude(
				e => e.RefSourceID == e.Tbl90RefSources.RefSourceID && e.ClassID == classId,
				_tbl90ReferencesRepository.OrderBy(r => r.Tbl90RefSources.RefSourceName + r.Tbl90RefSources.SourceYear),
				p => p.Tbl90RefSources);
		}

		public IList<Tbl90Reference> ListTbl90ExpertsByClassId(int classId)
		{
			return _tbl90ReferencesRepository.ListWhereOrderByInclude(
				e => e.RefExpertID == e.Tbl90RefExperts.RefExpertID && e.ClassID == classId,
				_tbl90ReferencesRepository.OrderBy(r => r.Tbl90RefExperts.RefExpertName),
				p => p.Tbl90RefExperts);
		}

		public IList<Tbl90Reference> ListTbl90RefAuthorsByClassId(int classId)
		{
			return _tbl90ReferencesRepository.ListWhereOrderByInclude(
				e => e.RefAuthorID == e.Tbl90RefAuthors.RefAuthorID && e.ClassID == classId,
				_tbl90ReferencesRepository.OrderBy(r => r.Tbl90RefAuthors.RefAuthorName + r.Tbl90RefAuthors.ArticelTitle + r.Tbl90RefAuthors.BookName + r.Tbl90RefAuthors.Page1 + r.Tbl90RefAuthors.Publisher),
		...
		public IList<Tbl90Reference> ListTbl90RefSourcesByClassId(int classId)
		{
			return _tbl90ReferencesRepository.ListWhereOrderByInclude(
				e => e.RefSourceID == e.Tbl90RefSources.RefSourceID && e.ClassID == classId,
				_tbl90ReferencesRepository.OrderBy(r => r.Tbl90RefSources.RefSourceName + r.Tbl90RefSources.SourceYear),
		...
		public IList<Tbl90Reference> ListTbl90RefExpertsByClassId(int classId)
		{
			return _tbl90ReferencesRepository.ListWhereOrderByInclude(
				e => e.RefExpertID == e.Tbl90RefExperts.RefExpertID && e.ClassID == classId,
				_tbl90ReferencesRepository.OrderBy(r => r.Tbl90RefExperts.RefExpertName),
		...
		public IList<Tbl93Comment> ListTbl93CommentsByClassId(int classId)
		{
