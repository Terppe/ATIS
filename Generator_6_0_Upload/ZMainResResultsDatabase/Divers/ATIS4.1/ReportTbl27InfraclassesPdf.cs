...
using Microsoft.Win32;   
         ...
         //    ReportTbl27InfraclassesPdf Skriptdatum:  15.06.2018  18:32    
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id)
        {
           ...
           var reportVm = new ReportViewModel();
            reportVm.GetTbl27InfraclassesById(id); 
        ...
        private static Document AddTbl27InfraclassesHaeder(Document doc)       
        {
            ...
            table.AddCell(new PdfPCell(new Phrase(_infraclass.InfraclassName + "  " + _infraclass.Author + "  " + _infraclass.AuthorYear, LargeFont)) { Colspan = 4, Border = 0 });  // 1.-4. field
