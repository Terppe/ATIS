 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id)
        {
           ...
           var reportVm = new ReportViewModel();
            reportVm.GetTbl45FamiliesById(id); 
        ...
        private static Document AddTbl45FamiliesHaeder(Document doc)       
        {
            ...
            table.AddCell(new PdfPCell(new Phrase(_family.FamilyName + "  " + _family.Author + "  " + _family.AuthorYear, LargeFont)) { Colspan = 4, Border = 0 });  // 1.-4. field
