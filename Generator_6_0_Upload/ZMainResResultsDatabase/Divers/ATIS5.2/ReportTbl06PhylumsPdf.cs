...
using Microsoft.Win32;   
         ...
         //    ReportTbl06PhylumsPdf Skriptdatum:  21.01.2019  12:32    
...
{     
 ...
 //    Part 1    
        ...
        private static Document AddTbl06PhylumsHaeder(Document doc)       
        {
            ...
            table.AddCell(new PdfPCell(new Phrase(_phylum.PhylumName + "  " + _phylum.Author + "  " + _phylum.AuthorYear, LargeFont)) { Colspan = 4, Border = 0 });  // 1.-4. field
