...
using Microsoft.Win32;   
         ...
         //    ReportTbl03RegnumsPdf Skriptdatum:  02.06.2019  12:32      

namespace Te.Atis.Ui.Desktop.Views.Report.PDF
{     
    
    public class ReportTbl03RegnumsPdf : ViewModelBase
    {     
 ...
 //    Part 1    
        ...
        private static Document AddTbl03RegnumsHaeder(Document doc)       
        {
            ...
            table.AddCell(new PdfPCell(new Phrase(_regnum.RegnumName + "  " + _regnum.Subregnum + "  " + _regnum.Author + "  " + _regnum.AuthorYear, LargeFont)) { Colspan = 4, Border = 0 });  // 1.-4. field
