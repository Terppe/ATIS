...
using Microsoft.Win32;   
         ...
         //    ReportTbl66GenussesPdf Skriptdatum:  09.11.2018  10:32    
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id)
        {
           ...
           var reportVm = new ReportViewModel();
            reportVm.GetTbl66GenussesById(id); 
        ...
        private static Document AddTbl66GenussesHaeder(Document doc)       
        {
            ...
            table.AddCell(new PdfPCell(new Phrase(_genus.GenusName + "  " + _genus.Author + "  " + _genus.AuthorYear, LargeFont)) { Colspan = 4, Border = 0 });  // 1.-4. field
