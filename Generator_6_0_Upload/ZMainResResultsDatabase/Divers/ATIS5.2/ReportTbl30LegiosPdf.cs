 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id)
        {
           ...
           var reportVm = new ReportViewModel();
            reportVm.GetTbl30LegiosById(id); 
        ...
        private static Document AddTbl30LegiosHaeder(Document doc)       
        {
            ...
            table.AddCell(new PdfPCell(new Phrase(_legio.LegioName + "  " + _legio.Author + "  " + _legio.AuthorYear, LargeFont)) { Colspan = 4, Border = 0 });  // 1.-4. field
