...
using Microsoft.Win32;   
         ...
         //    ReportTbl69FiSpeciessesPdf Skriptdatum:  22.01.2019  10:32    
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id)
        {
           ...
           var reportVm = new ReportViewModel();
            reportVm.GetTbl69FiSpeciessesById(id); 
        ...
        private static Document AddTbl69FiSpeciessesHaeder(Document doc)       
        {
            ...
            table.AddCell(new PdfPCell(new Phrase(_fispecies.Tbl66Genusses.GenusName + "  " + _fispecies.FiSpeciesName + "  " + _fispecies.Subspecies + "  " + _fispecies.Divers + "  " + _fispecies.Author + "  " + _fispecies.AuthorYear, LargeFont)) { Colspan = 4, Border = 0 });  // 1.-4. field
