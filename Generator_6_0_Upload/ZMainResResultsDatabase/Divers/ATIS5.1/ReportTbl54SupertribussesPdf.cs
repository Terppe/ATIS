 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id)
        {
           ...
           var reportVm = new ReportViewModel();
            reportVm.GetTbl54SupertribussesById(id); 
        ...
        private static Document AddTbl54SupertribussesHaeder(Document doc)       
        {
            ...
            table.AddCell(new PdfPCell(new Phrase(_supertribus.SupertribusName + "  " + _supertribus.Author + "  " + _supertribus.AuthorYear, LargeFont)) { Colspan = 4, Border = 0 });  // 1.-4. field
