...
using Microsoft.Win32;   
         ...
         //    ReportTbl24SubclassesPdf Skriptdatum:  21.12.2017  18:32    
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id)
        {
           var reportVm = new ReportViewModel();
            reportVm.GetTbl24SubclassesById(id); 
        ...
        private static Document AddTbl24SubclassesHaeder(Document doc)       
        {
            ...
            table.AddCell(new PdfPCell(new Phrase(_subclass.SubclassName + "  " + _subclass.Author + "  " + _subclass.AuthorYear, LargeFont)) { Colspan = 4, Border = 0 });  // 1.-4. field
