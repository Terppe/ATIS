...
using Microsoft.Win32;   
         ...
         //    ReportTblUserProfilesPdf Skriptdatum:   15.11.2017  10:32    
...
{     
 ...
 //    Part 1    
        ...
        private static Document AddTblUserProfilesHaeder(Document doc)       
        {
            ...
            table.AddCell(new PdfPCell(new Phrase(_userprofile.LastName + "  " + _userprofile.Author + "  " + _userprofile.AuthorYear, LargeFont)) { Colspan = 4, Border = 0 });  // 1.-4. field
