...
using Microsoft.Win32;   
         ...
         //    ReportTbl68SpeciesgroupsPdf Skriptdatum:  11.11.2017  10:32    
...
{     
 ...
 //    Part 1    
        ...
        private static Document AddTbl68SpeciesgroupsHaeder(Document doc)       
        {
            ...
            table.AddCell(new PdfPCell(new Phrase(_speciesgroup.SpeciesgroupName + "  " + _speciesgroup.Author + "  " + _speciesgroup.AuthorYear, LargeFont)) { Colspan = 4, Border = 0 });  // 1.-4. field
