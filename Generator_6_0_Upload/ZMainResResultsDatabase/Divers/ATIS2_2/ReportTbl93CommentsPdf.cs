...
using Microsoft.Win32;   
         ...
         //    ReportTbl93CommentsPdf Skriptdatum:  14.11.2017  10:32    
...
{     
 ...
 //    Part 1    
        ...
        private static Document AddTbl93CommentsHaeder(Document doc)       
        {
            ...
            table.AddCell(new PdfPCell(new Phrase(_comment.CommentName + "  " + _comment.Author + "  " + _comment.AuthorYear, LargeFont)) { Colspan = 4, Border = 0 });  // 1.-4. field
