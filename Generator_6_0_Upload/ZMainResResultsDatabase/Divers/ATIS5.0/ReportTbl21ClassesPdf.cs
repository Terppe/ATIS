...
using Microsoft.Win32;   
         ...
         //    ReportTbl21ClassesPdf Skriptdatum:  16.12.2018  18:32    
...
{     
 ...
 //    Part 1    
        ...
        private static Document AddTbl21ClassesHaeder(Document doc)       
        {
            ...
            table.AddCell(new PdfPCell(new Phrase(_classe.ClassName + "  " + _classe.Author + "  " + _classe.AuthorYear, LargeFont)) { Colspan = 4, Border = 0 });  // 1.-4. field
