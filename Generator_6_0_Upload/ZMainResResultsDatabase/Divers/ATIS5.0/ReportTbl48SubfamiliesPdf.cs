 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id)
        {
           ...
           var reportVm = new ReportViewModel();
            reportVm.GetTbl48SubfamiliesById(id); 
        ...
        private static Document AddTbl48SubfamiliesHaeder(Document doc)       
        {
            ...
            table.AddCell(new PdfPCell(new Phrase(_subfamily.SubfamilyName + "  " + _subfamily.Author + "  " + _subfamily.AuthorYear, LargeFont)) { Colspan = 4, Border = 0 });  // 1.-4. field
