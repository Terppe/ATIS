...
using Microsoft.Win32;   
         ...
         //    ReportTbl33OrdosPdf Skriptdatum:  11.12.2018  10:32    
...
{     
 ...
 //    Part 1    
        ...
        private static Document AddTbl33OrdosHaeder(Document doc)       
        {
            ...
            table.AddCell(new PdfPCell(new Phrase(_ordo.OrdoName + "  " + _ordo.Author + "  " + _ordo.AuthorYear, LargeFont)) { Colspan = 4, Border = 0 });  // 1.-4. field
