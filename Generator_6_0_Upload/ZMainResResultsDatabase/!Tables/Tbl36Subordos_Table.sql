USE [ATIS34]
GO
/****** Object:  Table [dbo].[Tbl36Subordos]    Script Date:  15.12.2019  10:32   ******/  
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[Tbl36Subordos] (
            ...
            [SubordoName] [nvarchar] (100) COLLATE Latin1_General_CI_AS NOT NULL,
            [OrdoID] [int] NOT NULL,
...
(
 ...
 , 
CONSTRAINT [IX_Tbl36Subordos_CountID] UNIQUE NONCLUSTERED 
(
	[CountID] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE = OFF,  IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON,  ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
 , 
CONSTRAINT [IX_Tbl36Subordos_SubordoName] UNIQUE NONCLUSTERED 
(
	[SubordoName] ASC, [OrdoID] ASC, [Author] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE = OFF,  IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON,  ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
...
ALTER TABLE [dbo].[Tbl36Subordos]  WITH CHECK ADD  CONSTRAINT 
[FK_Tbl36Subordos_Tbl33Ordos] FOREIGN KEY ([OrdoID])
