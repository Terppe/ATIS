USE [ATIS34]
GO
/****** Object:  Table [dbo].[Tbl33Ordos]    Script Date:  10.12.2020  10:32   ******/  
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[Tbl33Ordos] (
            ...
            [OrdoName] [nvarchar] (100) COLLATE Latin1_General_CI_AS NOT NULL,
...
(
 ...
 , 
CONSTRAINT [IX_Tbl33Ordos_CountID] UNIQUE NONCLUSTERED 
(
	[CountID] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE = OFF,  IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON,  ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
 , 
CONSTRAINT [IX_Tbl33Ordos_OrdoName] UNIQUE NONCLUSTERED 
(
	[OrdoName] ASC, [LegioID] ASC, [Author] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE = OFF,  IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON,  ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
...
ALTER TABLE [dbo].[Tbl33Ordos]  WITH CHECK ADD  CONSTRAINT 
[FK_Tbl33Ordos_Tbl30Legios] FOREIGN KEY ([LegioID])
