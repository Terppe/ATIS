USE [ATIS34]
GO
/****** Object:  Table [dbo].[Tbl45Families]    Script Date:  19.06.2018  10:32   ******/  
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[Tbl45Families] (
            ...
            [FamilyName] [nvarchar] (100) COLLATE Latin1_General_CI_AS NOT NULL,
...
(
 ...
 , 
CONSTRAINT [IX_Tbl45Families_CountID] UNIQUE NONCLUSTERED 
(
	[CountID] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE = OFF,  IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON,  ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
 , 
CONSTRAINT [IX_Tbl45Families_FamilyName] UNIQUE NONCLUSTERED 
(
	[FamilyName] ASC, [SuperfamilyID] ASC, [Author] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE = OFF,  IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON,  ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
...
ALTER TABLE [dbo].[Tbl45Families]  WITH CHECK ADD  CONSTRAINT 
[FK_Tbl45Families_Tbl42Superfamilies] FOREIGN KEY ([SuperfamilyID])
