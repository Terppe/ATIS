USE [ATIS34]
GO
/****** Object:  Table [dbo].[Tbl90RefExperts]    Script Date:  29.11.2018  10:32   ******/  
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[Tbl90RefExperts] (
            ...
            [RefExpertName] [nvarchar] (300) COLLATE Latin1_General_CI_AS NULL,
...
(
 ...
 , 
CONSTRAINT [IX_Tbl90RefExperts_CountID] UNIQUE NONCLUSTERED 
(
	[CountID] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE = OFF,  IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON,  ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
