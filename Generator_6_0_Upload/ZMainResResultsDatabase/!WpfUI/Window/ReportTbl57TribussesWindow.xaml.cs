...
using System.Windows.Documents;
   ...
   //  ReportTbl57TribussesWindow.xaml.cs Skriptdatum:  11.11.2017  10:32     

namespace WPFUI.Views.Report 
{  

    /// <summary>
    /// Interactionslogic for ReportTbl57TribussesWindow.xaml
    /// </summary>
    public partial class ReportTbl57TribussesWindow : Window
   {

        public ReportTbl57TribussesWindow(int un, string tab)
       {         
