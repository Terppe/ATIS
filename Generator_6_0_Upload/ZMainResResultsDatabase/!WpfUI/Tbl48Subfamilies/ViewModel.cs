...
//    Tbl48SubfamilyViewModel Skriptdatum:  7.1.2012  10:32    
...
{   
    ...
    {     
      ...
      #region "Private Data Members"
        ...
        {
            get { return _getSubfamilyByNameCommand ?? (_getSubfamilyByNameCommand = new RelayCommand(GetSubfamilyByName)); }
        }

        private void GetSubfamilyByName()
        {   
Tbl48SubfamiliesList =
                 new ObservableCollection<Tbl48Subfamily>((from x in Tbl48SubfamiliesRepository.Tbl48Subfamilies
                                                        where x.SubfamilyName.StartsWith(SearchSubfamilyName)
                                                        orderby x.SubfamilyName
                                                        select x));

            Tbl48SubfamiliesAllList =
                 new ObservableCollection<Tbl48Subfamily>((from y in Tbl48SubfamiliesRepository.Tbl48Subfamilies
                                                        orderby y.SubfamilyName
                                                        select y));

            Tbl45FamiliesAllList =
                 new ObservableCollection<Tbl45Family>((from z in Tbl45FamiliesRepository.Tbl45Families
                                                        orderby z.FamilyName
                                                        select z));

              
  Tbl42SuperfamiliesAllList =
                 new ObservableCollection<Tbl42Superfamily>((from z in Tbl42SuperfamiliesRepository.Tbl42Superfamilies
...
Tbl45FamiliesList = null;                  
  ...
  View = CollectionViewSource.GetDefaultView(Tbl48SubfamiliesList);
            if (View != null)
                View.CurrentChanged += tbl48SubfamilyView_CurrentChanged;                   
        ...
        {
            get { return _getFamilyByNameCommand ?? (_getFamilyByNameCommand = new RelayCommand(GetFamilyByName)); }
        }

        private void GetFamilyByName()
        {
            Tbl45FamiliesList =
            ...
            if (View != null)
                View.CurrentChanged += tbl45FamilyView_CurrentChanged;                   
        ...
        private void GetNULLByName()
        {
            Tbl54SupertribussesList =
                new ObservableCollection<Tbl54Supertribus>((from  in Tbl54SupertribussesRepository.Tbl54Supertribusses
                                                       where .SupertribusName.StartsWith(SearchNULLName)
                                                       orderby .SupertribusName
                                                       select ));
        ...
        private void DeleteNULL()
        {
            try
            {
                var = Tbl54SupertribussesRepository.Tbl54Supertribusses.FirstOrDefault(x => x.SupertribusID== CurrentTbl54Supertribus.SupertribusID);
                if (!= null)
                {
                    if (MessageBox.Show("Are you really shure to delete this "
                                        + CurrentTbl54Supertribus.SupertribusName, "Question", MessageBoxButton.YesNo) !=
                        MessageBoxResult.Yes) return;
                    Tbl54SupertribussesRepository.Delete();
            ...
            try
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            SubfamilyID= CurrentTbl54Supertribus.SubfamilyID,              
        ...
        public new Tbl48Subfamily CurrentTbl48Subfamily
        {
            ...
            {
                if (View != null)
                    return View.CurrentItem as Tbl48Subfamily;
                return null;
            }
        }
        //--------------------------------------------
        ...
        private ObservableCollection<Tbl54Supertribus> List;
        ...
        public void tbl51InfrafamilyView_CurrentChanged(object sender, EventArgs e)
        {
            RaisePropertyChanged("CurrentTbl51Infrafamily");
        }
