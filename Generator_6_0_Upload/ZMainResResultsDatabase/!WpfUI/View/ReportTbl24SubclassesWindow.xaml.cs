...
using System.Windows.Documents;
   ...
   //  ReportTbl24SubclassesWindow.xaml.cs Skriptdatum:  22.02.2016  18:32     

namespace WPFUI.Views.Report 
{  

    /// <summary>
    /// Interactionslogic for ReportTbl24SubclassesWindow.xaml
    /// </summary>
    public partial class ReportTbl24SubclassesWindow : Window
   {

        public ReportTbl24SubclassesWindow(int un, string tab)
       {         
