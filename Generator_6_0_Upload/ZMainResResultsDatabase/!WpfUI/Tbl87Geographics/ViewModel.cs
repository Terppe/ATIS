...
//    Tbl87GeographicViewModel Skriptdatum:  15.03.2012  10:32    
...
{   
    ...
    public class Tbl87GeographicsViewModel : Tbl69FiSpeciessesViewModel                     
    {     
      ...
      #region "Private Data Members"
        ...
        private RelayCommand _getGeographicByNameCommand;
        public new ICommand GetGeographicByNameCommand
        {
            get { return _getGeographicByNameCommand ?? (_getGeographicByNameCommand = new RelayCommand(GetGeographicByName)); }
        }

        private void GetGeographicByName()
        {   
Tbl87GeographicsList =
                 new ObservableCollection<Tbl87Geographic>((from x in Tbl87GeographicsRepository.Tbl87Geographics
                                                        where x.GeographicName.StartsWith(SearchGeographicName)
                                                        orderby x.GeographicName
                                                        select x));

            Tbl87GeographicsAllList =
                 new ObservableCollection<Tbl87Geographic>((from y in Tbl87GeographicsRepository.Tbl87Geographics
                                                        orderby y.GeographicName
                                                        select y));
...
Tbl69FiSpeciessesList = null;                  
  ...
  View = CollectionViewSource.GetDefaultView(Tbl87GeographicsList);
            if (View != null)
                View.CurrentChanged += tbl87GeographicView_CurrentChanged;                   
            RaisePropertyChanged("CurrentTbl87Geographic");
        }
        //------------------------------------------------------------------------------
        private RelayCommand _addGeographicCommand;
        public new ICommand AddGeographicCommand
        {
        ...
        private void AddGeographic()
        {
            ...
            Tbl87GeographicsList.Add(new Tbl87Geographic{ GeographicName= "New " });
            View = CollectionViewSource.GetDefaultView(Tbl87GeographicsList);
            if (View != null)
                View.CurrentChanged += tbl87GeographicView_CurrentChanged;
            RaisePropertyChanged("CurrentTbl87Geographic");
        ...
        public new ICommand DeleteGeographicCommand
        {
            ...
            try
            {
                ...
                if (geographic!= null)
                {
                    if (MessageBox.Show("Are you really shure to delete this "
                                        + CurrentTbl87Geographic.GeographicName, "Question", MessageBoxButton.YesNo) !=
                        MessageBoxResult.Yes) return;
                    Tbl87GeographicsRepository.Delete(geographic);
                    Tbl87GeographicsRepository.Save();
                    MessageBox.Show(CurrentTbl87Geographic.GeographicName + " was deleted successfully");
                    GetGeographicByName(); //Refresh
                }
                else
                {
                    MessageBox.Show("Only " + CurrentTbl87Geographic.GeographicName+ " can be deleted");
                }
            }
            catch (Exception ex)
            {
        ...
        public new ICommand SaveGeographicCommand
        {
                ...
                else
                {
                    ...
                    else
                    {
                        Tbl87GeographicsRepository.Add(new Tbl87Geographic
                        {
                            ...
                            GeographicName= CurrentTbl87Geographic.GeographicName,              
                            CountID = TblCountersRepository.Counter(),
                            Valid = CurrentTbl87Geographic.Valid,
                            ValidYear = CurrentTbl87Geographic.ValidYear,
                            Synonym = CurrentTbl87Geographic.Synonym,
                            Author = CurrentTbl87Geographic.Author,
                            AuthorYear = CurrentTbl87Geographic.AuthorYear,
                            Info = CurrentTbl87Geographic.Info,
                            EngName = CurrentTbl87Geographic.EngName,
                            GerName = CurrentTbl87Geographic.GerName,
                            FraName = CurrentTbl87Geographic.FraName,
                            PorName = CurrentTbl87Geographic.PorName,
                    ...
                    {
                        Tbl87GeographicsRepository.Save();
                        MessageBox.Show(CurrentTbl87Geographic.GeographicName+  " was successfully saved ");
                        GetGeographicByName();  //Refresh
                    }
                }
            }
            ...
            try
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            GeographicID= CurrentNULL.GeographicID,              
                ...
                else
                {
                    ...
                    else
                    {
                        Tbl90ReferencesRepository.Add(new Tbl90Reference()
                        {
                            ...
                            GeographicID= CurrentTbl90RefAuthor.GeographicID,
                            CountID = TblCountersRepository.Counter(),
                ...
                else
                {
                    ...
                    else
                    {
                        Tbl90ReferencesRepository.Add(new Tbl90Reference()
                        {
                            ...
                            GeographicID= CurrentTbl90RefSource.GeographicID,
                            CountID = TblCountersRepository.Counter(),
                ...
                else
                {
                    ...
                    else
                    {
                        Tbl90ReferencesRepository.Add(new Tbl90Reference
                        {
                            ...
                            GeographicID= CurrentTbl90RefExpert.GeographicID,
                            CountID = TblCountersRepository.Counter(),
            ...
            try
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            GeographicID= CurrentTbl93Comment.GeographicID,                
                            CountID = TblCountersRepository.Counter(),
        ...
        public new void GetConnectedTablesById()
        {
            ...
            Tbl69FiSpeciessesList =
                new ObservableCollection<Tbl69FiSpecies>((from fispecies in Tbl69FiSpeciessesRepository.Tbl69FiSpeciesses
                                                       where fispecies.FiSpeciesID== CurrentTbl87Geographic.FiSpeciesID
                                                       orderby fispecies.FiSpeciesName
                                                       select fispecies));
            ...
            Tbl78NamesList =
                new ObservableCollection<NULL>((from NULL in Tbl78NamesRepository.Tbl78Names
                                                       where NULL.GeographicID== CurrentTbl87Geographic.GeographicID
                                                       orderby NULL.Tbl87Geographics.GeographicName
                                                       select NULL));
            ...
            Tbl90RefAuthorsList =
                new ObservableCollection<Tbl90Reference>((from refAu in Tbl90ReferencesRepository.Tbl90References
                                                          where refAu.GeographicID== CurrentTbl87Geographic.GeographicID
            ...
            Tbl90RefSourcesList =
                new ObservableCollection<Tbl90Reference>((from refSo in Tbl90ReferencesRepository.Tbl90References
                                                          where refSo.GeographicID== CurrentTbl87Geographic.GeographicID
            ...
            Tbl90RefExpertsList =
                new ObservableCollection<Tbl90Reference>((from refEx in Tbl90ReferencesRepository.Tbl90References
                                                          where refEx.GeographicID== CurrentTbl87Geographic.GeographicID
            ...
            Tbl93CommentsList =
                new ObservableCollection<Tbl93Comment>((from comm in Tbl93CommentsRepository.Tbl93Comments
                                                          where comm.GeographicID== CurrentTbl87Geographic.GeographicID
                                                        orderby comm.Info
                                                        select comm));
        ...
        public new Tbl87Geographic CurrentTbl87Geographic
        {
            get
            {
                if (View != null)
                    return View.CurrentItem as Tbl87Geographic;
                return null;
            }
        }
        //--------------------------------------------
        private string _searchGeographicName;
        public new string SearchGeographicName
        {
            get { return _searchGeographicName; }
            set
            {
                if (value == _searchGeographicName) return;
                _searchGeographicName = value;
                RaisePropertyChanged("SearchGeographicName");
            }
        }

        private ObservableCollection<Tbl87Geographic> _tbl87GeographicsList;
        public new ObservableCollection<Tbl87Geographic> Tbl87GeographicsList
        {
        ...
        public ObservableCollection<Tbl87Geographic> Tbl87GeographicsAllList
        {
            ...
            set
            {
                if (_tbl87GeographicsAllList == value) return;
                _tbl87GeographicsAllList = value;
                RaisePropertyChanged("Tbl87GeographicsAllList");
            }
        }
