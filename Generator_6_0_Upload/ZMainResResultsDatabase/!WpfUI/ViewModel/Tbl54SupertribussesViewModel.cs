...
//    Tbl54SupertribussesViewModel Skriptdatum:  01.04.2014  10:32    
...
Tbl54SupertribussesList =  new ObservableCollection<Tbl54Supertribus>
                                                       (from x in Tbl54SupertribussesRepository.Tbl54Supertribusses
            ...
            Tbl54SupertribussesAllList =  new ObservableCollection<Tbl54Supertribus>
                                                       (from y in Tbl54SupertribussesRepository.Tbl54Supertribusses
...
Tbl51InfrafamiliesList = null;                  
            ...
            try
            {
                ...
                if (supertribus!= null)
                {
                    if (MessageBox.Show(CultRes.StringsRes.DeleteQuestion
                                        + " " +  CurrentTbl54Supertribus.SupertribusName, CultRes.StringsRes.DeleteQuestion1, MessageBoxButton.YesNo) !=
 ...
 //    Part 4    
        ...
        private void GetTribusByNameOrId(object o)
        {
            ...
            if (int.TryParse(SearchTribusName, out id))
                Tbl57TribussesList = new ObservableCollection<Tbl57Tribus> { Tbl57TribussesRepository.Get(id) };
            else
            Tbl57TribussesList =  new ObservableCollection<Tbl57Tribus>
                                                      (from x in Tbl57TribussesRepository.FindAll()
        ...
        private void DeleteTribus(object o)
        {
            try
            {
                ...
                if (tribus != null)
                {
                    if (MessageBox.Show(CultRes.StringsRes.DeleteQuestion + " " + CurrentTbl57Tribus.TribusName, CultRes.StringsRes.DeleteQuestion1, MessageBoxButton.YesNo) !=
                        MessageBoxResult.Yes) return;
 ...
 //    Part 11    
        ...
        public new ICollectionView SupertribussesView;
