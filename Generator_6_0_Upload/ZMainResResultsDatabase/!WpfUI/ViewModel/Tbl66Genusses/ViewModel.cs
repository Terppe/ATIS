...
//    Tbl66GenusViewModel Skriptdatum:  8.1.2012  10:32    
...
{   
    ...
    {     
      ...
      #region "Private Data Members"
        ...
        {   
Tbl66GenussesList =
                 new ObservableCollection<Tbl66Genus>((from x in Tbl66GenussesRepository.Tbl66Genusses
                                                        where x.GenusName.StartsWith(SearchGenusName)
                                                        orderby x.GenusName
                                                        select x));

            Tbl66GenussesAllList =
                 new ObservableCollection<Tbl66Genus>((from y in Tbl66GenussesRepository.Tbl66Genusses
                                                        orderby y.GenusName
                                                        select y));
...
Tbl63InfratribussesList = null;                  
  ...
  View = CollectionViewSource.GetDefaultView(Tbl66GenussesList);
        ...
        public new void GetConnectedTablesById()
        {
            ...
            Tbl69FiSpeciessesList =
                new ObservableCollection<Tbl69FiSpecies>((from fispecies in Tbl69FiSpeciessesRepository.Tbl69FiSpeciesses
                                                       where fispecies.GenusID== CurrentTbl66Genus.GenusID
                                                       orderby fispecies.Tbl66Genusses.GenusName
                                                       select fispecies));
