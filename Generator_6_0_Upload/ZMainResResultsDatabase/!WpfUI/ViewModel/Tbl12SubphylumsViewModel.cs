...
//    Tbl12SubphylumsViewModel Skriptdatum:  22.02.2016  12:32    
...
Tbl12SubphylumsList =  new ObservableCollection<Tbl12Subphylum>
                                                       (from x in Tbl12SubphylumsRepository.Tbl12Subphylums
            ...
            Tbl12SubphylumsAllList =  new ObservableCollection<Tbl12Subphylum>
                                                       (from y in Tbl12SubphylumsRepository.Tbl12Subphylums
            ...
            Tbl06PhylumsAllList =  new ObservableCollection<Tbl06Phylum>
                                                       (from z in Tbl06PhylumsRepository.Tbl06Phylums
                                                        orderby z.PhylumName, z.Subregnum
                                                        select z);
            ...
            try
            {
                ...
                if (subphylum!= null)
                {
                    if (MessageBox.Show(CultRes.StringsRes.DeleteQuestion
                                        + " " +  CurrentTbl12Subphylum.SubphylumName, CultRes.StringsRes.DeleteQuestion1, MessageBoxButton.YesNo) !=
 ...
 //    Part 4    
        ...
        private void GetSuperclassByNameOrId(object o)
        {
            ...
            if (int.TryParse(SearchSuperclassName, out id))
                Tbl18SuperclassesList = new ObservableCollection<Tbl18Superclass> { Tbl18SuperclassesRepository.Get(id) };
            else
            Tbl18SuperclassesList =  new ObservableCollection<Tbl18Superclass>
                                                      (from x in Tbl18SuperclassesRepository.FindAll()
        ...
        private void DeleteSuperclass(object o)
        {
            try
            {
                ...
                if (superclass != null)
                {
                    if (MessageBox.Show(CultRes.StringsRes.DeleteQuestion + " " + CurrentTbl18Superclass.SuperclassName, CultRes.StringsRes.DeleteQuestion1, MessageBoxButton.YesNo) !=
                        MessageBoxResult.Yes) return;
