...
//    Tbl15SubdivisionsViewModel Skriptdatum:  22.02.2016  12:32    
...
Tbl15SubdivisionsList =  new ObservableCollection<Tbl15Subdivision>
                                                       (from x in Tbl15SubdivisionsRepository.Tbl15Subdivisions
            ...
            Tbl15SubdivisionsAllList =  new ObservableCollection<Tbl15Subdivision>
                                                       (from y in Tbl15SubdivisionsRepository.Tbl15Subdivisions
            ...
            try
            {
                ...
                if (subdivision!= null)
                {
                    if (MessageBox.Show(CultRes.StringsRes.DeleteQuestion
                                        + " " +  CurrentTbl15Subdivision.SubdivisionName, CultRes.StringsRes.DeleteQuestion1, MessageBoxButton.YesNo) !=
