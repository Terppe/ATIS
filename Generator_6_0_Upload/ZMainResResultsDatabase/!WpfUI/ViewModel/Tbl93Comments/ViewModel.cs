...
//    Tbl93CommentViewModel Skriptdatum:  15.03.2012  10:32    
...
{   
    ...
    {     
        ...
        private void GetCommentByName()
        {   
Tbl93CommentsList =
                 new ObservableCollection<Tbl93Comment>((from x in Tbl93CommentsRepository.Tbl93Comments
                                                        where x.CommentName.StartsWith(SearchCommentName)
                                                        orderby x.CommentName
                                                        select x));

            Tbl93CommentsAllList =
                 new ObservableCollection<Tbl93Comment>((from y in Tbl93CommentsRepository.Tbl93Comments
...
View = CollectionViewSource.GetDefaultView(Tbl93CommentsList);
            if (View != null)
                View.CurrentChanged += tbl93CommentView_CurrentChanged;                   
        ...
        private void AddComment()
        {
            ...
            Tbl93CommentsList.Add(new Tbl93Comment{ CommentName= "New " });
            View = CollectionViewSource.GetDefaultView(Tbl93CommentsList);
            if (View != null)
                View.CurrentChanged += tbl93CommentView_CurrentChanged;
            RaisePropertyChanged("CurrentTbl93Comment");
            ...
            try
            {
                ...
                if (comment!= null)
                {
                    if (MessageBox.Show("Are you really shure to delete this "
                                        + CurrentTbl93Comment.CommentName, "Question", MessageBoxButton.YesNo) !=
                        MessageBoxResult.Yes) return;
                    Tbl93CommentsRepository.Delete(comment);
                    Tbl93CommentsRepository.Save();
                    MessageBox.Show(CurrentTbl93Comment.CommentName + " was deleted successfully");
                    GetCommentByName(); //Refresh
                }
                else
                {
                    MessageBox.Show("Only " + CurrentTbl93Comment.CommentName+ " can be deleted");
                }
            }
            catch (Exception ex)
            {
        ...
        private void SaveComment()
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        Tbl93CommentsRepository.Save();
                        MessageBox.Show(CurrentTbl93Comment.CommentName+  " was successfully saved ");
                        GetCommentByName();  //Refresh
                    }
                }
            }
        ...
        public new Tbl93Comment CurrentTbl93Comment
        {
            ...
            {
                if (View != null)
                    return View.CurrentItem as Tbl93Comment;
                return null;
            }
        }
        //--------------------------------------------
