...
{   
    ...
    {     
        ...
        private RelayCommand _getaspnet_MembershipByNameCommand;
        public new ICommand Getaspnet_MembershipByNameCommand
        {
            get { return _getaspnet_MembershipByNameCommand ?? (_getaspnet_MembershipByNameCommand = new RelayCommand(Getaspnet_MembershipByName)); }
        }

        private void Getaspnet_MembershipByName()
        {   
...
aspnet_ApplicationsList = null;                  
  View = CollectionViewSource.GetDefaultView(aspnet_MembershipsList);
        ...
        //------------------------------------------------------------------------------
        private RelayCommand _addaspnet_MembershipCommand;
        public new ICommand Addaspnet_MembershipCommand
        {
            get { return _addaspnet_MembershipCommand ?? (_addaspnet_MembershipCommand = new RelayCommand(Addaspnet_Membership)); }
        }

        private void Addaspnet_Membership()
        {
        ...
        private RelayCommand _deleteaspnet_MembershipCommand;
        public new ICommand Deleteaspnet_MembershipCommand
        {
            get { return _deleteaspnet_MembershipCommand ?? (_deleteaspnet_MembershipCommand = new RelayCommand(Deleteaspnet_Membership)); }
        }

        private void Deleteaspnet_Membership()
        {
            try
            {
                ...
                if (membership!= null)
                {
                    ...
                    Getaspnet_MembershipByName(); //Refresh
                }
                else
                {
        ...
        //-------------------------------------------------------------------------------------------------
        private RelayCommand _saveaspnet_MembershipCommand;
        public new ICommand Saveaspnet_MembershipCommand
        {
            get { return _saveaspnet_MembershipCommand ?? (_saveaspnet_MembershipCommand = new RelayCommand(Saveaspnet_Membership)); }
        }

        private void Saveaspnet_Membership()
        {
            try
            {
                var membership= aspnet_MembershipsRepository.aspnet_Memberships.FirstOrDefault(x => x.UserId== Currentaspnet_Membership.UserId);
