...
//    Tbl78NameViewModel Skriptdatum:  28.12.2011  10:32    
...
{   
    ...
    public class Tbl78NamesViewModel : Tbl69FiSpeciessesViewModel                     
    {     
      ...
      #region "Private Data Members"
        ...
        public new ICommand GetNameByNameCommand
        {
        ...
        {   
Tbl78NamesList =
                 new ObservableCollection<Tbl78Name>((from x in Tbl78NamesRepository.Tbl78Names
                                                        where x.NameName.StartsWith(SearchNameName)
                                                        orderby x.NameName
                                                        select x));

            Tbl78NamesAllList =
                 new ObservableCollection<Tbl78Name>((from y in Tbl78NamesRepository.Tbl78Names
                                                        orderby y.NameName
                                                        select y));
...
Tbl69FiSpeciessesList = null;                  
  ...
  View = CollectionViewSource.GetDefaultView(Tbl78NamesList);
        ...
        public new ICommand AddNameCommand
        {
        ...
        public new ICommand DeleteNameCommand
        {
        ...
        public new ICommand SaveNameCommand
        {
                ...
                else
                {
                    ...
                    else
                    {
                        Tbl90ReferencesRepository.Add(new Tbl90Reference()
                        {
                            ...
                            NameID= CurrentTbl90RefAuthor.NameID,
                            CountID = TblCountersRepository.Counter(),
                ...
                else
                {
                    ...
                    else
                    {
                        Tbl90ReferencesRepository.Add(new Tbl90Reference()
                        {
                            ...
                            NameID= CurrentTbl90RefSource.NameID,
                            CountID = TblCountersRepository.Counter(),
                ...
                else
                {
                    ...
                    else
                    {
                        Tbl90ReferencesRepository.Add(new Tbl90Reference
                        {
                            ...
                            NameID= CurrentTbl90RefExpert.NameID,
                            CountID = TblCountersRepository.Counter(),
            ...
            try
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            NameID= CurrentTbl93Comment.NameID,                
                            CountID = TblCountersRepository.Counter(),
        ...
        public new void GetConnectedTablesById()
        {
            ...
            Tbl69FiSpeciessesList =
                new ObservableCollection<Tbl69FiSpecies>((from fispecies in Tbl69FiSpeciessesRepository.Tbl69FiSpeciesses
                                                       where fispecies.FiSpeciesID== CurrentTbl78Name.FiSpeciesID
                                                       orderby fispecies.FiSpeciesName
                                                       select fispecies));
            ...
            Tbl81ImagesList =
                new ObservableCollection<NULL>((from NULL in Tbl81ImagesRepository.Tbl81Images
                                                       where NULL.NameID== CurrentTbl78Name.NameID
                                                       orderby NULL.Tbl78Names.NameName
                                                       select NULL));
            ...
            Tbl90RefSourcesList =
                new ObservableCollection<Tbl90Reference>((from refSo in Tbl90ReferencesRepository.Tbl90References
                                                          where refSo.NameID== CurrentTbl78Name.NameID
            ...
            Tbl90RefExpertsList =
                new ObservableCollection<Tbl90Reference>((from refEx in Tbl90ReferencesRepository.Tbl90References
                                                          where refEx.NameID== CurrentTbl78Name.NameID
            ...
            Tbl93CommentsList =
                new ObservableCollection<Tbl93Comment>((from comm in Tbl93CommentsRepository.Tbl93Comments
                                                          where comm.NameID== CurrentTbl78Name.NameID
                                                        orderby comm.Info
                                                        select comm));
        ...
        public new Tbl78Name CurrentTbl78Name
        {
            get
            {
                if (View != null)
        ...
        public new string SearchNameName
        {
        ...
        public new ObservableCollection<Tbl78Name> Tbl78NamesList
        {
