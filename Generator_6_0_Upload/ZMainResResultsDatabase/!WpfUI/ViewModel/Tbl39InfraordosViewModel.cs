...
//    Tbl39InfraordosViewModel Skriptdatum:  31.03.2014  10:32    
...
Tbl39InfraordosList =  new ObservableCollection<Tbl39Infraordo>
                                                       (from x in Tbl39InfraordosRepository.Tbl39Infraordos
            ...
            Tbl39InfraordosAllList =  new ObservableCollection<Tbl39Infraordo>
                                                       (from y in Tbl39InfraordosRepository.Tbl39Infraordos
            ...
            try
            {
                ...
                if (infraordo!= null)
                {
                    if (MessageBox.Show(CultRes.StringsRes.DeleteQuestion
                                        + " " +  CurrentTbl39Infraordo.InfraordoName, CultRes.StringsRes.DeleteQuestion1, MessageBoxButton.YesNo) !=
 ...
 //    Part 4    
        ...
        private void GetSuperfamilyByNameOrId(object o)
        {
            ...
            if (int.TryParse(SearchSuperfamilyName, out id))
                Tbl42SuperfamiliesList = new ObservableCollection<Tbl42Superfamily> { Tbl42SuperfamiliesRepository.Get(id) };
            else
            Tbl42SuperfamiliesList =  new ObservableCollection<Tbl42Superfamily>
                                                      (from x in Tbl42SuperfamiliesRepository.FindAll()
        ...
        private void DeleteSuperfamily(object o)
        {
            try
            {
                ...
                if (superfamily != null)
                {
                    if (MessageBox.Show(CultRes.StringsRes.DeleteQuestion + " " + CurrentTbl42Superfamily.SuperfamilyName, CultRes.StringsRes.DeleteQuestion1, MessageBoxButton.YesNo) !=
                        MessageBoxResult.Yes) return;
