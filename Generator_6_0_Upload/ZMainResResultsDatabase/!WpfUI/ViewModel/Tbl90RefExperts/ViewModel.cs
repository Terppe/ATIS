...
//    Tbl90RefExpertViewModel Skriptdatum:  29.12.2011  10:32    
...
{   
    ...
    {     
      ...
      #region "Private Data Members"
        ...
        {   
Tbl90RefExpertsList =
                 new ObservableCollection<Tbl90RefExpert>((from x in Tbl90RefExpertsRepository.Tbl90RefExperts
                                                        where x.RefExpertName.StartsWith(SearchRefExpertName)
                                                        orderby x.RefExpertName
                                                        select x));

            Tbl90RefExpertsAllList =
                 new ObservableCollection<Tbl90RefExpert>((from y in Tbl90RefExpertsRepository.Tbl90RefExperts
