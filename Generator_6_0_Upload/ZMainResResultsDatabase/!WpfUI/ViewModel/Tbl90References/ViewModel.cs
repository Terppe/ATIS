...
//    Tbl90ReferenceViewModel Skriptdatum:  15.03.2012  10:32    
...
{   
    ...
    {     
        ...
        {
            get { return _getReferenceByNameCommand ?? (_getReferenceByNameCommand = new RelayCommand(GetReferenceByName)); }
        }

        private void GetReferenceByName()
        {   
Tbl90ReferencesList =
                 new ObservableCollection<Tbl90Reference>((from x in Tbl90ReferencesRepository.Tbl90References
                                                        where x.ReferenceName.StartsWith(SearchReferenceName)
                                                        orderby x.ReferenceName
                                                        select x));

            Tbl90ReferencesAllList =
                 new ObservableCollection<Tbl90Reference>((from y in Tbl90ReferencesRepository.Tbl90References
                                                        orderby y.ReferenceName
                                                        select y));

            Tbl90RefExpertsAllList =
                 new ObservableCollection<Tbl90RefExpert>((from z in Tbl90RefExpertsRepository.Tbl90RefExperts
...
Tbl90RefExpertsList = null;                  
  View = CollectionViewSource.GetDefaultView(Tbl90ReferencesList);
            ...
            RaisePropertyChanged("CurrentTbl90Reference");
        }
        //------------------------------------------------------------------------------
        ...
        private void AddReference()
        {
            ...
            Tbl90ReferencesList.Add(new Tbl90Reference{ ReferenceName= "New " });
            View = CollectionViewSource.GetDefaultView(Tbl90ReferencesList);
            if (View != null)
                View.CurrentChanged += tbl90ReferenceView_CurrentChanged;
            RaisePropertyChanged("CurrentTbl90Reference");
        ...
        {
            get { return _deleteReferenceCommand ?? (_deleteReferenceCommand = new RelayCommand(DeleteReference)); }
        }
            ...
            try
            {
                ...
                if (reference!= null)
                {
                    if (MessageBox.Show("Are you really shure to delete this "
                                        + CurrentTbl90Reference.ReferenceName, "Question", MessageBoxButton.YesNo) !=
                        MessageBoxResult.Yes) return;
                    Tbl90ReferencesRepository.Delete(reference);
                    Tbl90ReferencesRepository.Save();
                    MessageBox.Show(CurrentTbl90Reference.ReferenceName + " was deleted successfully");
                    GetReferenceByName(); //Refresh
                }
                else
                {
                    MessageBox.Show("Only " + CurrentTbl90Reference.ReferenceName+ " can be deleted");
                }
            }
            catch (Exception ex)
            {
        ...
        {
            get { return _saveReferenceCommand ?? (_saveReferenceCommand = new RelayCommand(SaveReference)); }
        }
        ...
        private void SaveReference()
        {
            try
            {
                ...
                {
                    MessageBox.Show("reference was not found");
                }
                else
                {
                    ...
                    {
                        Tbl90ReferencesRepository.Save();
                        MessageBox.Show(CurrentTbl90Reference.ReferenceName+  " was successfully saved ");
                        GetReferenceByName();  //Refresh
                    }
                }
            }
        ...
        private void GetRefExpertByName()
        {
            Tbl90RefExpertsList =
