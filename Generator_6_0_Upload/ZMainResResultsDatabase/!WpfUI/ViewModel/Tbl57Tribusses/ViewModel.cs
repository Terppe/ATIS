...
//    Tbl57TribusViewModel Skriptdatum:  7.1.2012  10:32    
...
{   
    ...
    {     
      ...
      #region "Private Data Members"
        ...
        {   
Tbl57TribussesList =
                 new ObservableCollection<Tbl57Tribus>((from x in Tbl57TribussesRepository.Tbl57Tribusses
                                                        where x.TribusName.StartsWith(SearchTribusName)
                                                        orderby x.TribusName
                                                        select x));

            Tbl57TribussesAllList =
                 new ObservableCollection<Tbl57Tribus>((from y in Tbl57TribussesRepository.Tbl57Tribusses
  ...
  View = CollectionViewSource.GetDefaultView(Tbl57TribussesList);
        ...
        private void GetNULLByName()
        {
            Tbl63InfratribussesList =
                new ObservableCollection<Tbl63Infratribus>((from  in Tbl63InfratribussesRepository.Tbl63Infratribusses
                                                       where .InfratribusName.StartsWith(SearchNULLName)
                                                       orderby .InfratribusName
                                                       select ));
        ...
        private void DeleteNULL()
        {
            try
            {
                var = Tbl63InfratribussesRepository.Tbl63Infratribusses.FirstOrDefault(x => x.InfratribusID== CurrentTbl63Infratribus.InfratribusID);
                if (!= null)
                {
                    if (MessageBox.Show("Are you really shure to delete this "
                                        + CurrentTbl63Infratribus.InfratribusName, "Question", MessageBoxButton.YesNo) !=
                        MessageBoxResult.Yes) return;
                    Tbl63InfratribussesRepository.Delete();
            ...
            try
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            TribusID= CurrentTbl63Infratribus.TribusID,              
        ...
        private ObservableCollection<Tbl63Infratribus> List;
        ...
        public void tbl60SubtribusView_CurrentChanged(object sender, EventArgs e)
        {
            RaisePropertyChanged("CurrentTbl60Subtribus");
        }
