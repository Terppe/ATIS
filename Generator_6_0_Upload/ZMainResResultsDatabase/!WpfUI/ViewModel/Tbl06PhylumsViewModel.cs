...
//    Tbl06PhylumsViewModel Skriptdatum:  14.03.2016  12:32    
...
Tbl06PhylumsList =  new ObservableCollection<Tbl06Phylum>
                                                       (from x in Tbl06PhylumsRepository.Tbl06Phylums
            ...
            Tbl06PhylumsAllList =  new ObservableCollection<Tbl06Phylum>
                                                       (from y in Tbl06PhylumsRepository.Tbl06Phylums
...
Tbl03RegnumsList = null;                  
            ...
            try
            {
                ...
                if (phylum!= null)
                {
                    if (MessageBox.Show(CultRes.StringsRes.DeleteQuestion
                                        + " " +  CurrentTbl06Phylum.PhylumName, CultRes.StringsRes.DeleteQuestion1, MessageBoxButton.YesNo) !=
 ...
 //    Part 2    
        ...
        private void GetRegnumByNameOrId(object o)
        {
            Tbl03RegnumsList =   new ObservableCollection<Tbl03Regnum>
                                                      (from regnum in Tbl03RegnumsRepository.Tbl03Regnums
 ...
 //    Part 4    
        ...
        {
            get { return _getSubphylumByNameCommand ?? (_getSubphylumByNameCommand = new RelayCommand(delegate { GetSubphylumByNameOrId(null); })); }
        }
        ...
        private void GetSubphylumByNameOrId(object o)
        {
            ...
            if (int.TryParse(SearchSubphylumName, out id))
                Tbl12SubphylumsList = new ObservableCollection<Tbl12Subphylum> { Tbl12SubphylumsRepository.Get(id) };
            else
            Tbl12SubphylumsList =  new ObservableCollection<Tbl12Subphylum>
                                                      (from x in Tbl12SubphylumsRepository.FindAll()
        ...
        private void AddSubphylum(object o)
        {
            if (Tbl12SubphylumsList == null)
                Tbl12SubphylumsList = new ObservableCollection<Tbl12Subphylum>();
            Tbl12SubphylumsList.Add(new Tbl12Subphylum{ SubphylumName= CultRes.StringsRes.DatasetNew });                   
            SubphylumsView = CollectionViewSource.GetDefaultView(Tbl12SubphylumsList);
            if (SubphylumsView != null)
                SubphylumsView.CurrentChanged += tbl12SubphylumView_CurrentChanged;
            RaisePropertyChanged();
        ...
        private void DeleteSubphylum(object o)
        {
            try
            {
                ...
                if (subphylum != null)
                {
                    if (MessageBox.Show(CultRes.StringsRes.DeleteQuestion + " " + CurrentTbl12Subphylum.SubphylumName, CultRes.StringsRes.DeleteQuestion1, MessageBoxButton.YesNo) !=
                        MessageBoxResult.Yes) return;
                    Tbl12SubphylumsRepository.Delete(subphylum);
                    Tbl12SubphylumsRepository.Save();
                    MessageBox.Show(CurrentTbl12Subphylum.SubphylumName + " " + CultRes.StringsRes.DeleteSuccess);
                    GetSubphylumByNameOrId(o);  //Refresh
                }
                else
                {
                    MessageBox.Show(CultRes.StringsRes.DeleteCan + " " + CurrentTbl12Subphylum.SubphylumName+ " " + CultRes.StringsRes.DeleteCan1);
                }
            }
            catch (Exception ex)
            {
            ...
            try
            {
                ...
                else
                {
                    ...
                    }
                    {
                        Tbl12SubphylumsRepository.Save();
                        if (CurrentTbl12Subphylum != null)
                            MessageBox.Show(CurrentTbl12Subphylum.SubphylumName+ " " + CultRes.StringsRes.SaveSuccess);
                        GetSubphylumByNameOrId(o);  //Refresh      
                    }
                }
            }
