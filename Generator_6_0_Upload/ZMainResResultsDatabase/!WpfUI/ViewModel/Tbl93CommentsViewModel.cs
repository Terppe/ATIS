...
//    Tbl93CommentsViewModel Skriptdatum:  14.06.2014  10:32    
...
{   
    ...
    public class Tbl93CommentsViewModel : NULLViewModel                     
    {     
 ...
 //    Part 1    
        ...
        {
            get { return _getCommentByNameCommand ?? (_getCommentByNameCommand = new RelayCommand(delegate { GetCommentByNameOrId(null); })); }   
        }

        private void GetCommentByNameOrId(object o)       
        {   
Tbl93CommentsList =  new ObservableCollection<Tbl93Comment>
                                                       (from x in Tbl93CommentsRepository.Tbl93Comments
                                                        where x.CommentName.StartsWith(SearchCommentName)
                                                        orderby x.CommentName
                                                        select x);

            Tbl93CommentsAllList =  new ObservableCollection<Tbl93Comment>
                                                       (from y in Tbl93CommentsRepository.Tbl93Comments
                                                        orderby y.CommentName
                                                        select y);
...
CommentsView = CollectionViewSource.GetDefaultView(Tbl93CommentsList);
        ...
        private void AddComment(object o)
        {
            if (Tbl93CommentsList == null)
                Tbl93CommentsList = new ObservableCollection<Tbl93Comment>();
            Tbl93CommentsList.Add(new Tbl93Comment{ CommentName= CultRes.StringsRes.DatasetNew });
            CommentsView = CollectionViewSource.GetDefaultView(Tbl93CommentsList);
            if (CommentsView != null)
                CommentsView.CurrentChanged += tbl93CommentView_CurrentChanged;
            RaisePropertyChanged();
            ...
            try
            {
                ...
                if (comment!= null)
                {
                    if (MessageBox.Show(CultRes.StringsRes.DeleteQuestion
                                        + " " +  CurrentTbl93Comment.CommentName, CultRes.StringsRes.DeleteQuestion1, MessageBoxButton.YesNo) !=
                        MessageBoxResult.Yes) return;
                    Tbl93CommentsRepository.Delete(comment);
                    Tbl93CommentsRepository.Save();
                    MessageBox.Show(CurrentTbl93Comment.CommentName + " " + CultRes.StringsRes.DeleteSuccess);
                    GetCommentByNameOrId(o); //Refresh
                }
                else
                {
                    MessageBox.Show(CultRes.StringsRes.DeleteCan + " " + CurrentTbl93Comment.CommentName+ " " + CultRes.StringsRes.DeleteCan1);
                }
            }
            catch (Exception ex)
            {
            ...
            try
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            NULL= CurrentTbl93Comment.NULL,              
                            CommentName= CurrentTbl93Comment.CommentName,              
                            CountID = RandomHelper.Randomnumber(),
                            Valid = CurrentTbl93Comment.Valid,
                            ValidYear = CurrentTbl93Comment.ValidYear,
                            Synonym = CurrentTbl93Comment.Synonym,
                            Author = CurrentTbl93Comment.Author,
                            AuthorYear = CurrentTbl93Comment.AuthorYear,
                            Info = CurrentTbl93Comment.Info,
                            EngName = CurrentTbl93Comment.EngName,
                            GerName = CurrentTbl93Comment.GerName,
                            FraName = CurrentTbl93Comment.FraName,
                            PorName = CurrentTbl93Comment.PorName,
                    ...
                    {
                        Tbl93CommentsRepository.Save();
                        MessageBox.Show(CurrentTbl93Comment.CommentName+ " " + CultRes.StringsRes.SaveSuccess);
                        GetCommentByNameOrId(o);  //Refresh
                    }
                }
            }
                ...
                else
                {
                    ...
                    else
                    {
                        Tbl90ReferencesRepository.Add(new Tbl90Reference()
                        {
                            ...
                            CommentID= CurrentTbl90RefAuthor.CommentID,
                ...
                else
                {
                    ...
                    else
                    {
                        Tbl90ReferencesRepository.Add(new Tbl90Reference()
                        {
                            ...
                            CommentID= CurrentTbl90RefSource.CommentID,
                            CountID = TblCountersRepository.Counter(),
                ...
                else
                {
                    ...
                    else
                    {
                        Tbl90ReferencesRepository.Add(new Tbl90Reference
                        {
                            ...
                            CommentID= CurrentTbl90RefExpert.CommentID,
                            CountID = TblCountersRepository.Counter(),
            ...
            try
            {
                ...
                else
                {
                    ...
                    else
                    {
                        Tbl93CommentsRepository.Add(new Tbl93Comment()
                        {
                            CommentID= CurrentTbl93Comment.CommentID,                
                            CountID = TblCountersRepository.Counter(),
                            Valid = CurrentTbl93Comment.Valid,
                            ValidYear = CurrentTbl93Comment.ValidYear,
                            Info = CurrentTbl93Comment.Info,
        ...
        public new void GetConnectedTablesById()
        {
            ...
            NULLList =
                new ObservableCollection<NULL>((from NULL in NULLRepository.NULL
                                                       where NULL.NULL== CurrentTbl93Comment.NULL
                                                       orderby NULL.NULL
                                                       select NULL));

            NULLView = CollectionViewSource.GetDefaultView(NULLList);
            if (NULLView != null)
                NULLView.CurrentChanged += tbl69FiSpeciesView_CurrentChanged;
            RaisePropertyChanged("CurrentNULL");
            //-----------------------------------------------------------------------------------
            NULLList =
                new ObservableCollection<NULL>((from NULL in NULLRepository.NULL
                                                       where NULL.CommentID== CurrentTbl93Comment.CommentID
                                                       orderby NULL.Tbl93Comments.CommentName
                                                       select NULL));


            NULLView = CollectionViewSource.GetDefaultView(NULLList);
            if (NULLView != null)
                NULLView.CurrentChanged += NULLView_CurrentChanged;
            RaisePropertyChanged("CurrentNULL");
            //-----------------------------------------------------------------------------------
            Tbl90RefAuthorsList =
                new ObservableCollection<Tbl90Reference>((from refAu in Tbl90ReferencesRepository.Tbl90References
                                                          where refAu.CommentID== CurrentTbl93Comment.CommentID
            ...
            Tbl90RefSourcesList =
                new ObservableCollection<Tbl90Reference>((from refSo in Tbl90ReferencesRepository.Tbl90References
                                                          where refSo.CommentID== CurrentTbl93Comment.CommentID
            ...
            Tbl90RefExpertsList =
                new ObservableCollection<Tbl90Reference>((from refEx in Tbl90ReferencesRepository.Tbl90References
                                                          where refEx.CommentID== CurrentTbl93Comment.CommentID
 ...
 //    Part 11    
        ...
        public new Tbl93Comment CurrentTbl93Comment
        {
            get
            {
                if (CommentsView != null)
        ...
        //--------------------------------------------
        private string _searchCommentName;
        public new string SearchCommentName
        {
            get { return _searchCommentName; }
            set
            {
                if (value == _searchCommentName) return;
                _searchCommentName = value;
                RaisePropertyChanged("SearchCommentName");
            }
        }
        ...
        public ObservableCollection<Tbl93Comment> Tbl93CommentsAllList
        {
            ...
            set
            {
                if (_tbl93CommentsAllList == value) return;
                _tbl93CommentsAllList = value;
                RaisePropertyChanged("Tbl93CommentsAllList");
            }
        }
