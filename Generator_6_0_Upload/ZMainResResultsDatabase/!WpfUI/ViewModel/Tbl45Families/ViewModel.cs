...
//    Tbl45FamilyViewModel Skriptdatum:  15.03.2012  10:32    
...
{   
    ...
    {     
      ...
      #region "Private Data Members"
        ...
        {   
Tbl45FamiliesList =
                 new ObservableCollection<Tbl45Family>((from x in Tbl45FamiliesRepository.Tbl45Families
                                                        where x.FamilyName.StartsWith(SearchFamilyName)
                                                        orderby x.FamilyName
                                                        select x));

            Tbl45FamiliesAllList =
                 new ObservableCollection<Tbl45Family>((from y in Tbl45FamiliesRepository.Tbl45Families
  ...
  Tbl39InfraordosAllList =
                 new ObservableCollection<Tbl39Infraordo>((from z in Tbl39InfraordosRepository.Tbl39Infraordos
  ...
  View = CollectionViewSource.GetDefaultView(Tbl45FamiliesList);
        ...
        private void GetNULLByName()
        {
            Tbl51InfrafamiliesList =
                new ObservableCollection<Tbl51Infrafamily>((from  in Tbl51InfrafamiliesRepository.Tbl51Infrafamilies
                                                       where .InfrafamilyName.StartsWith(SearchNULLName)
                                                       orderby .InfrafamilyName
                                                       select ));
        ...
        private void DeleteNULL()
        {
            try
            {
                var = Tbl51InfrafamiliesRepository.Tbl51Infrafamilies.FirstOrDefault(x => x.InfrafamilyID== CurrentTbl51Infrafamily.InfrafamilyID);
                if (!= null)
                {
                    if (MessageBox.Show("Are you really shure to delete this "
                                        + CurrentTbl51Infrafamily.InfrafamilyName, "Question", MessageBoxButton.YesNo) !=
                        MessageBoxResult.Yes) return;
                    Tbl51InfrafamiliesRepository.Delete();
        ...
        private ObservableCollection<Tbl51Infrafamily> List;
        ...
        public void tbl48SubfamilyView_CurrentChanged(object sender, EventArgs e)
        {
            RaisePropertyChanged("CurrentTbl48Subfamily");
        }
