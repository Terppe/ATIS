...
//    Tbl42SuperfamilyViewModel Skriptdatum:  15.03.2012  10:32    
...
Tbl42SuperfamiliesList =
                 new ObservableCollection<Tbl42Superfamily>((from x in Tbl42SuperfamiliesRepository.Tbl42Superfamilies
                                                        where x.SuperfamilyName.StartsWith(SearchSuperfamilyName)
                                                        orderby x.SuperfamilyName
                                                        select x));

            Tbl42SuperfamiliesAllList =
                 new ObservableCollection<Tbl42Superfamily>((from y in Tbl42SuperfamiliesRepository.Tbl42Superfamilies
  ...
  View = CollectionViewSource.GetDefaultView(Tbl42SuperfamiliesList);
        ...
        private void GetNULLByName()
        {
            Tbl48SubfamiliesList =
                new ObservableCollection<Tbl48Subfamily>((from  in Tbl48SubfamiliesRepository.Tbl48Subfamilies
                                                       where .SubfamilyName.StartsWith(SearchNULLName)
        ...
        private void DeleteNULL()
        {
            try
            {
                var = Tbl48SubfamiliesRepository.Tbl48Subfamilies.FirstOrDefault(x => x.SubfamilyID== CurrentTbl48Subfamily.SubfamilyID);
                if (!= null)
                {
                    if (MessageBox.Show("Are you really shure to delete this "
                                        + CurrentTbl48Subfamily.SubfamilyName, "Question", MessageBoxButton.YesNo) !=
                        MessageBoxResult.Yes) return;
                    Tbl48SubfamiliesRepository.Delete();
        ...
        private ObservableCollection<Tbl48Subfamily> List;
        ...
        public void tbl45FamilyView_CurrentChanged(object sender, EventArgs e)
        {
            RaisePropertyChanged("CurrentTbl45Family");
        }
