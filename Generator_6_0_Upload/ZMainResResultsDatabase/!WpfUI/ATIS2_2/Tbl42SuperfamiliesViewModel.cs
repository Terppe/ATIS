...
using MessageBoxImage = System.Windows.MessageBoxImage;      
         ...
         //    Tbl42SuperfamiliesViewModel Skriptdatum:  22.12.2017  10:32    

namespace WPFUI.Views.Database
{     
    
    public partial class Tbl42SuperfamiliesViewModel : Tbl03RegnumsViewModel
    {     
...
family.FamilyName = CurrentTbl45Family.FamilyName;
                            family.SuperfamilyID = CurrentTbl42Superfamily.SuperfamilyID;   
                    ...
                    }
                    {
                        ...
                        (from a in _tbl45FamiliesRepository.GetAll()
                         ...
                         a.SuperfamilyID == CurrentTbl42Superfamily.SuperfamilyID
                         select a); 
                ...
                else
                {
                    if (CurrentTbl90RefAuthor.ReferenceID != 0 && CurrentTbl90RefAuthor.RefAuthorID != 0)
                    {
                        ...
                        {   
                            ...
                            refAuthor.SuperfamilyID = CurrentTbl42Superfamily.SuperfamilyID;  
...
SuperfamilyID = CurrentTbl42Superfamily.SuperfamilyID,              
                    ...
                    {
                        //SuperfamilyID may be not 0
                        if (CurrentTbl42Superfamily.SuperfamilyID == 0 || CurrentTbl90RefAuthor.RefAuthorID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl90RefSource.ReferenceID != 0)
                    {
                        ...
                        {   
                            ...
                            refSource.SuperfamilyID = CurrentTbl42Superfamily.SuperfamilyID;            
...
SuperfamilyID = CurrentTbl42Superfamily.SuperfamilyID,              
                    ...
                    {
                        //SuperfamilyID may be not 0
                        if (CurrentTbl42Superfamily.SuperfamilyID == 0 || CurrentTbl90RefSource.RefSourceID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,            
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl90RefExpert.ReferenceID != 0 && CurrentTbl90RefExpert.RefExpertID != 0)
                    {
                        ...
                        {   
                            ...
                            refExpert.SuperfamilyID = CurrentTbl42Superfamily.SuperfamilyID;           
...
SuperfamilyID = CurrentTbl42Superfamily.SuperfamilyID,              
                    ...
                    {
                        //SuperfamilyID may be not 0
                        if (CurrentTbl42Superfamily.SuperfamilyID == 0 || CurrentTbl90RefExpert.RefExpertID == 0)   
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,          
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl93Comment.CommentID != 0)
                    {
                        ...
                        {   
                            ...
                            comment.SuperfamilyID = CurrentTbl42Superfamily.SuperfamilyID;            
            ...
            set
            {
                ...
                if (_selectedDetailSubTabIndex == 1)
                {
                    ...
                    Tbl45FamiliesList =  new ObservableCollection<Tbl45Family>
                              ...
                              where x.SuperfamilyID == CurrentTbl42Superfamily.SuperfamilyID
