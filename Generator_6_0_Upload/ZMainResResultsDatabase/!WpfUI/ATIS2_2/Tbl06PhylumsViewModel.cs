...
using MessageBoxImage = System.Windows.MessageBoxImage;      
         ...
         //    Tbl06PhylumsViewModel Skriptdatum:  19.12.2017  12:32    

namespace WPFUI.Views.Database
{     
    
    public partial class Tbl06PhylumsViewModel : Tbl03RegnumsViewModel
    {     
...
subphylum.SubphylumName = CurrentTbl12Subphylum.SubphylumName;
                            subphylum.PhylumID = CurrentTbl06Phylum.PhylumID;   
                    ...
                    }
                    {
                        ...
                        (from a in _tbl12SubphylumsRepository.GetAll()
                         ...
                         a.PhylumID == CurrentTbl06Phylum.PhylumID
                         select a); 
                ...
                else
                {
                    if (CurrentTbl90RefAuthor.ReferenceID != 0 && CurrentTbl90RefAuthor.RefAuthorID != 0)
                    {
                        ...
                        {   
                            ...
                            refAuthor.PhylumID = CurrentTbl06Phylum.PhylumID;  
...
PhylumID = CurrentTbl06Phylum.PhylumID,              
                    ...
                    {
                        //PhylumID may be not 0
                        if (CurrentTbl06Phylum.PhylumID == 0 || CurrentTbl90RefAuthor.RefAuthorID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl90RefSource.ReferenceID != 0)
                    {
                        ...
                        {   
                            ...
                            refSource.PhylumID = CurrentTbl06Phylum.PhylumID;            
...
PhylumID = CurrentTbl06Phylum.PhylumID,              
                    ...
                    {
                        //PhylumID may be not 0
                        if (CurrentTbl06Phylum.PhylumID == 0 || CurrentTbl90RefSource.RefSourceID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,            
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl90RefExpert.ReferenceID != 0 && CurrentTbl90RefExpert.RefExpertID != 0)
                    {
                        ...
                        {   
                            ...
                            refExpert.PhylumID = CurrentTbl06Phylum.PhylumID;           
...
PhylumID = CurrentTbl06Phylum.PhylumID,              
                    ...
                    {
                        //PhylumID may be not 0
                        if (CurrentTbl06Phylum.PhylumID == 0 || CurrentTbl90RefExpert.RefExpertID == 0)   
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,          
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl93Comment.CommentID != 0)
                    {
                        ...
                        {   
                            ...
                            comment.PhylumID = CurrentTbl06Phylum.PhylumID;            
            ...
            set
            {
                ...
                if (_selectedDetailSubTabIndex == 1)
                {
                    ...
                    Tbl12SubphylumsList =  new ObservableCollection<Tbl12Subphylum>
                              ...
                              where x.PhylumID == CurrentTbl06Phylum.PhylumID
