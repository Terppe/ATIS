...
using MessageBoxImage = System.Windows.MessageBoxImage;      
         ...
         //    Tbl09DivisionsViewModel Skriptdatum:  19.12.2017  12:32    

namespace WPFUI.Views.Database
{     
    
    public partial class Tbl09DivisionsViewModel : Tbl03RegnumsViewModel
    {     
...
subdivision.SubdivisionName = CurrentTbl15Subdivision.SubdivisionName;
                            subdivision.DivisionID = CurrentTbl09Division.DivisionID;   
                    ...
                    }
                    {
                        ...
                        (from a in _tbl15SubdivisionsRepository.GetAll()
                         ...
                         a.DivisionID == CurrentTbl09Division.DivisionID
                         select a); 
                ...
                else
                {
                    if (CurrentTbl90RefAuthor.ReferenceID != 0 && CurrentTbl90RefAuthor.RefAuthorID != 0)
                    {
                        ...
                        {   
                            ...
                            refAuthor.DivisionID = CurrentTbl09Division.DivisionID;  
...
DivisionID = CurrentTbl09Division.DivisionID,              
                    ...
                    {
                        //DivisionID may be not 0
                        if (CurrentTbl09Division.DivisionID == 0 || CurrentTbl90RefAuthor.RefAuthorID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl90RefSource.ReferenceID != 0)
                    {
                        ...
                        {   
                            ...
                            refSource.DivisionID = CurrentTbl09Division.DivisionID;            
...
DivisionID = CurrentTbl09Division.DivisionID,              
                    ...
                    {
                        //DivisionID may be not 0
                        if (CurrentTbl09Division.DivisionID == 0 || CurrentTbl90RefSource.RefSourceID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,            
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl90RefExpert.ReferenceID != 0 && CurrentTbl90RefExpert.RefExpertID != 0)
                    {
                        ...
                        {   
                            ...
                            refExpert.DivisionID = CurrentTbl09Division.DivisionID;           
...
DivisionID = CurrentTbl09Division.DivisionID,              
                    ...
                    {
                        //DivisionID may be not 0
                        if (CurrentTbl09Division.DivisionID == 0 || CurrentTbl90RefExpert.RefExpertID == 0)   
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,          
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl93Comment.CommentID != 0)
                    {
                        ...
                        {   
                            ...
                            comment.DivisionID = CurrentTbl09Division.DivisionID;            
            ...
            set
            {
                ...
                if (_selectedDetailSubTabIndex == 1)
                {
                    ...
                    Tbl15SubdivisionsList =  new ObservableCollection<Tbl15Subdivision>
                              ...
                              where x.DivisionID == CurrentTbl09Division.DivisionID
