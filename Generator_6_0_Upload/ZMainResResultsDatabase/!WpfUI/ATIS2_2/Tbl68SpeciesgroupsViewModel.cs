...
using MessageBoxImage = System.Windows.MessageBoxImage;      
         ...
         //    Tbl68SpeciesgroupsViewModel Skriptdatum:  11.11.2017  10:32    

namespace WPFUI.Views.Database
{     
    
    public partial class Tbl68SpeciesgroupsViewModel : ViewModelBase                     
    {     
        ...
        private void DeleteSpeciesgroup(object o)
        {
            try
            {
                ...
                {   
                    ...
                    if (WpfMessageBox.Show(CultRes.StringsRes.DeleteQuestion1, CultRes.StringsRes.DeleteQuestion + " " + 
...
_tbl68SpeciesgroupsRepository.Delete(speciesgroup);
                    ...
                    WpfMessageBox.Show(CultRes.StringsRes.DeleteSuccess, CurrentTbl68Speciesgroup.SpeciesgroupName + " " + CurrentTbl68Speciesgroup.Subspeciesgroup, 
                ...
                {    
                    ...
                    WpfMessageBox.Show(CultRes.StringsRes.Information, CultRes.StringsRes.DeleteCan + " " + CurrentTbl68Speciesgroup.SpeciesgroupName + " " + CurrentTbl68Speciesgroup.Subspeciesgroup + " " + CultRes.StringsRes.DeleteCan1,
                         MessageBoxButton.OK, MessageBoxImage.Information);   
                ...
                else
                {
                    ...
                    }
                    {
                        ...
                        (from a in _tbl69FiSpeciessesRepository.GetAll()
                         ...
                         a.SpeciesgroupID == CurrentTbl68Speciesgroup.SpeciesgroupID
                         select a);             
