...
using MessageBoxImage = System.Windows.MessageBoxImage;      
         ...
         //    Tbl66GenussesViewModel Skriptdatum:  23.12.2017  10:32    

namespace WPFUI.Views.Database
{     
    
    public partial class Tbl66GenussesViewModel : Tbl03RegnumsViewModel
    {     
                ...
                else
                {
                    if (CurrentTbl69FiSpecies.FiSpeciesID != 0)   
                    {
                        ...
                        {   
                            ...
                            fispecies.GenusID = CurrentTbl66Genus.GenusID;
                    ...
                    }
                    {
                        ...
                        (from a in _tbl69FiSpeciessesRepository.GetAll()
                         ...
                         a.GenusID == CurrentTbl66Genus.GenusID
                         select a);             
                ...
                else
                {
                    if (CurrentTbl90RefAuthor.ReferenceID != 0 && CurrentTbl90RefAuthor.RefAuthorID != 0)
                    {
                        ...
                        {   
                            ...
                            refAuthor.GenusID = CurrentTbl66Genus.GenusID;  
...
GenusID = CurrentTbl66Genus.GenusID,              
                    ...
                    {
                        //GenusID may be not 0
                        if (CurrentTbl66Genus.GenusID == 0 || CurrentTbl90RefAuthor.RefAuthorID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl90RefSource.ReferenceID != 0)
                    {
                        ...
                        {   
                            ...
                            refSource.GenusID = CurrentTbl66Genus.GenusID;            
...
GenusID = CurrentTbl66Genus.GenusID,              
                    ...
                    {
                        //GenusID may be not 0
                        if (CurrentTbl66Genus.GenusID == 0 || CurrentTbl90RefSource.RefSourceID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,            
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl90RefExpert.ReferenceID != 0 && CurrentTbl90RefExpert.RefExpertID != 0)
                    {
                        ...
                        {   
                            ...
                            refExpert.GenusID = CurrentTbl66Genus.GenusID;           
...
GenusID = CurrentTbl66Genus.GenusID,              
                    ...
                    {
                        //GenusID may be not 0
                        if (CurrentTbl66Genus.GenusID == 0 || CurrentTbl90RefExpert.RefExpertID == 0)   
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,          
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl93Comment.CommentID != 0)
                    {
                        ...
                        {   
                            ...
                            comment.GenusID = CurrentTbl66Genus.GenusID;            
 ...
 //    Part 9    
        ...
        public  void GetConnectedTablesById(object o)
        {
            ...
            Tbl63InfratribussesList =  new ObservableCollection<Tbl63Infratribus>
                 ...
                 where x.InfratribusID == CurrentTbl66Genus.InfratribusID
