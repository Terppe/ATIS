...
using MessageBoxImage = System.Windows.MessageBoxImage;      
         ...
         //    Tbl45FamiliesViewModel Skriptdatum:  22.12.2017  10:32    

namespace WPFUI.Views.Database
{     
    
    public partial class Tbl45FamiliesViewModel : Tbl03RegnumsViewModel
    {     
...
subfamily.SubfamilyName = CurrentTbl48Subfamily.SubfamilyName;
                            subfamily.FamilyID = CurrentTbl45Family.FamilyID;   
                    ...
                    }
                    {
                        ...
                        (from a in _tbl48SubfamiliesRepository.GetAll()
                         ...
                         a.FamilyID == CurrentTbl45Family.FamilyID
                         select a); 
                ...
                else
                {
                    if (CurrentTbl90RefAuthor.ReferenceID != 0 && CurrentTbl90RefAuthor.RefAuthorID != 0)
                    {
                        ...
                        {   
                            ...
                            refAuthor.FamilyID = CurrentTbl45Family.FamilyID;  
...
FamilyID = CurrentTbl45Family.FamilyID,              
                    ...
                    {
                        //FamilyID may be not 0
                        if (CurrentTbl45Family.FamilyID == 0 || CurrentTbl90RefAuthor.RefAuthorID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl90RefSource.ReferenceID != 0)
                    {
                        ...
                        {   
                            ...
                            refSource.FamilyID = CurrentTbl45Family.FamilyID;            
...
FamilyID = CurrentTbl45Family.FamilyID,              
                    ...
                    {
                        //FamilyID may be not 0
                        if (CurrentTbl45Family.FamilyID == 0 || CurrentTbl90RefSource.RefSourceID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,            
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl90RefExpert.ReferenceID != 0 && CurrentTbl90RefExpert.RefExpertID != 0)
                    {
                        ...
                        {   
                            ...
                            refExpert.FamilyID = CurrentTbl45Family.FamilyID;           
...
FamilyID = CurrentTbl45Family.FamilyID,              
                    ...
                    {
                        //FamilyID may be not 0
                        if (CurrentTbl45Family.FamilyID == 0 || CurrentTbl90RefExpert.RefExpertID == 0)   
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,          
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl93Comment.CommentID != 0)
                    {
                        ...
                        {   
                            ...
                            comment.FamilyID = CurrentTbl45Family.FamilyID;            
            ...
            set
            {
                ...
                if (_selectedDetailSubTabIndex == 1)
                {
                    ...
                    Tbl48SubfamiliesList =  new ObservableCollection<Tbl48Subfamily>
                              ...
                              where x.FamilyID == CurrentTbl45Family.FamilyID
