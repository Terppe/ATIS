...
using MessageBoxImage = System.Windows.MessageBoxImage;      
         ...
         //    Tbl51InfrafamiliesViewModel Skriptdatum:  23.12.2017  10:32    

namespace WPFUI.Views.Database
{     
    
    public partial class Tbl51InfrafamiliesViewModel : Tbl03RegnumsViewModel
    {     
...
supertribus.SupertribusName = CurrentTbl54Supertribus.SupertribusName;
                            supertribus.InfrafamilyID = CurrentTbl51Infrafamily.InfrafamilyID;   
                    ...
                    else
                    {
                        _tbl54SupertribussesRepository.Add(new Tbl54Supertribus     //add new
                        {
                            ...
                            InfrafamilyID = CurrentTbl51Infrafamily.InfrafamilyID,
                            CountID = RandomHelper.Randomnumber(),
                    ...
                    }
                    {
                        ...
                        (from a in _tbl54SupertribussesRepository.GetAll()
                         ...
                         a.InfrafamilyID == CurrentTbl51Infrafamily.InfrafamilyID
                         select a); 
                ...
                else
                {
                    if (CurrentTbl90RefAuthor.ReferenceID != 0 && CurrentTbl90RefAuthor.RefAuthorID != 0)
                    {
                        ...
                        {   
                            ...
                            refAuthor.InfrafamilyID = CurrentTbl51Infrafamily.InfrafamilyID;  
...
InfrafamilyID = CurrentTbl51Infrafamily.InfrafamilyID,              
                    ...
                    {
                        //InfrafamilyID may be not 0
                        if (CurrentTbl51Infrafamily.InfrafamilyID == 0 || CurrentTbl90RefAuthor.RefAuthorID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl90RefSource.ReferenceID != 0)
                    {
                        ...
                        {   
                            ...
                            refSource.InfrafamilyID = CurrentTbl51Infrafamily.InfrafamilyID;            
...
InfrafamilyID = CurrentTbl51Infrafamily.InfrafamilyID,              
                    ...
                    {
                        //InfrafamilyID may be not 0
                        if (CurrentTbl51Infrafamily.InfrafamilyID == 0 || CurrentTbl90RefSource.RefSourceID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,            
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl90RefExpert.ReferenceID != 0 && CurrentTbl90RefExpert.RefExpertID != 0)
                    {
                        ...
                        {   
                            ...
                            refExpert.InfrafamilyID = CurrentTbl51Infrafamily.InfrafamilyID;           
...
InfrafamilyID = CurrentTbl51Infrafamily.InfrafamilyID,              
                    ...
                    {
                        //InfrafamilyID may be not 0
                        if (CurrentTbl51Infrafamily.InfrafamilyID == 0 || CurrentTbl90RefExpert.RefExpertID == 0)   
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,          
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl93Comment.CommentID != 0)
                    {
                        ...
                        {   
                            ...
                            comment.InfrafamilyID = CurrentTbl51Infrafamily.InfrafamilyID;            
            ...
            set
            {
                ...
                if (_selectedDetailSubTabIndex == 1)
                {
                    ...
                    Tbl54SupertribussesList =  new ObservableCollection<Tbl54Supertribus>
                              ...
                              where x.InfrafamilyID == CurrentTbl51Infrafamily.InfrafamilyID
