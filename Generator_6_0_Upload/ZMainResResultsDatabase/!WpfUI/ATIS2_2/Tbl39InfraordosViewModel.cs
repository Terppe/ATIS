...
using MessageBoxImage = System.Windows.MessageBoxImage;      
         ...
         //    Tbl39InfraordosViewModel Skriptdatum:  22.12.2017  10:32    

namespace WPFUI.Views.Database
{     
    
    public partial class Tbl39InfraordosViewModel : Tbl03RegnumsViewModel
    {     
...
superfamily.SuperfamilyName = CurrentTbl42Superfamily.SuperfamilyName;
                            superfamily.InfraordoID = CurrentTbl39Infraordo.InfraordoID;   
                    ...
                    }
                    {
                        ...
                        (from a in _tbl42SuperfamiliesRepository.GetAll()
                         ...
                         a.InfraordoID == CurrentTbl39Infraordo.InfraordoID
                         select a); 
                ...
                else
                {
                    if (CurrentTbl90RefAuthor.ReferenceID != 0 && CurrentTbl90RefAuthor.RefAuthorID != 0)
                    {
                        ...
                        {   
                            ...
                            refAuthor.InfraordoID = CurrentTbl39Infraordo.InfraordoID;  
...
InfraordoID = CurrentTbl39Infraordo.InfraordoID,              
                    ...
                    {
                        //InfraordoID may be not 0
                        if (CurrentTbl39Infraordo.InfraordoID == 0 || CurrentTbl90RefAuthor.RefAuthorID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl90RefSource.ReferenceID != 0)
                    {
                        ...
                        {   
                            ...
                            refSource.InfraordoID = CurrentTbl39Infraordo.InfraordoID;            
...
InfraordoID = CurrentTbl39Infraordo.InfraordoID,              
                    ...
                    {
                        //InfraordoID may be not 0
                        if (CurrentTbl39Infraordo.InfraordoID == 0 || CurrentTbl90RefSource.RefSourceID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,            
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl90RefExpert.ReferenceID != 0 && CurrentTbl90RefExpert.RefExpertID != 0)
                    {
                        ...
                        {   
                            ...
                            refExpert.InfraordoID = CurrentTbl39Infraordo.InfraordoID;           
...
InfraordoID = CurrentTbl39Infraordo.InfraordoID,              
                    ...
                    {
                        //InfraordoID may be not 0
                        if (CurrentTbl39Infraordo.InfraordoID == 0 || CurrentTbl90RefExpert.RefExpertID == 0)   
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,          
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl93Comment.CommentID != 0)
                    {
                        ...
                        {   
                            ...
                            comment.InfraordoID = CurrentTbl39Infraordo.InfraordoID;            
            ...
            set
            {
                ...
                if (_selectedDetailSubTabIndex == 1)
                {
                    ...
                    Tbl42SuperfamiliesList =  new ObservableCollection<Tbl42Superfamily>
                              ...
                              where x.InfraordoID == CurrentTbl39Infraordo.InfraordoID
