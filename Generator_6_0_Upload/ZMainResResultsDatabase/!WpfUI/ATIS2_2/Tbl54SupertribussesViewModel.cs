...
{     
    ...
    public partial class Tbl54SupertribussesViewModel : Tbl03RegnumsViewModel
    {     
...
tribus.TribusName = CurrentTbl57Tribus.TribusName;
                            tribus.SupertribusID = CurrentTbl54Supertribus.SupertribusID;   
                    ...
                    }
                    {
                        ...
                        (from a in _tbl57TribussesRepository.GetAll()
                         ...
                         a.SupertribusID == CurrentTbl54Supertribus.SupertribusID
                         select a); 
                ...
                else
                {
                    if (CurrentTbl90RefAuthor.ReferenceID != 0 && CurrentTbl90RefAuthor.RefAuthorID != 0)
                    {
                        ...
                        {   
                            ...
                            refAuthor.SupertribusID = CurrentTbl54Supertribus.SupertribusID;  
...
SupertribusID = CurrentTbl54Supertribus.SupertribusID,              
                    ...
                    {
                        //SupertribusID may be not 0
                        if (CurrentTbl54Supertribus.SupertribusID == 0 || CurrentTbl90RefAuthor.RefAuthorID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl90RefSource.ReferenceID != 0)
                    {
                        ...
                        {   
                            ...
                            refSource.SupertribusID = CurrentTbl54Supertribus.SupertribusID;            
...
SupertribusID = CurrentTbl54Supertribus.SupertribusID,              
                    ...
                    {
                        //SupertribusID may be not 0
                        if (CurrentTbl54Supertribus.SupertribusID == 0 || CurrentTbl90RefSource.RefSourceID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,            
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl90RefExpert.ReferenceID != 0 && CurrentTbl90RefExpert.RefExpertID != 0)
                    {
                        ...
                        {   
                            ...
                            refExpert.SupertribusID = CurrentTbl54Supertribus.SupertribusID;           
...
SupertribusID = CurrentTbl54Supertribus.SupertribusID,              
                    ...
                    {
                        //SupertribusID may be not 0
                        if (CurrentTbl54Supertribus.SupertribusID == 0 || CurrentTbl90RefExpert.RefExpertID == 0)   
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,          
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl93Comment.CommentID != 0)
                    {
                        ...
                        {   
                            ...
                            comment.SupertribusID = CurrentTbl54Supertribus.SupertribusID;            
            ...
            set
            {
                ...
                if (_selectedDetailSubTabIndex == 1)
                {
                    ...
                    Tbl57TribussesList =  new ObservableCollection<Tbl57Tribus>
                              ...
                              where x.SupertribusID == CurrentTbl54Supertribus.SupertribusID
