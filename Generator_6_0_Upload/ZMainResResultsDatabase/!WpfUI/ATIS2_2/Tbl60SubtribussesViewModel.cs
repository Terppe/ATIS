...
using MessageBoxImage = System.Windows.MessageBoxImage;      
         ...
         //    Tbl60SubtribussesViewModel Skriptdatum:  23.12.2017  10:32    

namespace WPFUI.Views.Database
{     
    
    public partial class Tbl60SubtribussesViewModel : Tbl03RegnumsViewModel
    {     
...
infratribus.InfratribusName = CurrentTbl63Infratribus.InfratribusName;
                            infratribus.SubtribusID = CurrentTbl60Subtribus.SubtribusID;   
                    ...
                    }
                    {
                        ...
                        (from a in _tbl63InfratribussesRepository.GetAll()
                         ...
                         a.SubtribusID == CurrentTbl60Subtribus.SubtribusID
                         select a); 
                ...
                else
                {
                    if (CurrentTbl90RefAuthor.ReferenceID != 0 && CurrentTbl90RefAuthor.RefAuthorID != 0)
                    {
                        ...
                        {   
                            ...
                            refAuthor.SubtribusID = CurrentTbl60Subtribus.SubtribusID;  
...
SubtribusID = CurrentTbl60Subtribus.SubtribusID,              
                    ...
                    {
                        //SubtribusID may be not 0
                        if (CurrentTbl60Subtribus.SubtribusID == 0 || CurrentTbl90RefAuthor.RefAuthorID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl90RefSource.ReferenceID != 0)
                    {
                        ...
                        {   
                            ...
                            refSource.SubtribusID = CurrentTbl60Subtribus.SubtribusID;            
...
SubtribusID = CurrentTbl60Subtribus.SubtribusID,              
                    ...
                    {
                        //SubtribusID may be not 0
                        if (CurrentTbl60Subtribus.SubtribusID == 0 || CurrentTbl90RefSource.RefSourceID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,            
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl90RefExpert.ReferenceID != 0 && CurrentTbl90RefExpert.RefExpertID != 0)
                    {
                        ...
                        {   
                            ...
                            refExpert.SubtribusID = CurrentTbl60Subtribus.SubtribusID;           
...
SubtribusID = CurrentTbl60Subtribus.SubtribusID,              
                    ...
                    {
                        //SubtribusID may be not 0
                        if (CurrentTbl60Subtribus.SubtribusID == 0 || CurrentTbl90RefExpert.RefExpertID == 0)   
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,          
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl93Comment.CommentID != 0)
                    {
                        ...
                        {   
                            ...
                            comment.SubtribusID = CurrentTbl60Subtribus.SubtribusID;            
        ...
        public new int SelectedDetailSubTabIndex
        {
            ...
            set
            {
                ...
                if (_selectedDetailSubTabIndex == 1)
                {
                    ...
                    Tbl63InfratribussesList =  new ObservableCollection<Tbl63Infratribus>
                              (from x in _tbl63InfratribussesRepository.GetAll()
                              where x.SubtribusID == CurrentTbl60Subtribus.SubtribusID
