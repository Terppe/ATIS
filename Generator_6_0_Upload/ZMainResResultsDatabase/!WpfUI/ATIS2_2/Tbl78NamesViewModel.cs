...
using System.Windows.Threading;  
         ...
         //    Tbl78NamesViewModel Skriptdatum:  13.11.2017  10:32    

namespace WPFUI.Views.Database
{     
    
    public partial class Tbl78NamesViewModel : Tbl03RegnumsViewModel
    {     
...
NameName = CurrentTbl78Name.NameName,
                    ...
                    {    
                        ...
                        (from a in _tbl78NamesRepository.GetAll()
                         ...
                         a.FiSpeciesID == CurrentTbl78Name.FiSpeciesID  &&
                         a.PlSpeciesID == CurrentTbl78Name.PlSpeciesID         
                         select a);
                        ...
                        if (SearchNameName == null && CurrentTbl78Name.NameID == 0)  //new Dataset                        
                            Tbl78NamesList = _allListVm.GetValueTbl78NamesList();  //last Dataset
                        if (SearchNameName == null && CurrentTbl78Name.NameID != 0)   //update 
                            Tbl78NamesList = _allListVm.GetValueTbl78NamesList(CurrentTbl78Name.NameID);
                        if (SearchNameName != null && CurrentTbl78Name.NameID == 0)  //new Dataset                        
                            Tbl78NamesList = _allListVm.GetValueTbl78NamesList();  //last Dataset
                        if (SearchNameName != null && CurrentTbl78Name.NameID != 0)   //update 
                            Tbl78NamesList = _allListVm.GetValueTbl78NamesList(CurrentTbl78Name.NameID);     
