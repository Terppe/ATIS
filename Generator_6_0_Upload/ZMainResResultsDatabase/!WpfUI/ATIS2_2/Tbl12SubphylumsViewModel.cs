...
using MessageBoxImage = System.Windows.MessageBoxImage;      
         ...
         //    Tbl12SubphylumsViewModel Skriptdatum:  19.12.2017  12:32    

namespace WPFUI.Views.Database
{     
    
    public partial class Tbl12SubphylumsViewModel : Tbl03RegnumsViewModel
    {     
                ...
                else
                {
                    ...
                    }
                    {
                        ...
                        (from a in _tbl18SuperclassesRepository.GetAll()
                         ...
                         a.SubphylumID == CurrentTbl12Subphylum.SubphylumID  &&
                         a.SubdivisionID == 1
                         select a);               
                ...
                else
                {
                    if (CurrentTbl90RefAuthor.ReferenceID != 0 && CurrentTbl90RefAuthor.RefAuthorID != 0)
                    {
                        ...
                        {   
                            ...
                            refAuthor.SubphylumID = CurrentTbl12Subphylum.SubphylumID;  
...
SubphylumID = CurrentTbl12Subphylum.SubphylumID,              
                    ...
                    {
                        //SubphylumID may be not 0
                        if (CurrentTbl12Subphylum.SubphylumID == 0 || CurrentTbl90RefAuthor.RefAuthorID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl90RefSource.ReferenceID != 0)
                    {
                        ...
                        {   
                            ...
                            refSource.SubphylumID = CurrentTbl12Subphylum.SubphylumID;            
...
SubphylumID = CurrentTbl12Subphylum.SubphylumID,              
                    ...
                    {
                        //SubphylumID may be not 0
                        if (CurrentTbl12Subphylum.SubphylumID == 0 || CurrentTbl90RefSource.RefSourceID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,            
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl90RefExpert.ReferenceID != 0 && CurrentTbl90RefExpert.RefExpertID != 0)
                    {
                        ...
                        {   
                            ...
                            refExpert.SubphylumID = CurrentTbl12Subphylum.SubphylumID;           
...
SubphylumID = CurrentTbl12Subphylum.SubphylumID,              
                    ...
                    {
                        //SubphylumID may be not 0
                        if (CurrentTbl12Subphylum.SubphylumID == 0 || CurrentTbl90RefExpert.RefExpertID == 0)   
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,          
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl93Comment.CommentID != 0)
                    {
                        ...
                        {   
                            ...
                            comment.SubphylumID = CurrentTbl12Subphylum.SubphylumID;            
            ...
            set
            {
                ...
                if (_selectedDetailSubTabIndex == 1)
                {
                    ...
                    Tbl18SuperclassesList =  new ObservableCollection<Tbl18Superclass>
                              ...
                              where x.SubphylumID == CurrentTbl12Subphylum.SubphylumID
