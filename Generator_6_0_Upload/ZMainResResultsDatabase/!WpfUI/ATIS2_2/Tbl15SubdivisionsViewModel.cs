...
{     
    ...
    public partial class Tbl15SubdivisionsViewModel : Tbl03RegnumsViewModel
    {     
                ...
                else
                {
                    ...
                    }
                    {
                        ...
                        (from a in _tbl18SuperclassesRepository.GetAll()
                         ...
                         a.SubdivisionID == CurrentTbl15Subdivision.SubdivisionID  &&
                         a.SubphylumID == 10
                         select a);               
                ...
                else
                {
                    if (CurrentTbl90RefAuthor.ReferenceID != 0 && CurrentTbl90RefAuthor.RefAuthorID != 0)
                    {
                        ...
                        {   
                            ...
                            refAuthor.SubdivisionID = CurrentTbl15Subdivision.SubdivisionID;  
...
SubdivisionID = CurrentTbl15Subdivision.SubdivisionID,              
                    ...
                    {
                        //SubdivisionID may be not 0
                        if (CurrentTbl15Subdivision.SubdivisionID == 0 || CurrentTbl90RefAuthor.RefAuthorID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl90RefSource.ReferenceID != 0)
                    {
                        ...
                        {   
                            ...
                            refSource.SubdivisionID = CurrentTbl15Subdivision.SubdivisionID;            
...
SubdivisionID = CurrentTbl15Subdivision.SubdivisionID,              
                    ...
                    {
                        //SubdivisionID may be not 0
                        if (CurrentTbl15Subdivision.SubdivisionID == 0 || CurrentTbl90RefSource.RefSourceID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,            
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl90RefExpert.ReferenceID != 0 && CurrentTbl90RefExpert.RefExpertID != 0)
                    {
                        ...
                        {   
                            ...
                            refExpert.SubdivisionID = CurrentTbl15Subdivision.SubdivisionID;           
...
SubdivisionID = CurrentTbl15Subdivision.SubdivisionID,              
                    ...
                    {
                        //SubdivisionID may be not 0
                        if (CurrentTbl15Subdivision.SubdivisionID == 0 || CurrentTbl90RefExpert.RefExpertID == 0)   
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,          
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl93Comment.CommentID != 0)
                    {
                        ...
                        {   
                            ...
                            comment.SubdivisionID = CurrentTbl15Subdivision.SubdivisionID;            
            ...
            set
            {
                ...
                if (_selectedDetailSubTabIndex == 1)
                {
                    ...
                    Tbl18SuperclassesList =  new ObservableCollection<Tbl18Superclass>
                              ...
                              where x.SubdivisionID == CurrentTbl15Subdivision.SubdivisionID
