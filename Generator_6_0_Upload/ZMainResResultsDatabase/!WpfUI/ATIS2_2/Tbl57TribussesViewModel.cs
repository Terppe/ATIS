...
{     
    ...
    public partial class Tbl57TribussesViewModel : Tbl03RegnumsViewModel
    {     
...
subtribus.SubtribusName = CurrentTbl60Subtribus.SubtribusName;
                            subtribus.TribusID = CurrentTbl57Tribus.TribusID;   
                    ...
                    else
                    {
                        _tbl60SubtribussesRepository.Add(new Tbl60Subtribus     //add new
                        {
                            ...
                            TribusID = CurrentTbl57Tribus.TribusID,
                            CountID = RandomHelper.Randomnumber(),
                    ...
                    }
                    {
                        ...
                        (from a in _tbl60SubtribussesRepository.GetAll()
                         ...
                         a.TribusID == CurrentTbl57Tribus.TribusID
                         select a); 
                ...
                else
                {
                    if (CurrentTbl90RefAuthor.ReferenceID != 0 && CurrentTbl90RefAuthor.RefAuthorID != 0)
                    {
                        ...
                        {   
                            ...
                            refAuthor.TribusID = CurrentTbl57Tribus.TribusID;  
...
TribusID = CurrentTbl57Tribus.TribusID,              
                    ...
                    {
                        //TribusID may be not 0
                        if (CurrentTbl57Tribus.TribusID == 0 || CurrentTbl90RefAuthor.RefAuthorID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl90RefSource.ReferenceID != 0)
                    {
                        ...
                        {   
                            ...
                            refSource.TribusID = CurrentTbl57Tribus.TribusID;            
...
TribusID = CurrentTbl57Tribus.TribusID,              
                    ...
                    {
                        //TribusID may be not 0
                        if (CurrentTbl57Tribus.TribusID == 0 || CurrentTbl90RefSource.RefSourceID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,            
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl90RefExpert.ReferenceID != 0 && CurrentTbl90RefExpert.RefExpertID != 0)
                    {
                        ...
                        {   
                            ...
                            refExpert.TribusID = CurrentTbl57Tribus.TribusID;           
...
TribusID = CurrentTbl57Tribus.TribusID,              
                    ...
                    {
                        //TribusID may be not 0
                        if (CurrentTbl57Tribus.TribusID == 0 || CurrentTbl90RefExpert.RefExpertID == 0)   
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,          
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                ...
                else
                {
                    if (CurrentTbl93Comment.CommentID != 0)
                    {
                        ...
                        {   
                            ...
                            comment.TribusID = CurrentTbl57Tribus.TribusID;            
            ...
            set
            {
                ...
                if (_selectedDetailSubTabIndex == 1)
                {
                    ...
                    Tbl60SubtribussesList =  new ObservableCollection<Tbl60Subtribus>
                              ...
                              where x.TribusID == CurrentTbl57Tribus.TribusID
