...
//    Tbl18SuperclassViewModel Skriptdatum:  19.03.2014  12:32    
...
Tbl18SuperclassesList =
                 new ObservableCollection<Tbl18Superclass>((from x in Tbl18SuperclassesRepository.Tbl18Superclasses
                                                        where x.SuperclassName.StartsWith(SearchSuperclassName)
                                                        orderby x.SuperclassName
                                                        select x));

            Tbl18SuperclassesAllList =
                 new ObservableCollection<Tbl18Superclass>((from y in Tbl18SuperclassesRepository.Tbl18Superclasses
            ...
            Tbl12SubphylumsAllList =
                 new ObservableCollection<Tbl12Subphylum>((from z in Tbl12SubphylumsRepository.Tbl12Subphylums
