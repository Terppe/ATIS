...
//    Tbl09DivisionViewModel Skriptdatum:  16.03.2014  12:32    
...
{   
    ...
    {     
      ...
      #region "Private Data Members"
        ...
        {   
Tbl09DivisionsList =
                 new ObservableCollection<Tbl09Division>((from x in Tbl09DivisionsRepository.Tbl09Divisions
                                                        where x.DivisionName.StartsWith(SearchDivisionName)
                                                        orderby x.DivisionName
                                                        select x));

            Tbl09DivisionsAllList =
                 new ObservableCollection<Tbl09Division>((from y in Tbl09DivisionsRepository.Tbl09Divisions
...
Tbl03RegnumsList = null;                  
  ...
  DivisionsView = CollectionViewSource.GetDefaultView(Tbl09DivisionsList);
        ...
        public void tbl15SubdivisionView_CurrentChanged(object sender, EventArgs e)
        {
            RaisePropertyChanged("CurrentTbl15Subdivision");
        }
