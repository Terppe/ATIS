...
//    Tbl69FiSpeciesViewModel Skriptdatum:  15.03.2012  10:32    
...
Tbl69FiSpeciessesList =
                 new ObservableCollection<Tbl69FiSpecies>((from x in Tbl69FiSpeciessesRepository.Tbl69FiSpeciesses
                                                        where x.FiSpeciesName.StartsWith(SearchFiSpeciesName)
                                                        orderby x.FiSpeciesName
                                                        select x));

            Tbl69FiSpeciessesAllList =
                 new ObservableCollection<Tbl69FiSpecies>((from y in Tbl69FiSpeciessesRepository.Tbl69FiSpeciesses
                                                        orderby y.FiSpeciesName
                                                        select y));
