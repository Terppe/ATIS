...
using Te.Atis.Ui.Desktop.MessageBox;    
         ...
         //    Tbl63InfratribussesViewModel Skriptdatum:  19.06.2018  10:32    
 ...
 //    Part 1    
        ...
        private void SaveInfratribus(object o)
        {
            ...
            if (CurrentTbl63Infratribus.InfratribusID == 0)  //new Dataset                        
                Tbl63InfratribussesList = new ObservableCollection<Tbl63Infratribus>(_businessLayer.ListTbl63InfratribussesByEmail(CurrentTbl63Infratribus.Email));
 ...
 //    Part 8    
        ...
        public new void CopyReferenceAuthor(object o)
        {
            ...
            Tbl90ReferenceAuthorsList.Add(new Tbl90Reference
            {
                ...
                InfratribusID = reference.InfratribusID,
