...
using System.Windows.Documents;
   ...
   //  ReportTbl72PlSpeciessesWindow.xaml.cs Skriptdatum:  30.06.2018  12:32     

namespace WPFUI.Views.Report 
{  

    /// <summary>
    /// Interactionslogic for ReportTbl72PlSpeciessesWindow.xaml
    /// </summary>
    public partial class ReportTbl72PlSpeciessesWindow : Window
   {

        public ReportTbl72PlSpeciessesWindow(int un, string tab)
       {         
