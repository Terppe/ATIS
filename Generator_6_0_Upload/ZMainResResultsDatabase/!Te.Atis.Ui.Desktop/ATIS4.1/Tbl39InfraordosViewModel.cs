...
using Te.Atis.Ui.Desktop.MessageBox;    
         ...
         //    Tbl39InfraordosViewModel Skriptdatum:  19.06.2018  10:32    

namespace Te.Atis.Ui.Desktop.Views.Database
{     
    
    public class Tbl39InfraordosViewModel : Tbl03RegnumsViewModel
    {     
 ...
 //    Part 1    
        ...
        private void SaveInfraordo(object o)
        {
            ...
            if (CurrentTbl39Infraordo.InfraordoID == 0)  //new Dataset                        
                Tbl39InfraordosList = new ObservableCollection<Tbl39Infraordo>(_businessLayer.ListTbl39InfraordosByEmail(CurrentTbl39Infraordo.Email));
 ...
 //    Part 4    
        ...
        private void AddSuperfamily(object o)      
        {
            ...
            {  
                ...
                InfraordoID = CurrentTbl39Infraordo.InfraordoID
            }    };
 ...
 //    Part 8    
        ...
        public new void CopyReferenceAuthor(object o)
        {
            ...
            Tbl90ReferenceAuthorsList.Add(new Tbl90Reference
            {
                ...
                InfraordoID = reference.InfraordoID,
        ...
        public new void CopyComment(object o)
        {
            ...
            {
                InfraordoID = comment.InfraordoID,
                Valid = comment.Valid,
