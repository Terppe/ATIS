...
using Te.Atis.Ui.Desktop.MessageBox;    
         ...
         //    Tbl27InfraclassesViewModel Skriptdatum:  15.06.2018  18:32    
...
{     
 ...
 //    Part 1    
        ...
        private void DeleteInfraclass(object o)
        {
            ...
            Tbl27InfraclassesList = new ObservableCollection<Tbl27Infraclass>(_businessLayer.ListTbl27InfraclassesByInfraclassName(SearchInfraclassName));
        ...
        private void SaveInfraclass(object o)
        {
            ...
            if (CurrentTbl27Infraclass.InfraclassID == 0)  //new Dataset                        
                Tbl27InfraclassesList = new ObservableCollection<Tbl27Infraclass>(_businessLayer.ListTbl27InfraclassesByEmail(CurrentTbl27Infraclass.Email));
 ...
 //    Part 2    
        ...
        public new ICommand ClearSubclassCommand => _clearSubclassCommand ??
                                                  (_clearSubclassCommand = new RelayCommand(delegate { ClearSubclass(null); }));

        private RelayCommand _getSubclassesByNameOrIdCommand;  

        public new ICommand GetSubclassesByNameOrIdCommand => _getSubclassesByNameOrIdCommand ??
 ...
 //    Part 8    
        ...
        public new void CopyReferenceAuthor(object o)
        {
            ...
            Tbl90ReferenceAuthorsList.Add(new Tbl90Reference
            {
                ...
                InfraclassID = reference.InfraclassID,
 ...
 //    Part 9    
        ...
        private void GetConnectedTablesById(object o)
        {
            ...
            Tbl24SubclassesList =  new ObservableCollection<Tbl24Subclass>(
                    _businessLayer.ListTbl24SubclassesBySubclassId(CurrentTbl27Infraclass.SubclassID));
 ...
 //    Part 10    
        ...
        public new int SelectedDetailSubTabIndex
        {
            ...
            set
            {
                ...
                {
                    Tbl30LegiosList =  new ObservableCollection<Tbl30Legio>(
                        _businessLayer.ListTbl30LegiosByInfraclassId(CurrentTbl27Infraclass.InfraclassID));
                ...
                if (_selectedDetailSubTabIndex == 2)
                {
                    ...
                    Tbl90ReferenceExpertsList = new ObservableCollection<Tbl90Reference>(
                        _businessLayer.ListTbl90ReferenceListRefExpertsByInfraclassId(CurrentTbl27Infraclass.InfraclassID));
                ...
                {
                    Tbl93CommentsList = new ObservableCollection<Tbl93Comment>(
                        _businessLayer.ListTbl93CommentsByInfraclassId(CurrentTbl27Infraclass.InfraclassID));
        ...
        public new int SelectedDetailSubRefTabIndex
        {
            ...
            set
            {
                ...
                if (_selectedDetailSubRefTabIndex == 1)
                {
                    ...
                    Tbl90ReferenceSourcesList = new ObservableCollection<Tbl90Reference>(
                        _businessLayer.ListTbl90ReferenceListRefSourcesByInfraclassId(CurrentTbl27Infraclass.InfraclassID));
                ...
                if (_selectedDetailSubRefTabIndex == 2)
                {
                    ...
                    Tbl90ReferenceAuthorsList = new ObservableCollection<Tbl90Reference>(
                        _businessLayer.ListTbl90ReferenceListRefAuthorsByInfraclassId(CurrentTbl27Infraclass.InfraclassID));
