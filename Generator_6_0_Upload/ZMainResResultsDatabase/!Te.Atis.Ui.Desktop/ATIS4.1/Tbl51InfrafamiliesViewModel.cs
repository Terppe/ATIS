...
using Te.Atis.Ui.Desktop.MessageBox;    
         ...
         //    Tbl51InfrafamiliesViewModel Skriptdatum:  19.06.2018  10:32    
 ...
 //    Part 1    
        ...
        private void SaveInfrafamily(object o)
        {
            ...
            if (CurrentTbl51Infrafamily.InfrafamilyID == 0)  //new Dataset                        
                Tbl51InfrafamiliesList = new ObservableCollection<Tbl51Infrafamily>(_businessLayer.ListTbl51InfrafamiliesByEmail(CurrentTbl51Infrafamily.Email));
 ...
 //    Part 8    
        ...
        public new void CopyReferenceAuthor(object o)
        {
            ...
            Tbl90ReferenceAuthorsList.Add(new Tbl90Reference
            {
                ...
                InfrafamilyID = reference.InfrafamilyID,
