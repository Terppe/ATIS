...
using Te.Atis.Ui.Desktop.MessageBox;    
         ...
         //    Tbl57TribussesViewModel Skriptdatum:  19.06.2018  10:32    
 ...
 //    Part 1    
        ...
        private void SaveTribus(object o)
        {
            ...
            if (CurrentTbl57Tribus.TribusID == 0)  //new Dataset                        
                Tbl57TribussesList = new ObservableCollection<Tbl57Tribus>(_businessLayer.ListTbl57TribussesByEmail(CurrentTbl57Tribus.Email));
