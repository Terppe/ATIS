...
using Te.Atis.Ui.Desktop.MessageBox;    
         ...
         //    Tbl18SuperclassesViewModel Skriptdatum:  14.06.2018  12:32    
...
{     
 ...
 //    Part 2    
        ...
        public new ICommand ClearSubphylumCommand => _clearSubphylumCommand ??
                                                  (_clearSubphylumCommand = new RelayCommand(delegate { ClearSubphylum(null); }));

        private RelayCommand _getSubphylumsByNameOrIdCommand;  

        public new ICommand GetSubphylumsByNameOrIdCommand => _getSubphylumsByNameOrIdCommand ??
 ...
 //    Part 8    
        ...
        public new void CopyReferenceAuthor(object o)
        {
            ...
            Tbl90ReferenceAuthorsList.Add(new Tbl90Reference
            {
                ...
                SuperclassID = reference.SuperclassID,
 ...
 //    Part 11    
        ...
        public new ObservableCollection<Tbl15Subdivision> Tbl15SubdivisionsAllList
        {
