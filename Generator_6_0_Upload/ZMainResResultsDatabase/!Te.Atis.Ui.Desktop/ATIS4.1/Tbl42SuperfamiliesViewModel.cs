...
using Te.Atis.Ui.Desktop.MessageBox;    
         ...
         //    Tbl42SuperfamiliesViewModel Skriptdatum:  19.06.2018  10:32    
...
{     
 ...
 //    Part 1    
        ...
        private void SaveSuperfamily(object o)
        {
            ...
            if (CurrentTbl42Superfamily.SuperfamilyID == 0)  //new Dataset                        
                Tbl42SuperfamiliesList = new ObservableCollection<Tbl42Superfamily>(_businessLayer.ListTbl42SuperfamiliesByEmail(CurrentTbl42Superfamily.Email));
 ...
 //    Part 4    
        ...
        private void AddFamily(object o)      
        {
            ...
            {  
                ...
                SuperfamilyID = CurrentTbl42Superfamily.SuperfamilyID
            }    };
 ...
 //    Part 8    
        ...
        public new void CopyReferenceAuthor(object o)
        {
            ...
            Tbl90ReferenceAuthorsList.Add(new Tbl90Reference
            {
                ...
                SuperfamilyID = reference.SuperfamilyID,
 ...
 //    Part 11    
        ...
        public new ICollectionView InfraordosView;
