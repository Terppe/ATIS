...
using Te.Atis.Ui.Desktop.MessageBox;    
         ...
         //    Tbl48SubfamiliesViewModel Skriptdatum:  19.06.2018  10:32    
 ...
 //    Part 1    
        ...
        private void SaveSubfamily(object o)
        {
            ...
            if (CurrentTbl48Subfamily.SubfamilyID == 0)  //new Dataset                        
                Tbl48SubfamiliesList = new ObservableCollection<Tbl48Subfamily>(_businessLayer.ListTbl48SubfamiliesByEmail(CurrentTbl48Subfamily.Email));
 ...
 //    Part 8    
        ...
        public new void CopyReferenceAuthor(object o)
        {
            ...
            Tbl90ReferenceAuthorsList.Add(new Tbl90Reference
            {
                ...
                SubfamilyID = reference.SubfamilyID,
