...
using Te.Atis.Ui.Desktop.MessageBox;    
         ...
         //    Tbl09DivisionsViewModel Skriptdatum:  13.06.2018  12:32    
...
{     
 ...
 //    Part 1    
        ...
        private void SaveDivision(object o)
        {
            ...
            if (CurrentTbl09Division.DivisionID == 0)  //new Dataset                        
                Tbl09DivisionsList = new ObservableCollection<Tbl09Division>(_businessLayer.ListTbl09DivisionsByEmail(CurrentTbl09Division.Email));
 ...
 //    Part 4    
        ...
        private void AddSubdivision(object o)      
        {
            ...
            {  
                ...
                DivisionID = CurrentTbl09Division.DivisionID
            }    };
        ...
        private void SaveSubdivision(object o)
        {
            ...
            if (CurrentTbl15Subdivision.SubdivisionID == 0)  //new Dataset                        
                Tbl15SubdivisionsList = new ObservableCollection<Tbl15Subdivision>(_businessLayer.ListTbl15SubdivisionsBySubdivisionName(CurrentTbl15Subdivision.SubdivisionName));
 ...
 //    Part 9    
        ...
        private void GetConnectedTablesById(object o)
        {
            ...
            Tbl03RegnumsList =  new ObservableCollection<Tbl03Regnum>(
                    _businessLayer.ListTbl03RegnumsByRegnumId(CurrentTbl09Division.RegnumID));
 ...
 //    Part 10    
        ...
        public new int SelectedDetailSubTabIndex
        {
            ...
            set
            {
                ...
                {
                    Tbl15SubdivisionsList =  new ObservableCollection<Tbl15Subdivision>(
                        _businessLayer.ListTbl15SubdivisionsByDivisionId(CurrentTbl09Division.DivisionID));
                ...
                if (_selectedDetailSubTabIndex == 2)
                {
                    ...
                    Tbl90ReferenceExpertsList = new ObservableCollection<Tbl90Reference>(
                        _businessLayer.ListTbl90ReferenceListRefExpertsByDivisionId(CurrentTbl09Division.DivisionID));
                ...
                {
                    Tbl93CommentsList = new ObservableCollection<Tbl93Comment>(
                        _businessLayer.ListTbl93CommentsByDivisionId(CurrentTbl09Division.DivisionID));
        ...
        public new int SelectedDetailSubRefTabIndex
        {
            ...
            set
            {
                ...
                if (_selectedDetailSubRefTabIndex == 1)
                {
                    ...
                    Tbl90ReferenceSourcesList = new ObservableCollection<Tbl90Reference>(
                        _businessLayer.ListTbl90ReferenceListRefSourcesByDivisionId(CurrentTbl09Division.DivisionID));
                ...
                if (_selectedDetailSubRefTabIndex == 2)
                {
                    ...
                    Tbl90ReferenceAuthorsList = new ObservableCollection<Tbl90Reference>(
                        _businessLayer.ListTbl90ReferenceListRefAuthorsByDivisionId(CurrentTbl09Division.DivisionID));
