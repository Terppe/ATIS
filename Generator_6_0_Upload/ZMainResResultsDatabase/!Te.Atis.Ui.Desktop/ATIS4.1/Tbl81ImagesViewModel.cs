...
using RelayCommand = Te.Atis.Ui.Desktop.Domain.RelayCommand; 
         ...
         //    Tbl81ImagesViewModel Skriptdatum:  12.07.2018  10:32    
...
{     
    ...
    {     
        ...
        public Tbl81ImagesViewModel(string defaultPath, string defaultPath1)
        {
 ...
 //    Part 9    
        ...
        private void GetConnectedTablesById(object o)
        {
            Tbl68SpeciesgroupsAllList = new ObservableCollection<Tbl68Speciesgroup>(
                _businessLayer.ListTbl68SpeciesgroupsBySpeciesgroupId(CurrentTbl81Image.Tbl69FiSpeciesses.SpeciesgroupID));

            Tbl66GenussesAllList = new ObservableCollection<Tbl66Genus>(
                _businessLayer.ListTbl66GenussesByGenusId(CurrentTbl81Image.Tbl69FiSpeciesses.GenusID));
 ...
 //    Part 10    
        ...
        public new int SelectedDetailSubTabIndex
        {
            ...
            set
            {
                ...
                {
                    Tbl68SpeciesgroupsAllList = new ObservableCollection<Tbl68Speciesgroup>(
                        _businessLayer.ListTbl68SpeciesgroupsBySpeciesgroupId(CurrentTbl81Image.Tbl72PlSpeciesses.SpeciesgroupID));

                    Tbl66GenussesAllList = new ObservableCollection<Tbl66Genus>(
                        _businessLayer.ListTbl66GenussesByGenusId(CurrentTbl81Image.Tbl72PlSpeciesses.GenusID));
 ...
 //    Part 11    
        ...
        public new  ICollectionView ImagesView;
        ...
        public  new ObservableCollection<Tbl81Image> Tbl81ImagesAllList
        {
