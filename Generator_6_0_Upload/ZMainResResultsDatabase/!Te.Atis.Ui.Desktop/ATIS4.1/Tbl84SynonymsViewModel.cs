...
using Te.Atis.Ui.Desktop.MessageBox;    
         ...
         //    Tbl84SynonymsViewModel Skriptdatum:  17.07.2018  10:32    
 ...
 //    Part 9    
        ...
        private void GetConnectedTablesById(object o)
        {
            Tbl68SpeciesgroupsAllList = new ObservableCollection<Tbl68Speciesgroup>(
                _businessLayer.ListTbl68SpeciesgroupsBySpeciesgroupId(CurrentTbl84Synonym.Tbl69FiSpeciesses.SpeciesgroupID));

            Tbl66GenussesAllList = new ObservableCollection<Tbl66Genus>(
                _businessLayer.ListTbl66GenussesByGenusId(CurrentTbl84Synonym.Tbl69FiSpeciesses.GenusID));
 ...
 //    Part 10    
        ...
        public new int SelectedDetailSubTabIndex
        {
            ...
            set
            {
                ...
                {
                    Tbl68SpeciesgroupsAllList = new ObservableCollection<Tbl68Speciesgroup>(
                        _businessLayer.ListTbl68SpeciesgroupsBySpeciesgroupId(CurrentTbl84Synonym.Tbl72PlSpeciesses.SpeciesgroupID));

                    Tbl66GenussesAllList = new ObservableCollection<Tbl66Genus>(
                        _businessLayer.ListTbl66GenussesByGenusId(CurrentTbl84Synonym.Tbl72PlSpeciesses.GenusID));
