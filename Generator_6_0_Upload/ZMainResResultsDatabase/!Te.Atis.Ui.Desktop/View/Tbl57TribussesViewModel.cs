...
using MessageBoxImage = System.Windows.MessageBoxImage;
         ...
         //    Tbl57TribussesViewModel Skriptdatum:  13.12.2019  10:32    
 ...
 //    Part 5    
  ...
  InfratribussesView = CollectionViewSource.GetDefaultView(Tbl63InfratribussesList);
        ...
        private void CopyInfratribus(object o)
        {
            ...
            var  = _tbl63InfratribussesRepository.Get(CurrentTbl63Infratribus.InfratribusID);
        ...
        private void DeleteInfratribus(object o)
        {
            try
            {
                ...
                {  
                    ...
                    _tbl63InfratribussesRepository.Delete();
  ...
  TribusID = CurrentTbl63Infratribus.TribusID,              
                    ...
                    {
                        //TribusID may be not 0
                        if (CurrentTbl63Infratribus.TribusID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl63InfratribussesRepository.GetAll()
                         ...
                         a.TribusID == CurrentTbl63Infratribus.TribusID
                         select a);
