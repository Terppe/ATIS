                ...
                else
                {
                    if (CurrentTbl90RefAuthor.ReferenceID != 0 && CurrentTbl90RefAuthor.RefAuthorID != 0)
                    {
                        ...
                        {   
                            ...
                            refAuthor.FiSpeciesID = CurrentTbl90RefAuthor.FiSpeciesID;  
...
FiSpeciesID = CurrentTbl90RefAuthor.FiSpeciesID,              
                    ...
                    }
                    {
                        ...
                        if (CurrentTbl90RefAuthor.FiSpeciesID == 0 || CurrentTbl90RefAuthor.RefAuthorID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl90ReferencesRepository.GetAll()
                         ...
                         a.FiSpeciesID == CurrentTbl90RefAuthor.FiSpeciesID &&
                ...
                else
                {
                    if (CurrentTbl90RefSource.ReferenceID != 0)
                    {
                        ...
                        {   
                            ...
                            refSource.FiSpeciesID = CurrentTbl90RefSource.FiSpeciesID;            
...
FiSpeciesID = CurrentTbl90RefSource.FiSpeciesID,              
                    ...
                    {
                        //FiSpeciesID may be not 0
                        if (CurrentTbl90RefSource.FiSpeciesID == 0 || CurrentTbl90RefSource.RefSourceID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,            
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl90ReferencesRepository.GetAll()
                         ...
                         a.FiSpeciesID == CurrentTbl90RefSource.FiSpeciesID &&
                ...
                else
                {
                    if (CurrentTbl90RefExpert.ReferenceID != 0 && CurrentTbl90RefExpert.RefExpertID != 0)
                    {
                        ...
                        {   
                            ...
                            refExpert.FiSpeciesID = CurrentTbl90RefExpert.FiSpeciesID;           
...
FiSpeciesID = CurrentTbl90RefExpert.FiSpeciesID,              
                    ...
                    {
                        //FiSpeciesID may be not 0
                        if (CurrentTbl90RefExpert.FiSpeciesID == 0 || CurrentTbl90RefExpert.RefExpertID == 0)   
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,          
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl90ReferencesRepository.GetAll()
                         ...
                         a.FiSpeciesID == CurrentTbl90RefExpert.FiSpeciesID &&
...
FiSpeciesID = CurrentTbl93Comment.FiSpeciesID,              
                    ...
                    {
                        //FiSpeciesID may be not 0
                        if (CurrentTbl93Comment.FiSpeciesID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
 ...
 //    Part 9    
        ...
        {
            SelectedDetailThreeRefTabIndex = 7;  //change to Connect tab
 ...
 //    Part 11    
        ...
        public new  Tbl69FiSpecies CurrentTbl69FiSpecies => FiSpeciessesView?.CurrentItem as Tbl69FiSpecies;
        ...
        public new  ObservableCollection<Tbl69FiSpecies> Tbl69FiSpeciessesAllList
        {
