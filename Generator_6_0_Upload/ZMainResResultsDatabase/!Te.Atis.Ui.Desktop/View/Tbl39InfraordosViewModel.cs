...
OrdoID = CurrentTbl36Subordo.OrdoID,     
 ...
 //    Part 5    
  ...
  FamiliesView = CollectionViewSource.GetDefaultView(Tbl45FamiliesList);
        ...
        private void CopyFamily(object o)
        {
            ...
            var  = _tbl45FamiliesRepository.Get(CurrentTbl45Family.FamilyID);

            Tbl45FamiliesList.Insert(0, new Tbl45Family
            {                 
  InfraordoID = .InfraordoID,     
        ...
        private void DeleteFamily(object o)
        {
            try
            {
                ...
                {  
                    ...
                    _tbl45FamiliesRepository.Delete();
  ...
  InfraordoID = CurrentTbl45Family.InfraordoID,              
                    ...
                    {
                        //InfraordoID may be not 0
                        if (CurrentTbl45Family.InfraordoID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl45FamiliesRepository.GetAll()
                         ...
                         a.InfraordoID == CurrentTbl45Family.InfraordoID
                         select a);
 ...
 //    Part 8    
        ...
        public new void CopyRefAuthor(object o)
        {
            ...
            {                 
InfraordoID = refAuthor.InfraordoID,              
                ...
                else
                {
                    if (CurrentTbl90RefAuthor.ReferenceID != 0 && CurrentTbl90RefAuthor.RefAuthorID != 0)
                    {
                        ...
                        {   
                            ...
                            refAuthor.InfraordoID = CurrentTbl90RefAuthor.InfraordoID;  
...
InfraordoID = CurrentTbl90RefAuthor.InfraordoID,              
                    ...
                    {
                        //InfraordoID may be not 0
                        if (CurrentTbl90RefAuthor.InfraordoID == 0 || CurrentTbl90RefAuthor.RefAuthorID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl90ReferencesRepository.GetAll()
                         ...
                         a.InfraordoID == CurrentTbl90RefAuthor.InfraordoID &&
        ...
        public new void CopyRefSource(object o)
        {
            ...
            {                 
InfraordoID = refSource.InfraordoID,              
                Info = CultRes.StringsRes.DatasetNew,
                ...
                else
                {
                    if (CurrentTbl90RefSource.ReferenceID != 0)
                    {
                        ...
                        {   
                            ...
                            refSource.InfraordoID = CurrentTbl90RefSource.InfraordoID;            
...
InfraordoID = CurrentTbl90RefSource.InfraordoID,              
                    ...
                    {
                        //InfraordoID may be not 0
                        if (CurrentTbl90RefSource.InfraordoID == 0 || CurrentTbl90RefSource.RefSourceID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,            
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl90ReferencesRepository.GetAll()
                         ...
                         a.InfraordoID == CurrentTbl90RefSource.InfraordoID &&
        ...
        public new void CopyRefExpert(object o)
        {
            ...
            {                 
InfraordoID = refExpert.InfraordoID,              
                Info = CultRes.StringsRes.DatasetNew,
                ...
                else
                {
                    if (CurrentTbl90RefExpert.ReferenceID != 0 && CurrentTbl90RefExpert.RefExpertID != 0)
                    {
                        ...
                        {   
                            ...
                            refExpert.InfraordoID = CurrentTbl90RefExpert.InfraordoID;           
...
InfraordoID = CurrentTbl90RefExpert.InfraordoID,              
                    ...
                    {
                        //InfraordoID may be not 0
                        if (CurrentTbl90RefExpert.InfraordoID == 0 || CurrentTbl90RefExpert.RefExpertID == 0)   
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,          
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl90ReferencesRepository.GetAll()
                         ...
                         a.InfraordoID == CurrentTbl90RefExpert.InfraordoID &&
...
InfraordoID = CurrentTbl93Comment.InfraordoID,              
                    ...
                    {
                        //InfraordoID may be not 0
                        if (CurrentTbl93Comment.InfraordoID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
 ...
 //    Part 9    
        ...
        public  void GetConnectedTablesById(object o)
        {
            ...
            Tbl36SubordosList =  new ObservableCollection<Tbl36Subordo>
                                                       ...
                                                       where x.SubordoID == CurrentTbl39Infraordo.SubordoID
            ...
            Tbl42SuperfamiliesList =  new ObservableCollection<Tbl42Superfamily>
                                                       ...
                                                       where y.InfraordoID == CurrentTbl39Infraordo.InfraordoID
