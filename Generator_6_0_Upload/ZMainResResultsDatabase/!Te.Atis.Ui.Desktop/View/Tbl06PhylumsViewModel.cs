            ...
            try
            {
                ...
                else
                {
                    if (CurrentTbl18Superclass.SuperclassID!= 0)
                    {
                        ...
                        {   
  superclass.PhylumID= CurrentTbl18Superclass.PhylumID;            
                    ...
                    else
                    {
                        ...
                        {   
  PhylumID = CurrentTbl18Superclass.PhylumID,              
                    ...
                    {
                        //PhylumID may be not 0
                        if (CurrentTbl18Superclass.PhylumID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl18SuperclassesRepository.GetAll()
                         ...
                         a.PhylumID == CurrentTbl18Superclass.PhylumID
                         select a);
                ...
                else
                {
                    if (CurrentTbl90RefAuthor.ReferenceID != 0 && CurrentTbl90RefAuthor.RefAuthorID != 0)
                    {
                        ...
                        {   
                            ...
                            refAuthor.PhylumID = CurrentTbl90RefAuthor.PhylumID;  
...
PhylumID = CurrentTbl90RefAuthor.PhylumID,              
                    ...
                    {
                        //PhylumID may be not 0
                        if (CurrentTbl90RefAuthor.PhylumID == 0 || CurrentTbl90RefAuthor.RefAuthorID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl90ReferencesRepository.GetAll()
                         ...
                         a.PhylumID == CurrentTbl90RefAuthor.PhylumID &&
                ...
                else
                {
                    if (CurrentTbl90RefSource.ReferenceID != 0)
                    {
                        ...
                        {   
                            ...
                            refSource.PhylumID = CurrentTbl90RefSource.PhylumID;            
...
PhylumID = CurrentTbl90RefSource.PhylumID,              
                    ...
                    {
                        //PhylumID may be not 0
                        if (CurrentTbl90RefSource.PhylumID == 0 || CurrentTbl90RefSource.RefSourceID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,            
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl90ReferencesRepository.GetAll()
                         ...
                         a.PhylumID == CurrentTbl90RefSource.PhylumID &&
                ...
                else
                {
                    if (CurrentTbl90RefExpert.ReferenceID != 0 && CurrentTbl90RefExpert.RefExpertID != 0)
                    {
                        ...
                        {   
                            ...
                            refExpert.PhylumID = CurrentTbl90RefExpert.PhylumID;           
...
PhylumID = CurrentTbl90RefExpert.PhylumID,              
                    ...
                    {
                        //PhylumID may be not 0
                        if (CurrentTbl90RefExpert.PhylumID == 0 || CurrentTbl90RefExpert.RefExpertID == 0)   
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,          
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl90ReferencesRepository.GetAll()
                         ...
                         a.PhylumID == CurrentTbl90RefExpert.PhylumID &&
...
PhylumID = CurrentTbl93Comment.PhylumID,              
                    ...
                    {
                        //PhylumID may be not 0
                        if (CurrentTbl93Comment.PhylumID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
 ...
 //    Part 9    
        ...
        public void GetConnectedTablesById(object o)
        {
            ...
            Tbl03RegnumsList =  new ObservableCollection<Tbl03Regnum>
                                           ...
                                           where x.RegnumID == CurrentTbl06Phylum.RegnumID
             ...
             Tbl12SubphylumsList =
                 new ObservableCollection<Tbl12Subphylum>
                                         (from y in _tbl12SubphylumsRepository.GetAll()
                                          where y.PhylumID == CurrentTbl06Phylum.PhylumID
