...
using Te.Atis.Ui.Desktop.MessageBox;    
         ...
         //    Tbl39InfraordosViewModel Skriptdatum:  08.11.2018  10:32    

namespace Te.Atis.Ui.Desktop.Views.Database
{     
    
    public class Tbl39InfraordosViewModel : ViewModelBase                     
    {     
 ...
 //    Part 1    
        ...
        public ICommand DeleteInfraordoCommand => _deleteInfraordoCommand ??
                                                   (_deleteInfraordoCommand = new RelayCommand(delegate { DeleteInfraordo(null); }));    
        ...
        {
            if (SearchInfraordoName != "")
            {
                Tbl39InfraordosList?.Clear();
                if (SearchInfraordoName == "*") // show whole table
                {
                    SearchInfraordoName = "";
                    _businessLayer = new BusinessLayer.BusinessLayer();
                    Tbl36SubordosAllList = new ObservableCollection<Tbl36Subordo>(_businessLayer.ListTbl36Subordos());
                    Tbl39InfraordosList = new ObservableCollection<Tbl39Infraordo>(_businessLayer.ListTbl39InfraordosByInfraordoName(SearchInfraordoName));
                    SearchInfraordoName = "*";
                }
                else
                {
        ...
        private void DeleteInfraordo(object o)
        {
            ...
            var ret = false;
            //check if in Tbl42Superfamilies connected datasets, than return
            Tbl42SuperfamiliesList = new ObservableCollection<Tbl42Superfamily>(_businessLayer.ListTbl42SuperfamiliesByInfraordoId(CurrentTbl39Infraordo.InfraordoID));
            if (Tbl42SuperfamiliesList.Count != 0)
            {
                WpfMessageBox.Show(CultRes.StringsRes.ConnectedTable, CultRes.StringsRes.Superfamily + " " + CultRes.StringsRes.ConnectedDataset,
                    MessageBoxButton.OK, System.Windows.MessageBoxImage.Information);
                 ret = true;              
            }
            Tbl90ReferenceAuthorsList = new ObservableCollection<Tbl90Reference>(_businessLayer.ListTbl90ReferenceListRefAuthorsByInfraordoId(CurrentTbl39Infraordo.InfraordoID));
            ...
            Tbl90ReferenceSourcesList = new ObservableCollection<Tbl90Reference>(_businessLayer.ListTbl90ReferenceListRefSourcesByInfraordoId(CurrentTbl39Infraordo.InfraordoID));
            ...
            Tbl90ReferenceExpertsList = new ObservableCollection<Tbl90Reference>(_businessLayer.ListTbl90ReferenceListRefExpertsByInfraordoId(CurrentTbl39Infraordo.InfraordoID));
            ...
            Tbl93CommentsList = new ObservableCollection<Tbl93Comment>(_businessLayer.ListTbl93CommentsByInfraordoId(CurrentTbl39Infraordo.InfraordoID));
            ...
            try
            {
                ...
                if (infraordo != null)
                {
                    if (WpfMessageBox.Show(CultRes.StringsRes.DeleteQuestion1, CultRes.StringsRes.DeleteQuestion + " " + CurrentTbl39Infraordo.InfraordoName,
                        ...
                        return;
                    infraordo.EntityState = EntityState.Deleted;
                    _businessLayer.RemoveInfraordo(infraordo);
            ...
            if (SearchInfraordoName != "")
            {
                if (SearchInfraordoName == "*")  //show all datasets
                {
                    SearchInfraordoName = "";
                    Tbl39InfraordosList.Clear();
                            ...
                            return;
                        {
                                ...
                                _position = InfraordosView.CurrentPosition;
                                    ...
                                    WpfMessageBox.Show(CultRes.StringsRes.SaveSuccess,
                                        CurrentTbl39Infraordo.InfraordoID == 0
 ...
 //    Part 2    
        ...
        private void SaveSubordo(object o)
        {
            ...
            catch (DbEntityValidationException ex)
            {
                ...
                Tbl36SubordosList = new ObservableCollection<Tbl36Subordo>(_businessLayer.ListTbl36SubordosBySubordoId(CurrentTbl39Infraordo.SubordoID));            
 ...
 //    Part 4    
        ...
        public ICommand DeleteSuperfamilyCommand => _deleteSuperfamilyCommand ??
                                                 (_deleteSuperfamilyCommand = new RelayCommand(delegate { DeleteSuperfamily(null); }));
        ...
        private void DeleteSuperfamily(object o)
        {
            ...
            var ret = false;
            //check if in Tbl45Families connected datasets, than return
            Tbl45FamiliesList = new ObservableCollection<Tbl45Family>(_businessLayer.ListTbl45FamiliesBySuperfamilyId(CurrentTbl42Superfamily.SuperfamilyID));
            if (Tbl45FamiliesList.Count != 0)
            {
                WpfMessageBox.Show(CultRes.StringsRes.ConnectedTable, CultRes.StringsRes.Family + " " + CultRes.StringsRes.ConnectedDataset,
                    MessageBoxButton.OK, System.Windows.MessageBoxImage.Information);
                 ret = true;              
            }
            Tbl90ReferenceAuthorsList = new ObservableCollection<Tbl90Reference>(_businessLayer.ListTbl90ReferenceListRefAuthorsBySuperfamilyId(CurrentTbl42Superfamily.SuperfamilyID));
            if (Tbl90ReferenceAuthorsList.Count != 0)
            {
                WpfMessageBox.Show(CultRes.StringsRes.ConnectedTable, CultRes.StringsRes.ReferenceAuthor + " " + CultRes.StringsRes.ConnectedDataset,
                    MessageBoxButton.OK, System.Windows.MessageBoxImage.Information);
            ...
            Tbl90ReferenceSourcesList = new ObservableCollection<Tbl90Reference>(_businessLayer.ListTbl90ReferenceListRefSourcesBySuperfamilyId(CurrentTbl42Superfamily.SuperfamilyID));
            if (Tbl90ReferenceSourcesList.Count != 0)
            {
                WpfMessageBox.Show(CultRes.StringsRes.ConnectedTable, CultRes.StringsRes.ReferenceSource + " " + CultRes.StringsRes.ConnectedDataset,
                    MessageBoxButton.OK, System.Windows.MessageBoxImage.Information);
            ...
            Tbl90ReferenceExpertsList = new ObservableCollection<Tbl90Reference>(_businessLayer.ListTbl90ReferenceListRefExpertsBySuperfamilyId(CurrentTbl42Superfamily.SuperfamilyID));
            if (Tbl90ReferenceExpertsList.Count != 0)
            {
                WpfMessageBox.Show(CultRes.StringsRes.ConnectedTable, CultRes.StringsRes.ReferenceExpert + " " + CultRes.StringsRes.ConnectedDataset,
                    MessageBoxButton.OK, System.Windows.MessageBoxImage.Information);
            ...
            Tbl93CommentsList = new ObservableCollection<Tbl93Comment>(_businessLayer.ListTbl93CommentsBySuperfamilyId(CurrentTbl42Superfamily.SuperfamilyID));
            if (Tbl93CommentsList.Count != 0)
            {
                WpfMessageBox.Show(CultRes.StringsRes.ConnectedTable, CultRes.StringsRes.Comment + " " + CultRes.StringsRes.ConnectedDataset,
                    MessageBoxButton.OK, System.Windows.MessageBoxImage.Information);
            ...
            try
            {
                ...
                if (superfamily!= null)
                {
                    if (WpfMessageBox.Show(CultRes.StringsRes.DeleteQuestion1, CultRes.StringsRes.DeleteQuestion + " " + CurrentTbl42Superfamily.SuperfamilyName,
                         MessageBoxButton.YesNo, System.Windows.MessageBoxImage.Question) != MessageBoxResult.Yes) 
                    return;
                    superfamily.EntityState = EntityState.Deleted;
                    _businessLayer.RemoveSuperfamily(superfamily);
        ...
        private void SaveSuperfamily(object o)
        {
            ...
            try
            {
                ...
                }
                {
                    ...
                    //check if dataset with Name and InfraordoId already exist       
        ...
        private void GetConnectedTablesById(object o)
        {
            ...
            _businessLayer = new BusinessLayer.BusinessLayer();
             ...
             Tbl36SubordosList =  new ObservableCollection<Tbl36Subordo>(
                       _businessLayer.ListTbl36SubordosBySubordoId(CurrentTbl39Infraordo.SubordoID));
 ...
 //    Part 10    
        ...
        public  int SelectedDetailSubTabIndex
        {
            ...
            set
            {
                ...
                {
                    Tbl42SuperfamiliesList =  new ObservableCollection<Tbl42Superfamily>(
                        _businessLayer.ListTbl42SuperfamiliesByInfraordoId(CurrentTbl39Infraordo.InfraordoID));
                ...
                if (_selectedDetailSubTabIndex == 2)
                {
                    ...
                    Tbl90ReferenceExpertsList = new ObservableCollection<Tbl90Reference>(
                        _businessLayer.ListTbl90ReferenceListRefExpertsByInfraordoId(CurrentTbl39Infraordo.InfraordoID));
                ...
                {
                    Tbl93CommentsList = new ObservableCollection<Tbl93Comment>(
                        _businessLayer.ListTbl93CommentsByInfraordoId(CurrentTbl39Infraordo.InfraordoID));
        ...
        public  int SelectedDetailSubRefTabIndex
        {
            ...
            set
            {
                ...
                if (_selectedDetailSubRefTabIndex == 1)
                {
                    ...
                    Tbl90ReferenceSourcesList = new ObservableCollection<Tbl90Reference>(
                        _businessLayer.ListTbl90ReferenceListRefSourcesByInfraordoId(CurrentTbl39Infraordo.InfraordoID));
                ...
                if (_selectedDetailSubRefTabIndex == 2)
                {
                    ...
                    Tbl90ReferenceAuthorsList = new ObservableCollection<Tbl90Reference>(
                        _businessLayer.ListTbl90ReferenceListRefAuthorsByInfraordoId(CurrentTbl39Infraordo.InfraordoID));
