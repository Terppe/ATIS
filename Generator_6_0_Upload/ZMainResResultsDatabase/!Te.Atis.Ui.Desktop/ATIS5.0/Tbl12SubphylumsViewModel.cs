...
{     
    ...
    public class Tbl12SubphylumsViewModel : ViewModelBase                     
    {     
 ...
 //    Part 1    
        ...
        {
            if (SearchSubphylumName != "")
            {
                Tbl12SubphylumsList?.Clear();
                if (SearchSubphylumName == "*") // show whole table
                {
                    SearchSubphylumName = "";
        ...
        private void DeleteSubphylum(object o)
        {
            ...
            if (SearchSubphylumName != "")
            {
                if (SearchSubphylumName == "*")  //show all datasets
                {
                    SearchSubphylumName = "";
                    Tbl12SubphylumsList.Clear();
 ...
 //    Part 2    
        ...
        private void SavePhylum(object o)
        {
            ...
            catch (DbEntityValidationException ex)
            {
                ...
                Tbl06PhylumsList = new ObservableCollection<Tbl06Phylum>(_businessLayer.ListTbl06PhylumsByPhylumId(CurrentTbl12Subphylum.PhylumID));            
 ...
 //    Part 4    
        ...
        private void SaveSuperclass(object o)
        {
            ...
            CurrentTbl18Superclass.SubdivisionID = plantaeRegnum.SubdivisionID;
