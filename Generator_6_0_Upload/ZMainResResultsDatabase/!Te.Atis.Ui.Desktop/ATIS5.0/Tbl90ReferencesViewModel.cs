...
using Te.Atis.Ui.Desktop.MessageBox;    
         ...
         //    Tbl90ReferencesViewModel Skriptdatum:  29.11.2018  10:32    
...
{     
 ...
 //    Part 1    
        ...
        {
            if (SearchReferenceInfo != "")
            {
                Tbl90ReferencesList?.Clear();
                if (SearchReferenceInfo == "*") // show whole table
                {
                    SearchReferenceInfo = "";
        ...
        private void DeleteReference(object o)
        {
            ...
            if (SearchReferenceInfo != "")
            {
                if (SearchReferenceInfo == "*")  //show all datasets
                {
                    SearchReferenceInfo = "";
                    Tbl90ReferencesList.Clear();
                            ...
                            return;
                        {
                                ...
                                _position = ReferencesView.CurrentPosition;
                                    ...
                                    WpfMessageBox.Show(CultRes.StringsRes.SaveSuccess,
                                        CurrentTbl90Reference.ReferenceID == 0
                                            ? CultRes.StringsRes.DatasetNew
                                            : CurrentTbl90Reference.ReferenceID.ToString(),
                                        MessageBoxButton.OK, System.Windows.MessageBoxImage.Information);
                        }
                    }
                }
 ...
 //    Part 2    
        ...
        private void SaveRefExpert(object o)
        {
            ...
            catch (DbEntityValidationException ex)
            {
                ...
                Tbl90RefExpertsList = new ObservableCollection<Tbl90RefExpert>(_businessLayer.ListTbl90RefExpertsByRefExpertId(CurrentTbl90Reference.RefExpertID));            
 ...
 //    Part 3    
        ...
        private void SaveRefSource(object o)
        {
            ...
            catch (DbEntityValidationException ex)
            {
                ...
                Tbl90RefSourcesList = new ObservableCollection<Tbl90RefSource>(_businessLayer.ListTbl90RefSourcesByRefSourceId(CurrentTbl90Reference.RefSourceID));            
 ...
 //    Part 4    
        ...
        private void SaveRefAuthor(object o)
        {
            ...
            Tbl90RefAuthorsList = new ObservableCollection<Tbl90RefAuthor>(_businessLayer.ListTbl90RefAuthorsByRefAuthorId(CurrentTbl90Reference.RefAuthorID));
