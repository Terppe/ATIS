...
using System.Windows.Documents;
   ...
   //  ReportTbl63InfratribussesWindow.xaml.cs Skriptdatum:  08.11.2018  10:32     

namespace WPFUI.Views.Report 
{  

    /// <summary>
    /// Interactionslogic for ReportTbl63InfratribussesWindow.xaml
    /// </summary>
    public partial class ReportTbl63InfratribussesWindow : Window
   {

        public ReportTbl63InfratribussesWindow(int un, string tab)
       {         
