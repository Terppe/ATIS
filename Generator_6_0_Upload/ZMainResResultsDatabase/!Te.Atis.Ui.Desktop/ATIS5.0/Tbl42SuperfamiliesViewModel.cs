...
{     
    ...
    public class Tbl42SuperfamiliesViewModel : ViewModelBase                     
    {     
 ...
 //    Part 1    
        ...
        {
            if (SearchSuperfamilyName != "")
            {
                Tbl42SuperfamiliesList?.Clear();
                if (SearchSuperfamilyName == "*") // show whole table
                {
                    SearchSuperfamilyName = "";
                    _businessLayer = new BusinessLayer.BusinessLayer();
                    Tbl39InfraordosAllList = new ObservableCollection<Tbl39Infraordo>(_businessLayer.ListTbl39Infraordos());
                    Tbl42SuperfamiliesList = new ObservableCollection<Tbl42Superfamily>(_businessLayer.ListTbl42SuperfamiliesBySuperfamilyName(SearchSuperfamilyName));
                    SearchSuperfamilyName = "*";
                }
                else
                {
        ...
        private void DeleteSuperfamily(object o)
        {
            ...
            if (SearchSuperfamilyName != "")
            {
                if (SearchSuperfamilyName == "*")  //show all datasets
                {
                    SearchSuperfamilyName = "";
                    Tbl42SuperfamiliesList.Clear();
 ...
 //    Part 2    
        ...
        private void SaveInfraordo(object o)
        {
            ...
            catch (DbEntityValidationException ex)
            {
                ...
                Tbl39InfraordosList = new ObservableCollection<Tbl39Infraordo>(_businessLayer.ListTbl39InfraordosByInfraordoId(CurrentTbl42Superfamily.InfraordoID));            
        ...
        private void GetConnectedTablesById(object o)
        {
            ...
            _businessLayer = new BusinessLayer.BusinessLayer();
             ...
             Tbl39InfraordosList =  new ObservableCollection<Tbl39Infraordo>(
                       _businessLayer.ListTbl39InfraordosByInfraordoId(CurrentTbl42Superfamily.InfraordoID));
            ...
            set
            {
                ...
                if (_selectedDetailSubTabIndex == 0)
                {
                    ...
                    Tbl36SubordosAllList =  new ObservableCollection<Tbl36Subordo>(
                        _businessLayer.ListTbl36Subordos());
                ...
                {
                    Tbl45FamiliesList =  new ObservableCollection<Tbl45Family>(
                        _businessLayer.ListTbl45FamiliesBySuperfamilyId(CurrentTbl42Superfamily.SuperfamilyID));
                ...
                if (_selectedDetailSubTabIndex == 2)
                {
                    ...
                    Tbl90ReferenceExpertsList = new ObservableCollection<Tbl90Reference>(
                        _businessLayer.ListTbl90ReferenceListRefExpertsBySuperfamilyId(CurrentTbl42Superfamily.SuperfamilyID));
                ...
                {
                    Tbl93CommentsList = new ObservableCollection<Tbl93Comment>(
                        _businessLayer.ListTbl93CommentsBySuperfamilyId(CurrentTbl42Superfamily.SuperfamilyID));
        ...
        public  int SelectedDetailSubRefTabIndex
        {
            ...
            set
            {
                ...
                if (_selectedDetailSubRefTabIndex == 1)
                {
                    ...
                    Tbl90ReferenceSourcesList = new ObservableCollection<Tbl90Reference>(
                        _businessLayer.ListTbl90ReferenceListRefSourcesBySuperfamilyId(CurrentTbl42Superfamily.SuperfamilyID));
                ...
                if (_selectedDetailSubRefTabIndex == 2)
                {
                    ...
                    Tbl90ReferenceAuthorsList = new ObservableCollection<Tbl90Reference>(
                        _businessLayer.ListTbl90ReferenceListRefAuthorsBySuperfamilyId(CurrentTbl42Superfamily.SuperfamilyID));
