...
using Te.Atis.Ui.Desktop.MessageBox;    
         ...
         //    Tbl27InfraclassesViewModel Skriptdatum:  08.11.2018  18:32    

namespace Te.Atis.Ui.Desktop.Views.Database
{     
    
    public class Tbl27InfraclassesViewModel : ViewModelBase                     
    {     
 ...
 //    Part 1    
        ...
        {
            if (SearchInfraclassName != "")
            {
                Tbl27InfraclassesList?.Clear();
                if (SearchInfraclassName == "*") // show whole table
                {
                    SearchInfraclassName = "";
        ...
        private void DeleteInfraclass(object o)
        {
            ...
            if (SearchInfraclassName != "")
            {
                if (SearchInfraclassName == "*")  //show all datasets
                {
                    SearchInfraclassName = "";
                    Tbl27InfraclassesList.Clear();
 ...
 //    Part 2    
        ...
        private void SaveSubclass(object o)
        {
            ...
            catch (DbEntityValidationException ex)
            {
                ...
                Tbl24SubclassesList = new ObservableCollection<Tbl24Subclass>(_businessLayer.ListTbl24SubclassesBySubclassId(CurrentTbl27Infraclass.SubclassID));            
            ...
            set
            {
                ...
                if (_selectedDetailSubTabIndex == 0)
                {
                    ...
                    Tbl21ClassesAllList =  new ObservableCollection<Tbl21Class>(
                        _businessLayer.ListTbl21Classes());
