...
using Te.Atis.Ui.Desktop.MessageBox;    
         ...
         //    Tbl48SubfamiliesViewModel Skriptdatum:  08.11.2018  10:32    

namespace Te.Atis.Ui.Desktop.Views.Database
{     
    
    public class Tbl48SubfamiliesViewModel : ViewModelBase                     
    {     
 ...
 //    Part 1    
        ...
        {
            if (SearchSubfamilyName != "")
            {
                Tbl48SubfamiliesList?.Clear();
                if (SearchSubfamilyName == "*") // show whole table
                {
                    SearchSubfamilyName = "";
                    _businessLayer = new BusinessLayer.BusinessLayer();
                    Tbl45FamiliesAllList = new ObservableCollection<Tbl45Family>(_businessLayer.ListTbl45Families());
                    Tbl48SubfamiliesList = new ObservableCollection<Tbl48Subfamily>(_businessLayer.ListTbl48SubfamiliesBySubfamilyName(SearchSubfamilyName));
                    SearchSubfamilyName = "*";
                }
                else
                {
        ...
        private void DeleteSubfamily(object o)
        {
            ...
            if (SearchSubfamilyName != "")
            {
                if (SearchSubfamilyName == "*")  //show all datasets
                {
                    SearchSubfamilyName = "";
                    Tbl48SubfamiliesList.Clear();
 ...
 //    Part 2    
        ...
        private void SaveFamily(object o)
        {
            ...
            catch (DbEntityValidationException ex)
            {
                ...
                Tbl45FamiliesList = new ObservableCollection<Tbl45Family>(_businessLayer.ListTbl45FamiliesByFamilyId(CurrentTbl48Subfamily.FamilyID));            
        ...
        private void GetConnectedTablesById(object o)
        {
            ...
            _businessLayer = new BusinessLayer.BusinessLayer();
             ...
             Tbl45FamiliesList =  new ObservableCollection<Tbl45Family>(
                       _businessLayer.ListTbl45FamiliesByFamilyId(CurrentTbl48Subfamily.FamilyID));
            ...
            set
            {
                ...
                if (_selectedDetailSubTabIndex == 0)
                {
                    ...
                    Tbl42SuperfamiliesAllList =  new ObservableCollection<Tbl42Superfamily>(
                        _businessLayer.ListTbl42Superfamilies());
                ...
                {
                    Tbl51InfrafamiliesList =  new ObservableCollection<Tbl51Infrafamily>(
                        _businessLayer.ListTbl51InfrafamiliesBySubfamilyId(CurrentTbl48Subfamily.SubfamilyID));
                ...
                if (_selectedDetailSubTabIndex == 2)
                {
                    ...
                    Tbl90ReferenceExpertsList = new ObservableCollection<Tbl90Reference>(
                        _businessLayer.ListTbl90ReferenceListRefExpertsBySubfamilyId(CurrentTbl48Subfamily.SubfamilyID));
                ...
                {
                    Tbl93CommentsList = new ObservableCollection<Tbl93Comment>(
                        _businessLayer.ListTbl93CommentsBySubfamilyId(CurrentTbl48Subfamily.SubfamilyID));
        ...
        public  int SelectedDetailSubRefTabIndex
        {
            ...
            set
            {
                ...
                if (_selectedDetailSubRefTabIndex == 1)
                {
                    ...
                    Tbl90ReferenceSourcesList = new ObservableCollection<Tbl90Reference>(
                        _businessLayer.ListTbl90ReferenceListRefSourcesBySubfamilyId(CurrentTbl48Subfamily.SubfamilyID));
                ...
                if (_selectedDetailSubRefTabIndex == 2)
                {
                    ...
                    Tbl90ReferenceAuthorsList = new ObservableCollection<Tbl90Reference>(
                        _businessLayer.ListTbl90ReferenceListRefAuthorsBySubfamilyId(CurrentTbl48Subfamily.SubfamilyID));
