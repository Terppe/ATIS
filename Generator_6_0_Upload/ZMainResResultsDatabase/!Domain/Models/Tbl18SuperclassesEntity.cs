...
namespace Atis.Domain.Models     {  
    [MetadataType(typeof(Tbl18SuperclassValidation))]
    public partial class Tbl18Superclass    {   
   

    }     

    public class Tbl18SuperclassValidation    {               
  
        [HiddenInput(DisplayValue = false)]   
        [Column(IsPrimaryKey = true, IsDbGenerated = true, AutoSync = AutoSync.OnInsert)]   
        public int SuperclassID { get; set; }   
      
        [Required(ErrorMessageResourceName = "RequiredSuperclassName", ErrorMessageResourceType = typeof(SharedRes.StringsRes))]
        [LocalizedDisplayName("NameTbl18Superclass", NameResourceType = typeof(SharedRes.StringsRes))]
