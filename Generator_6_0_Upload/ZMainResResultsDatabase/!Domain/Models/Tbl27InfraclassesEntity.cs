...
// <!-- Entities Skriptdatum:  30.12.2011  18:32    -->  

namespace Atis.Domain.Models     {  
    [MetadataType(typeof(Tbl27InfraclassValidation))]
    public partial class Tbl27Infraclass    {   
   

    }     

    public class Tbl27InfraclassValidation    {               
  
        [HiddenInput(DisplayValue = false)]   
        [Column(IsPrimaryKey = true, IsDbGenerated = true, AutoSync = AutoSync.OnInsert)]   
        public int InfraclassID { get; set; }   
      
        [Required(ErrorMessageResourceName = "RequiredInfraclassName", ErrorMessageResourceType = typeof(SharedRes.StringsRes))]
        [LocalizedDisplayName("NameTbl27Infraclass", NameResourceType = typeof(SharedRes.StringsRes))]
