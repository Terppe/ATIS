...
namespace Atis.Domain.Models     {  
    [MetadataType(typeof(Tbl60SubtribusValidation))]
    public partial class Tbl60Subtribus    {   
   

    }     

    public class Tbl60SubtribusValidation    {               
  
        [HiddenInput(DisplayValue = false)]   
        [Column(IsPrimaryKey = true, IsDbGenerated = true, AutoSync = AutoSync.OnInsert)]   
        public int SubtribusID { get; set; }   
      
        [Required(ErrorMessageResourceName = "RequiredSubtribusName", ErrorMessageResourceType = typeof(SharedRes.StringsRes))]
        [LocalizedDisplayName("NameTbl60Subtribus", NameResourceType = typeof(SharedRes.StringsRes))]
