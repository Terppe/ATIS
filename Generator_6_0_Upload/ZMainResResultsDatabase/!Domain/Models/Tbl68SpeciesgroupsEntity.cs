...
namespace Atis.Domain.Models     {  
    [MetadataType(typeof(Tbl68SpeciesgroupValidation))]
    public partial class Tbl68Speciesgroup    {   
   

    }     

    public class Tbl68SpeciesgroupValidation    {               
  
        [HiddenInput(DisplayValue = false)]   
        [Column(IsPrimaryKey = true, IsDbGenerated = true, AutoSync = AutoSync.OnInsert)]   
        public int SpeciesgroupID { get; set; }   
      
        [Required(ErrorMessageResourceName = "RequiredSpeciesgroupName", ErrorMessageResourceType = typeof(SharedRes.StringsRes))]
        [LocalizedDisplayName("NameTbl68Speciesgroup", NameResourceType = typeof(SharedRes.StringsRes))]
