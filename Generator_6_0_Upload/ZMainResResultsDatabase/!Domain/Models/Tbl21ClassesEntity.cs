...
// <!-- Entities Skriptdatum:  15.03.2012  18:32    -->  

namespace Atis.Domain.Models     {  
    [MetadataType(typeof(Tbl21ClassValidation))]
    public partial class Tbl21Class    {   
   

    }     

    public class Tbl21ClassValidation    {               
  
        [HiddenInput(DisplayValue = false)]   
        [Column(IsPrimaryKey = true, IsDbGenerated = true, AutoSync = AutoSync.OnInsert)]   
        public int ClassID { get; set; }   
      
        [Required(ErrorMessageResourceName = "RequiredClassName", ErrorMessageResourceType = typeof(SharedRes.StringsRes))]
        [LocalizedDisplayName("NameTbl21Class", NameResourceType = typeof(SharedRes.StringsRes))]
