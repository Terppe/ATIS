...
namespace Atis.Domain.Models     {  
    [MetadataType(typeof(Tbl63InfratribusValidation))]
    public partial class Tbl63Infratribus    {   
   

    }     

    public class Tbl63InfratribusValidation    {               
  
        [HiddenInput(DisplayValue = false)]   
        [Column(IsPrimaryKey = true, IsDbGenerated = true, AutoSync = AutoSync.OnInsert)]   
        public int InfratribusID { get; set; }   
      
        [Required(ErrorMessageResourceName = "RequiredInfratribusName", ErrorMessageResourceType = typeof(SharedRes.StringsRes))]
        [LocalizedDisplayName("NameTbl63Infratribus", NameResourceType = typeof(SharedRes.StringsRes))]
