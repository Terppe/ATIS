...
namespace Atis.Domain.Models     {  
    [MetadataType(typeof(Tbl12SubphylumValidation))]
    public partial class Tbl12Subphylum    {   
   

    }     

    public class Tbl12SubphylumValidation    {               
  
        [HiddenInput(DisplayValue = false)]   
        [Column(IsPrimaryKey = true, IsDbGenerated = true, AutoSync = AutoSync.OnInsert)]   
        public int SubphylumID { get; set; }   
      
        [Required(ErrorMessageResourceName = "RequiredSubphylumName", ErrorMessageResourceType = typeof(SharedRes.StringsRes))]
        [LocalizedDisplayName("NameTbl12Subphylum", NameResourceType = typeof(SharedRes.StringsRes))]
