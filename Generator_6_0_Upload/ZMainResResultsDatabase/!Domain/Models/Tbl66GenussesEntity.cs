...
// <!-- Entities Skriptdatum:  8.1.2012  10:32    -->  

namespace Atis.Domain.Models     {  
    [MetadataType(typeof(Tbl66GenusValidation))]
    public partial class Tbl66Genus    {   
   

    }     

    public class Tbl66GenusValidation    {               
  
        [HiddenInput(DisplayValue = false)]   
        [Column(IsPrimaryKey = true, IsDbGenerated = true, AutoSync = AutoSync.OnInsert)]   
        public int GenusID { get; set; }   
      
        [Required(ErrorMessageResourceName = "RequiredGenusName", ErrorMessageResourceType = typeof(SharedRes.StringsRes))]
        [LocalizedDisplayName("NameTbl66Genus", NameResourceType = typeof(SharedRes.StringsRes))]
