...
namespace Atis.Domain.Models     {  
    [MetadataType(typeof(Tbl33OrdoValidation))]
    public partial class Tbl33Ordo    {   
   

    }     

    public class Tbl33OrdoValidation    {               
  
        [HiddenInput(DisplayValue = false)]   
        [Column(IsPrimaryKey = true, IsDbGenerated = true, AutoSync = AutoSync.OnInsert)]   
        public int OrdoID { get; set; }   
      
        [Required(ErrorMessageResourceName = "RequiredOrdoName", ErrorMessageResourceType = typeof(SharedRes.StringsRes))]
        [LocalizedDisplayName("NameTbl33Ordo", NameResourceType = typeof(SharedRes.StringsRes))]
