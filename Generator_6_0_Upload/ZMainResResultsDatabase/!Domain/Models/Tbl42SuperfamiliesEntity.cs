...
namespace Atis.Domain.Models     {  
    [MetadataType(typeof(Tbl42SuperfamilyValidation))]
    public partial class Tbl42Superfamily    {   
   

    }     

    public class Tbl42SuperfamilyValidation    {               
  
        [HiddenInput(DisplayValue = false)]   
        [Column(IsPrimaryKey = true, IsDbGenerated = true, AutoSync = AutoSync.OnInsert)]   
        public int SuperfamilyID { get; set; }   
      
        [Required(ErrorMessageResourceName = "RequiredSuperfamilyName", ErrorMessageResourceType = typeof(SharedRes.StringsRes))]
        [LocalizedDisplayName("NameTbl42Superfamily", NameResourceType = typeof(SharedRes.StringsRes))]
