...
namespace Atis.Domain.Models     {  
    [MetadataType(typeof(Tbl03RegnumValidation))]
    public partial class Tbl03Regnum    {   
   

    }     

    public class Tbl03RegnumValidation    {               
  
        [HiddenInput(DisplayValue = false)]   
        [Column(IsPrimaryKey = true, IsDbGenerated = true, AutoSync = AutoSync.OnInsert)]   
        public int RegnumID { get; set; }   
      
        [Required(ErrorMessageResourceName = "RequiredRegnumName", ErrorMessageResourceType = typeof(SharedRes.StringsRes))]
        [LocalizedDisplayName("NameTbl03Regnum", NameResourceType = typeof(SharedRes.StringsRes))]
