...
namespace Atis.Domain.Models     {  
    [MetadataType(typeof(Tbl90RefAuthorValidation))]
    public partial class Tbl90RefAuthor    {   
   

    }     

    public class Tbl90RefAuthorValidation    {               
  
        [HiddenInput(DisplayValue = false)]   
        [Column(IsPrimaryKey = true, IsDbGenerated = true, AutoSync = AutoSync.OnInsert)]   
        public int RefAuthorID { get; set; }   
      
        [Required(ErrorMessageResourceName = "RequiredRefAuthorName", ErrorMessageResourceType = typeof(SharedRes.StringsRes))]
        [LocalizedDisplayName("NameTbl90RefAuthor", NameResourceType = typeof(SharedRes.StringsRes))]
