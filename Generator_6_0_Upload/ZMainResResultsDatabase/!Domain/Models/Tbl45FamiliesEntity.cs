...
namespace Atis.Domain.Models     {  
    [MetadataType(typeof(Tbl45FamilyValidation))]
    public partial class Tbl45Family    {   
   

    }     

    public class Tbl45FamilyValidation    {               
  
        [HiddenInput(DisplayValue = false)]   
        [Column(IsPrimaryKey = true, IsDbGenerated = true, AutoSync = AutoSync.OnInsert)]   
        public int FamilyID { get; set; }   
      
        [Required(ErrorMessageResourceName = "RequiredFamilyName", ErrorMessageResourceType = typeof(SharedRes.StringsRes))]
        [LocalizedDisplayName("NameTbl45Family", NameResourceType = typeof(SharedRes.StringsRes))]
