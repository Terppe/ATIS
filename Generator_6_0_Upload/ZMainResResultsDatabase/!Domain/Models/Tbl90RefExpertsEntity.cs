...
namespace Atis.Domain.Models     {  
    [MetadataType(typeof(Tbl90RefExpertValidation))]
    public partial class Tbl90RefExpert    {   
   

    }     

    public class Tbl90RefExpertValidation    {               
  
        [HiddenInput(DisplayValue = false)]   
        [Column(IsPrimaryKey = true, IsDbGenerated = true, AutoSync = AutoSync.OnInsert)]   
        public int RefExpertID { get; set; }   
      
        [Required(ErrorMessageResourceName = "RequiredRefExpertName", ErrorMessageResourceType = typeof(SharedRes.StringsRes))]
        [LocalizedDisplayName("NameTbl90RefExpert", NameResourceType = typeof(SharedRes.StringsRes))]
