...
// <!-- Entities Skriptdatum:  15.03.2012  12:32    -->  

namespace Atis.Domain.Models     {  
    [MetadataType(typeof(Tbl15SubdivisionValidation))]
    public partial class Tbl15Subdivision    {   
   

    }     

    public class Tbl15SubdivisionValidation    {               
  
        [HiddenInput(DisplayValue = false)]   
        [Column(IsPrimaryKey = true, IsDbGenerated = true, AutoSync = AutoSync.OnInsert)]   
        public int SubdivisionID { get; set; }   
      
        [Required(ErrorMessageResourceName = "RequiredSubdivisionName", ErrorMessageResourceType = typeof(SharedRes.StringsRes))]
        [LocalizedDisplayName("NameTbl15Subdivision", NameResourceType = typeof(SharedRes.StringsRes))]
