...
namespace Atis.Domain.Models     {  
    [MetadataType(typeof(Tbl54SupertribusValidation))]
    public partial class Tbl54Supertribus    {   
   

    }     

    public class Tbl54SupertribusValidation    {               
  
        [HiddenInput(DisplayValue = false)]   
        [Column(IsPrimaryKey = true, IsDbGenerated = true, AutoSync = AutoSync.OnInsert)]   
        public int SupertribusID { get; set; }   
      
        [Required(ErrorMessageResourceName = "RequiredSupertribusName", ErrorMessageResourceType = typeof(SharedRes.StringsRes))]
        [LocalizedDisplayName("NameTbl54Supertribus", NameResourceType = typeof(SharedRes.StringsRes))]
