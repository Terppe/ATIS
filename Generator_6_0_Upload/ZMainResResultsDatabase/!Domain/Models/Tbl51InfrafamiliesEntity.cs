...
namespace Atis.Domain.Models     {  
    [MetadataType(typeof(Tbl51InfrafamilyValidation))]
    public partial class Tbl51Infrafamily    {   
   

    }     

    public class Tbl51InfrafamilyValidation    {               
  
        [HiddenInput(DisplayValue = false)]   
        [Column(IsPrimaryKey = true, IsDbGenerated = true, AutoSync = AutoSync.OnInsert)]   
        public int InfrafamilyID { get; set; }   
      
        [Required(ErrorMessageResourceName = "RequiredInfrafamilyName", ErrorMessageResourceType = typeof(SharedRes.StringsRes))]
        [LocalizedDisplayName("NameTbl51Infrafamily", NameResourceType = typeof(SharedRes.StringsRes))]
