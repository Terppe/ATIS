...
namespace Atis.Domain.Models     {  
    [MetadataType(typeof(Tbl36SubordoValidation))]
    public partial class Tbl36Subordo    {   
   

    }     

    public class Tbl36SubordoValidation    {               
  
        [HiddenInput(DisplayValue = false)]   
        [Column(IsPrimaryKey = true, IsDbGenerated = true, AutoSync = AutoSync.OnInsert)]   
        public int SubordoID { get; set; }   
      
        [Required(ErrorMessageResourceName = "RequiredSubordoName", ErrorMessageResourceType = typeof(SharedRes.StringsRes))]
        [LocalizedDisplayName("NameTbl36Subordo", NameResourceType = typeof(SharedRes.StringsRes))]
