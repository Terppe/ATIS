...
namespace Atis.Domain.Models     {  
    [MetadataType(typeof(Tbl84SynonymValidation))]
    public partial class Tbl84Synonym    {   
   

    }     

    public class Tbl84SynonymValidation    {               
  
        [HiddenInput(DisplayValue = false)]   
        [Column(IsPrimaryKey = true, IsDbGenerated = true, AutoSync = AutoSync.OnInsert)]   
        public int SynonymID { get; set; }   
      
        [Required(ErrorMessageResourceName = "RequiredSynonymName", ErrorMessageResourceType = typeof(SharedRes.StringsRes))]
        [LocalizedDisplayName("NameTbl84Synonym", NameResourceType = typeof(SharedRes.StringsRes))]
