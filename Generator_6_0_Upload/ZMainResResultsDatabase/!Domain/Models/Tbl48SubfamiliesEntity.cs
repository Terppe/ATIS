...
namespace Atis.Domain.Models     {  
    [MetadataType(typeof(Tbl48SubfamilyValidation))]
    public partial class Tbl48Subfamily    {   
   

    }     

    public class Tbl48SubfamilyValidation    {               
  
        [HiddenInput(DisplayValue = false)]   
        [Column(IsPrimaryKey = true, IsDbGenerated = true, AutoSync = AutoSync.OnInsert)]   
        public int SubfamilyID { get; set; }   
      
        [Required(ErrorMessageResourceName = "RequiredSubfamilyName", ErrorMessageResourceType = typeof(SharedRes.StringsRes))]
        [LocalizedDisplayName("NameTbl48Subfamily", NameResourceType = typeof(SharedRes.StringsRes))]
