...
namespace Atis.Domain.Models     {  
    [MetadataType(typeof(Tbl30LegioValidation))]
    public partial class Tbl30Legio    {   
   

    }     

    public class Tbl30LegioValidation    {               
  
        [HiddenInput(DisplayValue = false)]   
        [Column(IsPrimaryKey = true, IsDbGenerated = true, AutoSync = AutoSync.OnInsert)]   
        public int LegioID { get; set; }   
      
        [Required(ErrorMessageResourceName = "RequiredLegioName", ErrorMessageResourceType = typeof(SharedRes.StringsRes))]
        [LocalizedDisplayName("NameTbl30Legio", NameResourceType = typeof(SharedRes.StringsRes))]
