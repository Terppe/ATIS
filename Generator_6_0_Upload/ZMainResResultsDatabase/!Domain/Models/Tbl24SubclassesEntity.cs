...
// <!-- Entities Skriptdatum:  20.12.2011  18:32    -->  

namespace Atis.Domain.Models     {  
    [MetadataType(typeof(Tbl24SubclassValidation))]
    public partial class Tbl24Subclass    {   
   

    }     

    public class Tbl24SubclassValidation    {               
  
        [HiddenInput(DisplayValue = false)]   
        [Column(IsPrimaryKey = true, IsDbGenerated = true, AutoSync = AutoSync.OnInsert)]   
        public int SubclassID { get; set; }   
      
        [Required(ErrorMessageResourceName = "RequiredSubclassName", ErrorMessageResourceType = typeof(SharedRes.StringsRes))]
        [LocalizedDisplayName("NameTbl24Subclass", NameResourceType = typeof(SharedRes.StringsRes))]
