...
namespace Atis.Domain.Models     {  
    [MetadataType(typeof(Tbl57TribusValidation))]
    public partial class Tbl57Tribus    {   
   

    }     

    public class Tbl57TribusValidation    {               
  
        [HiddenInput(DisplayValue = false)]   
        [Column(IsPrimaryKey = true, IsDbGenerated = true, AutoSync = AutoSync.OnInsert)]   
        public int TribusID { get; set; }   
      
        [Required(ErrorMessageResourceName = "RequiredTribusName", ErrorMessageResourceType = typeof(SharedRes.StringsRes))]
        [LocalizedDisplayName("NameTbl57Tribus", NameResourceType = typeof(SharedRes.StringsRes))]
