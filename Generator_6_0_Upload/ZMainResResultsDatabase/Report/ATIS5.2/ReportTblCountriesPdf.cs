...
{     
 ...
 //    Part 1    
        ...
        private static Document AddTblCountriesHaeder(Document doc)       
        {
            ...
            var author = PdfHelper.AuthorViewChangeWithoutString(_country.Author, _country.AuthorYear);

            table.AddCell(new PdfPCell(new Phrase(_country.CountryName + " " + author, LargeFont)) { Colspan = 4, Border = 0 });  // 1.-4. field
