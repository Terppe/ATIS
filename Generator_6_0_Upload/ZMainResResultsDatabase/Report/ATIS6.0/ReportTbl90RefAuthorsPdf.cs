...
using Microsoft.Win32;  
         ...
         //    ReportRefAuthorPdf Skriptdatum:  30.03.2019  10:32    

namespace ATIS.Ui.Views.Report.ListDetails
{     
    
    public class ReportRefAuthorPdf : ViewModelBase
    {     
         
        private static readonly ILog Log = LogManager.GetLogger(typeof(ReportRefAuthorPdf));
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id, string use)
        {
            ...
            var refAuthorList = ExtGet.GetRefAuthorsCollectionOrderByFromRefAuthorId<Tbl90RefAuthor>(id).FirstOrDefault();    
        
            var NULLsList = ExtGet.GetFiSpeciessCollectionOrderByFromRefAuthorId<NULL>(id);           
             
            var expertsList = ExtGet.GetReferenceExpertsCollectionOrderByFromRefAuthorIdAndRefAuthorIdIsNullAndRefSourceIdIsNull<Tbl90Reference>(id);
            var sourcesList = ExtGet.GetReferenceSourcesCollectionOrderByFromRefAuthorIdAndRefAuthorIdIsNullAndRefExpertIdIsNull<Tbl90Reference>(id);
            var authorsList = ExtGet.GetReferenceAuthorsCollectionOrderByFromRefAuthorIdAndRefSourceIdIsNullAndRefExpertIdIsNull<Tbl90Reference>(id);
            var commentsList = ExtGet.GetCommentsCollectionOrderByFromRefAuthorId<Tbl93Comment>(id);   
            ...
            { 
                ...
                using (var pdf = new PdfDocument())
                {
                    ...
                    AddRefAuthorHaeder(pdf, refAuthorList);
                    AddRefAuthorTaxoNomenList(pdf, refAuthorList);   
          
                        if (NULLsList.Count != 0)
                        AddFiSpeciessChildrenList(pdf, NULLsList);      
        ...
        private static void AddRefAuthorHaeder(PdfDocument pdf, Tbl90RefAuthor tbl90RefAuthorList)
        {
            _page = pdf.Pages[_arrInts[6]];

            var textAusgabeAuthor = PdfHelper.AuthorViewChangeWithString(refAuthorList.Author, refAuthorList.AuthorYear);    
          
            var textAusgabeNameAuthor = refAuthorList.RefAuthorName + " " + textAusgabeAuthor;  
            ...
            _arrInts = PdfHelper.PdfTbBoldLeft("countId", _arrInts, false, CultRes.StringsRes.ReportTaxonomicId + refAuthorList.CountId, 0);

            _arrInts[1] += _arrInts[9] + 5; //Distance to next TextBox
        } 
          
        private static void AddRefAuthorTaxoNomenList(PdfDocument pdf, Tbl90RefAuthor tbl90RefAuthorList)         
          
        {
            ...
            _arrInts[1] += _arrInts[9]; //Distance to next TextBox
            //----------------------------------------------------------------
            _arrInts = PdfHelper.PdfTbMoveLeft("kingdomLeft", _arrInts, false, CultRes.StringsRes.RefAuthor + ":", 0);  
          
            _arrInts = PdfHelper.PdfTbRight("kingdomRight", _arrInts, false, refAuthorList.RefAuthorName, 0);     
            ...
            //------------------------------------------------------
            _arrInts = PdfHelper.PdfTbMtRight("synonymRight", _arrInts, refAuthorList.Synonym);
            ...
            //---------------------------------------------------------------
            _arrInts = PdfHelper.PdfTbRight("commNameGerRight", _arrInts, false, refAuthorList.GerName + " " + CultRes.StringsRes.ReportGerman, 0);
            _arrInts = PdfHelper.PdfTbRight("commNameEngRight", _arrInts, false, refAuthorList.EngName + " " + CultRes.StringsRes.ReportEnglish, 0);
            _arrInts = PdfHelper.PdfTbRight("commNameFraRight", _arrInts, false, refAuthorList.FraName + " " + CultRes.StringsRes.ReportFrench, 0);
            _arrInts = PdfHelper.PdfTbRight("commNameSpaRight", _arrInts, false, refAuthorList.PorName + " " + CultRes.StringsRes.ReportSpanish, 0);
            ...
            _arrInts = PdfHelper.PdfTbRight("currStatusRight", _arrInts, false, refAuthorList.Valid.ToString(), 0);
            ...
            _arrInts = PdfHelper.PdfTbRight("recordRight", _arrInts, false, Convert.ToString(refAuthorList.UpdaterDate, CultureInfo.InvariantCulture), 0);
            ...
            _arrInts = PdfHelper.PdfTbMtRight("infoRight", _arrInts, refAuthorList.Info);
            ...
            _arrInts = PdfHelper.PdfTbMtRight("memoRight", _arrInts, refAuthorList.Memo);
        ...
        private static void AddRefAuthorHierarchyList(PdfDocument pdf, Tbl90RefAuthor tbl90RefAuthorList)
        {
            _page = pdf.Pages[_arrInts[6]];

            _arrInts = PdfHelper.PdfTbMoveLeft("refAuthorLeft", _arrInts, false, CultRes.StringsRes.RefAuthor, 0);     
          
            var txtName = refAuthorList.RefAuthorName;        
          
            var textResult = PdfHelper.NamesAuthorsForeignNamesViewChange(txtName, refAuthorList.Author,
                refAuthorList.AuthorYear, refAuthorList.GerName, refAuthorList.EngName, refAuthorList.FraName, refAuthorList.PorName);

            _arrInts = PdfHelper.PdfTbMtRight("refAuthorRight", _arrInts, textResult);

            _arrInts[1] += _arrInts[9] + 2; //Distance to next TextBox
        }      
             
        private static void AddFiSpeciessChildrenList(PdfDocument pdf, ObservableCollection<NULL> NULLsList)
        {
            _page = pdf.Pages[_arrInts[6]];
            ...
            foreach (var t in NULLsList)
            {
                ...
                _arrInts = PdfHelper.PdfTbMoveLeft("NULLLeft" + _z1, _arrInts, false, CultRes.StringsRes.FiSpecies, 0);
