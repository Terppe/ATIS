...
namespace ATIS.Ui.Views.Report
{
    public class ReportViewModel : ViewModelBase
    {
        ...
        {
            UserProfilesCollection = _extReportBasicGet.CollUserProfilesByUserProfileId(id);
            //direct children
            Collection = _extReportBasicGet.CollByUserProfileIdAndHash(id);
            //------------------------------------------------------------------------------
            //Function
            var NULLId = _extReportBasicGet.NULLIdFromUserProfilesCollectionSelect(id);
            //-----------------------------------------------------------------------------
            //ForeignKeyTable
            Collection = _extReportBasicGet.CollByRegnumIdAndHash(NULLId);
            //------------------------------------------------------------------------------
            ExpertsCollection = _extReportBasicGet.CollExpertsByUserProfileId(id);
            SourcesCollection = _extReportBasicGet.CollSourcesByUserProfileId(id);
            AuthorsCollection = _extReportBasicGet.CollAuthorsByUserProfileId(id);
            //------------------------------------------------------------------------------
            CommentsCollection = _extReportBasicGet.CollCommentsByUserProfileId(id);
        }
        //------------------------------------------------------------------------------

        private RelayCommand _pdfUserProfilePrintCommand;
        public ICommand PdfUserProfilePrintCommand
        {
            get { return _pdfUserProfilePrintCommand ??= new RelayCommand(delegate { CreatePdfUserProfilePrint(_mainId); }); }
        }

        private static void CreatePdfUserProfilePrint(int id)
        {
            const string use = "print";
            ReportUserProfilePdf.CreateMainPdf(id, use);
        }
        private RelayCommand _pdfUserProfileSaveCommand;
        public ICommand PdfUserProfileSaveCommand
        {
            get { return _pdfUserProfileSaveCommand ??= new RelayCommand(delegate { CreatePdfUserProfileSave(_mainId); }); }
        }

        private static void CreatePdfUserProfileSave(int id)
        {
            const string use = "save";
            ReportUserProfilePdf.CreateMainPdf(id, use);
        }
