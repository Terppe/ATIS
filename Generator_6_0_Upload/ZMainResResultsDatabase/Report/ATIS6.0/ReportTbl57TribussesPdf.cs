...
{     
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id, string use)
        {
            ...
            { 
                ...
                using (var pdf = new PdfDocument())
                {
                    ...
                    AddTribusHierarchyList(pdf, tribusList);       
        ...
        private static void AddTribusHierarchyList(PdfDocument pdf, Tbl57Tribus tbl57TribusList)
        {
            ...
            //      _arrInts = PdfHelper.PdfTbRight("tribusRight", _arrInts, false, textResult, 0);
        ...
        private static void AddInfratribussChildrenList(PdfDocument pdf, ObservableCollection<Tbl63Infratribus> sList)
        {
            _page = pdf.Pages[_arrInts[6]];
            ...
            foreach (var t in sList)
            {
                ...
                _arrInts = PdfHelper.PdfTbMoveLeft("Left" + _z1, _arrInts, false, CultRes.StringsRes.Infratribus, 0);
