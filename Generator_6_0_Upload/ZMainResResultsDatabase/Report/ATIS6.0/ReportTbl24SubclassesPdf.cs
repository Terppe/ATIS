...
{     
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id, string use)
        {
            ...
            var subclassList = ExtCrud.GetSubclassesCollectionFromSubclassIdOrderBy<Tbl24Subclass>(id).FirstOrDefault();    
        
            //Child
            var infraclasssList = ExtCrud.GetInfraclassesCollectionFromSubclassIdOrderBy<Tbl27Infraclass>(id);           
