...
{     
    ...
    {     
        ...
        private static readonly ILog Log = LogManager.GetLogger(typeof(ReportInfraclassPdf));
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id, string use)
        {
            ...
            var infraclassList = ExtCrud.GetInfraclassesCollectionFromInfraclassIdOrderBy<Tbl27Infraclass>(id).FirstOrDefault();    
        
            //Child
            var legiosList = ExtCrud.GetLegiosCollectionFromInfraclassIdOrderBy<Tbl30Legio>(id);           
             
            var expertsList = ExtCrud.GetReferenceExpertsCollectionFromInfraclassIdAndRefAuthorIdIsNullAndRefSourceIdIsNullOrderBy<Tbl90Reference>(id);
            var sourcesList = ExtCrud.GetReferenceSourcesCollectionFromInfraclassIdAndRefAuthorIdIsNullAndRefExpertIdIsNullOrderBy<Tbl90Reference>(id);
            var authorsList = ExtCrud.GetReferenceAuthorsCollectionFromInfraclassIdAndRefSourceIdIsNullAndRefExpertIdIsNullOrderBy<Tbl90Reference>(id);
            var commentsList = ExtCrud.GetCommentsCollectionFromInfraclassIdOrderBy<Tbl93Comment>(id);   
            ...
            { 
                    ...
                    AddInfraclassHaeder(pdf, infraclassList);
                    AddInfraclassTaxoNomenList(pdf, infraclassList);   
          
                        if (legiosList.Count != 0)
                        AddLegiosChildrenList(pdf, legiosList);      
        ...
        private static void AddInfraclassHaeder(PdfDocument pdf, Tbl27Infraclass tbl27InfraclassList)
        {
            _page = pdf.Pages[_arrInts[6]];

            var textAusgabeAuthor = PdfHelper.AuthorViewChangeWithString(infraclassList.Author, infraclassList.AuthorYear);    
          
            var textAusgabeNameAuthor = infraclassList.InfraclassName + " " + textAusgabeAuthor;  
            ...
            _arrInts = PdfHelper.PdfTbBoldLeft("countId", _arrInts, false, CultRes.StringsRes.ReportTaxonomicId + infraclassList.CountId, 0);

            _arrInts[1] += _arrInts[9] + 5; //Distance to next TextBox
        } 
          
        private static void AddInfraclassTaxoNomenList(PdfDocument pdf, Tbl27Infraclass tbl27InfraclassList)         
          
        {
            ...
            _arrInts[1] += _arrInts[9]; //Distance to next TextBox
            //----------------------------------------------------------------
            _arrInts = PdfHelper.PdfTbMoveLeft("kingdomLeft", _arrInts, false, CultRes.StringsRes.Infraclass + ":", 0);  
          
            _arrInts = PdfHelper.PdfTbRight("kingdomRight", _arrInts, false, infraclassList.InfraclassName, 0);     
            ...
            //------------------------------------------------------
            _arrInts = PdfHelper.PdfTbMtRight("synonymRight", _arrInts, infraclassList.Synonym);
            ...
            //---------------------------------------------------------------
            _arrInts = PdfHelper.PdfTbRight("commNameGerRight", _arrInts, false, infraclassList.GerName + " " + CultRes.StringsRes.ReportGerman, 0);
            _arrInts = PdfHelper.PdfTbRight("commNameEngRight", _arrInts, false, infraclassList.EngName + " " + CultRes.StringsRes.ReportEnglish, 0);
            _arrInts = PdfHelper.PdfTbRight("commNameFraRight", _arrInts, false, infraclassList.FraName + " " + CultRes.StringsRes.ReportFrench, 0);
            _arrInts = PdfHelper.PdfTbRight("commNameSpaRight", _arrInts, false, infraclassList.PorName + " " + CultRes.StringsRes.ReportSpanish, 0);
            ...
            _arrInts = PdfHelper.PdfTbRight("currStatusRight", _arrInts, false, infraclassList.Valid.ToString(), 0);
            ...
            _arrInts = PdfHelper.PdfTbRight("recordRight", _arrInts, false, Convert.ToString(infraclassList.UpdaterDate, CultureInfo.InvariantCulture), 0);
            ...
            _arrInts = PdfHelper.PdfTbMtRight("infoRight", _arrInts, infraclassList.Info);
            ...
            _arrInts = PdfHelper.PdfTbMtRight("memoRight", _arrInts, infraclassList.Memo);
        ...
        private static void AddInfraclassHierarchyList(PdfDocument pdf, Tbl27Infraclass tbl27InfraclassList)
        {
            _page = pdf.Pages[_arrInts[6]];
        ...
        private static void AddLegiosChildrenList(PdfDocument pdf, ObservableCollection<Tbl30Legio> legiosList)
        {
            _page = pdf.Pages[_arrInts[6]];

            _arrInts = PdfHelper.PdfTbRight("childrenLegio", _arrInts, true, CultRes.StringsRes.ReportDirectChild, 1);
            ...
            foreach (var t in legiosList)
            {
                ...
                _arrInts = PdfHelper.PdfTbMoveLeft("legioLeft" + _z1, _arrInts, false, CultRes.StringsRes.Legio, 0);
