...
{     
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id, string use)
        {
            ...
            var subdivisionList = ExtCrud.GetSubdivisionsCollectionFromSubdivisionIdOrderBy<Tbl15Subdivision>(id).FirstOrDefault();    
        
            //Child
            var superclasssList = ExtCrud.GetSuperclassesCollectionFromSubdivisionIdOrderBy<Tbl18Superclass>(id);           
