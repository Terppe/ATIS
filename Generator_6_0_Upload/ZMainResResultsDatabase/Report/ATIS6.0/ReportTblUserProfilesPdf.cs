...
{     
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id, string use)
        {
            ...
            { 
                ...
                using (var pdf = new PdfDocument())
                {
                    ...
                    AddUserProfileHierarchyList(pdf, userprofileList);       
        ...
        private static void AddUserProfileHierarchyList(PdfDocument pdf, TblUserProfile tbluserprofileList)
        {
            ...
            //      _arrInts = PdfHelper.PdfTbRight("userprofileRight", _arrInts, false, textResult, 0);
        ...
        private static void AddsChildrenList(PdfDocument pdf, ObservableCollection<> NULLsList)
        {
            _page = pdf.Pages[_arrInts[6]];

            _arrInts = PdfHelper.PdfTbRight("children", _arrInts, true, CultRes.StringsRes.ReportDirectChild, 1);
            ...
            foreach (var t in NULLsList)
            {
                ...
                _arrInts = PdfHelper.PdfTbMoveLeft("NULLLeft" + _z1, _arrInts, false, CultRes.StringsRes., 0);
