...
using Microsoft.Win32;  
         ...
         //    ReportUserProfilePdf Skriptdatum:   26.02.2019  10:32    

namespace ATIS.Ui.Views.Report.ListDetails
{     
    
    public class ReportUserProfilePdf : ViewModelBase
    {     
         
        private static readonly ILog Log = LogManager.GetLogger(typeof(ReportUserProfilePdf));
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id, string use)
        {
            ...
            var userprofileList = ExtCrud.GetUserProfilesCollectionFromUserProfileIdOrderBy<TblUserProfile>(id).FirstOrDefault();    
        
            //Child
            var NULLsList = ExtCrud.GetCollectionFromUserProfileIdOrderBy<NULL>(id);           
             
            var expertsList = ExtCrud.GetReferenceExpertsCollectionFromUserProfileIdAndRefAuthorIdIsNullAndRefSourceIdIsNullOrderBy<Tbl90Reference>(id);
            var sourcesList = ExtCrud.GetReferenceSourcesCollectionFromUserProfileIdAndRefAuthorIdIsNullAndRefExpertIdIsNullOrderBy<Tbl90Reference>(id);
            var authorsList = ExtCrud.GetReferenceAuthorsCollectionFromUserProfileIdAndRefSourceIdIsNullAndRefExpertIdIsNullOrderBy<Tbl90Reference>(id);
            var commentsList = ExtCrud.GetCommentsCollectionFromUserProfileIdOrderBy<Tbl93Comment>(id);   
            ...
            { 
                    ...
                    AddUserProfileHaeder(pdf, userprofileList);
                    AddUserProfileTaxoNomenList(pdf, userprofileList);   
          
                        if (NULLsList.Count != 0)
                        AddNULLsChildrenList(pdf, NULLsList);      
        ...
        private static void AddUserProfileHaeder(PdfDocument pdf, TblUserProfile tbluserprofileList)
        {
            _page = pdf.Pages[_arrInts[6]];

            var textAusgabeAuthor = PdfHelper.AuthorViewChangeWithString(userprofileList.Author, userprofileList.AuthorYear);    
          
            var textAusgabeNameAuthor = userprofileList.UserProfileName + " " + textAusgabeAuthor;  
            ...
            _arrInts = PdfHelper.PdfTbBoldLeft("countId", _arrInts, false, CultRes.StringsRes.ReportTaxonomicId + userprofileList.CountId, 0);

            _arrInts[1] += _arrInts[9] + 5; //Distance to next TextBox
        } 
          
        private static void AddUserProfileTaxoNomenList(PdfDocument pdf, TblUserProfile tbluserprofileList)         
          
        {
            ...
            _arrInts[1] += _arrInts[9]; //Distance to next TextBox
            //----------------------------------------------------------------
            _arrInts = PdfHelper.PdfTbMoveLeft("kingdomLeft", _arrInts, false, CultRes.StringsRes.UserProfile + ":", 0);  
          
            _arrInts = PdfHelper.PdfTbRight("kingdomRight", _arrInts, false, userprofileList.UserProfileName, 0);     
            ...
            //------------------------------------------------------
            _arrInts = PdfHelper.PdfTbMtRight("synonymRight", _arrInts, userprofileList.Synonym);
            ...
            //---------------------------------------------------------------
            _arrInts = PdfHelper.PdfTbRight("commNameGerRight", _arrInts, false, userprofileList.GerName + " " + CultRes.StringsRes.ReportGerman, 0);
            _arrInts = PdfHelper.PdfTbRight("commNameEngRight", _arrInts, false, userprofileList.EngName + " " + CultRes.StringsRes.ReportEnglish, 0);
            _arrInts = PdfHelper.PdfTbRight("commNameFraRight", _arrInts, false, userprofileList.FraName + " " + CultRes.StringsRes.ReportFrench, 0);
            _arrInts = PdfHelper.PdfTbRight("commNameSpaRight", _arrInts, false, userprofileList.PorName + " " + CultRes.StringsRes.ReportSpanish, 0);
            ...
            _arrInts = PdfHelper.PdfTbRight("currStatusRight", _arrInts, false, userprofileList.Valid.ToString(), 0);
            ...
            _arrInts = PdfHelper.PdfTbRight("recordRight", _arrInts, false, Convert.ToString(userprofileList.UpdaterDate, CultureInfo.InvariantCulture), 0);
            ...
            _arrInts = PdfHelper.PdfTbMtRight("infoRight", _arrInts, userprofileList.Info);
            ...
            _arrInts = PdfHelper.PdfTbMtRight("memoRight", _arrInts, userprofileList.Memo);
        ...
        private static void AddUserProfileHierarchyList(PdfDocument pdf, TblUserProfile tbluserprofileList)
        {
            _page = pdf.Pages[_arrInts[6]];

            _arrInts = PdfHelper.PdfTbMoveLeft("userprofileLeft", _arrInts, false, CultRes.StringsRes.UserProfile, 0);     
          
            var txtName = userprofileList.UserProfileName;        
          
            var textResult = PdfHelper.NamesAuthorsForeignNamesViewChange(txtName, userprofileList.Author,
                userprofileList.AuthorYear, userprofileList.GerName, userprofileList.EngName, userprofileList.FraName, userprofileList.PorName);

            _arrInts = PdfHelper.PdfTbMtRight("userprofileRight", _arrInts, textResult);
