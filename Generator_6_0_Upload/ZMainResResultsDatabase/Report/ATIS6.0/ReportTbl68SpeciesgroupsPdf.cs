...
{     
    ...
    {     
        ...
        private static readonly ILog Log = LogManager.GetLogger(typeof(ReportSpeciesgroupPdf));
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id, string use)
        {
            ...
            var speciesgroupList = ExtCrud.GetSpeciesgroupsCollectionFromSpeciesgroupIdOrderBy<Tbl68Speciesgroup>(id).FirstOrDefault();    
        
            //Child
            var fispeciessList = ExtCrud.GetFiSpeciessesCollectionFromSpeciesgroupIdOrderBy<Tbl69FiSpecies>(id);           
             
            var expertsList = ExtCrud.GetReferenceExpertsCollectionFromSpeciesgroupIdAndRefAuthorIdIsNullAndRefSourceIdIsNullOrderBy<Tbl90Reference>(id);
            var sourcesList = ExtCrud.GetReferenceSourcesCollectionFromSpeciesgroupIdAndRefAuthorIdIsNullAndRefExpertIdIsNullOrderBy<Tbl90Reference>(id);
            var authorsList = ExtCrud.GetReferenceAuthorsCollectionFromSpeciesgroupIdAndRefSourceIdIsNullAndRefExpertIdIsNullOrderBy<Tbl90Reference>(id);
            var commentsList = ExtCrud.GetCommentsCollectionFromSpeciesgroupIdOrderBy<Tbl93Comment>(id);   
            ...
            { 
                    ...
                    AddSpeciesgroupHaeder(pdf, speciesgroupList);
                    AddSpeciesgroupTaxoNomenList(pdf, speciesgroupList);   
          
                        if (fispeciessList.Count != 0)
                        AddFiSpeciessChildrenList(pdf, fispeciessList);      
        ...
        private static void AddSpeciesgroupHaeder(PdfDocument pdf, Tbl68Speciesgroup speciesgroupList)
        {
            ...
            var textAusgabeAuthor = PdfHelper.AuthorViewChangeWithString(speciesgroupList.Author, speciesgroupList.AuthorYear);    
          
            var textAusgabeNameAuthor = speciesgroupList.SpeciesgroupName + " " + textAusgabeAuthor;  
            ...
            _arrInts = PdfHelper.PdfTbBoldLeft("countId", _arrInts, false, CultRes.StringsRes.ReportTaxonomicId + speciesgroupList.CountId, 0);
          ...
          
        {
            ...
            _arrInts[1] += _arrInts[9]; //Distance to next TextBox
            //----------------------------------------------------------------
            _arrInts = PdfHelper.PdfTbMoveLeft("kingdomLeft", _arrInts, false, CultRes.StringsRes.Speciesgroup + ":", 0);  
          
            _arrInts = PdfHelper.PdfTbRight("kingdomRight", _arrInts, false, speciesgroupList.SpeciesgroupName, 0);     
            ...
            //------------------------------------------------------
            _arrInts = PdfHelper.PdfTbMtRight("synonymRight", _arrInts, speciesgroupList.Synonym);
            ...
            //---------------------------------------------------------------
            _arrInts = PdfHelper.PdfTbRight("commNameGerRight", _arrInts, false, speciesgroupList.GerName + " " + CultRes.StringsRes.ReportGerman, 0);
            _arrInts = PdfHelper.PdfTbRight("commNameEngRight", _arrInts, false, speciesgroupList.EngName + " " + CultRes.StringsRes.ReportEnglish, 0);
            _arrInts = PdfHelper.PdfTbRight("commNameFraRight", _arrInts, false, speciesgroupList.FraName + " " + CultRes.StringsRes.ReportFrench, 0);
            _arrInts = PdfHelper.PdfTbRight("commNameSpaRight", _arrInts, false, speciesgroupList.PorName + " " + CultRes.StringsRes.ReportSpanish, 0);
            ...
            _arrInts = PdfHelper.PdfTbRight("currStatusRight", _arrInts, false, speciesgroupList.Valid.ToString(), 0);
            ...
            _arrInts = PdfHelper.PdfTbRight("recordRight", _arrInts, false, Convert.ToString(speciesgroupList.UpdaterDate, CultureInfo.InvariantCulture), 0);
            ...
            _arrInts = PdfHelper.PdfTbMtRight("infoRight", _arrInts, speciesgroupList.Info);
            ...
            _arrInts = PdfHelper.PdfTbMtRight("memoRight", _arrInts, speciesgroupList.Memo);
        ...
        private static void AddSpeciesgroupHierarchyList(PdfDocument pdf, Tbl68Speciesgroup speciesgroupList)
        {
            ...
            _arrInts = PdfHelper.PdfTbMoveLeft("speciesgroupLeft", _arrInts, false, CultRes.StringsRes.Speciesgroup, 0);     
          
            var txtName = speciesgroupList.SpeciesgroupName;        
          
            var textResult = PdfHelper.NamesAuthorsForeignNamesViewChange(txtName, speciesgroupList.Author,
                speciesgroupList.AuthorYear, speciesgroupList.GerName, speciesgroupList.EngName, speciesgroupList.FraName, speciesgroupList.PorName);

            _arrInts = PdfHelper.PdfTbMtRight("speciesgroupRight", _arrInts, textResult);

            _arrInts[1] += _arrInts[9] + 2; //Distance to next TextBox
        }      
             
        private static void AddFiSpeciessChildrenList(PdfDocument pdf, ObservableCollection<Tbl69FiSpecies> fispeciessList)
        {
            _page = pdf.Pages[_arrInts[6]];
