...
{     
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id, string use)
        {
            ...
            { 
                ...
                using (var pdf = new PdfDocument())
                {
                    ...
                    AddSpeciesgroupHierarchyList(pdf, speciesgroupList);       
        ...
        private static void AddSpeciesgroupHierarchyList(PdfDocument pdf, Tbl68Speciesgroup tbl68SpeciesgroupList)
        {
            ...
            //      _arrInts = PdfHelper.PdfTbRight("speciesgroupRight", _arrInts, false, textResult, 0);
        ...
        private static void AddPlSpeciessChildrenList(PdfDocument pdf, ObservableCollection<Tbl72PlSpecies> plspeciessList)
        {
            _page = pdf.Pages[_arrInts[6]];
