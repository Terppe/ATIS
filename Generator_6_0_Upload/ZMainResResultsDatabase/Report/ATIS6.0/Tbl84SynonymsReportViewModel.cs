...
namespace ATIS.Ui.Views.Report
{
    public class ReportViewModel : ViewModelBase
    {
        ...
        {
            SynonymsCollection = _extReportBasicGet.CollSynonymsBySynonymId(id);
            //direct children
            NULLCollection = _extReportBasicGet.CollNULLBySynonymIdAndHash(id);
            //------------------------------------------------------------------------------
            //Function
            var fispeciesId = _extReportBasicGet.FiSpeciesIdFromSynonymsCollectionSelect(id);
            //-----------------------------------------------------------------------------
            //ForeignKeyTable
            FiSpeciessesCollection = _extReportBasicGet.CollFiSpeciessesByRegnumIdAndHash(fispeciesId);
            //------------------------------------------------------------------------------
            ExpertsCollection = _extReportBasicGet.CollExpertsBySynonymId(id);
            SourcesCollection = _extReportBasicGet.CollSourcesBySynonymId(id);
            AuthorsCollection = _extReportBasicGet.CollAuthorsBySynonymId(id);
            //------------------------------------------------------------------------------
            CommentsCollection = _extReportBasicGet.CollCommentsBySynonymId(id);
        }
        //------------------------------------------------------------------------------

        private RelayCommand _pdfSynonymPrintCommand;
        public ICommand PdfSynonymPrintCommand
        {
            get { return _pdfSynonymPrintCommand ??= new RelayCommand(delegate { CreatePdfSynonymPrint(_mainId); }); }
        }

        private static void CreatePdfSynonymPrint(int id)
        {
            const string use = "print";
            ReportSynonymPdf.CreateMainPdf(id, use);
        }
        private RelayCommand _pdfSynonymSaveCommand;
        public ICommand PdfSynonymSaveCommand
        {
            get { return _pdfSynonymSaveCommand ??= new RelayCommand(delegate { CreatePdfSynonymSave(_mainId); }); }
        }

        private static void CreatePdfSynonymSave(int id)
        {
            const string use = "save";
            ReportSynonymPdf.CreateMainPdf(id, use);
        }
