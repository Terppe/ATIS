...
{     
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id, string use)
        {
            ...
            var commentList = ExtCrud.GetCommentsCollectionFromCommentIdOrderBy<Tbl93Comment>(id).FirstOrDefault();    
        
            //Child
            var NULLsList = ExtCrud.GetNULLCollectionFromCommentIdOrderBy<NULL>(id);           
             
            var expertsList = ExtCrud.GetReferenceExpertsCollectionFromCommentIdAndRefAuthorIdIsNullAndRefSourceIdIsNullOrderBy<Tbl90Reference>(id);
            var sourcesList = ExtCrud.GetReferenceSourcesCollectionFromCommentIdAndRefAuthorIdIsNullAndRefExpertIdIsNullOrderBy<Tbl90Reference>(id);
            var authorsList = ExtCrud.GetReferenceAuthorsCollectionFromCommentIdAndRefSourceIdIsNullAndRefExpertIdIsNullOrderBy<Tbl90Reference>(id);
            var commentsList = ExtCrud.GetCommentsCollectionFromCommentIdOrderBy<Tbl93Comment>(id);   
          ...
          
        {
            ...
            //------------------------------------------------------
            _arrInts = PdfHelper.PdfTbMtRight("synonymRight", _arrInts, commentList.Synonym);
