...
using Microsoft.Win32;  
         ...
         //    ReportGeographicPdf Skriptdatum:  22.01.2019  10:32    

namespace ATIS.Ui.Views.Report.ListDetails
{     
    
    public class ReportGeographicPdf : ViewModelBase
    {     
         
        private static readonly ILog Log = LogManager.GetLogger(typeof(ReportGeographicPdf));
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id, string use)
        {
            ...
            var geographicList = ExtCrud.GetGeographicsCollectionFromGeographicIdOrderBy<Tbl87Geographic>(id).FirstOrDefault();    
        
            //Child
            var NULLsList = ExtCrud.GetNULLCollectionFromGeographicIdOrderBy<Tbl68Speciesgroup>(id);           
             
            var expertsList = ExtCrud.GetReferenceExpertsCollectionFromGeographicIdAndRefAuthorIdIsNullAndRefSourceIdIsNullOrderBy<Tbl90Reference>(id);
            var sourcesList = ExtCrud.GetReferenceSourcesCollectionFromGeographicIdAndRefAuthorIdIsNullAndRefExpertIdIsNullOrderBy<Tbl90Reference>(id);
            var authorsList = ExtCrud.GetReferenceAuthorsCollectionFromGeographicIdAndRefSourceIdIsNullAndRefExpertIdIsNullOrderBy<Tbl90Reference>(id);
            var commentsList = ExtCrud.GetCommentsCollectionFromGeographicIdOrderBy<Tbl93Comment>(id);   
            ...
            { 
                    ...
                    AddGeographicHaeder(pdf, geographicList);
                    AddGeographicTaxoNomenList(pdf, geographicList);   
        ...
        private static void AddGeographicHaeder(PdfDocument pdf, Tbl87Geographic tbl87GeographicList)
        {
            _page = pdf.Pages[_arrInts[6]];

            var textAusgabeAuthor = PdfHelper.AuthorViewChangeWithString(geographicList.Author, geographicList.AuthorYear);    
          
            var textAusgabeNameAuthor = geographicList.GeographicName + " " + textAusgabeAuthor;  
            ...
            _arrInts = PdfHelper.PdfTbBoldLeft("countId", _arrInts, false, CultRes.StringsRes.ReportTaxonomicId + geographicList.CountId, 0);

            _arrInts[1] += _arrInts[9] + 5; //Distance to next TextBox
        } 
          
        private static void AddGeographicTaxoNomenList(PdfDocument pdf, Tbl87Geographic tbl87GeographicList)         
          
        {
            ...
            _arrInts[1] += _arrInts[9]; //Distance to next TextBox
            //----------------------------------------------------------------
            _arrInts = PdfHelper.PdfTbMoveLeft("kingdomLeft", _arrInts, false, CultRes.StringsRes.Geographic + ":", 0);  
          
            _arrInts = PdfHelper.PdfTbRight("kingdomRight", _arrInts, false, geographicList.GeographicName, 0);     
            ...
            //------------------------------------------------------
            _arrInts = PdfHelper.PdfTbMtRight("synonymRight", _arrInts, geographicList.Synonym);
            ...
            //---------------------------------------------------------------
            _arrInts = PdfHelper.PdfTbRight("commNameGerRight", _arrInts, false, geographicList.GerName + " " + CultRes.StringsRes.ReportGerman, 0);
            _arrInts = PdfHelper.PdfTbRight("commNameEngRight", _arrInts, false, geographicList.EngName + " " + CultRes.StringsRes.ReportEnglish, 0);
            _arrInts = PdfHelper.PdfTbRight("commNameFraRight", _arrInts, false, geographicList.FraName + " " + CultRes.StringsRes.ReportFrench, 0);
            _arrInts = PdfHelper.PdfTbRight("commNameSpaRight", _arrInts, false, geographicList.PorName + " " + CultRes.StringsRes.ReportSpanish, 0);
            ...
            _arrInts = PdfHelper.PdfTbRight("currStatusRight", _arrInts, false, geographicList.Valid.ToString(), 0);
            ...
            _arrInts = PdfHelper.PdfTbRight("recordRight", _arrInts, false, Convert.ToString(geographicList.UpdaterDate, CultureInfo.InvariantCulture), 0);
            ...
            _arrInts = PdfHelper.PdfTbMtRight("infoRight", _arrInts, geographicList.Info);
            ...
            _arrInts = PdfHelper.PdfTbMtRight("memoRight", _arrInts, geographicList.Memo);
        ...
        private static void AddGeographicHierarchyList(PdfDocument pdf, Tbl87Geographic tbl87GeographicList)
        {
            _page = pdf.Pages[_arrInts[6]];

            _arrInts = PdfHelper.PdfTbMoveLeft("geographicLeft", _arrInts, false, CultRes.StringsRes.Geographic, 0);     
          
            var txtName = geographicList.GeographicName;        
          
            var textResult = PdfHelper.NamesAuthorsForeignNamesViewChange(txtName, geographicList.Author,
                geographicList.AuthorYear, geographicList.GerName, geographicList.EngName, geographicList.FraName, geographicList.PorName);

            _arrInts = PdfHelper.PdfTbMtRight("geographicRight", _arrInts, textResult);
