...
{     
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id, string use)
        {
            ...
            var imageList = ExtCrud.GetImagesCollectionFromImageIdOrderBy<Tbl81Image>(id).FirstOrDefault();    
        
            //Child
            var NULLsList = ExtCrud.GetNULLCollectionFromImageIdOrderBy<Tbl68Speciesgroup>(id);           
             
            var expertsList = ExtCrud.GetReferenceExpertsCollectionFromImageIdAndRefAuthorIdIsNullAndRefSourceIdIsNullOrderBy<Tbl90Reference>(id);
            var sourcesList = ExtCrud.GetReferenceSourcesCollectionFromImageIdAndRefAuthorIdIsNullAndRefExpertIdIsNullOrderBy<Tbl90Reference>(id);
            var authorsList = ExtCrud.GetReferenceAuthorsCollectionFromImageIdAndRefSourceIdIsNullAndRefExpertIdIsNullOrderBy<Tbl90Reference>(id);
            var commentsList = ExtCrud.GetCommentsCollectionFromImageIdOrderBy<Tbl93Comment>(id);   
