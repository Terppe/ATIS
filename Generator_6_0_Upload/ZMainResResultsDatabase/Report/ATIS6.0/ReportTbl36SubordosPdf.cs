...
{     
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id, string use)
        {
            ...
            { 
                ...
                using (var pdf = new PdfDocument())
                {
                    ...
                    AddSubordoHierarchyList(pdf, subordoList);       
        ...
        private static void AddSubordoHierarchyList(PdfDocument pdf, Tbl36Subordo tbl36SubordoList)
        {
            ...
            //      _arrInts = PdfHelper.PdfTbRight("subordoRight", _arrInts, false, textResult, 0);
        ...
        private static void AddSuperfamilysChildrenList(PdfDocument pdf, ObservableCollection<Tbl42Superfamily> sList)
        {
            _page = pdf.Pages[_arrInts[6]];
            ...
            foreach (var t in sList)
            {
                ...
                _arrInts = PdfHelper.PdfTbMoveLeft("Left" + _z1, _arrInts, false, CultRes.StringsRes.Superfamily, 0);
