...
{     
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id, string use)
        {
            ...
            var subordoList = ExtCrud.GetSubordosCollectionFromSubordoIdOrderBy<Tbl36Subordo>(id).FirstOrDefault();    
        ...
        private static void AddSubordoTaxoNomenList(PdfDocument pdf, Tbl36Subordo subordoList)         
