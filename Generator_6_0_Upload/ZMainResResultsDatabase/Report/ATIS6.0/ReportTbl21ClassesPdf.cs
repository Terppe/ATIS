...
using Microsoft.Win32;  
         ...
         //    ReportClassPdf Skriptdatum:  05.11.2020  18:32    

namespace ATIS.Ui.Views.Report.D21Class
{     
    
    public class ReportClassPdf : ViewModelBase
    {     
         
        private static readonly ILog Log = LogManager.GetLogger(typeof(ReportClassPdf));
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id, string use)
        {
            ...
            var classeList = ExtCrud.GetClassesCollectionFromClassIdOrderBy<Tbl21Class>(id).FirstOrDefault();    
        
            //Child
            var subclasssList = ExtCrud.GetSubclassesCollectionFromClassIdOrderBy<Tbl24Subclass>(id);           
            ...
            var expertsList = ExtCrud.GetReferenceExpertsCollectionFromClassIdAndRefAuthorIdIsNullAndRefSourceIdIsNullOrderBy<Tbl90Reference>(id);
            var sourcesList = ExtCrud.GetReferenceSourcesCollectionFromClassIdAndRefAuthorIdIsNullAndRefExpertIdIsNullOrderBy<Tbl90Reference>(id);
            var authorsList = ExtCrud.GetReferenceAuthorsCollectionFromClassIdAndRefSourceIdIsNullAndRefExpertIdIsNullOrderBy<Tbl90Reference>(id);
            var commentsList = ExtCrud.GetCommentsCollectionFromClassIdOrderBy<Tbl93Comment>(id);   
        ...
        private static void AddClassHaeder(PdfDocument pdf, Tbl21Class classList)
        {
            ...
            var textAusgabeAuthor = PdfHelper.AuthorViewChangeWithString(classeList.Author, classeList.AuthorYear);    
          
            var textAusgabeNameAuthor = classeList.ClassName + " " + textAusgabeAuthor;  
            ...
            _arrInts = PdfHelper.PdfTbBoldLeft("countId", _arrInts, false, CultRes.StringsRes.ReportTaxonomicId + classeList.CountId, 0);
          ...
          
        {
            ...
            _arrInts[1] += _arrInts[9]; //Distance to next TextBox
            //----------------------------------------------------------------
            _arrInts = PdfHelper.PdfTbMoveLeft("kingdomLeft", _arrInts, false, CultRes.StringsRes.Class + ":", 0);  
          
            _arrInts = PdfHelper.PdfTbRight("kingdomRight", _arrInts, false, classeList.ClassName, 0);     
            ...
            //------------------------------------------------------
            _arrInts = PdfHelper.PdfTbMtRight("synonymRight", _arrInts, classeList.Synonym);
            ...
            //---------------------------------------------------------------
            _arrInts = PdfHelper.PdfTbRight("commNameGerRight", _arrInts, false, classeList.GerName + " " + CultRes.StringsRes.ReportGerman, 0);
            _arrInts = PdfHelper.PdfTbRight("commNameEngRight", _arrInts, false, classeList.EngName + " " + CultRes.StringsRes.ReportEnglish, 0);
            _arrInts = PdfHelper.PdfTbRight("commNameFraRight", _arrInts, false, classeList.FraName + " " + CultRes.StringsRes.ReportFrench, 0);
            _arrInts = PdfHelper.PdfTbRight("commNameSpaRight", _arrInts, false, classeList.PorName + " " + CultRes.StringsRes.ReportSpanish, 0);
            ...
            _arrInts = PdfHelper.PdfTbRight("currStatusRight", _arrInts, false, classeList.Valid.ToString(), 0);
            ...
            _arrInts = PdfHelper.PdfTbRight("recordRight", _arrInts, false, Convert.ToString(classeList.UpdaterDate, CultureInfo.InvariantCulture), 0);
            ...
            _arrInts = PdfHelper.PdfTbMtRight("infoRight", _arrInts, classeList.Info);
            ...
            _arrInts = PdfHelper.PdfTbMtRight("memoRight", _arrInts, classeList.Memo);
        ...
        private static void AddClassHierarchyList(PdfDocument pdf, Tbl21Class classList)
        {
            ...
            var txtName = classeList.ClassName;        
          
            var textResult = PdfHelper.NamesAuthorsForeignNamesViewChange(txtName, classeList.Author,
                classeList.AuthorYear, classeList.GerName, classeList.EngName, classeList.FraName, classeList.PorName);
        ...
        private static void AddSubclasssChildrenList(PdfDocument pdf, ObservableCollection<Tbl24Subclass> subclasssList)
        {
            _page = pdf.Pages[_arrInts[6]];

            _arrInts = PdfHelper.PdfTbRight("childrenSubclass", _arrInts, true, CultRes.StringsRes.ReportDirectChild, 1);
            ...
            foreach (var t in subclasssList)
            {
                ...
                _arrInts = PdfHelper.PdfTbMoveLeft("subclassLeft" + _z1, _arrInts, false, CultRes.StringsRes.Subclass, 0);
