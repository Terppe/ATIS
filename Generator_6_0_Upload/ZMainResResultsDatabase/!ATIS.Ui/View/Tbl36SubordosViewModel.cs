...
using MessageBoxImage = System.Windows.MessageBoxImage;
         ...
         //    Tbl36SubordosViewModel Skriptdatum:  15.12.2019  10:32    
 ...
 //    Part 5    
  ...
  SuperfamiliesView = CollectionViewSource.GetDefaultView(Tbl42SuperfamiliesList);
        ...
        private void CopySuperfamily(object o)
        {
            ...
            var  = _tbl42SuperfamiliesRepository.Get(CurrentTbl42Superfamily.SuperfamilyID);
        ...
        private void DeleteSuperfamily(object o)
        {
            try
            {
                ...
                {  
                    ...
                    _tbl42SuperfamiliesRepository.Delete();
            ...
            try
            {
                ...
                else
                {
                    if (CurrentTbl42Superfamily.SuperfamilyID!= 0)
                    {
                        if (!= null) //update
                        {   
  .SubordoID= CurrentTbl42Superfamily.SubordoID;            
  ...
  SubordoID = CurrentTbl42Superfamily.SubordoID,              
                    ...
                    {
                        //SubordoID may be not 0
                        if (CurrentTbl42Superfamily.SubordoID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl42SuperfamiliesRepository.GetAll()
                         ...
                         a.SubordoID == CurrentTbl42Superfamily.SubordoID
                         select a);
                ...
                else
                {
                    if (CurrentTbl90RefAuthor.ReferenceID != 0 && CurrentTbl90RefAuthor.RefAuthorID != 0)
                    {
                        ...
                        {   
                            ...
                            refAuthor.SubordoID = CurrentTbl90RefAuthor.SubordoID;  
...
SubordoID = CurrentTbl90RefAuthor.SubordoID,              
                    ...
                    {
                        //SubordoID may be not 0
                        if (CurrentTbl90RefAuthor.SubordoID == 0 || CurrentTbl90RefAuthor.RefAuthorID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl90ReferencesRepository.GetAll()
                         ...
                         a.SubordoID == CurrentTbl90RefAuthor.SubordoID &&
                ...
                else
                {
                    if (CurrentTbl90RefSource.ReferenceID != 0)
                    {
                        ...
                        {   
                            ...
                            refSource.SubordoID = CurrentTbl90RefSource.SubordoID;            
...
SubordoID = CurrentTbl90RefSource.SubordoID,              
                    ...
                    {
                        //SubordoID may be not 0
                        if (CurrentTbl90RefSource.SubordoID == 0 || CurrentTbl90RefSource.RefSourceID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,            
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl90ReferencesRepository.GetAll()
                         ...
                         a.SubordoID == CurrentTbl90RefSource.SubordoID &&
                ...
                else
                {
                    if (CurrentTbl90RefExpert.ReferenceID != 0 && CurrentTbl90RefExpert.RefExpertID != 0)
                    {
                        ...
                        {   
                            ...
                            refExpert.SubordoID = CurrentTbl90RefExpert.SubordoID;           
...
SubordoID = CurrentTbl90RefExpert.SubordoID,              
                    ...
                    {
                        //SubordoID may be not 0
                        if (CurrentTbl90RefExpert.SubordoID == 0 || CurrentTbl90RefExpert.RefExpertID == 0)   
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,          
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl90ReferencesRepository.GetAll()
                         ...
                         a.SubordoID == CurrentTbl90RefExpert.SubordoID &&
...
SubordoID = CurrentTbl93Comment.SubordoID,              
                    ...
                    {
                        //SubordoID may be not 0
                        if (CurrentTbl93Comment.SubordoID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
 ...
 //    Part 9    
        ...
        public  void GetConnectedTablesById(object o)
        {
            ...
            Tbl39InfraordosList =  new ObservableCollection<Tbl39Infraordo>
                                                       ...
                                                       where y.SubordoID == CurrentTbl36Subordo.SubordoID
