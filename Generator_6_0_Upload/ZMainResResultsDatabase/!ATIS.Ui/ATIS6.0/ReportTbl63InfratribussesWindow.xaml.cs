...
using MahApps.Metro.Controls;
   ...
   //  ReportInfratribusWindow.xaml.cs Skriptdatum:  13.12.2020  10:32     

namespace ATIS.Ui.Views.Report.D63Infratribus
{  

    /// <summary>
    /// Interactionslogic for ReportInfratribusWindow.xaml
    /// </summary>
    public partial class ReportInfratribusWindow : MetroWindow
   {

        public ReportInfratribusWindow(int un, string tab)
       {         
