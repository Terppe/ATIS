...
using Microsoft.EntityFrameworkCore;          
         ...
         //    GenussesViewModel Skriptdatum:  12.12.2019  10:32    
...
{     
 ...
 //    Part 1    
        ...
        private void ExecuteGetGenussesByNameOrId(string searchName)
        {
            ...
            Tbl66GenussesList = _extGet.SearchNameAndIdReturnCollection<Tbl66Genus>(SearchGenusName, "genus");
 ...
 //    Part 4    
        ...
        private void ExecuteDeleteFiSpecies(string searchName)
        {
            ...
            Tbl72PlSpeciessesList = _extDelete.SearchForConnectedDatasetsWithFiSpeciesIdInTablePlSpecies(CurrentTbl69FiSpecies);
            ...
            Tbl69FiSpeciessesList = _extGet.GetFiSpeciessesCollectionOrderByFromGenusId<Tbl69FiSpecies>(CurrentTbl69FiSpecies.GenusId);
 ...
 //    Part 8    
        ...
        public void ExecuteCopyReferenceAuthor(object o)
        {
            ...
            Tbl90ReferenceAuthorsList = _extCopy.CopyReferenceGenus(CurrentTbl90ReferenceAuthor, "Author");
        ...
        public void ExecuteSaveReferenceAuthor(string searchName)
        {
            ...
            try
            {
                ...
                if (CurrentTbl90ReferenceAuthor.ReferenceId == 0)
                    reference = _extSave.ReferenceAuthorGenusAdd(CurrentTbl90ReferenceAuthor);

                else
                    reference = _extSave.ReferenceAuthorGenusUpdate(reference, CurrentTbl90ReferenceAuthor);
           ...
           Tbl90ReferenceAuthorsList = _extGet.GetReferenceAuthorsCollectionOrderByFromGenusIdAndRefSourceIdIsNullAndRefExpertIdIsNull<Tbl90Reference>(CurrentTbl66Genus.GenusId);            
        ...
        public void ExecuteCopyReferenceSource(object o)
        {
            ...
            Tbl90ReferenceAuthorsList = _extCopy.CopyReferenceGenus(CurrentTbl90ReferenceSource, "Source");
        ...
        private void ExecuteDeleteReferenceSource(object o)
        {
           ...
           Tbl90ReferenceSourcesList = _extGet.GetReferenceSourcesCollectionOrderByFromGenusIdAndRefAuthorIdIsNullAndRefExpertIdIsNull<Tbl90Reference>(CurrentTbl66Genus.GenusId);          
           ...
           if (_genSourceMessageBoxes.NoDatasetSelectedInfoMessageBox(CurrentTbl90ReferenceSource)) return;
            ...
            try
            {
                ...
                if (CurrentTbl90ReferenceSource.ReferenceId == 0)
                    reference = _extSave.ReferenceSourceGenusAdd(CurrentTbl90ReferenceSource);
                else
                    reference = _extSave.ReferenceSourceGenusUpdate(reference, CurrentTbl90ReferenceSource);
        ...
        public void ExecuteCopyReferenceExpert(object o)
        {
            ...
            Tbl90ReferenceExpertsList = _extCopy.CopyReferenceGenus(CurrentTbl90ReferenceExpert, "Expert");
        ...
        private void ExecuteDeleteReferenceExpert(object o)
        {
           ...
           Tbl90ReferenceExpertsList= _extGet.GetReferenceExpertsCollectionOrderByFromGenusIdAndRefAuthorIdIsNullAndRefSourceIdIsNull<Tbl90Reference>(CurrentTbl66Genus.GenusId);           
        ...
        public void ExecuteSaveReferenceExpert(object o)
        {
            ...
            try
            {
                ...
                if (CurrentTbl90ReferenceExpert.ReferenceId == 0)
                    reference = _extSave.ReferenceExpertGenusAdd(CurrentTbl90ReferenceExpert);
                else
                    reference = _extSave.ReferenceExpertGenusUpdate(reference, CurrentTbl90ReferenceExpert);
       ...
       #region [Methods Genus ==> Tbl93Comments]        
        ...
        private void ExecuteDeleteComment(object o)
        {
            ...
            Tbl93CommentsList = _extGet.GetCommentsCollectionOrderByFromGenusId<Tbl93Comment>(CurrentTbl93Comment.GenusId);
        ...
        private void ExecuteSaveComment(object o)
        {
            ...
            try
            {
                ...
                if (CurrentTbl93Comment.CommentId == 0)
                    comment = _extSave.CommentGenusAdd(CurrentTbl93Comment);
                else
                    comment = _extSave.CommentGenusUpdate(comment, CurrentTbl93Comment);
 ...
 //    Part 9    
        ...
        {           
Tbl63InfratribussesList = _extGet.GetInfratribussesCollectionOrderByFromInfratribusId<Tbl63Infratribus>(CurrentTbl66Genus.InfratribusId);

            Tbl60SubtribussesAllList = _extGet.AllCollection<Tbl60Subtribus>("");
        ...
        public  int SelectedMainTabIndex
        {
            ...
            set
            {
                ...
                if (_selectedMainTabIndex == 1)
                {
                    if (CurrentTbl66Genus != null)
                    {
                        Tbl69FiSpeciessesList = _extGet.GetFiSpeciessesCollectionOrderByFromGenusId<Tbl69FiSpecies>(CurrentTbl66Genus.GenusId);
                ...
                if (_selectedMainTabIndex == 3)
                {
                    if (CurrentTbl66Genus != null)
                    {
                        Tbl93CommentsList = _extGet.GetCommentsCollectionOrderByFromGenusId<Tbl93Comment>(CurrentTbl66Genus.GenusId);
