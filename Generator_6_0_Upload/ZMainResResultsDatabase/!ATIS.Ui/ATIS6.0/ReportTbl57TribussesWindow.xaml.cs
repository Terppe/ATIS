...
using MahApps.Metro.Controls;
   ...
   //  ReportTribusWindow.xaml.cs Skriptdatum:  13.12.2019  10:32     

namespace ATIS.Ui.Views.Report.ListDetails
{  

    /// <summary>
    /// Interactionslogic for ReportTribusWindow.xaml
    /// </summary>
    public partial class ReportTribusWindow : MetroWindow
   {

        public ReportTribusWindow(int un, string tab)
       {         
