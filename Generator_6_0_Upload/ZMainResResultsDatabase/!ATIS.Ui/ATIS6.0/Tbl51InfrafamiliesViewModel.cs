...
{     
 ...
 //    Part 1    
        ...
        private void ExecuteGetInfrafamiliesByNameOrId(string searchName)
        {
            ...
            Tbl51InfrafamiliesList = _extCrud.GetCollectionFromSearchNameOrIdOrderBy<Tbl51Infrafamily>(SearchInfrafamilyName, "infrafamily");
 ...
 //    Part 8    
        ...
        public void ExecuteSaveReferenceAuthor(string searchName)
        {
            ...
            try
            {
                ...
                if (CurrentTbl90ReferenceAuthor.ReferenceId == 0)
                    reference = _extCrud.ReferenceAuthorInfrafamilyAdd(CurrentTbl90ReferenceAuthor);

                else
                    reference = _extCrud.ReferenceAuthorInfrafamilyUpdate(reference, CurrentTbl90ReferenceAuthor);
           ...
           if (_genSourceMessageBoxes.NoDatasetSelectedInfoMessageBox(CurrentTbl90ReferenceSource)) return;
            ...
            try
            {
                ...
                if (CurrentTbl90ReferenceSource.ReferenceId == 0)
                    reference = _extCrud.ReferenceSourceInfrafamilyAdd(CurrentTbl90ReferenceSource);
                else
                    reference = _extCrud.ReferenceSourceInfrafamilyUpdate(reference, CurrentTbl90ReferenceSource);
        ...
        public void ExecuteSaveReferenceExpert(object o)
        {
            ...
            try
            {
                ...
                if (CurrentTbl90ReferenceExpert.ReferenceId == 0)
                    reference = _extCrud.ReferenceExpertInfrafamilyAdd(CurrentTbl90ReferenceExpert);
                else
                    reference = _extCrud.ReferenceExpertInfrafamilyUpdate(reference, CurrentTbl90ReferenceExpert);
       ...
       #region [Methods Infrafamily ==> Tbl93Comments]        
        ...
        private void ExecuteDeleteComment(object o)
        {
            ...
            Tbl93CommentsList = _extCrud.GetCommentsCollectionFromInfrafamilyIdOrderBy<Tbl93Comment>(CurrentTbl93Comment.InfrafamilyId);
        ...
        private void ExecuteSaveComment(object o)
        {
            ...
            try
            {
                ...
                if (CurrentTbl93Comment.CommentId == 0)
                    comment = _extCrud.CommentInfrafamilyAdd(CurrentTbl93Comment);
                else
                    comment = _extCrud.CommentInfrafamilyUpdate(comment, CurrentTbl93Comment);
...
Tbl48SubfamiliesList = _extCrud.GetSubfamiliesCollectionFromSubfamilyIdOrderBy<Tbl48Subfamily>(CurrentTbl51Infrafamily.SubfamilyId);
            ...
            Tbl45FamiliesAllList = _extCrud.GetCollectionAllOrderBy<Tbl45Family>("");
