...
using MahApps.Metro.Controls;
   ...
   //  ReportCommentWindow.xaml.cs Skriptdatum:  29.11.2018  10:32     

namespace ATIS.Ui.Views.Report.ListDetails
{  

    /// <summary>
    /// Interactionslogic for ReportCommentWindow.xaml
    /// </summary>
    public partial class ReportCommentWindow : MetroWindow
   {

        public ReportCommentWindow(int un, string tab)
       {         
