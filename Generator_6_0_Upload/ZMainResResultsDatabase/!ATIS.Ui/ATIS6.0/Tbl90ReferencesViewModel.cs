...
ReferencesView = CollectionViewSource.GetDefaultView(Tbl90ReferencesList);
        ...
        private void ExecuteCopyReference(object o)
        {
            ...
            Tbl90ReferencesList = _extCopy.CopyReference(CurrentTbl90Reference);
        ...
        private void ExecuteDeleteReference(string searchName)
        {
            ...
            Tbl90RefAuthorsList = _extDelete.SearchForConnectedDatasetsWithReferenceIdInTableRefAuthor(CurrentTbl90Reference);     
     
            if (_allMessageBoxes.DoNotDeleteDatasetInfoMessageBox(Tbl90RefAuthorsList.Count, "RefAuthor")) return;

            //Delete all References Experts, Sources, Authors  ----------------------------------------------------
            Tbl90ReferencesList = _extDelete.DeleteDatasetsWithReferenceIdInTableReference(CurrentTbl90Reference);
            ...
            //Delete all Comments  ----------------------------------------------------
            Tbl93CommentsList = _extDelete.DeleteDatasetsWithReferenceIdInTableComment(CurrentTbl90Reference);
        ...
        private void ExecuteSaveRefExpert(string searchName)
        {
            ...
            try
            {
                ...
                if (CurrentTbl90RefExpert.RefExpertId == 0)
                    refexpert = _extSave.RefExpertAdd(CurrentTbl90RefExpert);
                else
                    refexpert = _extSave.RefExpertUpdate(refexpert, CurrentTbl90RefExpert);
                ...
                try
                {
                    _extSave.RefExpertSave(refexpert, CurrentTbl90RefExpert);
                }
        ...
        public  int SelectedMainTabIndex
        {
            ...
            set
            {
                ...
                if (_selectedMainTabIndex == 1)
                {
                    if (CurrentTbl90Reference != null)
                    {
                        Tbl90RefAuthorsList = _extGet.GetRefAuthorsCollectionOrderByFromReferenceId<Tbl90RefAuthor>(CurrentTbl90Reference.ReferenceId);

                        Tbl90ReferencesAllList = _extGet.AllCollection<Tbl90Reference>("reference");
            ...
            set
            {
                ...
                if (_selectedDetailTabIndex == 3)
                {
                    if (CurrentTbl90Reference != null)
                    {
                        ...
                        Tbl90ReferenceExpertsList = _extGet.GetReferenceExpertsCollectionOrderByFromReferenceIdAndRefAuthorIdIsNullAndRefSourceIdIsNull<Tbl90Reference>(CurrentTbl90Reference.ReferenceId);
                ...
                if (_selectedDetailTabIndex == 4)
                {
                    if (CurrentTbl90Reference != null)
                    {
                        ...
                        Tbl90ReferenceSourcesList = _extGet.GetReferenceSourcesCollectionOrderByFromReferenceIdAndRefAuthorIdIsNullAndRefExpertIdIsNull<Tbl90Reference>(CurrentTbl90Reference.ReferenceId);
                ...
                if (_selectedDetailTabIndex == 5)
                {
                    if (CurrentTbl90Reference != null)
                    {
                        ...
                        Tbl90ReferenceAuthorsList = _extGet.GetReferenceAuthorsCollectionOrderByFromReferenceIdAndRefSourceIdIsNullAndRefExpertIdIsNull<Tbl90Reference>(CurrentTbl90Reference.ReferenceId);
