...
using MahApps.Metro.Controls;
   ...
   //  ReportSpeciesgroupWindow.xaml.cs Skriptdatum:  15.12.2020  10:32     

namespace ATIS.Ui.Views.Report.D68Speciesgroup
{  

    /// <summary>
    /// Interactionslogic for ReportSpeciesgroupWindow.xaml
    /// </summary>
    public partial class ReportSpeciesgroupWindow : MetroWindow
   {

        public ReportSpeciesgroupWindow(int un, string tab)
       {         
