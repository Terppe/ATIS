...
{     
    ...
    {  
        ...
        private static readonly ILog Log = LogManager.GetLogger(typeof(CommentsViewModel));
...
CommentsView = CollectionViewSource.GetDefaultView(Tbl93CommentsList);
        ...
        private void ExecuteDeleteComment(string searchName)
        {
            ...
            NULLList = _extCrud.SearchForConnectedDatasetsWithCommentIdInTableNULL(CurrentTbl93Comment);     
     
            if (_allMessageBoxes.DoNotDeleteDatasetInfoMessageBox(NULLList.Count, "NULL")) return;

            //Delete all References Experts, Sources, Authors  ----------------------------------------------------
            Tbl90ReferencesList = _extCrud.DeleteDatasetsWithCommentIdInTableReference(CurrentTbl93Comment);
            ...
            //Delete all Comments  ----------------------------------------------------
            Tbl93CommentsList = _extCrud.DeleteDatasetsWithCommentIdInTableComment(CurrentTbl93Comment);
        ...
        public  int SelectedMainTabIndex
        {
            ...
            set
            {
                ...
                if (_selectedMainTabIndex == 0)             
                {
                    ...
                    {
                        NULLList = _extCrud.GetNULLCollectionFromNULLIdOrderBy<NULL>(CurrentTbl93Comment.NULLId);
                ...
                if (_selectedMainTabIndex == 1)
                {
                    if (CurrentTbl93Comment != null)
                    {
                        NULLList = _extCrud.GetNULLCollectionFromCommentIdOrderBy<NULL>(CurrentTbl93Comment.CommentId);

                        Tbl93CommentsAllList = _extCrud.GetCollectionAllOrderBy<Tbl93Comment>("comment");
                ...
                if (_selectedMainTabIndex == 3)
                {
                    if (CurrentTbl93Comment != null)
                    {
                        Tbl93CommentsList = _extCrud.GetCommentsCollectionFromCommentIdOrderBy<Tbl93Comment>(CurrentTbl93Comment.CommentId);
            ...
            set
            {
                ...
                if (_selectedDetailTabIndex == 3)
                {
                    if (CurrentTbl93Comment != null)
                    {
                        ...
                        Tbl90ReferenceExpertsList = _extCrud.GetReferenceExpertsCollectionFromCommentIdAndRefAuthorIdIsNullAndRefSourceIdIsNullOrderBy<Tbl90Reference>(CurrentTbl93Comment.CommentId);
                ...
                if (_selectedDetailTabIndex == 4)
                {
                    if (CurrentTbl93Comment != null)
                    {
                        ...
                        Tbl90ReferenceSourcesList = _extCrud.GetReferenceSourcesCollectionFromCommentIdAndRefAuthorIdIsNullAndRefExpertIdIsNullOrderBy<Tbl90Reference>(CurrentTbl93Comment.CommentId);
                ...
                if (_selectedDetailTabIndex == 5)
                {
                    if (CurrentTbl93Comment != null)
                    {
                        ...
                        Tbl90ReferenceAuthorsList = _extCrud.GetReferenceAuthorsCollectionFromCommentIdAndRefSourceIdIsNullAndRefExpertIdIsNullOrderBy<Tbl90Reference>(CurrentTbl93Comment.CommentId);
