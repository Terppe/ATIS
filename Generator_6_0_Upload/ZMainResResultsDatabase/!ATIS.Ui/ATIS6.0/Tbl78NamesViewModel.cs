...
NamesView = CollectionViewSource.GetDefaultView(Tbl78NamesList);
        ...
        private void ExecuteCopyName(object o)
        {
            ...
            Tbl78NamesList = _extCopy.CopyName(CurrentTbl78Name);
        ...
        private void ExecuteDeleteName(string searchName)
        {
            ...
            NULLList = _extDelete.SearchForConnectedDatasetsWithNameIdInTableImage(CurrentTbl78Name);     
        ...
        private void ExecuteSaveName(string searchName)
        {
            ...
            try
            {
                ...
                if (CurrentTbl78Name.NameId == 0)
                    name = _extSave.NameAdd(CurrentTbl78Name);
                else
                    name = _extSave.NameUpdate(name, CurrentTbl78Name);

                _position = NamesView.CurrentPosition;

                try
                {
                    _extSave.NameSave(name, CurrentTbl78Name);
                }
        ...
        public  int SelectedMainTabIndex
        {
            ...
            set
            {
                ...
                if (_selectedMainTabIndex == 0)             
                {
                    ...
                    {
                        Tbl69FiSpeciessesList = _extGet.GetFiSpeciessesCollectionOrderByFromFiSpeciesId<Tbl69FiSpecies>(CurrentTbl78Name.FiSpeciesId);
                ...
                if (_selectedMainTabIndex == 1)
                {
                    if (CurrentTbl78Name != null)
                    {
                        NULLList = _extGet.GetNULLCollectionOrderByFromNameId<Tbl68Speciesgroup>(CurrentTbl78Name.NameId);

                        Tbl78NamesAllList = _extGet.AllCollection<Tbl78Name>("name");
            ...
            set
            {
                ...
                if (_selectedDetailTabIndex == 3)
                {
                    if (CurrentTbl78Name != null)
                    {
                        ...
                        Tbl90ReferenceExpertsList = _extGet.GetReferenceExpertsCollectionOrderByFromNameIdAndRefAuthorIdIsNullAndRefSourceIdIsNull<Tbl90Reference>(CurrentTbl78Name.NameId);
                ...
                if (_selectedDetailTabIndex == 4)
                {
                    if (CurrentTbl78Name != null)
                    {
                        ...
                        Tbl90ReferenceSourcesList = _extGet.GetReferenceSourcesCollectionOrderByFromNameIdAndRefAuthorIdIsNullAndRefExpertIdIsNull<Tbl90Reference>(CurrentTbl78Name.NameId);
                ...
                if (_selectedDetailTabIndex == 5)
                {
                    if (CurrentTbl78Name != null)
                    {
                        ...
                        Tbl90ReferenceAuthorsList = _extGet.GetReferenceAuthorsCollectionOrderByFromNameIdAndRefSourceIdIsNullAndRefExpertIdIsNull<Tbl90Reference>(CurrentTbl78Name.NameId);
