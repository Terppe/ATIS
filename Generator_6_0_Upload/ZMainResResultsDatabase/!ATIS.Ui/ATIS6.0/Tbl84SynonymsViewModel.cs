...
SynonymsView = CollectionViewSource.GetDefaultView(Tbl84SynonymsList);
        ...
        private void ExecuteDeleteSynonym(string searchName)
        {
            ...
            NULLList = _extCrud.SearchForConnectedDatasetsWithSynonymIdInTableName(CurrentTbl84Synonym);     
            ...
            //Delete all Comments  ----------------------------------------------------
            Tbl93CommentsList = _extCrud.DeleteDatasetsWithSynonymIdInTableComment(CurrentTbl84Synonym);
        ...
        public  int SelectedMainTabIndex
        {
            ...
            set
            {
                ...
                if (_selectedMainTabIndex == 1)
                {
                    if (CurrentTbl84Synonym != null)
                    {
                        NULLList = _extCrud.GetNULLCollectionFromSynonymIdOrderBy<Tbl68Speciesgroup>(CurrentTbl84Synonym.SynonymId);

                        Tbl84SynonymsAllList = _extCrud.GetCollectionAllOrderBy<Tbl84Synonym>("synonym");
                ...
                if (_selectedMainTabIndex == 3)
                {
                    if (CurrentTbl84Synonym != null)
                    {
                        Tbl93CommentsList = _extCrud.GetCommentsCollectionFromSynonymIdOrderBy<Tbl93Comment>(CurrentTbl84Synonym.SynonymId);
            ...
            set
            {
                ...
                if (_selectedDetailTabIndex == 3)
                {
                    if (CurrentTbl84Synonym != null)
                    {
                        ...
                        Tbl90ReferenceExpertsList = _extCrud.GetReferenceExpertsCollectionFromSynonymIdAndRefAuthorIdIsNullAndRefSourceIdIsNullOrderBy<Tbl90Reference>(CurrentTbl84Synonym.SynonymId);
                ...
                if (_selectedDetailTabIndex == 4)
                {
                    if (CurrentTbl84Synonym != null)
                    {
                        ...
                        Tbl90ReferenceSourcesList = _extCrud.GetReferenceSourcesCollectionFromSynonymIdAndRefAuthorIdIsNullAndRefExpertIdIsNullOrderBy<Tbl90Reference>(CurrentTbl84Synonym.SynonymId);
                ...
                if (_selectedDetailTabIndex == 5)
                {
                    if (CurrentTbl84Synonym != null)
                    {
                        ...
                        Tbl90ReferenceAuthorsList = _extCrud.GetReferenceAuthorsCollectionFromSynonymIdAndRefSourceIdIsNullAndRefExpertIdIsNullOrderBy<Tbl90Reference>(CurrentTbl84Synonym.SynonymId);
