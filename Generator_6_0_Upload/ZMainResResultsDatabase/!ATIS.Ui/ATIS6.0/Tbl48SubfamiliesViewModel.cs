...
using Microsoft.EntityFrameworkCore;          
         ...
         //    SubfamiliesViewModel Skriptdatum:  08.11.2018  10:32    
...
{     
 ...
 //    Part 1    
        ...
        private void ExecuteGetSubfamiliesByNameOrId(string searchName)
        {
            ...
            Tbl48SubfamiliesList = _extGet.SearchNameAndIdReturnCollection<Tbl48Subfamily>(SearchSubfamilyName, "subfamily");
 ...
 //    Part 4    
        ...
        private void ExecuteDeleteInfrafamily(string searchName)
        {
            ...
            Tbl51InfrafamiliesList = _extGet.GetInfrafamiliesCollectionOrderByFromSubfamilyId<Tbl51Infrafamily>(CurrentTbl51Infrafamily.SubfamilyId);
 ...
 //    Part 8    
        ...
        public void ExecuteCopyReferenceAuthor(object o)
        {
            ...
            Tbl90ReferenceAuthorsList = _extCopy.CopyReferenceSubfamily(CurrentTbl90ReferenceAuthor, "Author");
        ...
        public void ExecuteSaveReferenceAuthor(string searchName)
        {
            ...
            try
            {
                ...
                if (CurrentTbl90ReferenceAuthor.ReferenceId == 0)
                    reference = _extSave.ReferenceAuthorSubfamilyAdd(CurrentTbl90ReferenceAuthor);

                else
                    reference = _extSave.ReferenceAuthorSubfamilyUpdate(reference, CurrentTbl90ReferenceAuthor);
           ...
           Tbl90ReferenceAuthorsList = _extGet.GetReferenceAuthorsCollectionOrderByFromSubfamilyIdAndRefSourceIdIsNullAndRefExpertIdIsNull<Tbl90Reference>(CurrentTbl48Subfamily.SubfamilyId);            
        ...
        public void ExecuteCopyReferenceSource(object o)
        {
            ...
            Tbl90ReferenceAuthorsList = _extCopy.CopyReferenceSubfamily(CurrentTbl90ReferenceSource, "Source");
        ...
        private void ExecuteDeleteReferenceSource(object o)
        {
           ...
           Tbl90ReferenceSourcesList = _extGet.GetReferenceSourcesCollectionOrderByFromSubfamilyIdAndRefAuthorIdIsNullAndRefExpertIdIsNull<Tbl90Reference>(CurrentTbl48Subfamily.SubfamilyId);          
           ...
           if (_genSourceMessageBoxes.NoDatasetSelectedInfoMessageBox(CurrentTbl90ReferenceSource)) return;
            ...
            try
            {
                ...
                if (CurrentTbl90ReferenceSource.ReferenceId == 0)
                    reference = _extSave.ReferenceSourceSubfamilyAdd(CurrentTbl90ReferenceSource);
                else
                    reference = _extSave.ReferenceSourceSubfamilyUpdate(reference, CurrentTbl90ReferenceSource);
        ...
        public void ExecuteCopyReferenceExpert(object o)
        {
            ...
            Tbl90ReferenceExpertsList = _extCopy.CopyReferenceSubfamily(CurrentTbl90ReferenceExpert, "Expert");
        ...
        private void ExecuteDeleteReferenceExpert(object o)
        {
           ...
           Tbl90ReferenceExpertsList= _extGet.GetReferenceExpertsCollectionOrderByFromSubfamilyIdAndRefAuthorIdIsNullAndRefSourceIdIsNull<Tbl90Reference>(CurrentTbl48Subfamily.SubfamilyId);           
        ...
        public void ExecuteSaveReferenceExpert(object o)
        {
            ...
            try
            {
                ...
                if (CurrentTbl90ReferenceExpert.ReferenceId == 0)
                    reference = _extSave.ReferenceExpertSubfamilyAdd(CurrentTbl90ReferenceExpert);
                else
                    reference = _extSave.ReferenceExpertSubfamilyUpdate(reference, CurrentTbl90ReferenceExpert);
       ...
       #region [Methods Subfamily ==> Tbl93Comments]        
        ...
        private void ExecuteDeleteComment(object o)
        {
            ...
            Tbl93CommentsList = _extGet.GetCommentsCollectionOrderByFromSubfamilyId<Tbl93Comment>(CurrentTbl93Comment.SubfamilyId);
        ...
        private void ExecuteSaveComment(object o)
        {
            ...
            try
            {
                ...
                if (CurrentTbl93Comment.CommentId == 0)
                    comment = _extSave.CommentSubfamilyAdd(CurrentTbl93Comment);
                else
                    comment = _extSave.CommentSubfamilyUpdate(comment, CurrentTbl93Comment);
 ...
 //    Part 9    
        ...
        {           
Tbl45FamiliesList = _extGet.GetFamiliesCollectionOrderByFromFamilyId<Tbl45Family>(CurrentTbl48Subfamily.FamilyId);

            Tbl42SuperfamiliesAllList = _extGet.AllCollection<Tbl42Superfamily>("");
        ...
        public  int SelectedMainTabIndex
        {
            ...
            set
            {
                ...
                if (_selectedMainTabIndex == 1)
                {
                    if (CurrentTbl48Subfamily != null)
                    {
                        Tbl51InfrafamiliesList = _extGet.GetInfrafamiliesCollectionOrderByFromSubfamilyId<Tbl51Infrafamily>(CurrentTbl48Subfamily.SubfamilyId);
                ...
                if (_selectedMainTabIndex == 3)
                {
                    if (CurrentTbl48Subfamily != null)
                    {
                        Tbl93CommentsList = _extGet.GetCommentsCollectionOrderByFromSubfamilyId<Tbl93Comment>(CurrentTbl48Subfamily.SubfamilyId);
