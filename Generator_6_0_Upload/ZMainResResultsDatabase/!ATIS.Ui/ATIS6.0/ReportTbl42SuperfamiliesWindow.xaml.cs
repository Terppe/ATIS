...
using MahApps.Metro.Controls;
   ...
   //  ReportSuperfamilyWindow.xaml.cs Skriptdatum:  10.12.2020  10:32     

namespace ATIS.Ui.Views.Report.D42Superfamily
{  

    /// <summary>
    /// Interactionslogic for ReportSuperfamilyWindow.xaml
    /// </summary>
    public partial class ReportSuperfamilyWindow : MetroWindow
   {

        public ReportSuperfamilyWindow(int un, string tab)
       {         
