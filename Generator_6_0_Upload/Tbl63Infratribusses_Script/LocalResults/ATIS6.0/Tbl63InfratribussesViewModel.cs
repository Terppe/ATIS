...
using Microsoft.EntityFrameworkCore;          
         ...
         //    InfratribussesViewModel Skriptdatum:  08.11.2018  10:32    
...
{     
 ...
 //    Part 1    
        ...
        {
            Tbl60SubtribussesAllList = _extGet.AllCollection<Tbl60Subtribus>("subtribus");
            Tbl63InfratribussesList = _extGet.SearchNameAndIdReturnCollection<Tbl63Infratribus>(SearchInfratribusName, "infratribus");
        ...
        private void ExecuteCopyInfratribus(object o)
        {
            ...
            Tbl63InfratribussesList = _extCopy.CopyInfratribus(CurrentTbl63Infratribus);
        ...
        private void ExecuteDeleteInfratribus(string searchName)
        {
            ...
            Tbl66GenussesList = _extDelete.SearchForConnectedDatasetsWithInfratribusIdInTableGenus(CurrentTbl63Infratribus);     
     
            if (_allMessageBoxes.DoNotDeleteDatasetInfoMessageBox(Tbl66GenussesList.Count, "Genus")) return;

            //Delete all References Experts, Sources, Authors  ----------------------------------------------------
            Tbl90ReferencesList = _extDelete.DeleteDatasetsWithInfratribusIdInTableReference(CurrentTbl63Infratribus);
            ...
            //Delete all Comments  ----------------------------------------------------
            Tbl93CommentsList = _extDelete.DeleteDatasetsWithInfratribusIdInTableComment(CurrentTbl63Infratribus);
            ...
            try
            {
                ...
                if (infratribus!= null)
                {
                    ...
                    _extDelete.DeleteInfratribus(infratribus);
        ...
        private void ExecuteSaveInfratribus(string searchName)
        {
            ...
            try
            {
                ...
                if (CurrentTbl63Infratribus.InfratribusId == 0)
                    infratribus = _extSave.InfratribusAdd(CurrentTbl63Infratribus);
                else
                    infratribus = _extSave.InfratribusUpdate(infratribus, CurrentTbl63Infratribus);

                _position = InfratribussesView.CurrentPosition;

                try
                {
                    _extSave.InfratribusSave(infratribus, CurrentTbl63Infratribus);
                }
 ...
 //    Part 4    
        ...
        private void ExecuteAddGenus(object o)      
        {
            ...
            Tbl63InfratribussesAllList = _extGet.AllCollection<Tbl63Infratribus>("infratribus");
        ...
        private void ExecuteCopyGenus(object o)
        {
            ...
            Tbl66GenussesList = _extCopy.CopyGenus(CurrentTbl66Genus);
        ...
        private void ExecuteDeleteGenus(string searchName)
        {
            ...
            Tbl69FiSpeciessesList = _extDelete.SearchForConnectedDatasetsWithGenusIdInTableFiSpecies(CurrentTbl66Genus);
            if (_allMessageBoxes.DoNotDeleteDatasetInfoMessageBox(Tbl69FiSpeciessesList.Count, "FiSpecies")) return;                                                                                                                   
           
            //Delete all References Experts, Sources, Authors  ----------------------------------------------------
            Tbl90ReferencesList = _extDelete.DeleteDatasetsWithGenusIdInTableReference(CurrentTbl66Genus);
            if (Tbl90ReferencesList.Count > 0)
            {
                if (_allMessageBoxes.DeleteDatasetQuestionMessageBox(CultRes.StringsRes.ReferenceAuthor + " " + CultRes.StringsRes.ReferenceSource + " " + CultRes.StringsRes.ReferenceSource)) return;
            ...
            //Delete all Comments  ----------------------------------------------------
            Tbl93CommentsList = _extDelete.DeleteDatasetsWithGenusIdInTableComment(CurrentTbl66Genus);
            if (Tbl93CommentsList.Count > 0)
            {
                if (_allMessageBoxes.DeleteDatasetQuestionMessageBox(CultRes.StringsRes.Comment)) return;
            ...
            Tbl66GenussesList = _extGet.GetGenussesCollectionOrderByFromInfratribusId<Tbl66Genus>(CurrentTbl66Genus.InfratribusId);
 ...
 //    Part 8    
        ...
        public void ExecuteCopyReferenceAuthor(object o)
        {
            ...
            Tbl90ReferenceAuthorsList = _extCopy.CopyReferenceInfratribus(CurrentTbl90ReferenceAuthor, "Author");
        ...
        public void ExecuteSaveReferenceAuthor(string searchName)
        {
            ...
            try
            {
                ...
                if (CurrentTbl90ReferenceAuthor.ReferenceId == 0)
                    reference = _extSave.ReferenceAuthorInfratribusAdd(CurrentTbl90ReferenceAuthor);

                else
                    reference = _extSave.ReferenceAuthorInfratribusUpdate(reference, CurrentTbl90ReferenceAuthor);
           ...
           Tbl90ReferenceAuthorsList = _extGet.GetReferenceAuthorsCollectionOrderByFromInfratribusIdAndRefSourceIdIsNullAndRefExpertIdIsNull<Tbl90Reference>(CurrentTbl63Infratribus.InfratribusId);            
        ...
        public void ExecuteCopyReferenceSource(object o)
        {
            ...
            Tbl90ReferenceAuthorsList = _extCopy.CopyReferenceInfratribus(CurrentTbl90ReferenceSource, "Source");
        ...
        private void ExecuteDeleteReferenceSource(object o)
        {
           ...
           Tbl90ReferenceSourcesList = _extGet.GetReferenceSourcesCollectionOrderByFromInfratribusIdAndRefAuthorIdIsNullAndRefExpertIdIsNull<Tbl90Reference>(CurrentTbl63Infratribus.InfratribusId);          
           ...
           if (_genSourceMessageBoxes.NoDatasetSelectedInfoMessageBox(CurrentTbl90ReferenceSource)) return;
            ...
            try
            {
                ...
                if (CurrentTbl90ReferenceSource.ReferenceId == 0)
                    reference = _extSave.ReferenceSourceInfratribusAdd(CurrentTbl90ReferenceSource);
                else
                    reference = _extSave.ReferenceSourceInfratribusUpdate(reference, CurrentTbl90ReferenceSource);
        ...
        public void ExecuteCopyReferenceExpert(object o)
        {
            ...
            Tbl90ReferenceExpertsList = _extCopy.CopyReferenceInfratribus(CurrentTbl90ReferenceExpert, "Expert");
        ...
        private void ExecuteDeleteReferenceExpert(object o)
        {
           ...
           Tbl90ReferenceExpertsList= _extGet.GetReferenceExpertsCollectionOrderByFromInfratribusIdAndRefAuthorIdIsNullAndRefSourceIdIsNull<Tbl90Reference>(CurrentTbl63Infratribus.InfratribusId);           
        ...
        public void ExecuteSaveReferenceExpert(object o)
        {
            ...
            try
            {
                ...
                if (CurrentTbl90ReferenceExpert.ReferenceId == 0)
                    reference = _extSave.ReferenceExpertInfratribusAdd(CurrentTbl90ReferenceExpert);
                else
                    reference = _extSave.ReferenceExpertInfratribusUpdate(reference, CurrentTbl90ReferenceExpert);
       ...
       #region [Methods Infratribus ==> Tbl93Comments]        
        ...
        private void ExecuteDeleteComment(object o)
        {
            ...
            Tbl93CommentsList = _extGet.GetCommentsCollectionOrderByFromInfratribusId<Tbl93Comment>(CurrentTbl93Comment.InfratribusId);
        ...
        private void ExecuteSaveComment(object o)
        {
            ...
            try
            {
                ...
                if (CurrentTbl93Comment.CommentId == 0)
                    comment = _extSave.CommentInfratribusAdd(CurrentTbl93Comment);
                else
                    comment = _extSave.CommentInfratribusUpdate(comment, CurrentTbl93Comment);
 ...
 //    Part 9    
        ...
        {           
Tbl60SubtribussesList = _extGet.GetSubtribussesCollectionOrderByFromSubtribusId<Tbl60Subtribus>(CurrentTbl63Infratribus.SubtribusId);

            Tbl57TribussesAllList = _extGet.AllCollection<Tbl57Tribus>("");
        ...
        public  int SelectedMainTabIndex
        {
            ...
            set
            {
                ...
                if (_selectedMainTabIndex == 1)
                {
                    if (CurrentTbl63Infratribus != null)
                    {
                        Tbl66GenussesList = _extGet.GetGenussesCollectionOrderByFromInfratribusId<Tbl66Genus>(CurrentTbl63Infratribus.InfratribusId);
                ...
                if (_selectedMainTabIndex == 3)
                {
                    if (CurrentTbl63Infratribus != null)
                    {
                        Tbl93CommentsList = _extGet.GetCommentsCollectionOrderByFromInfratribusId<Tbl93Comment>(CurrentTbl63Infratribus.InfratribusId);
