...
using Microsoft.Win32;  
         ...
         //    ReportInfratribusPdf Skriptdatum:  13.12.2020  10:32    
...
{     
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id, string use)
        {
            ...
            var infratribusList = ExtCrud.GetInfratribussesCollectionFromInfratribusIdOrderBy<Tbl63Infratribus>(id).FirstOrDefault();    
        
            //Child
            var genussList = ExtCrud.GetGenussesCollectionFromInfratribusIdOrderBy<Tbl66Genus>(id);           
        ...
        private static void AddInfratribusTaxoNomenList(PdfDocument pdf, Tbl63Infratribus infratribusList)         
