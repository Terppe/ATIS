...
namespace ATIS.Ui.Views.Report
{
    public class ReportViewModel : ViewModelBase
    {
        ...
        {
            SpeciesgroupsCollection = _extReportBasicGet.CollSpeciesgroupsBySpeciesgroupId(id);
            //direct children
            ...
            AuthorsCollection = _extReportBasicGet.CollAuthorsBySpeciesgroupId(id);
            //------------------------------------------------------------------------------
            CommentsCollection = _extReportBasicGet.CollCommentsBySpeciesgroupId(id);
        }
        //------------------------------------------------------------------------------

        private RelayCommand _pdfSpeciesgroupPrintCommand;
        public ICommand PdfSpeciesgroupPrintCommand
        {
            get { return _pdfSpeciesgroupPrintCommand ??= new RelayCommand(delegate { CreatePdfSpeciesgroupPrint(_mainId); }); }
        }

        private static void CreatePdfSpeciesgroupPrint(int id)
        {
            const string use = "print";
            ReportSpeciesgroupPdf.CreateMainPdf(id, use);
        }
        private RelayCommand _pdfSpeciesgroupSaveCommand;
        public ICommand PdfSpeciesgroupSaveCommand
        {
            get { return _pdfSpeciesgroupSaveCommand ??= new RelayCommand(delegate { CreatePdfSpeciesgroupSave(_mainId); }); }
        }

        private static void CreatePdfSpeciesgroupSave(int id)
        {
            const string use = "save";
            ReportSpeciesgroupPdf.CreateMainPdf(id, use);
        }
