...
RegnumID = CurrentTbl09Division.RegnumID,     
 ...
 //    Part 5    
  ...
  ClassesView = CollectionViewSource.GetDefaultView(Tbl21ClassesList);
        ...
        private void CopyClass(object o)
        {
            ...
            {                 
  SubdivisionID = class.SubdivisionID,     
            ...
            try
            {
                ...
                else
                {
                    if (CurrentTbl21Class.ClassID!= 0)
                    {
                        ...
                        {   
  class.SubdivisionID= CurrentTbl21Class.SubdivisionID;            
                    ...
                    else
                    {
                        ...
                        {   
  SubdivisionID = CurrentTbl21Class.SubdivisionID,              
                    ...
                    {
                        //SubdivisionID may be not 0
                        if (CurrentTbl21Class.SubdivisionID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl21ClassesRepository.GetAll()
                         ...
                         a.SubdivisionID == CurrentTbl21Class.SubdivisionID
                         select a);
 ...
 //    Part 8    
        ...
        public new void CopyRefAuthor(object o)
        {
            ...
            {                 
SubdivisionID = refAuthor.SubdivisionID,              
                ...
                else
                {
                    if (CurrentTbl90RefAuthor.ReferenceID != 0 && CurrentTbl90RefAuthor.RefAuthorID != 0)
                    {
                        ...
                        {   
                            ...
                            refAuthor.SubdivisionID = CurrentTbl90RefAuthor.SubdivisionID;  
...
SubdivisionID = CurrentTbl90RefAuthor.SubdivisionID,              
                    ...
                    {
                        //SubdivisionID may be not 0
                        if (CurrentTbl90RefAuthor.SubdivisionID == 0 || CurrentTbl90RefAuthor.RefAuthorID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl90ReferencesRepository.GetAll()
                         ...
                         a.SubdivisionID == CurrentTbl90RefAuthor.SubdivisionID &&
        ...
        public new void CopyRefSource(object o)
        {
            ...
            {                 
SubdivisionID = refSource.SubdivisionID,              
                Info = CultRes.StringsRes.DatasetNew,
                ...
                else
                {
                    if (CurrentTbl90RefSource.ReferenceID != 0)
                    {
                        ...
                        {   
                            ...
                            refSource.SubdivisionID = CurrentTbl90RefSource.SubdivisionID;            
...
SubdivisionID = CurrentTbl90RefSource.SubdivisionID,              
                    ...
                    {
                        //SubdivisionID may be not 0
                        if (CurrentTbl90RefSource.SubdivisionID == 0 || CurrentTbl90RefSource.RefSourceID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,            
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl90ReferencesRepository.GetAll()
                         ...
                         a.SubdivisionID == CurrentTbl90RefSource.SubdivisionID &&
        ...
        public new void CopyRefExpert(object o)
        {
            ...
            {                 
SubdivisionID = refExpert.SubdivisionID,              
                Info = CultRes.StringsRes.DatasetNew,
                ...
                else
                {
                    if (CurrentTbl90RefExpert.ReferenceID != 0 && CurrentTbl90RefExpert.RefExpertID != 0)
                    {
                        ...
                        {   
                            ...
                            refExpert.SubdivisionID = CurrentTbl90RefExpert.SubdivisionID;           
...
SubdivisionID = CurrentTbl90RefExpert.SubdivisionID,              
                    ...
                    {
                        //SubdivisionID may be not 0
                        if (CurrentTbl90RefExpert.SubdivisionID == 0 || CurrentTbl90RefExpert.RefExpertID == 0)   
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,          
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl90ReferencesRepository.GetAll()
                         ...
                         a.SubdivisionID == CurrentTbl90RefExpert.SubdivisionID &&
...
SubdivisionID = CurrentTbl93Comment.SubdivisionID,              
                    ...
                    {
                        //SubdivisionID may be not 0
                        if (CurrentTbl93Comment.SubdivisionID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
 ...
 //    Part 9    
        ...
        private void GetConnectedTablesById(object o)
        {
            ...
            Tbl09DivisionsList =  new ObservableCollection<Tbl09Division>
                                                       (from x in _tbl09DivisionsRepository.GetAll()
                                                       where x.DivisionID== CurrentTbl15Subdivision.DivisionID
            ...
            Tbl18SuperclassesList =  new ObservableCollection<Tbl18Superclass>
                                                       ...
                                                       where y.SubdivisionID== CurrentTbl15Subdivision.SubdivisionID
                                                       orderby y.Tbl15Subdivisions.SubdivisionName
                                                       select y);
