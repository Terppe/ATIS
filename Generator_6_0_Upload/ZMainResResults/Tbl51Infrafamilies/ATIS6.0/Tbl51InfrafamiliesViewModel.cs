...
{     
    ...
    {  
        ...
        private static readonly ILog Log = LogManager.GetLogger(typeof(InfrafamiliesViewModel));
 ...
 //    Part 1    
        ...
        {
            Tbl48SubfamiliesAllList = _extGet.AllCollection<Tbl48Subfamily>("subfamily");
            Tbl51InfrafamiliesList = _extGet.SearchNameAndIdReturnCollection<Tbl51Infrafamily>(SearchInfrafamilyName, "infrafamily");
        ...
        private void ExecuteCopyInfrafamily(object o)
        {
            ...
            Tbl51InfrafamiliesList = _extCopy.CopyInfrafamily(CurrentTbl51Infrafamily);
        ...
        private void ExecuteDeleteInfrafamily(string searchName)
        {
            ...
            Tbl54SupertribussesList = _extDelete.SearchForConnectedDatasetsWithInfrafamilyIdInTableSupertribus(CurrentTbl51Infrafamily);     
     
            if (_allMessageBoxes.DoNotDeleteDatasetInfoMessageBox(Tbl54SupertribussesList.Count, "Supertribus")) return;

            //Delete all References Experts, Sources, Authors  ----------------------------------------------------
            Tbl90ReferencesList = _extDelete.DeleteDatasetsWithInfrafamilyIdInTableReference(CurrentTbl51Infrafamily);
            ...
            //Delete all Comments  ----------------------------------------------------
            Tbl93CommentsList = _extDelete.DeleteDatasetsWithInfrafamilyIdInTableComment(CurrentTbl51Infrafamily);
            ...
            try
            {
                ...
                if (infrafamily!= null)
                {
                    ...
                    _extDelete.DeleteInfrafamily(infrafamily);
            ...
            ExecuteGetInfrafamiliesByNameOrId(searchName);
        ...
        private void ExecuteSaveInfrafamily(string searchName)
        {
            ...
            {
                var infrafamily = _uow.Tbl51Infrafamilies .GetById(CurrentTbl51Infrafamily.InfrafamilyId);
                //   var phylum = _context.Tbl51Infrafamilies.AsNoTracking().FirstOrDefault(a=>a.InfrafamilyId == CurrentTbl51Infrafamily.InfrafamilyId);
                //          _context.Entry(infrafamily).State = Microsoft.EntityFrameworkCore.EntityState.Unchanged;

                if (_allMessageBoxes.SaveDatasetQuestionMessageBox(CurrentTbl51Infrafamily.InfrafamilyName))
                    return;

                if (CurrentTbl51Infrafamily.InfrafamilyId == 0)
                    infrafamily = _extSave.InfrafamilyAdd(CurrentTbl51Infrafamily);
                else
                    infrafamily = _extSave.InfrafamilyUpdate(infrafamily, CurrentTbl51Infrafamily);

                _position = InfrafamiliesView.CurrentPosition;

                try
                {
                    _extSave.InfrafamilySave(infrafamily, CurrentTbl51Infrafamily);
                }
 ...
 //    Part 2    
        ...
        private void ExecuteSaveSubfamily(string searchName)
        {
            ...
            try
            {
                ...
                var cap = CurrentTbl48Subfamily.SubfamilyName;
 ...
 //    Part 4    
        ...
        public ICommand DeleteSupertribusCommand => _deleteSupertribusCommand ??= new RelayCommand(delegate { ExecuteDeleteSupertribus(SearchInfrafamilyName); });

        private RelayCommand _saveSupertribusCommand;
        public ICommand SaveSupertribusCommand => _saveSupertribusCommand ??= new RelayCommand(delegate { ExecuteSaveSupertribus(SearchInfrafamilyName); });    
        ...
        private void ExecuteAddSupertribus(object o)      
        {
            ...
            Tbl51InfrafamiliesAllList = _extGet.AllCollection<Tbl51Infrafamily>("infrafamily");
        ...
        private void ExecuteCopySupertribus(object o)
        {
            ...
            Tbl54SupertribussesList = _extCopy.CopySupertribus(CurrentTbl54Supertribus);
        ...
        private void ExecuteDeleteSupertribus(string searchName)
        {
            ...
            Tbl57TribussesList = _extDelete.SearchForConnectedDatasetsWithSupertribusIdInTableTribus(CurrentTbl54Supertribus);
            if (_allMessageBoxes.DoNotDeleteDatasetInfoMessageBox(Tbl57TribussesList.Count, "Tribus")) return;                                                                                                                   
           
            //Delete all References Experts, Sources, Authors  ----------------------------------------------------
            Tbl90ReferencesList = _extDelete.DeleteDatasetsWithSupertribusIdInTableReference(CurrentTbl54Supertribus);
            if (Tbl90ReferencesList.Count > 0)
            {
                if (_allMessageBoxes.DeleteDatasetQuestionMessageBox(CultRes.StringsRes.ReferenceAuthor + " " + CultRes.StringsRes.ReferenceSource + " " + CultRes.StringsRes.ReferenceSource)) return;
            ...
            //Delete all Comments  ----------------------------------------------------
            Tbl93CommentsList = _extDelete.DeleteDatasetsWithSupertribusIdInTableComment(CurrentTbl54Supertribus);
            if (Tbl93CommentsList.Count > 0)
            {
                if (_allMessageBoxes.DeleteDatasetQuestionMessageBox(CultRes.StringsRes.Comment)) return;
            ...
            try 
            {
                ...
                if (supertribus != null)
                {
                    ...
                    _extDelete.DeleteSupertribus(supertribus);
            ...
            Tbl54SupertribussesList = _extGet.GetSupertribussesCollectionOrderByFromInfrafamilyId<Tbl54Supertribus>(CurrentTbl54Supertribus.InfrafamilyId);
 ...
 //    Part 8    
        ...
        public void ExecuteCopyReferenceAuthor(object o)
        {
            ...
            Tbl90ReferenceAuthorsList = _extCopy.CopyReferenceInfrafamily(CurrentTbl90ReferenceAuthor, "Author");
        ...
        public void ExecuteSaveReferenceAuthor(string searchName)
        {
            ...
            try
            {
                ...
                if (CurrentTbl90ReferenceAuthor.ReferenceId == 0)
                    reference = _extSave.ReferenceAuthorInfrafamilyAdd(CurrentTbl90ReferenceAuthor);

                else
                    reference = _extSave.ReferenceAuthorInfrafamilyUpdate(reference, CurrentTbl90ReferenceAuthor);
           ...
           Tbl90ReferenceAuthorsList = _extGet.GetReferenceAuthorsCollectionOrderByFromInfrafamilyIdAndRefSourceIdIsNullAndRefExpertIdIsNull<Tbl90Reference>(CurrentTbl51Infrafamily.InfrafamilyId);            
        ...
        public void ExecuteCopyReferenceSource(object o)
        {
            ...
            Tbl90ReferenceAuthorsList = _extCopy.CopyReferenceInfrafamily(CurrentTbl90ReferenceSource, "Source");
        ...
        private void ExecuteDeleteReferenceSource(object o)
        {
           ...
           Tbl90ReferenceSourcesList = _extGet.GetReferenceSourcesCollectionOrderByFromInfrafamilyIdAndRefAuthorIdIsNullAndRefExpertIdIsNull<Tbl90Reference>(CurrentTbl51Infrafamily.InfrafamilyId);          
           ...
           if (_genSourceMessageBoxes.NoDatasetSelectedInfoMessageBox(CurrentTbl90ReferenceSource)) return;
            ...
            try
            {
                ...
                if (CurrentTbl90ReferenceSource.ReferenceId == 0)
                    reference = _extSave.ReferenceSourceInfrafamilyAdd(CurrentTbl90ReferenceSource);
                else
                    reference = _extSave.ReferenceSourceInfrafamilyUpdate(reference, CurrentTbl90ReferenceSource);
        ...
        public void ExecuteCopyReferenceExpert(object o)
        {
            ...
            Tbl90ReferenceExpertsList = _extCopy.CopyReferenceInfrafamily(CurrentTbl90ReferenceExpert, "Expert");
        ...
        private void ExecuteDeleteReferenceExpert(object o)
        {
           ...
           Tbl90ReferenceExpertsList= _extGet.GetReferenceExpertsCollectionOrderByFromInfrafamilyIdAndRefAuthorIdIsNullAndRefSourceIdIsNull<Tbl90Reference>(CurrentTbl51Infrafamily.InfrafamilyId);           
        ...
        public void ExecuteSaveReferenceExpert(object o)
        {
            ...
            try
            {
                ...
                if (CurrentTbl90ReferenceExpert.ReferenceId == 0)
                    reference = _extSave.ReferenceExpertInfrafamilyAdd(CurrentTbl90ReferenceExpert);
                else
                    reference = _extSave.ReferenceExpertInfrafamilyUpdate(reference, CurrentTbl90ReferenceExpert);
       ...
       #region [Methods Infrafamily ==> Tbl93Comments]        
        ...
        private void ExecuteDeleteComment(object o)
        {
            ...
            Tbl93CommentsList = _extGet.GetCommentsCollectionOrderByFromInfrafamilyId<Tbl93Comment>(CurrentTbl93Comment.InfrafamilyId);
        ...
        private void ExecuteSaveComment(object o)
        {
            ...
            try
            {
                ...
                if (CurrentTbl93Comment.CommentId == 0)
                    comment = _extSave.CommentInfrafamilyAdd(CurrentTbl93Comment);
                else
                    comment = _extSave.CommentInfrafamilyUpdate(comment, CurrentTbl93Comment);
 ...
 //    Part 9    
        ...
        {           
Tbl48SubfamiliesList = _extGet.GetSubfamiliesCollectionOrderByFromSubfamilyId<Tbl48Subfamily>(CurrentTbl51Infrafamily.SubfamilyId);

            Tbl45FamiliesAllList = _extGet.AllCollection<Tbl45Family>("");
        ...
        public  int SelectedMainTabIndex
        {
            ...
            set
            {
                ...
                if (_selectedMainTabIndex == 1)
                {
                    if (CurrentTbl51Infrafamily != null)
                    {
                        Tbl54SupertribussesList = _extGet.GetSupertribussesCollectionOrderByFromInfrafamilyId<Tbl54Supertribus>(CurrentTbl51Infrafamily.InfrafamilyId);
                ...
                if (_selectedMainTabIndex == 3)
                {
                    if (CurrentTbl51Infrafamily != null)
                    {
                        Tbl93CommentsList = _extGet.GetCommentsCollectionOrderByFromInfrafamilyId<Tbl93Comment>(CurrentTbl51Infrafamily.InfrafamilyId);
