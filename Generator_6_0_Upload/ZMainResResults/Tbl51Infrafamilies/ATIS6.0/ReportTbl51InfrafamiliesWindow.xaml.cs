...
using MahApps.Metro.Controls;
   ...
   //  ReportInfrafamilyWindow.xaml.cs Skriptdatum:  08.11.2018  10:32     

namespace ATIS.Ui.Views.Report.D51Infrafamily
{  

    /// <summary>
    /// Interactionslogic for ReportInfrafamilyWindow.xaml
    /// </summary>
    public partial class ReportInfrafamilyWindow : MetroWindow
   {

        public ReportInfrafamilyWindow(int un, string tab)
       {         
