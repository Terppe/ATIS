...
{     
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id, string use)
        {
            ...
            { 
                ...
                using (var pdf = new PdfDocument())
                {
                    ...
                    AddInfrafamilyHierarchyList(pdf, infrafamilyList);       
        ...
        private static void AddInfrafamilyHierarchyList(PdfDocument pdf, Tbl51Infrafamily tbl51InfrafamilyList)
        {
            ...
            //      _arrInts = PdfHelper.PdfTbRight("infrafamilyRight", _arrInts, false, textResult, 0);
        ...
        private static void AddTribussChildrenList(PdfDocument pdf, ObservableCollection<Tbl57Tribus> sList)
        {
            _page = pdf.Pages[_arrInts[6]];
            ...
            foreach (var t in sList)
            {
                ...
                _arrInts = PdfHelper.PdfTbMoveLeft("Left" + _z1, _arrInts, false, CultRes.StringsRes.Tribus, 0);
