...
namespace ATIS.Ui.Views.Report
{
    public class ReportViewModel : ViewModelBase
    {
        ...
        {
            RefSourcesCollection = _extReportBasicGet.CollRefSourcesByRefSourceId(id);
            //direct children
            Collection = _extReportBasicGet.CollByRefSourceIdAndHash(id);
            //------------------------------------------------------------------------------
            //Function
            var NULLId = _extReportBasicGet.NULLIdFromRefSourcesCollectionSelect(id);
            //-----------------------------------------------------------------------------
            //ForeignKeyTable
            Collection = _extReportBasicGet.CollByRegnumIdAndHash(NULLId);
            //------------------------------------------------------------------------------
            ExpertsCollection = _extReportBasicGet.CollExpertsByRefSourceId(id);
            SourcesCollection = _extReportBasicGet.CollSourcesByRefSourceId(id);
            AuthorsCollection = _extReportBasicGet.CollAuthorsByRefSourceId(id);
            //------------------------------------------------------------------------------
            CommentsCollection = _extReportBasicGet.CollCommentsByRefSourceId(id);
        }
        //------------------------------------------------------------------------------

        private RelayCommand _pdfRefSourcePrintCommand;
        public ICommand PdfRefSourcePrintCommand
        {
            get { return _pdfRefSourcePrintCommand ??= new RelayCommand(delegate { CreatePdfRefSourcePrint(_mainId); }); }
        }

        private static void CreatePdfRefSourcePrint(int id)
        {
            const string use = "print";
            ReportRefSourcePdf.CreateMainPdf(id, use);
        }
        private RelayCommand _pdfRefSourceSaveCommand;
        public ICommand PdfRefSourceSaveCommand
        {
            get { return _pdfRefSourceSaveCommand ??= new RelayCommand(delegate { CreatePdfRefSourceSave(_mainId); }); }
        }

        private static void CreatePdfRefSourceSave(int id)
        {
            const string use = "save";
            ReportRefSourcePdf.CreateMainPdf(id, use);
        }
