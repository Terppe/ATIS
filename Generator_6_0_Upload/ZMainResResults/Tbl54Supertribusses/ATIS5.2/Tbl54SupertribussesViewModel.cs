...
using Te.Atis.Ui.Desktop.MessageBox;    
         ...
         //    Tbl54SupertribussesViewModel Skriptdatum:  08.11.2018  10:32    

namespace Te.Atis.Ui.Desktop.Views.Database
{     
    
    public class Tbl54SupertribussesViewModel : ViewModelBase                     
    {     
 ...
 //    Part 1    
        ...
        {
            if (SearchSupertribusName != "")
            {
                Tbl54SupertribussesList?.Clear();
                if (SearchSupertribusName == "*") // show whole table
                {
                    SearchSupertribusName = "";
        ...
        private void DeleteSupertribus(object o)
        {
            ...
            if (SearchSupertribusName != "")
            {
                if (SearchSupertribusName == "*")  //show all datasets
                {
                    SearchSupertribusName = "";
                    Tbl54SupertribussesList.Clear();
        ...
        private void SaveSupertribus(object o)
        {
            ...
            {
                Tbl54SupertribussesList = new ObservableCollection<Tbl54Supertribus>(_businessLayer.ListTbl54SupertribussesBySupertribusName(CurrentTbl54Supertribus.SupertribusName));
 ...
 //    Part 2    
        ...
        private void SaveInfrafamily(object o)
        {
            ...
            catch (DbEntityValidationException ex)
            {
                ...
                Tbl51InfrafamiliesList = new ObservableCollection<Tbl51Infrafamily>(_businessLayer.ListTbl51InfrafamiliesByInfrafamilyId(CurrentTbl54Supertribus.InfrafamilyID));            
            ...
            set
            {
                ...
                if (_selectedDetailSubTabIndex == 0)
                {
                    ...
                    Tbl48SubfamiliesAllList =  new ObservableCollection<Tbl48Subfamily>(
                        _businessLayer.ListTbl48Subfamilies());
