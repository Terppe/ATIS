...
{     
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id, string use)
        {
            ...
            var supertribusList = ExtCrud.GetSupertribussesCollectionFromSupertribusIdOrderBy<Tbl54Supertribus>(id).FirstOrDefault();    
          ...
          
        {
            ...
            _arrInts[1] += _arrInts[9]; //Distance to next TextBox
            //----------------------------------------------------------------
            _arrInts = PdfHelper.PdfTbMoveLeft("kingdomLeft", _arrInts, false, CultRes.StringsRes.Supertribus + ":", 0);  
          
            _arrInts = PdfHelper.PdfTbRight("kingdomRight", _arrInts, false, supertribusList.SupertribusName, 0);     
