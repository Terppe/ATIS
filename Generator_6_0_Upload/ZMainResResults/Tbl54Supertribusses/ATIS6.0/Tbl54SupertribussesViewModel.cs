...
{     
 ...
 //    Part 1    
        ...
        private void ExecuteGetSupertribussesByNameOrId(string searchName)
        {
            ...
            Tbl54SupertribussesList = _extGet.SearchNameAndIdReturnCollection<Tbl54Supertribus>(SearchSupertribusName, "supertribus");
 ...
 //    Part 4    
        ...
        private void ExecuteDeleteTribus(string searchName)
        {
            ...
            Tbl57TribussesList = _extGet.GetTribussesCollectionOrderByFromSupertribusId<Tbl57Tribus>(CurrentTbl57Tribus.SupertribusId);
 ...
 //    Part 8    
        ...
        public void ExecuteCopyReferenceAuthor(object o)
        {
            ...
            Tbl90ReferenceAuthorsList = _extCopy.CopyReferenceSupertribus(CurrentTbl90ReferenceAuthor, "Author");
        ...
        public void ExecuteSaveReferenceAuthor(string searchName)
        {
            ...
            try
            {
                ...
                if (CurrentTbl90ReferenceAuthor.ReferenceId == 0)
                    reference = _extSave.ReferenceAuthorSupertribusAdd(CurrentTbl90ReferenceAuthor);

                else
                    reference = _extSave.ReferenceAuthorSupertribusUpdate(reference, CurrentTbl90ReferenceAuthor);
           ...
           Tbl90ReferenceAuthorsList = _extGet.GetReferenceAuthorsCollectionOrderByFromSupertribusIdAndRefSourceIdIsNullAndRefExpertIdIsNull<Tbl90Reference>(CurrentTbl54Supertribus.SupertribusId);            
        ...
        public void ExecuteCopyReferenceSource(object o)
        {
            ...
            Tbl90ReferenceAuthorsList = _extCopy.CopyReferenceSupertribus(CurrentTbl90ReferenceSource, "Source");
        ...
        private void ExecuteDeleteReferenceSource(object o)
        {
           ...
           Tbl90ReferenceSourcesList = _extGet.GetReferenceSourcesCollectionOrderByFromSupertribusIdAndRefAuthorIdIsNullAndRefExpertIdIsNull<Tbl90Reference>(CurrentTbl54Supertribus.SupertribusId);          
           ...
           if (_genSourceMessageBoxes.NoDatasetSelectedInfoMessageBox(CurrentTbl90ReferenceSource)) return;
            ...
            try
            {
                ...
                if (CurrentTbl90ReferenceSource.ReferenceId == 0)
                    reference = _extSave.ReferenceSourceSupertribusAdd(CurrentTbl90ReferenceSource);
                else
                    reference = _extSave.ReferenceSourceSupertribusUpdate(reference, CurrentTbl90ReferenceSource);
        ...
        public void ExecuteCopyReferenceExpert(object o)
        {
            ...
            Tbl90ReferenceExpertsList = _extCopy.CopyReferenceSupertribus(CurrentTbl90ReferenceExpert, "Expert");
        ...
        private void ExecuteDeleteReferenceExpert(object o)
        {
           ...
           Tbl90ReferenceExpertsList= _extGet.GetReferenceExpertsCollectionOrderByFromSupertribusIdAndRefAuthorIdIsNullAndRefSourceIdIsNull<Tbl90Reference>(CurrentTbl54Supertribus.SupertribusId);           
        ...
        public void ExecuteSaveReferenceExpert(object o)
        {
            ...
            try
            {
                ...
                if (CurrentTbl90ReferenceExpert.ReferenceId == 0)
                    reference = _extSave.ReferenceExpertSupertribusAdd(CurrentTbl90ReferenceExpert);
                else
                    reference = _extSave.ReferenceExpertSupertribusUpdate(reference, CurrentTbl90ReferenceExpert);
       ...
       #region [Methods Supertribus ==> Tbl93Comments]        
        ...
        private void ExecuteDeleteComment(object o)
        {
            ...
            Tbl93CommentsList = _extGet.GetCommentsCollectionOrderByFromSupertribusId<Tbl93Comment>(CurrentTbl93Comment.SupertribusId);
        ...
        private void ExecuteSaveComment(object o)
        {
            ...
            try
            {
                ...
                if (CurrentTbl93Comment.CommentId == 0)
                    comment = _extSave.CommentSupertribusAdd(CurrentTbl93Comment);
                else
                    comment = _extSave.CommentSupertribusUpdate(comment, CurrentTbl93Comment);
 ...
 //    Part 9    
        ...
        {           
Tbl51InfrafamiliesList = _extGet.GetInfrafamiliesCollectionOrderByFromInfrafamilyId<Tbl51Infrafamily>(CurrentTbl54Supertribus.InfrafamilyId);

            Tbl48SubfamiliesAllList = _extGet.AllCollection<Tbl48Subfamily>("");
        ...
        public  int SelectedMainTabIndex
        {
            ...
            set
            {
                ...
                if (_selectedMainTabIndex == 1)
                {
                    if (CurrentTbl54Supertribus != null)
                    {
                        Tbl57TribussesList = _extGet.GetTribussesCollectionOrderByFromSupertribusId<Tbl57Tribus>(CurrentTbl54Supertribus.SupertribusId);
