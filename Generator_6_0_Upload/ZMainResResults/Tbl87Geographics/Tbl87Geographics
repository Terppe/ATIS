...
namespace ATIS.Ui.Views.Report
{
    public class ReportViewModel : ViewModelBase
    {
        ...
        {
            GeographicsCollection = _extReportBasicGet.CollGeographicsByGeographicId(id);
            //direct children
            NULLCollection = _extReportBasicGet.CollNULLByGeographicIdAndHash(id);
            //------------------------------------------------------------------------------
            //Function
            var fispeciesId = _extReportBasicGet.FiSpeciesIdFromGeographicsCollectionSelect(id);
            //-----------------------------------------------------------------------------
            //ForeignKeyTable
            FiSpeciessesCollection = _extReportBasicGet.CollFiSpeciessesByRegnumIdAndHash(fispeciesId);
            //------------------------------------------------------------------------------
            ExpertsCollection = _extReportBasicGet.CollExpertsByGeographicId(id);
            SourcesCollection = _extReportBasicGet.CollSourcesByGeographicId(id);
            AuthorsCollection = _extReportBasicGet.CollAuthorsByGeographicId(id);
            //------------------------------------------------------------------------------
            CommentsCollection = _extReportBasicGet.CollCommentsByGeographicId(id);
        }
        //------------------------------------------------------------------------------

        private RelayCommand _pdfGeographicPrintCommand;
        public ICommand PdfGeographicPrintCommand
        {
            get { return _pdfGeographicPrintCommand ??= new RelayCommand(delegate { CreatePdfGeographicPrint(_mainId); }); }
        }

        private static void CreatePdfGeographicPrint(int id)
        {
            const string use = "print";
            ReportGeographicPdf.CreateMainPdf(id, use);
        }
        private RelayCommand _pdfGeographicSaveCommand;
        public ICommand PdfGeographicSaveCommand
        {
            get { return _pdfGeographicSaveCommand ??= new RelayCommand(delegate { CreatePdfGeographicSave(_mainId); }); }
        }

        private static void CreatePdfGeographicSave(int id)
        {
            const string use = "save";
            ReportGeographicPdf.CreateMainPdf(id, use);
        }
