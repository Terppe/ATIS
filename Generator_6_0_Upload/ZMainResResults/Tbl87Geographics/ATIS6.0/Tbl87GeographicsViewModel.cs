...
GeographicsView = CollectionViewSource.GetDefaultView(Tbl87GeographicsList);
        ...
        private void ExecuteDeleteGeographic(string searchName)
        {
            ...
            NULLList = _extCrud.SearchForConnectedDatasetsWithGeographicIdInTableName(CurrentTbl87Geographic);     
            ...
            //Delete all Comments  ----------------------------------------------------
            Tbl93CommentsList = _extCrud.DeleteDatasetsWithGeographicIdInTableComment(CurrentTbl87Geographic);
        ...
        public  int SelectedMainTabIndex
        {
            ...
            set
            {
                ...
                if (_selectedMainTabIndex == 1)
                {
                    if (CurrentTbl87Geographic != null)
                    {
                        NULLList = _extCrud.GetNULLCollectionFromGeographicIdOrderBy<Tbl68Speciesgroup>(CurrentTbl87Geographic.GeographicId);

                        Tbl87GeographicsAllList = _extCrud.GetCollectionAllOrderBy<Tbl87Geographic>("geographic");
                ...
                if (_selectedMainTabIndex == 3)
                {
                    if (CurrentTbl87Geographic != null)
                    {
                        Tbl93CommentsList = _extCrud.GetCommentsCollectionFromGeographicIdOrderBy<Tbl93Comment>(CurrentTbl87Geographic.GeographicId);
            ...
            set
            {
                ...
                if (_selectedDetailTabIndex == 3)
                {
                    if (CurrentTbl87Geographic != null)
                    {
                        ...
                        Tbl90ReferenceExpertsList = _extCrud.GetReferenceExpertsCollectionFromGeographicIdAndRefAuthorIdIsNullAndRefSourceIdIsNullOrderBy<Tbl90Reference>(CurrentTbl87Geographic.GeographicId);
                ...
                if (_selectedDetailTabIndex == 4)
                {
                    if (CurrentTbl87Geographic != null)
                    {
                        ...
                        Tbl90ReferenceSourcesList = _extCrud.GetReferenceSourcesCollectionFromGeographicIdAndRefAuthorIdIsNullAndRefExpertIdIsNullOrderBy<Tbl90Reference>(CurrentTbl87Geographic.GeographicId);
                ...
                if (_selectedDetailTabIndex == 5)
                {
                    if (CurrentTbl87Geographic != null)
                    {
                        ...
                        Tbl90ReferenceAuthorsList = _extCrud.GetReferenceAuthorsCollectionFromGeographicIdAndRefSourceIdIsNullAndRefExpertIdIsNullOrderBy<Tbl90Reference>(CurrentTbl87Geographic.GeographicId);
