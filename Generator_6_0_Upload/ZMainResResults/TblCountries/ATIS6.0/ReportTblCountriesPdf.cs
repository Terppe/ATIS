...
{     
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id, string use)
        {
            ...
            { 
                ...
                using (var pdf = new PdfDocument())
                {
                    ...
                    AddCountryHierarchyList(pdf, countryList);       
        ...
        private static void AddCountryHierarchyList(PdfDocument pdf, TblCountry tblCountryList)
        {
            ...
            //      _arrInts = PdfHelper.PdfTbRight("countryRight", _arrInts, false, textResult, 0);
        ...
        private static void AddsChildrenList(PdfDocument pdf, ObservableCollection<> sList)
        {
            _page = pdf.Pages[_arrInts[6]];
            ...
            foreach (var t in sList)
            {
                ...
                _arrInts = PdfHelper.PdfTbMoveLeft("Left" + _z1, _arrInts, false, CultRes.StringsRes., 0);
