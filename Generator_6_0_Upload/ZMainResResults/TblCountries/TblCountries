...
namespace ATIS.Ui.Views.Report
{
    public class ReportViewModel : ViewModelBase
    {
        ...
        {
            CountriesCollection = _extReportBasicGet.CollCountriesByCountryId(id);
            //direct children
            Collection = _extReportBasicGet.CollByCountryIdAndHash(id);
            //------------------------------------------------------------------------------
            //Function
            var NULLId = _extReportBasicGet.NULLIdFromCountriesCollectionSelect(id);
            //-----------------------------------------------------------------------------
            //ForeignKeyTable
            Collection = _extReportBasicGet.CollByRegnumIdAndHash(NULLId);
            //------------------------------------------------------------------------------
            ExpertsCollection = _extReportBasicGet.CollExpertsByCountryId(id);
            SourcesCollection = _extReportBasicGet.CollSourcesByCountryId(id);
            AuthorsCollection = _extReportBasicGet.CollAuthorsByCountryId(id);
            //------------------------------------------------------------------------------
            CommentsCollection = _extReportBasicGet.CollCommentsByCountryId(id);
        }
        //------------------------------------------------------------------------------

        private RelayCommand _pdfCountryPrintCommand;
        public ICommand PdfCountryPrintCommand
        {
            get { return _pdfCountryPrintCommand ??= new RelayCommand(delegate { CreatePdfCountryPrint(_mainId); }); }
        }

        private static void CreatePdfCountryPrint(int id)
        {
            const string use = "print";
            ReportCountryPdf.CreateMainPdf(id, use);
        }
        private RelayCommand _pdfCountrySaveCommand;
        public ICommand PdfCountrySaveCommand
        {
            get { return _pdfCountrySaveCommand ??= new RelayCommand(delegate { CreatePdfCountrySave(_mainId); }); }
        }

        private static void CreatePdfCountrySave(int id)
        {
            const string use = "save";
            ReportCountryPdf.CreateMainPdf(id, use);
        }
