...
{     
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id, string use)
        {
            ...
            { 
                ...
                using (var pdf = new PdfDocument())
                {
                    ...
                    AddNameHierarchyList(pdf, nameList);       
        ...
        private static void AddNameHierarchyList(PdfDocument pdf, Tbl78Name tbl78NameList)
        {
            ...
            //      _arrInts = PdfHelper.PdfTbRight("nameRight", _arrInts, false, textResult, 0);
        ...
        private static void AddSynonymsChildrenList(PdfDocument pdf, ObservableCollection<NULL> NULLsList)
        {
            _page = pdf.Pages[_arrInts[6]];

            _arrInts = PdfHelper.PdfTbRight("childrenSynonym", _arrInts, true, CultRes.StringsRes.ReportDirectChild, 1);
            ...
            foreach (var t in NULLsList)
            {
                ...
                _arrInts = PdfHelper.PdfTbMoveLeft("NULLLeft" + _z1, _arrInts, false, CultRes.StringsRes.Synonym, 0);
