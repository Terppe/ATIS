...
using MahApps.Metro.Controls;
   ...
   //  ReportImageWindow.xaml.cs Skriptdatum:  22.01.2019  10:32     

namespace ATIS.Ui.Views.Report.ListDetails
{  

    /// <summary>
    /// Interactionslogic for ReportImageWindow.xaml
    /// </summary>
    public partial class ReportImageWindow : MetroWindow
   {

        public ReportImageWindow(int un, string tab)
       {         
