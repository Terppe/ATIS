...
{     
    ...
    public class Tbl63InfratribussesViewModel : Tbl03RegnumsViewModel
    {     
 ...
 //    Part 5    
  ...
  FiSpeciessesView = CollectionViewSource.GetDefaultView(Tbl69FiSpeciessesList);
        ...
        private void CopyFiSpecies(object o)
        {
            ...
            var  = _tbl69FiSpeciessesRepository.Get(CurrentTbl69FiSpecies.FiSpeciesID);

            Tbl69FiSpeciessesList.Insert(0, new Tbl69FiSpecies
            {                 
  InfratribusID = .InfratribusID,     
        ...
        private void DeleteFiSpecies(object o)
        {
            try
            {
                ...
                {  
                    ...
                    _tbl69FiSpeciessesRepository.Delete();
  ...
  InfratribusID = CurrentTbl69FiSpecies.InfratribusID,              
                    ...
                    {
                        //InfratribusID may be not 0
                        if (CurrentTbl69FiSpecies.InfratribusID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl69FiSpeciessesRepository.GetAll()
                         ...
                         a.InfratribusID == CurrentTbl69FiSpecies.InfratribusID
                         select a);
 ...
 //    Part 6    
  ...
  PlSpeciessesView = CollectionViewSource.GetDefaultView(Tbl72PlSpeciessesList);
        ...
        private void CopyPlSpecies(object o)
        {
            ...
            var  = _tbl72PlSpeciessesRepository.Get(CurrentTbl72PlSpecies.PlSpeciesID);
        ...
        private void DeletePlSpecies(object o)
        {
            try
            {
                ...
                {  
                    ...
                    _tbl72PlSpeciessesRepository.Delete();
  ...
  .Updater = Environment.UserName;
                    ...
                    else
                    {
                        ...
                        {   
  InfratribusID = CurrentTbl72PlSpecies.InfratribusID,              
                    ...
                    {
                        //InfratribusID may be not 0
                        if (CurrentTbl72PlSpecies.InfratribusID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl72PlSpeciessesRepository.GetAll()
                         ...
                         a.InfratribusID== CurrentTbl72PlSpecies.InfratribusID
                         select a);
                ...
                else
                {
                    if (CurrentTbl90RefAuthor.ReferenceID != 0 && CurrentTbl90RefAuthor.RefAuthorID != 0)
                    {
                        ...
                        {   
                            ...
                            refAuthor.InfratribusID = CurrentTbl90RefAuthor.InfratribusID;  
...
InfratribusID = CurrentTbl90RefAuthor.InfratribusID,              
                    ...
                    {
                        //InfratribusID may be not 0
                        if (CurrentTbl90RefAuthor.InfratribusID == 0 || CurrentTbl90RefAuthor.RefAuthorID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl90ReferencesRepository.GetAll()
                         ...
                         a.InfratribusID == CurrentTbl90RefAuthor.InfratribusID &&
                ...
                else
                {
                    if (CurrentTbl90RefSource.ReferenceID != 0)
                    {
                        ...
                        {   
                            ...
                            refSource.InfratribusID = CurrentTbl90RefSource.InfratribusID;            
...
InfratribusID = CurrentTbl90RefSource.InfratribusID,              
                    ...
                    {
                        //InfratribusID may be not 0
                        if (CurrentTbl90RefSource.InfratribusID == 0 || CurrentTbl90RefSource.RefSourceID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,            
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl90ReferencesRepository.GetAll()
                         ...
                         a.InfratribusID == CurrentTbl90RefSource.InfratribusID &&
                ...
                else
                {
                    if (CurrentTbl90RefExpert.ReferenceID != 0 && CurrentTbl90RefExpert.RefExpertID != 0)
                    {
                        ...
                        {   
                            ...
                            refExpert.InfratribusID = CurrentTbl90RefExpert.InfratribusID;           
...
InfratribusID = CurrentTbl90RefExpert.InfratribusID,              
                    ...
                    {
                        //InfratribusID may be not 0
                        if (CurrentTbl90RefExpert.InfratribusID == 0 || CurrentTbl90RefExpert.RefExpertID == 0)   
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,          
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl90ReferencesRepository.GetAll()
                         ...
                         a.InfratribusID == CurrentTbl90RefExpert.InfratribusID &&
...
InfratribusID = CurrentTbl93Comment.InfratribusID,              
                    ...
                    {
                        //InfratribusID may be not 0
                        if (CurrentTbl93Comment.InfratribusID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
 ...
 //    Part 9    
        ...
        public  void GetConnectedTablesById(object o)
        {
            ...
            Tbl66GenussesList =  new ObservableCollection<Tbl66Genus>
                                                       ...
                                                       where y.InfratribusID == CurrentTbl63Infratribus.InfratribusID
                                                       orderby y.GenusName
                                                       select y);
