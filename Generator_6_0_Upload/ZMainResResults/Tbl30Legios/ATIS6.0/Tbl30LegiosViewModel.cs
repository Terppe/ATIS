...
{     
 ...
 //    Part 1    
        ...
        private void ExecuteGetLegiosByNameOrId(string searchName)
        {
            ...
            Tbl30LegiosList = _extGet.SearchNameAndIdReturnCollection<Tbl30Legio>(SearchLegioName, "legio");
 ...
 //    Part 4    
        ...
        private void ExecuteDeleteOrdo(string searchName)
        {
            ...
            Tbl33OrdosList = _extGet.GetOrdosCollectionOrderByFromLegioId<Tbl33Ordo>(CurrentTbl33Ordo.LegioId);
 ...
 //    Part 8    
        ...
        public void ExecuteCopyReferenceAuthor(object o)
        {
            ...
            Tbl90ReferenceAuthorsList = _extCopy.CopyReferenceLegio(CurrentTbl90ReferenceAuthor, "Author");
        ...
        public void ExecuteSaveReferenceAuthor(string searchName)
        {
            ...
            try
            {
                ...
                if (CurrentTbl90ReferenceAuthor.ReferenceId == 0)
                    reference = _extSave.ReferenceAuthorLegioAdd(CurrentTbl90ReferenceAuthor);

                else
                    reference = _extSave.ReferenceAuthorLegioUpdate(reference, CurrentTbl90ReferenceAuthor);
           ...
           Tbl90ReferenceAuthorsList = _extGet.GetReferenceAuthorsCollectionOrderByFromLegioIdAndRefSourceIdIsNullAndRefExpertIdIsNull<Tbl90Reference>(CurrentTbl30Legio.LegioId);            
        ...
        public void ExecuteCopyReferenceSource(object o)
        {
            ...
            Tbl90ReferenceAuthorsList = _extCopy.CopyReferenceLegio(CurrentTbl90ReferenceSource, "Source");
        ...
        private void ExecuteDeleteReferenceSource(object o)
        {
           ...
           Tbl90ReferenceSourcesList = _extGet.GetReferenceSourcesCollectionOrderByFromLegioIdAndRefAuthorIdIsNullAndRefExpertIdIsNull<Tbl90Reference>(CurrentTbl30Legio.LegioId);          
           ...
           if (_genSourceMessageBoxes.NoDatasetSelectedInfoMessageBox(CurrentTbl90ReferenceSource)) return;
            ...
            try
            {
                ...
                if (CurrentTbl90ReferenceSource.ReferenceId == 0)
                    reference = _extSave.ReferenceSourceLegioAdd(CurrentTbl90ReferenceSource);
                else
                    reference = _extSave.ReferenceSourceLegioUpdate(reference, CurrentTbl90ReferenceSource);
        ...
        public void ExecuteCopyReferenceExpert(object o)
        {
            ...
            Tbl90ReferenceExpertsList = _extCopy.CopyReferenceLegio(CurrentTbl90ReferenceExpert, "Expert");
        ...
        private void ExecuteDeleteReferenceExpert(object o)
        {
           ...
           Tbl90ReferenceExpertsList= _extGet.GetReferenceExpertsCollectionOrderByFromLegioIdAndRefAuthorIdIsNullAndRefSourceIdIsNull<Tbl90Reference>(CurrentTbl30Legio.LegioId);           
        ...
        public void ExecuteSaveReferenceExpert(object o)
        {
            ...
            try
            {
                ...
                if (CurrentTbl90ReferenceExpert.ReferenceId == 0)
                    reference = _extSave.ReferenceExpertLegioAdd(CurrentTbl90ReferenceExpert);
                else
                    reference = _extSave.ReferenceExpertLegioUpdate(reference, CurrentTbl90ReferenceExpert);
       ...
       #region [Methods Legio ==> Tbl93Comments]        
        ...
        private void ExecuteDeleteComment(object o)
        {
            ...
            Tbl93CommentsList = _extGet.GetCommentsCollectionOrderByFromLegioId<Tbl93Comment>(CurrentTbl93Comment.LegioId);
        ...
        private void ExecuteSaveComment(object o)
        {
            ...
            try
            {
                ...
                if (CurrentTbl93Comment.CommentId == 0)
                    comment = _extSave.CommentLegioAdd(CurrentTbl93Comment);
                else
                    comment = _extSave.CommentLegioUpdate(comment, CurrentTbl93Comment);
 ...
 //    Part 9    
        ...
        {           
Tbl27InfraclassesList = _extGet.GetInfraclassesCollectionOrderByFromInfraclassId<Tbl27Infraclass>(CurrentTbl30Legio.InfraclassId);

            Tbl24SubclassesAllList = _extGet.AllCollection<Tbl24Subclass>("");
        ...
        public  int SelectedMainTabIndex
        {
            ...
            set
            {
                ...
                if (_selectedMainTabIndex == 1)
                {
                    if (CurrentTbl30Legio != null)
                    {
                        Tbl33OrdosList = _extGet.GetOrdosCollectionOrderByFromLegioId<Tbl33Ordo>(CurrentTbl30Legio.LegioId);
