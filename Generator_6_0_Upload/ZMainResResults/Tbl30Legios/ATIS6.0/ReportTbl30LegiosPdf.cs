...
{     
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id, string use)
        {
            ...
            { 
                ...
                using (var pdf = new PdfDocument())
                {
                    ...
                    AddLegioHierarchyList(pdf, legioList);       
        ...
        private static void AddLegioHierarchyList(PdfDocument pdf, Tbl30Legio tbl30LegioList)
        {
            ...
            //      _arrInts = PdfHelper.PdfTbRight("legioRight", _arrInts, false, textResult, 0);
        ...
        private static void AddSubordosChildrenList(PdfDocument pdf, ObservableCollection<Tbl36Subordo> sList)
        {
            _page = pdf.Pages[_arrInts[6]];
            ...
            foreach (var t in sList)
            {
                ...
                _arrInts = PdfHelper.PdfTbMoveLeft("Left" + _z1, _arrInts, false, CultRes.StringsRes.Subordo, 0);
