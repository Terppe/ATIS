...
{     
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id, string use)
        {
            ...
            { 
                ...
                using (var pdf = new PdfDocument())
                {
                    ...
                    AddSubfamilyHierarchyList(pdf, subfamilyList);       
        ...
        private static void AddSubfamilyHierarchyList(PdfDocument pdf, Tbl48Subfamily tbl48SubfamilyList)
        {
            ...
            //      _arrInts = PdfHelper.PdfTbRight("subfamilyRight", _arrInts, false, textResult, 0);
        ...
        private static void AddSupertribussChildrenList(PdfDocument pdf, ObservableCollection<Tbl54Supertribus> sList)
        {
            _page = pdf.Pages[_arrInts[6]];
            ...
            foreach (var t in sList)
            {
                ...
                _arrInts = PdfHelper.PdfTbMoveLeft("Left" + _z1, _arrInts, false, CultRes.StringsRes.Supertribus, 0);
