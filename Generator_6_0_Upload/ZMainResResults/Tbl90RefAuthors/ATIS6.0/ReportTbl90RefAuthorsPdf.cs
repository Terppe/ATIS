...
{     
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id, string use)
        {
            ...
            var refAuthorList = ExtCrud.GetRefAuthorsCollectionFromRefAuthorIdOrderBy<Tbl90RefAuthor>(id).FirstOrDefault();    
        
            //Child
            var NULLsList = ExtCrud.GetCollectionFromRefAuthorIdOrderBy<NULL>(id);           
             
            var expertsList = ExtCrud.GetReferenceExpertsCollectionFromRefAuthorIdAndRefAuthorIdIsNullAndRefSourceIdIsNullOrderBy<Tbl90Reference>(id);
            var sourcesList = ExtCrud.GetReferenceSourcesCollectionFromRefAuthorIdAndRefAuthorIdIsNullAndRefExpertIdIsNullOrderBy<Tbl90Reference>(id);
            var authorsList = ExtCrud.GetReferenceAuthorsCollectionFromRefAuthorIdAndRefSourceIdIsNullAndRefExpertIdIsNullOrderBy<Tbl90Reference>(id);
            var commentsList = ExtCrud.GetCommentsCollectionFromRefAuthorIdOrderBy<Tbl93Comment>(id);   
