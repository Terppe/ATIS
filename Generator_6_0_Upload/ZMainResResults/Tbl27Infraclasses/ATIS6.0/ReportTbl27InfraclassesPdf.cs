...
{     
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id, string use)
        {
            ...
            { 
                ...
                using (var pdf = new PdfDocument())
                {
                    ...
                    AddInfraclassHierarchyList(pdf, infraclassList);       
        ...
        private static void AddInfraclassHierarchyList(PdfDocument pdf, Tbl27Infraclass tbl27InfraclassList)
        {
            ...
            //      _arrInts = PdfHelper.PdfTbRight("infraclassRight", _arrInts, false, textResult, 0);
        ...
        private static void AddOrdosChildrenList(PdfDocument pdf, ObservableCollection<Tbl33Ordo> sList)
        {
            _page = pdf.Pages[_arrInts[6]];
            ...
            foreach (var t in sList)
            {
                ...
                _arrInts = PdfHelper.PdfTbMoveLeft("Left" + _z1, _arrInts, false, CultRes.StringsRes.Ordo, 0);
