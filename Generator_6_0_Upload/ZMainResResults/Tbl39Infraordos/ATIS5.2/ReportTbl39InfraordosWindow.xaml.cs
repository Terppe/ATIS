...
using Te.Atis.Ui.Desktop.Properties;
   ...
   //  ReportTbl39InfraordosWindow.xaml.cs Skriptdatum:  08.11.2018  10:32     

namespace Te.Atis.Ui.Desktop.Views.Report 
{  

    /// <summary>
    /// Interactionslogic for ReportTbl39InfraordosWindow.xaml
    /// </summary>
    public partial class ReportTbl39InfraordosWindow : Window
   {

        public ReportTbl39InfraordosWindow(int un, string tab)
       {         
