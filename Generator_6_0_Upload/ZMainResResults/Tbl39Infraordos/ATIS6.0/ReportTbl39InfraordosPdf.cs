...
using Microsoft.Win32;  
         ...
         //    ReportInfraordoPdf Skriptdatum:  10.12.2020  10:32    
...
{     
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id, string use)
        {
            ...
            var infraordoList = ExtCrud.GetInfraordosCollectionFromInfraordoIdOrderBy<Tbl39Infraordo>(id).FirstOrDefault();    
        ...
        private static void AddInfraordoTaxoNomenList(PdfDocument pdf, Tbl39Infraordo infraordoList)         
