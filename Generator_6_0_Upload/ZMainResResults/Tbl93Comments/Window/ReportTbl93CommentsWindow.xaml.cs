...
using System.Windows.Documents;
   ...
   //  ReportTbl93CommentsWindow.xaml.cs Skriptdatum:  14.11.2017  10:32     

namespace WPFUI.Views.Report 
{  

    /// <summary>
    /// Interactionslogic for ReportTbl93CommentsWindow.xaml
    /// </summary>
    public partial class ReportTbl93CommentsWindow : Window
   {

        public ReportTbl93CommentsWindow(int un, string tab)
       {         
