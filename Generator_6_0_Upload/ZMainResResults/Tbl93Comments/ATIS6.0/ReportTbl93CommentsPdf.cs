...
{     
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id, string use)
        {
            ...
            var authorsList = ExtGet.GetReferenceAuthorsCollectionOrderByFromCommentIdAndRefSourceIdIsNullAndRefExpertIdIsNull<Tbl90Reference>(id);
            var commentsList = ExtGet.GetCommentsCollectionOrderByFromCommentId<Tbl93Comment>(id);   
