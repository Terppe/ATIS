...
{     
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id, string use)
        {
            ...
            var refExpertList = ExtCrud.GetRefExpertsCollectionFromRefExpertIdOrderBy<Tbl90RefExpert>(id).FirstOrDefault();    
        
            //Child
            var NULLsList = ExtCrud.GetCollectionFromRefExpertIdOrderBy<NULL>(id);           
             
            var expertsList = ExtCrud.GetReferenceExpertsCollectionFromRefExpertIdAndRefAuthorIdIsNullAndRefSourceIdIsNullOrderBy<Tbl90Reference>(id);
            var sourcesList = ExtCrud.GetReferenceSourcesCollectionFromRefExpertIdAndRefAuthorIdIsNullAndRefExpertIdIsNullOrderBy<Tbl90Reference>(id);
            var authorsList = ExtCrud.GetReferenceAuthorsCollectionFromRefExpertIdAndRefSourceIdIsNullAndRefExpertIdIsNullOrderBy<Tbl90Reference>(id);
            var commentsList = ExtCrud.GetCommentsCollectionFromRefExpertIdOrderBy<Tbl93Comment>(id);   
