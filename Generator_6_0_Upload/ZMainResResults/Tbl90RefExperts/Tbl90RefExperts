...
namespace ATIS.Ui.Views.Report
{
    public class ReportViewModel : ViewModelBase
    {
        ...
        {
            RefExpertsCollection = _extReportBasicGet.CollRefExpertsByRefExpertId(id);
            //direct children
            Collection = _extReportBasicGet.CollByRefExpertIdAndHash(id);
            //------------------------------------------------------------------------------
            //Function
            var NULLId = _extReportBasicGet.NULLIdFromRefExpertsCollectionSelect(id);
            //-----------------------------------------------------------------------------
            //ForeignKeyTable
            Collection = _extReportBasicGet.CollByRegnumIdAndHash(NULLId);
            //------------------------------------------------------------------------------
            ExpertsCollection = _extReportBasicGet.CollExpertsByRefExpertId(id);
            SourcesCollection = _extReportBasicGet.CollSourcesByRefExpertId(id);
            AuthorsCollection = _extReportBasicGet.CollAuthorsByRefExpertId(id);
            //------------------------------------------------------------------------------
            CommentsCollection = _extReportBasicGet.CollCommentsByRefExpertId(id);
        }
        //------------------------------------------------------------------------------

        private RelayCommand _pdfRefExpertPrintCommand;
        public ICommand PdfRefExpertPrintCommand
        {
            get { return _pdfRefExpertPrintCommand ??= new RelayCommand(delegate { CreatePdfRefExpertPrint(_mainId); }); }
        }

        private static void CreatePdfRefExpertPrint(int id)
        {
            const string use = "print";
            ReportRefExpertPdf.CreateMainPdf(id, use);
        }
        private RelayCommand _pdfRefExpertSaveCommand;
        public ICommand PdfRefExpertSaveCommand
        {
            get { return _pdfRefExpertSaveCommand ??= new RelayCommand(delegate { CreatePdfRefExpertSave(_mainId); }); }
        }

        private static void CreatePdfRefExpertSave(int id)
        {
            const string use = "save";
            ReportRefExpertPdf.CreateMainPdf(id, use);
        }
