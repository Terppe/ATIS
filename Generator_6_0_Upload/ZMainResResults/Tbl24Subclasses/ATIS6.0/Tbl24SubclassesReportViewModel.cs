...
namespace ATIS.Ui.Views.Report
{
    public class ReportViewModel : ViewModelBase
    {
        ...
        public void GetTbl24SubclassesById(int id)
        {
            ...
            //------------------------------------------------------------------------------
            //Function
            var classeId = _extReportBasicGet.ClassIdFromSubclassesCollectionSelect(id);
            //-----------------------------------------------------------------------------
            //ForeignKeyTable
            ClassesCollection = _extReportBasicGet.CollClassesByRegnumIdAndHash(classeId);
            //------------------------------------------------------------------------------
        ...
        {
            const string use = "print";
            ReportSubclassPdf.CreateMainPdf(id, use);
        }
