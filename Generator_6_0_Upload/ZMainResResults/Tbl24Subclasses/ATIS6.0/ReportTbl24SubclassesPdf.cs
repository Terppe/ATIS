...
{     
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id, string use)
        {
            ...
            { 
                ...
                using (var pdf = new PdfDocument())
                {
                    ...
                    AddSubclassHierarchyList(pdf, subclassList);       
        ...
        private static void AddSubclassHierarchyList(PdfDocument pdf, Tbl24Subclass tbl24SubclassList)
        {
            ...
            //      _arrInts = PdfHelper.PdfTbRight("subclassRight", _arrInts, false, textResult, 0);
        ...
        private static void AddLegiosChildrenList(PdfDocument pdf, ObservableCollection<Tbl30Legio> sList)
        {
            _page = pdf.Pages[_arrInts[6]];
            ...
            foreach (var t in sList)
            {
                ...
                _arrInts = PdfHelper.PdfTbMoveLeft("Left" + _z1, _arrInts, false, CultRes.StringsRes.Legio, 0);
