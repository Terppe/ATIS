...
using MessageBoxImage = System.Windows.MessageBoxImage;
         ...
         //    Tbl24SubclassesViewModel Skriptdatum:  13.12.2019  18:32    
 ...
 //    Part 5    
  ...
  LegiosView = CollectionViewSource.GetDefaultView(Tbl30LegiosList);
        ...
        private void CopyLegio(object o)
        {
            ...
            var  = _tbl30LegiosRepository.Get(CurrentTbl30Legio.LegioID);
  ...
  SubclassID = CurrentTbl30Legio.SubclassID,              
                    ...
                    {
                        //SubclassID may be not 0
                        if (CurrentTbl30Legio.SubclassID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl30LegiosRepository.GetAll()
                         ...
                         a.SubclassID == CurrentTbl30Legio.SubclassID
                         select a);
