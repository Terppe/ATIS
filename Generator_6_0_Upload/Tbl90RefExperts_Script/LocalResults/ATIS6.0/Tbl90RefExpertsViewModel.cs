...
RefExpertsView = CollectionViewSource.GetDefaultView(Tbl90RefExpertsList);
        ...
        private void ExecuteDeleteRefExpert(string searchName)
        {
            ...
            Tbl69FiSpeciessesList = _extCrud.SearchForConnectedDatasetsWithRefExpertIdInTableFiSpecies(CurrentTbl90RefExpert);     
            ...
            //Delete all Comments  ----------------------------------------------------
            Tbl93CommentsList = _extCrud.DeleteDatasetsWithRefExpertIdInTableComment(CurrentTbl90RefExpert);
        ...
        public  int SelectedMainTabIndex
        {
            ...
            set
            {
                ...
                if (_selectedMainTabIndex == 0)             
                {
                    ...
                    {
                        NULLList = _extCrud.GetCollectionFromNULLIdOrderBy<NULL>(CurrentTbl90RefExpert.NULLId);
                ...
                if (_selectedMainTabIndex == 1)
                {
                    if (CurrentTbl90RefExpert != null)
                    {
                        Tbl69FiSpeciessesList = _extCrud.GetCollectionFromRefExpertIdOrderBy<NULL>(CurrentTbl90RefExpert.RefExpertId);

                        Tbl90RefExpertsAllList = _extCrud.GetCollectionAllOrderBy<Tbl90RefExpert>("refExpert");
                ...
                if (_selectedMainTabIndex == 3)
                {
                    if (CurrentTbl90RefExpert != null)
                    {
                        Tbl93CommentsList = _extCrud.GetCommentsCollectionFromRefExpertIdOrderBy<Tbl93Comment>(CurrentTbl90RefExpert.RefExpertId);
            ...
            set
            {
                ...
                if (_selectedDetailTabIndex == 3)
                {
                    if (CurrentTbl90RefExpert != null)
                    {
                        ...
                        Tbl90ReferenceExpertsList = _extCrud.GetReferenceExpertsCollectionFromRefExpertIdAndRefAuthorIdIsNullAndRefSourceIdIsNullOrderBy<Tbl90Reference>(CurrentTbl90RefExpert.RefExpertId);
                ...
                if (_selectedDetailTabIndex == 4)
                {
                    if (CurrentTbl90RefExpert != null)
                    {
                        ...
                        Tbl90ReferenceSourcesList = _extCrud.GetReferenceSourcesCollectionFromRefExpertIdAndRefAuthorIdIsNullAndRefExpertIdIsNullOrderBy<Tbl90Reference>(CurrentTbl90RefExpert.RefExpertId);
                ...
                if (_selectedDetailTabIndex == 5)
                {
                    if (CurrentTbl90RefExpert != null)
                    {
                        ...
                        Tbl90ReferenceAuthorsList = _extCrud.GetReferenceAuthorsCollectionFromRefExpertIdAndRefSourceIdIsNullAndRefExpertIdIsNullOrderBy<Tbl90Reference>(CurrentTbl90RefExpert.RefExpertId);
