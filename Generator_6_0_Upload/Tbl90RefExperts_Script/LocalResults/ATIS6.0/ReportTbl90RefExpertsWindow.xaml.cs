...
using MahApps.Metro.Controls;
   ...
   //  ReportRefExpertWindow.xaml.cs Skriptdatum:  29.11.2018  10:32     

namespace ATIS.Ui.Views.Report.ListDetails
{  

    /// <summary>
    /// Interactionslogic for ReportRefExpertWindow.xaml
    /// </summary>
    public partial class ReportRefExpertWindow : MetroWindow
   {

        public ReportRefExpertWindow(int un, string tab)
       {         
