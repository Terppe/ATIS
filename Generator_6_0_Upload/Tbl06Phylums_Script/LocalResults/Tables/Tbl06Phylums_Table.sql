USE [ATIS34]
GO
/****** Object:  Table [dbo].[Tbl06Phylums]    Script Date:  28.11.2020  12:32   ******/  
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[Tbl06Phylums] (
            ...
            [PhylumName] [nvarchar] (100) COLLATE Latin1_General_CI_AS NOT NULL,
...
(
 ...
 , 
CONSTRAINT [IX_Tbl06Phylums_CountID] UNIQUE NONCLUSTERED 
(
	[CountID] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE = OFF,  IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON,  ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
 , 
CONSTRAINT [IX_Tbl06Phylums_PhylumName] UNIQUE NONCLUSTERED 
(
	[PhylumName] ASC, [RegnumID] ASC, [Author] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE = OFF,  IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON,  ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
...
ALTER TABLE [dbo].[Tbl06Phylums]  WITH CHECK ADD  CONSTRAINT 
[FK_Tbl06Phylums_Tbl03Regnums] FOREIGN KEY ([RegnumID])
