...
using MahApps.Metro.Controls;
   ...
   //  ReportSubfamilyWindow.xaml.cs Skriptdatum:  10.12.2020  10:32     

namespace ATIS.Ui.Views.Report.D48Subfamily
{  

    /// <summary>
    /// Interactionslogic for ReportSubfamilyWindow.xaml
    /// </summary>
    public partial class ReportSubfamilyWindow : MetroWindow
   {

        public ReportSubfamilyWindow(int un, string tab)
       {         
