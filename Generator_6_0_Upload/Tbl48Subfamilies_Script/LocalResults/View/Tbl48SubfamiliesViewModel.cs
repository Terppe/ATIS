...
using MessageBoxImage = System.Windows.MessageBoxImage;
         ...
         //    Tbl48SubfamiliesViewModel Skriptdatum:  10.12.2020  10:32    

namespace WPFUI.Views.Database
{     
    
    public class Tbl48SubfamiliesViewModel : Tbl03RegnumsViewModel
    {     
 ...
 //    Part 5    
  ...
  SupertribussesView = CollectionViewSource.GetDefaultView(Tbl54SupertribussesList);
        ...
        private void CopySupertribus(object o)
        {
            ...
            var  = _tbl54SupertribussesRepository.Get(CurrentTbl54Supertribus.SupertribusID);
        ...
        private void DeleteSupertribus(object o)
        {
            try
            {
                ...
                {  
                    ...
                    _tbl54SupertribussesRepository.Delete();
  ...
  SubfamilyID = CurrentTbl54Supertribus.SubfamilyID,              
                    ...
                    {
                        //SubfamilyID may be not 0
                        if (CurrentTbl54Supertribus.SubfamilyID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl54SupertribussesRepository.GetAll()
                         ...
                         a.SubfamilyID == CurrentTbl54Supertribus.SubfamilyID
                         select a);
                ...
                else
                {
                    if (CurrentTbl90RefAuthor.ReferenceID != 0 && CurrentTbl90RefAuthor.RefAuthorID != 0)
                    {
                        ...
                        {   
                            ...
                            refAuthor.SubfamilyID = CurrentTbl90RefAuthor.SubfamilyID;  
...
SubfamilyID = CurrentTbl90RefAuthor.SubfamilyID,              
                    ...
                    {
                        //SubfamilyID may be not 0
                        if (CurrentTbl90RefAuthor.SubfamilyID == 0 || CurrentTbl90RefAuthor.RefAuthorID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl90ReferencesRepository.GetAll()
                         ...
                         a.SubfamilyID == CurrentTbl90RefAuthor.SubfamilyID &&
                ...
                else
                {
                    if (CurrentTbl90RefSource.ReferenceID != 0)
                    {
                        ...
                        {   
                            ...
                            refSource.SubfamilyID = CurrentTbl90RefSource.SubfamilyID;            
...
SubfamilyID = CurrentTbl90RefSource.SubfamilyID,              
                    ...
                    {
                        //SubfamilyID may be not 0
                        if (CurrentTbl90RefSource.SubfamilyID == 0 || CurrentTbl90RefSource.RefSourceID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,            
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl90ReferencesRepository.GetAll()
                         ...
                         a.SubfamilyID == CurrentTbl90RefSource.SubfamilyID &&
                ...
                else
                {
                    if (CurrentTbl90RefExpert.ReferenceID != 0 && CurrentTbl90RefExpert.RefExpertID != 0)
                    {
                        ...
                        {   
                            ...
                            refExpert.SubfamilyID = CurrentTbl90RefExpert.SubfamilyID;           
...
SubfamilyID = CurrentTbl90RefExpert.SubfamilyID,              
                    ...
                    {
                        //SubfamilyID may be not 0
                        if (CurrentTbl90RefExpert.SubfamilyID == 0 || CurrentTbl90RefExpert.RefExpertID == 0)   
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,          
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl90ReferencesRepository.GetAll()
                         ...
                         a.SubfamilyID == CurrentTbl90RefExpert.SubfamilyID &&
...
SubfamilyID = CurrentTbl93Comment.SubfamilyID,              
                    ...
                    {
                        //SubfamilyID may be not 0
                        if (CurrentTbl93Comment.SubfamilyID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
 ...
 //    Part 9    
        ...
        public  void GetConnectedTablesById(object o)
        {
            ...
            Tbl51InfrafamiliesList =  new ObservableCollection<Tbl51Infrafamily>
                                                       ...
                                                       where y.SubfamilyID == CurrentTbl48Subfamily.SubfamilyID
