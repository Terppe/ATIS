...
{     
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id, string use)
        {
            ...
            var authorsList = ExtGet.GetReferenceAuthorsCollectionOrderByFromTribusIdAndRefSourceIdIsNullAndRefExpertIdIsNull<Tbl90Reference>(id);
            var commentsList = ExtGet.GetCommentsCollectionOrderByFromTribusId<Tbl93Comment>(id);   
