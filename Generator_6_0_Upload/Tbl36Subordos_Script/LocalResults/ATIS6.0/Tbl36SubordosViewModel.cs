...
{     
 ...
 //    Part 1    
        ...
        private void ExecuteGetSubordosByNameOrId(string searchName)
        {
            ...
            Tbl36SubordosList = _extGet.SearchNameAndIdReturnCollection<Tbl36Subordo>(SearchSubordoName, "subordo");
 ...
 //    Part 4    
        ...
        private void ExecuteDeleteInfraordo(string searchName)
        {
            ...
            Tbl39InfraordosList = _extGet.GetInfraordosCollectionOrderByFromSubordoId<Tbl39Infraordo>(CurrentTbl39Infraordo.SubordoId);
 ...
 //    Part 8    
        ...
        public void ExecuteCopyReferenceAuthor(object o)
        {
            ...
            Tbl90ReferenceAuthorsList = _extCopy.CopyReferenceSubordo(CurrentTbl90ReferenceAuthor, "Author");
        ...
        public void ExecuteSaveReferenceAuthor(string searchName)
        {
            ...
            try
            {
                ...
                if (CurrentTbl90ReferenceAuthor.ReferenceId == 0)
                    reference = _extSave.ReferenceAuthorSubordoAdd(CurrentTbl90ReferenceAuthor);

                else
                    reference = _extSave.ReferenceAuthorSubordoUpdate(reference, CurrentTbl90ReferenceAuthor);
           ...
           Tbl90ReferenceAuthorsList = _extGet.GetReferenceAuthorsCollectionOrderByFromSubordoIdAndRefSourceIdIsNullAndRefExpertIdIsNull<Tbl90Reference>(CurrentTbl36Subordo.SubordoId);            
        ...
        public void ExecuteCopyReferenceSource(object o)
        {
            ...
            Tbl90ReferenceAuthorsList = _extCopy.CopyReferenceSubordo(CurrentTbl90ReferenceSource, "Source");
        ...
        private void ExecuteDeleteReferenceSource(object o)
        {
           ...
           Tbl90ReferenceSourcesList = _extGet.GetReferenceSourcesCollectionOrderByFromSubordoIdAndRefAuthorIdIsNullAndRefExpertIdIsNull<Tbl90Reference>(CurrentTbl36Subordo.SubordoId);          
           ...
           if (_genSourceMessageBoxes.NoDatasetSelectedInfoMessageBox(CurrentTbl90ReferenceSource)) return;
            ...
            try
            {
                ...
                if (CurrentTbl90ReferenceSource.ReferenceId == 0)
                    reference = _extSave.ReferenceSourceSubordoAdd(CurrentTbl90ReferenceSource);
                else
                    reference = _extSave.ReferenceSourceSubordoUpdate(reference, CurrentTbl90ReferenceSource);
        ...
        public void ExecuteCopyReferenceExpert(object o)
        {
            ...
            Tbl90ReferenceExpertsList = _extCopy.CopyReferenceSubordo(CurrentTbl90ReferenceExpert, "Expert");
        ...
        private void ExecuteDeleteReferenceExpert(object o)
        {
           ...
           Tbl90ReferenceExpertsList= _extGet.GetReferenceExpertsCollectionOrderByFromSubordoIdAndRefAuthorIdIsNullAndRefSourceIdIsNull<Tbl90Reference>(CurrentTbl36Subordo.SubordoId);           
        ...
        public void ExecuteSaveReferenceExpert(object o)
        {
            ...
            try
            {
                ...
                if (CurrentTbl90ReferenceExpert.ReferenceId == 0)
                    reference = _extSave.ReferenceExpertSubordoAdd(CurrentTbl90ReferenceExpert);
                else
                    reference = _extSave.ReferenceExpertSubordoUpdate(reference, CurrentTbl90ReferenceExpert);
       ...
       #region [Methods Subordo ==> Tbl93Comments]        
        ...
        private void ExecuteDeleteComment(object o)
        {
            ...
            Tbl93CommentsList = _extGet.GetCommentsCollectionOrderByFromSubordoId<Tbl93Comment>(CurrentTbl93Comment.SubordoId);
        ...
        private void ExecuteSaveComment(object o)
        {
            ...
            try
            {
                ...
                if (CurrentTbl93Comment.CommentId == 0)
                    comment = _extSave.CommentSubordoAdd(CurrentTbl93Comment);
                else
                    comment = _extSave.CommentSubordoUpdate(comment, CurrentTbl93Comment);
 ...
 //    Part 9    
        ...
        {           
Tbl33OrdosList = _extGet.GetOrdosCollectionOrderByFromOrdoId<Tbl33Ordo>(CurrentTbl36Subordo.OrdoId);

            Tbl30LegiosAllList = _extGet.AllCollection<Tbl30Legio>("");
        ...
        public  int SelectedMainTabIndex
        {
            ...
            set
            {
                ...
                if (_selectedMainTabIndex == 1)
                {
                    if (CurrentTbl36Subordo != null)
                    {
                        Tbl39InfraordosList = _extGet.GetInfraordosCollectionOrderByFromSubordoId<Tbl39Infraordo>(CurrentTbl36Subordo.SubordoId);
