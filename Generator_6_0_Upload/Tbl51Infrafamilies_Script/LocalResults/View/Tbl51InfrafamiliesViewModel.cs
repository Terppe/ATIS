...
{     
    ...
    public class Tbl51InfrafamiliesViewModel : Tbl03RegnumsViewModel
    {     
...
FamilyID = CurrentTbl48Subfamily.FamilyID,     
 ...
 //    Part 5    
  ...
  TribussesView = CollectionViewSource.GetDefaultView(Tbl57TribussesList);
        ...
        private void CopyTribus(object o)
        {
            ...
            var  = _tbl57TribussesRepository.Get(CurrentTbl57Tribus.TribusID);

            Tbl57TribussesList.Insert(0, new Tbl57Tribus
            {                 
  InfrafamilyID = .InfrafamilyID,     
        ...
        private void DeleteTribus(object o)
        {
            try
            {
                ...
                {  
                    ...
                    _tbl57TribussesRepository.Delete();
            ...
            try
            {
                ...
                else
                {
                    if (CurrentTbl57Tribus.TribusID!= 0)
                    {
                        if (!= null) //update
                        {   
  .InfrafamilyID= CurrentTbl57Tribus.InfrafamilyID;            
  ...
  InfrafamilyID = CurrentTbl57Tribus.InfrafamilyID,              
                    ...
                    {
                        //InfrafamilyID may be not 0
                        if (CurrentTbl57Tribus.InfrafamilyID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl57TribussesRepository.GetAll()
                         ...
                         a.InfrafamilyID == CurrentTbl57Tribus.InfrafamilyID
                         select a);
 ...
 //    Part 8    
        ...
        public new void CopyRefAuthor(object o)
        {
            ...
            {                 
InfrafamilyID = refAuthor.InfrafamilyID,              
                ...
                else
                {
                    if (CurrentTbl90RefAuthor.ReferenceID != 0 && CurrentTbl90RefAuthor.RefAuthorID != 0)
                    {
                        ...
                        {   
                            ...
                            refAuthor.InfrafamilyID = CurrentTbl90RefAuthor.InfrafamilyID;  
...
InfrafamilyID = CurrentTbl90RefAuthor.InfrafamilyID,              
                    ...
                    {
                        //InfrafamilyID may be not 0
                        if (CurrentTbl90RefAuthor.InfrafamilyID == 0 || CurrentTbl90RefAuthor.RefAuthorID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl90ReferencesRepository.GetAll()
                         ...
                         a.InfrafamilyID == CurrentTbl90RefAuthor.InfrafamilyID &&
        ...
        public new void CopyRefSource(object o)
        {
            ...
            {                 
InfrafamilyID = refSource.InfrafamilyID,              
                Info = CultRes.StringsRes.DatasetNew,
                ...
                else
                {
                    if (CurrentTbl90RefSource.ReferenceID != 0)
                    {
                        ...
                        {   
                            ...
                            refSource.InfrafamilyID = CurrentTbl90RefSource.InfrafamilyID;            
...
InfrafamilyID = CurrentTbl90RefSource.InfrafamilyID,              
                    ...
                    {
                        //InfrafamilyID may be not 0
                        if (CurrentTbl90RefSource.InfrafamilyID == 0 || CurrentTbl90RefSource.RefSourceID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,            
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl90ReferencesRepository.GetAll()
                         ...
                         a.InfrafamilyID == CurrentTbl90RefSource.InfrafamilyID &&
        ...
        public new void CopyRefExpert(object o)
        {
            ...
            {                 
InfrafamilyID = refExpert.InfrafamilyID,              
                Info = CultRes.StringsRes.DatasetNew,
                ...
                else
                {
                    if (CurrentTbl90RefExpert.ReferenceID != 0 && CurrentTbl90RefExpert.RefExpertID != 0)
                    {
                        ...
                        {   
                            ...
                            refExpert.InfrafamilyID = CurrentTbl90RefExpert.InfrafamilyID;           
...
InfrafamilyID = CurrentTbl90RefExpert.InfrafamilyID,              
                    ...
                    {
                        //InfrafamilyID may be not 0
                        if (CurrentTbl90RefExpert.InfrafamilyID == 0 || CurrentTbl90RefExpert.RefExpertID == 0)   
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,          
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl90ReferencesRepository.GetAll()
                         ...
                         a.InfrafamilyID == CurrentTbl90RefExpert.InfrafamilyID &&
        ...
        public new void CopyComment(object o)
        {
            ...
            {                 
InfrafamilyID = comment.InfrafamilyID,              
                Info = CultRes.StringsRes.DatasetNew,
                Valid = comment.Valid,
...
InfrafamilyID = CurrentTbl93Comment.InfrafamilyID,              
                    ...
                    {
                        //InfrafamilyID may be not 0
                        if (CurrentTbl93Comment.InfrafamilyID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
 ...
 //    Part 9    
        ...
        public  void GetConnectedTablesById(object o)
        {
            ...
            Tbl48SubfamiliesList =  new ObservableCollection<Tbl48Subfamily>
                                                       (from x in _tbl48SubfamiliesRepository.GetAll()
                                                       where x.SubfamilyID == CurrentTbl51Infrafamily.SubfamilyID
            ...
            Tbl54SupertribussesList =  new ObservableCollection<Tbl54Supertribus>
                                                       ...
                                                       where y.InfrafamilyID == CurrentTbl51Infrafamily.InfrafamilyID
