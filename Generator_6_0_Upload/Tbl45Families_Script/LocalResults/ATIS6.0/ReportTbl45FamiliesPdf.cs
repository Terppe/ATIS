...
{     
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id, string use)
        {
            ...
            var subfamilysList = ExtGet.GetSubfamilysCollectionOrderByFromFamilyId<Tbl48Subfamily>(id);           
            ...
            { 
                ...
                using (var pdf = new PdfDocument())
                {
                    ...
                    AddFamilyHierarchyList(pdf, familyList);       
        ...
        private static void AddFamilyHierarchyList(PdfDocument pdf, Tbl45Family tbl45FamilyList)
        {
            ...
            //      _arrInts = PdfHelper.PdfTbRight("familyRight", _arrInts, false, textResult, 0);
        ...
        private static void AddInfrafamilysChildrenList(PdfDocument pdf, ObservableCollection<Tbl51Infrafamily> sList)
        {
            _page = pdf.Pages[_arrInts[6]];
            ...
            foreach (var t in sList)
            {
                ...
                _arrInts = PdfHelper.PdfTbMoveLeft("Left" + _z1, _arrInts, false, CultRes.StringsRes.Infrafamily, 0);
