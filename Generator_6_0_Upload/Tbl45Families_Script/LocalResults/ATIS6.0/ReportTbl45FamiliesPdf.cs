...
using Microsoft.Win32;  
         ...
         //    ReportFamilyPdf Skriptdatum:  10.12.2020  10:32    
...
{     
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id, string use)
        {
            ...
            var familyList = ExtCrud.GetFamiliesCollectionFromFamilyIdOrderBy<Tbl45Family>(id).FirstOrDefault();    
        ...
        private static void AddFamilyTaxoNomenList(PdfDocument pdf, Tbl45Family familyList)         
