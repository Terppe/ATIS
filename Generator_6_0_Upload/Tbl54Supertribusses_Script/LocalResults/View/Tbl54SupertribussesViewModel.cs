 ...
 //    Part 5    
  ...
  SubtribussesView = CollectionViewSource.GetDefaultView(Tbl60SubtribussesList);
        ...
        private void CopySubtribus(object o)
        {
            ...
            var  = _tbl60SubtribussesRepository.Get(CurrentTbl60Subtribus.SubtribusID);

            Tbl60SubtribussesList.Insert(0, new Tbl60Subtribus
            {                 
  SupertribusID = .SupertribusID,     
        ...
        private void DeleteSubtribus(object o)
        {
            try
            {
                ...
                {  
                    ...
                    _tbl60SubtribussesRepository.Delete();
  ...
  SupertribusID = CurrentTbl60Subtribus.SupertribusID,              
                    ...
                    {
                        //SupertribusID may be not 0
                        if (CurrentTbl60Subtribus.SupertribusID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl60SubtribussesRepository.GetAll()
                         ...
                         a.SupertribusID == CurrentTbl60Subtribus.SupertribusID
                         select a);
