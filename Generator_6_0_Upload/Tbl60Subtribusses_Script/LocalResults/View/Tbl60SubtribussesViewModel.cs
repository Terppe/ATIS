...
SupertribusID = CurrentTbl57Tribus.SupertribusID,     
 ...
 //    Part 5    
  ...
  GenussesView = CollectionViewSource.GetDefaultView(Tbl66GenussesList);
        ...
        private void CopyGenus(object o)
        {
            ...
            var  = _tbl66GenussesRepository.Get(CurrentTbl66Genus.GenusID);

            Tbl66GenussesList.Insert(0, new Tbl66Genus
            {                 
  SubtribusID = .SubtribusID,     
        ...
        private void DeleteGenus(object o)
        {
            try
            {
                ...
                {  
                    ...
                    _tbl66GenussesRepository.Delete();
  ...
  SubtribusID = CurrentTbl66Genus.SubtribusID,              
                    ...
                    {
                        //SubtribusID may be not 0
                        if (CurrentTbl66Genus.SubtribusID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl66GenussesRepository.GetAll()
                         ...
                         a.SubtribusID == CurrentTbl66Genus.SubtribusID
                         select a);
 ...
 //    Part 8    
        ...
        public new void CopyRefAuthor(object o)
        {
            ...
            {                 
SubtribusID = refAuthor.SubtribusID,              
                ...
                else
                {
                    if (CurrentTbl90RefAuthor.ReferenceID != 0 && CurrentTbl90RefAuthor.RefAuthorID != 0)
                    {
                        ...
                        {   
                            ...
                            refAuthor.SubtribusID = CurrentTbl90RefAuthor.SubtribusID;  
...
SubtribusID = CurrentTbl90RefAuthor.SubtribusID,              
                    ...
                    {
                        //SubtribusID may be not 0
                        if (CurrentTbl90RefAuthor.SubtribusID == 0 || CurrentTbl90RefAuthor.RefAuthorID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl90ReferencesRepository.GetAll()
                         ...
                         a.SubtribusID == CurrentTbl90RefAuthor.SubtribusID &&
        ...
        public new void CopyRefSource(object o)
        {
            ...
            {                 
SubtribusID = refSource.SubtribusID,              
                Info = CultRes.StringsRes.DatasetNew,
                ...
                else
                {
                    if (CurrentTbl90RefSource.ReferenceID != 0)
                    {
                        ...
                        {   
                            ...
                            refSource.SubtribusID = CurrentTbl90RefSource.SubtribusID;            
...
SubtribusID = CurrentTbl90RefSource.SubtribusID,              
                    ...
                    {
                        //SubtribusID may be not 0
                        if (CurrentTbl90RefSource.SubtribusID == 0 || CurrentTbl90RefSource.RefSourceID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,            
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl90ReferencesRepository.GetAll()
                         ...
                         a.SubtribusID == CurrentTbl90RefSource.SubtribusID &&
        ...
        public new void CopyRefExpert(object o)
        {
            ...
            {                 
SubtribusID = refExpert.SubtribusID,              
                Info = CultRes.StringsRes.DatasetNew,
                ...
                else
                {
                    if (CurrentTbl90RefExpert.ReferenceID != 0 && CurrentTbl90RefExpert.RefExpertID != 0)
                    {
                        ...
                        {   
                            ...
                            refExpert.SubtribusID = CurrentTbl90RefExpert.SubtribusID;           
...
SubtribusID = CurrentTbl90RefExpert.SubtribusID,              
                    ...
                    {
                        //SubtribusID may be not 0
                        if (CurrentTbl90RefExpert.SubtribusID == 0 || CurrentTbl90RefExpert.RefExpertID == 0)   
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,          
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
                        ...
                        (from a in _tbl90ReferencesRepository.GetAll()
                         ...
                         a.SubtribusID == CurrentTbl90RefExpert.SubtribusID &&
...
SubtribusID = CurrentTbl93Comment.SubtribusID,              
                    ...
                    {
                        //SubtribusID may be not 0
                        if (CurrentTbl93Comment.SubtribusID == 0)
                        {
                            WpfMessageBox.Show(CultRes.StringsRes.RequiredGenealogyConnect, CultRes.StringsRes.RequiredInput,
                                MessageBoxButton.OK, MessageBoxImage.Information);
                            return;
 ...
 //    Part 9    
        ...
        public  void GetConnectedTablesById(object o)
        {
            ...
            Tbl57TribussesList =  new ObservableCollection<Tbl57Tribus>
                                                       (from x in _tbl57TribussesRepository.GetAll()
                                                       where x.TribusID == CurrentTbl60Subtribus.TribusID
            ...
            Tbl63InfratribussesList =  new ObservableCollection<Tbl63Infratribus>
                                                       ...
                                                       where y.SubtribusID == CurrentTbl60Subtribus.SubtribusID
