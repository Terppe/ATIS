...
{     
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id, string use)
        {
            ...
            var infratribussList = ExtGet.GetInfratribussCollectionOrderByFromSubtribusId<Tbl63Infratribus>(id);           
            ...
            { 
                ...
                using (var pdf = new PdfDocument())
                {
                    ...
                    AddSubtribusHierarchyList(pdf, subtribusList);       
        ...
        private static void AddSubtribusHierarchyList(PdfDocument pdf, Tbl60Subtribus tbl60SubtribusList)
        {
            ...
            //      _arrInts = PdfHelper.PdfTbRight("subtribusRight", _arrInts, false, textResult, 0);
        ...
        private static void AddGenussChildrenList(PdfDocument pdf, ObservableCollection<Tbl66Genus> sList)
        {
            _page = pdf.Pages[_arrInts[6]];
            ...
            foreach (var t in sList)
            {
                ...
                _arrInts = PdfHelper.PdfTbMoveLeft("Left" + _z1, _arrInts, false, CultRes.StringsRes.Genus, 0);
