...
{     
 ...
 //    Part 1    
        ...
        public static void CreateMainPdf(int id, string use)
        {
            ...
            { 
                ...
                using (var pdf = new PdfDocument())
                {
                    ...
                    AddRefAuthorHierarchyList(pdf, refAuthorList);       
        ...
        private static void AddRefAuthorHierarchyList(PdfDocument pdf, Tbl90RefAuthor tbl90RefAuthorList)
        {
            ...
            //      _arrInts = PdfHelper.PdfTbRight("refAuthorRight", _arrInts, false, textResult, 0);
        ...
        private static void AddPlSpeciessChildrenList(PdfDocument pdf, ObservableCollection<NULL> NULLsList)
        {
            _page = pdf.Pages[_arrInts[6]];
            ...
            foreach (var t in NULLsList)
            {
                ...
                _arrInts = PdfHelper.PdfTbMoveLeft("NULLLeft" + _z1, _arrInts, false, CultRes.StringsRes.PlSpecies, 0);
