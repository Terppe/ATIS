USE [ATIS34]
GO
/****** Object:  Table [dbo].[Tbl21Classes]    Script Date:  12.12.2019  18:32   ******/  
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[Tbl21Classes] (
            ...
            [ClassName] [nvarchar] (100) COLLATE Latin1_General_CI_AS NOT NULL,
...
(
 ...
 , 
CONSTRAINT [IX_Tbl21Classes_CountID] UNIQUE NONCLUSTERED 
(
	[CountID] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE = OFF,  IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON,  ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
 , 
CONSTRAINT [IX_Tbl21Classes_ClassName] UNIQUE NONCLUSTERED 
(
	[ClassName] ASC, [SuperclassID] ASC, [Author] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE = OFF,  IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON,  ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
...
ALTER TABLE [dbo].[Tbl21Classes]  WITH CHECK ADD  CONSTRAINT 
[FK_Tbl21Classes_Tbl18Superclasses] FOREIGN KEY ([SuperclassID])
