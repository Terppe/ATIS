...
using Te.Atis.Ui.Desktop.BusinessLayer;   
         ...
         //    ReportTbl09DivisionsPdf Skriptdatum:  04.11.2020  12:32    
...
{     
 ...
 //    Part 1    
        ...
        private static Document AddTbl09DivisionsHaeder(Document doc)       
        {
            ...
            var author = PdfHelper.AuthorViewChangeWithoutString(_division.Author, _division.AuthorYear);

            table.AddCell(new PdfPCell(new Phrase(_division.DivisionName + " " + author, LargeFont)) { Colspan = 4, Border = 0 });  // 1.-4. field
