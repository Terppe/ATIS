...
<xsl:when test="Table ='Tbl03Regnums'">   <![CDATA[ 
       ...
       // ----------------------------------------   ]]><xsl:value-of select="Basis"/><![CDATA[   ------------------------
        ...
        //Function
        public int Get]]><xsl:value-of select="Basis"/><![CDATA[IdFrom]]><xsl:value-of select="BasissTK2"/><![CDATA[CollectionSelect(int id)
        {
...
<xsl:otherwise>   <![CDATA[ 
       ...
       #region Get ]]><xsl:value-of select="Basis"/><![CDATA[
        ...
        public ObservableCollection<]]><xsl:value-of select="LinqModel"/><![CDATA[> Copy]]><xsl:value-of select="Basis"/><![CDATA[(]]><xsl:value-of select="LinqModel"/><![CDATA[ selected)
        {
            var dataset = _uow.]]><xsl:value-of select="Table"/><![CDATA[.GetById(selected.]]><xsl:value-of select="Basis"/><![CDATA[Id);
            var collection = new ObservableCollection<Tbl03Regnum>();

            collection.Insert(0, new ]]><xsl:value-of select="LinqModel"/><![CDATA[
            {
                ]]><xsl:value-of select="Basis"/><![CDATA[Name = CultRes.StringsRes.DatasetNew,
                ]]><xsl:value-of select="BasisFK1"/><![CDATA[Id = dataset.]]><xsl:value-of select="BasisFK1"/><![CDATA[Id,
                Valid = dataset.Valid,
                ValidYear = dataset.ValidYear,
                Synonym = dataset.Synonym,
                Author = dataset.Author,
        ...
        // ----------------------------------------   ]]><xsl:value-of select="BasisFK1"/><![CDATA[  ------------------------
        public ObservableCollection<]]><xsl:value-of select="LinqModelFK1"/><![CDATA[> Copy]]><xsl:value-of select="BasisFK1"/><![CDATA[(]]><xsl:value-of select="LinqModelFK1"/><![CDATA[ selected)
        {
            var dataset = _uow.]]><xsl:value-of select="TableFK1"/><![CDATA[.GetById(selected.]]><xsl:value-of select="BasisFK1"/><![CDATA[Id);
            var collection = new ObservableCollection<Tbl06Phylum>();

            collection.Insert(0, new ]]><xsl:value-of select="LinqModelFK1"/><![CDATA[
            {
                ]]><xsl:value-of select="BasisFK1"/><![CDATA[Name = CultRes.StringsRes.DatasetNew,
                ]]><xsl:value-of select="Basis"/><![CDATA[Id = dataset.]]><xsl:value-of select="Basis"/><![CDATA[Id,
                Valid = dataset.Valid,
                ValidYear = dataset.ValidYear,
                Synonym = dataset.Synonym,
        ...
        public ObservableCollection<]]><xsl:value-of select="LinqModelTK2"/><![CDATA[> SearchForConnectedDatasetsWith]]><xsl:value-of select="Basis"/><![CDATA[IdInTable]]><xsl:value-of select="BasisTK2"/><![CDATA[(]]><xsl:value-of select="LinqModel"/><![CDATA[ selected)
        {
            var collection = new ObservableCollection<]]><xsl:value-of select="LinqModelTK2"/><![CDATA[>(_uow.]]><xsl:value-of select="TableTK2"/><![CDATA[.Find(x => x.]]><xsl:value-of select="Basis"/><![CDATA[Id == selected.]]><xsl:value-of select="Basis"/><![CDATA[Id));
            return collection;
        }
        ...
        public ]]><xsl:value-of select="LinqModel"/><![CDATA[ ]]><xsl:value-of select="Basis"/><![CDATA[Update(]]><xsl:value-of select="LinqModel"/><![CDATA[ home, ]]><xsl:value-of select="LinqModel"/><![CDATA[ selected)
        {
            if (home != null) //update
            {
                home.]]><xsl:value-of select="Basis"/><![CDATA[Name = selected.]]><xsl:value-of select="Basis"/><![CDATA[Name;
                home.]]><xsl:value-of select="BasisFK1"/><![CDATA[id = selected.]]><xsl:value-of select="BasisFK1"/><![CDATA[id;
                home.Valid = selected.Valid;
                home.ValidYear = selected.ValidYear;
                home.Author = selected.Author;
                home.AuthorYear = selected.AuthorYear;
        ...
        public ]]><xsl:value-of select="LinqModel"/><![CDATA[ ]]><xsl:value-of select="Basis"/><![CDATA[Add(]]><xsl:value-of select="LinqModel"/><![CDATA[ selected)
        {
            var home = new ]]><xsl:value-of select="LinqModel"/><![CDATA[() //add new
            {
                ]]><xsl:value-of select="Basis"/><![CDATA[Name = selected.]]><xsl:value-of select="Basis"/><![CDATA[Name,
                ]]><xsl:value-of select="BasisFK1"/><![CDATA[id = selected.]]><xsl:value-of select="BasisFK1"/><![CDATA[id,
                CountId = RandomHelper.Randomnumber(),
                Valid = selected.Valid,
                ValidYear = selected.ValidYear,
                Author = selected.Author,
        ...
        public void ]]><xsl:value-of select="Basis"/><![CDATA[Save(]]><xsl:value-of select="LinqModel"/><![CDATA[ home, ]]><xsl:value-of select="LinqModel"/><![CDATA[ selected)
        {
            if (selected.]]><xsl:value-of select="Basis"/><![CDATA[Id != 0)   //update
                _uow.]]><xsl:value-of select="Table"/><![CDATA[.Update(home);
            else                                //add
                _uow.]]><xsl:value-of select="Table"/><![CDATA[.Add(home);
        ...
        //------------------ ]]><xsl:value-of select="BasisFK1"/><![CDATA[ ---------------------------------------
        public ]]><xsl:value-of select="LinqModelFK1"/><![CDATA[ ]]><xsl:value-of select="BasisFK1"/><![CDATA[Update(]]><xsl:value-of select="LinqModelFK1"/><![CDATA[ home, ]]><xsl:value-of select="LinqModelFK1"/><![CDATA[ selected)
        {
            if (home != null) //update
            {
                home.]]><xsl:value-of select="BasisFK1"/><![CDATA[Name = selected.]]><xsl:value-of select="BasisFK1"/><![CDATA[Name;
        ...
        public ]]><xsl:value-of select="LinqModelFK1"/><![CDATA[ ]]><xsl:value-of select="BasisFK1"/><![CDATA[Add(]]><xsl:value-of select="LinqModelFK1"/><![CDATA[ selected)
        {
            var res = new ]]><xsl:value-of select="LinqModelFK1"/><![CDATA[() //add new
            {
                ]]><xsl:value-of select="BasisFK1"/><![CDATA[Name = selected.]]><xsl:value-of select="BasisFK1"/><![CDATA[Name,
                ]]><xsl:value-of select="Basis"/><![CDATA[Id = selected.]]><xsl:value-of select="Basis"/><![CDATA[Id,
                CountId = RandomHelper.Randomnumber(),
                Valid = selected.Valid,
                ValidYear = selected.ValidYear,
        ...
        public void ]]><xsl:value-of select="BasisFK1"/><![CDATA[Save(]]><xsl:value-of select="LinqModelFK1"/><![CDATA[ home, ]]><xsl:value-of select="LinqModelFK1"/><![CDATA[ selected)
        {
            if (selected.]]><xsl:value-of select="BasisFK1"/><![CDATA[Id != 0) //update
            {
                _uow.]]><xsl:value-of select="TableFK1"/><![CDATA[.Update(home);
            }
            else                                //add
                _uow.]]><xsl:value-of select="TableFK1"/><![CDATA[.Add(home);
            _uow.Complete();
        }
