...
namespace ATIS.Ui.Views.Database.D45Family
{
    ...
    public class FamiliesViewModel : ViewModelBase
    {
        ...
        private void ExecuteDeleteFamily(string searchName)
        {
            ...
            Tbl90ReferencesList = _extCrud.DeleteDatasetsWithFamilyIdInTableReference(CurrentTbl45Family.FamilyId);
            ...
            //Delete all Comments  ----------------------------------------------------
            Tbl93CommentsList = _extCrud.DeleteDatasetsWithFamilyIdInTableComment(CurrentTbl45Family.FamilyId);
        ...
        private void ExecuteDeleteSubfamily(string searchName)
        {
            ...
            Tbl51InfrafamiliesList = _extCrud.SearchForConnectedDatasetsWithSubfamilyIdInTableInfrafamily(CurrentTbl48Subfamily.SubfamilyId);
            if (_allMessageBoxes.DoNotDeleteDatasetInfoMessageBox(Tbl51InfrafamiliesList.Count, "Infrafamily")) return;

            //Delete all References Experts, Sources, Authors  ----------------------------------------------------
            Tbl90ReferencesList = _extCrud.DeleteDatasetsWithSubfamilyIdInTableReference(CurrentTbl48Subfamily.SubfamilyId);
            if (Tbl90ReferencesList.Count > 0)
            {
                if (_allMessageBoxes.DeleteDatasetQuestionMessageBox(CultRes.StringsRes.ReferenceAuthor + " " + CultRes.StringsRes.ReferenceSource + " " + CultRes.StringsRes.ReferenceSource)) return;
            ...
            //Delete all Comments  ----------------------------------------------------
            Tbl93CommentsList = _extCrud.DeleteDatasetsWithSubfamilyIdInTableComment(CurrentTbl48Subfamily.SubfamilyId);
            if (Tbl93CommentsList.Count > 0)
            {
                if (_allMessageBoxes.DeleteDatasetQuestionMessageBox(CultRes.StringsRes.Comment)) return;
        ...
        public void ExecuteSaveReferenceAuthor(object o)
        {
            ...
            try
            {
                ...
                if (CurrentTbl90ReferenceAuthor.ReferenceId == 0)
                    reference = _extCrud.ReferenceAuthorFamilyAdd(CurrentTbl90ReferenceAuthor);

                else
                    reference = _extCrud.ReferenceAuthorFamilyUpdate(reference, CurrentTbl90ReferenceAuthor);
        ...
        public void ExecuteSaveReferenceSource(object o)
        {
            ...
            try
            {
                ...
                if (CurrentTbl90ReferenceSource.ReferenceId == 0)
                    reference = _extCrud.ReferenceSourceFamilyAdd(CurrentTbl90ReferenceSource);
                else
                    reference = _extCrud.ReferenceSourceFamilyUpdate(reference, CurrentTbl90ReferenceSource);
        ...
        public void ExecuteSaveReferenceExpert(object o)
        {
            ...
            try
            {
                ...
                if (CurrentTbl90ReferenceExpert.ReferenceId == 0)
                    reference = _extCrud.ReferenceExpertFamilyAdd(CurrentTbl90ReferenceExpert);
                else
                    reference = _extCrud.ReferenceExpertFamilyUpdate(reference, CurrentTbl90ReferenceExpert);
        ...
        private void ExecuteSaveComment(object o)
        {
            ...
            try
            {
                ...
                if (CurrentTbl93Comment.CommentId == 0)
                    comment = _extCrud.CommentFamilyAdd(CurrentTbl93Comment);
                else
                    comment = _extCrud.CommentFamilyUpdate(comment, CurrentTbl93Comment);
        ...
        private void GetConnectedTablesById(object o)
        {
            ...
            Tbl39InfraordosAllList = _extCrud.GetCollectionAllOrderBy<Tbl39Infraordo>("");
