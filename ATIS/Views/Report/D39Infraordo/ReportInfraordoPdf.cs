...
//    ReportInfraordoPdf Skriptdatum:  07.01.2021  10:32    

namespace ATIS.Ui.Views.Report.D39Infraordo
{
    ...
    public class ReportInfraordoPdf : ViewModelBase
    {
...

        {
            ...
            //Children
            var superfamilysList = ExtCrud.GetSuperfamiliesCollectionFromInfraordoIdOrderBy<Tbl42Superfamily>(id);

            //------------------------------------------------------   
            var expertsList = ExtCrud.GetReferenceExpertsCollectionFromInfraordoIdAndRefAuthorIdIsNullAndRefSourceIdIsNullOrderBy<Tbl90Reference>(id);
            var sourcesList = ExtCrud.GetReferenceSourcesCollectionFromInfraordoIdAndRefAuthorIdIsNullAndRefExpertIdIsNullOrderBy<Tbl90Reference>(id);
            var authorsList = ExtCrud.GetReferenceAuthorsCollectionFromInfraordoIdAndRefSourceIdIsNullAndRefExpertIdIsNullOrderBy<Tbl90Reference>(id);
            var commentsList = ExtCrud.GetCommentsCollectionFromInfraordoIdOrderBy<Tbl93Comment>(id);
            ...
            try
            {
                ...
                AddInfraordoHaeder(pdf, _infraordoSingleList);
                AddInfraordoTaxoNomenList(pdf, _infraordoSingleList, _regnumSingleList);
                ...
                if (superfamilysList.Count != 0)
                    AddSuperfamilysChildrenList(pdf, superfamilysList);
        ...
        private static void AddInfraordoHaeder(PdfDocument pdf, Tbl39Infraordo infraordoList)
        {
            ...
            _arrInts = PdfHelper.PdfTbBoldLeft("infraordoName", _arrInts, true, textAusgabeNameAuthor, 2);
        ...
        private static void AddInfraordoTaxoNomenList(PdfDocument pdf, Tbl39Infraordo infraordoList, Tbl03Regnum regnumList)

        {
            ...
            _arrInts = PdfHelper.PdfTbRight("rankRight", _arrInts, false, CultRes.StringsRes.Infraordo, 0);
            //------------------------------------------------------
            _arrInts = PdfHelper.PdfTbMoveLeft("synonymLeft", _arrInts, false, CultRes.StringsRes.ReportSynonyms, 0);
            //------------------------------------------------------
            _arrInts = PdfHelper.PdfTbMtRight("synonymRight", _arrInts, infraordoList.Synonym);
            _arrInts[1] += _arrInts[9]; //Distance to next TextBox
            //--------------------------------------------------------------
