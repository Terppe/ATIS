...
//    ReportSubclassPdf Skriptdatum:  07.01.2021  18:32    
...
namespace ATIS.Ui.Views.Report.D24Subclass
{
    ...
    public class ReportSubclassPdf : ViewModelBase
    {
        ...
        public static void CreateMainPdf(int id, int fishId, int plantId, string use)
        {
            ...
            _subclassSingleList = ExtCrud.GetSubclassSingleBySubclassId<Tbl24Subclass>(id);
            ...
            //Children
            var infraclassesList = ExtCrud.GetInfraclassesCollectionFromSubclassIdOrderBy<Tbl27Infraclass>(id);

            //------------------------------------------------------   
            var expertsList = ExtCrud.GetReferenceExpertsCollectionFromSubclassIdAndRefAuthorIdIsNullAndRefSourceIdIsNullOrderBy<Tbl90Reference>(id);
            var sourcesList = ExtCrud.GetReferenceSourcesCollectionFromSubclassIdAndRefAuthorIdIsNullAndRefExpertIdIsNullOrderBy<Tbl90Reference>(id);
            var authorsList = ExtCrud.GetReferenceAuthorsCollectionFromSubclassIdAndRefSourceIdIsNullAndRefExpertIdIsNullOrderBy<Tbl90Reference>(id);
            var commentsList = ExtCrud.GetCommentsCollectionFromSubclassIdOrderBy<Tbl93Comment>(id);
            ...
            try
            {
                ...
                AddSubclassHaeder(pdf, _subclassSingleList);
                AddSubclassTaxoNomenList(pdf, _subclassSingleList, _regnumSingleList);
                ...
                if (infraclassesList.Count != 0)
                    AddInfraclassesChildrenList(pdf, infraclassesList);
        ...
        private static void AddSubclassHaeder(PdfDocument pdf, Tbl24Subclass subclassList)
        {
            ...
            _arrInts = PdfHelper.PdfTbBoldLeft("subclassName", _arrInts, true, textAusgabeNameAuthor, 2);
        ...
        private static void AddSubclassTaxoNomenList(PdfDocument pdf, Tbl24Subclass subclassList, Tbl03Regnum regnumList)

        {
            ...
            _arrInts = PdfHelper.PdfTbRight("rankRight", _arrInts, false, CultRes.StringsRes.Subclass, 0);
            //------------------------------------------------------
        ...
        private static void AddInfraclassesChildrenList(PdfDocument pdf, ObservableCollection<Tbl27Infraclass> infraclasssList)
        {
            _page = pdf.Pages[_arrInts[6]];
