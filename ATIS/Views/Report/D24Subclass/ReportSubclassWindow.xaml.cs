...
//  ReportSubclassWindow.xaml.cs Skriptdatum:  07.01.2021  18:32     

namespace ATIS.Ui.Views.Report.D24Subclass
{

    /// <summary>
    /// Interactionslogic for ReportSubclassWindow.xaml
    /// </summary>
    public partial class ReportSubclassWindow : MetroWindow
    {

        public ReportSubclassWindow(int un, string tab)
        {
