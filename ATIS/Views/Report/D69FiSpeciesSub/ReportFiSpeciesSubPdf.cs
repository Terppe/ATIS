...
//    ReportFiSpeciesPdf Skriptdatum:  07.01.2021  10:32    

namespace ATIS.Ui.Views.Report.D69FiSpeciesSub
{

    public class ReportFiSpeciesSubPdf : ViewModelBase
    {
        ...
        private static Tbl69FiSpecies _fispeciesSingleList;
        private static Tbl69FiSpecies _fispeciesSubSingleList;
...

        {
            ...
            _fispeciesSubSingleList = ExtCrud.GetFiSpeciesSingleByFiSpeciesId<Tbl69FiSpecies>(id);
            _fispeciesSingleList = ExtCrud.GetFiSpeciesSingleByFiSpeciesId<Tbl69FiSpecies>(_fispeciesSubSingleList.FiSpeciesId);
            _genusSingleList = ExtCrud.GetGenusSingleByGenusId<Tbl66Genus>(_fispeciesSingleList.GenusId);
            ...
            try
            {
                ...
                AddFiSpeciesSubHaeder(pdf, _fispeciesSubSingleList);
                AddFiSpeciesSubTaxoNomenList(pdf, _fispeciesSubSingleList, _regnumSingleList);
                ...
                if (_fispeciesSingleList != null)
                    AddFiSpeciesHierarchyList(pdf, _fispeciesSingleList);

                AddFiSpeciesSubHierarchyList(pdf, _fispeciesSubSingleList);
        ...
        private static void AddFiSpeciesSubHaeder(PdfDocument pdf, Tbl69FiSpecies fispeciesList)
        {
            _page = pdf.Pages[_arrInts[6]];

            var textAusgabeAuthor = PdfHelper.AuthorViewChangeWithString(fispeciesList.Author, fispeciesList.AuthorYear);

            var textAusgabeNameAuthor = fispeciesList.FiSpeciesName + " " + textAusgabeAuthor;

            _arrInts = PdfHelper.PdfTbBoldLeft("fispeciesName", _arrInts, true, textAusgabeNameAuthor, 2);

            _arrInts[1] += _arrInts[9]; //Distance to next TextBox

            _arrInts = PdfHelper.PdfTbBoldLeft("countId", _arrInts, false, CultRes.StringsRes.ReportTaxonomicId + fispeciesList.CountId, 0);

            _arrInts[1] += _arrInts[9] + 5; //Distance to next TextBox
        }

        private static void AddFiSpeciesSubTaxoNomenList(PdfDocument pdf, Tbl69FiSpecies fispeciesList, Tbl03Regnum regnumList)

        {
            ...
            //------------------------------------------------------
            //_arrInts = PdfHelper.PdfTbMtRight("synonymRight", _arrInts, fispeciesList.Synonym);
            _arrInts[1] += _arrInts[9]; //Distance to next TextBox
                                        //--------------------------------------------------------------
            _arrInts = PdfHelper.PdfTbMoveLeft("commNameLeft", _arrInts, false, CultRes.StringsRes.ReportCommonNames, 0);
            //---------------------------------------------------------------
            //_arrInts = PdfHelper.PdfTbRight("commNameGerRight", _arrInts, false, fispeciesList.GerName + " " + CultRes.StringsRes.ReportGerman, 0);
            //_arrInts = PdfHelper.PdfTbRight("commNameEngRight", _arrInts, false, fispeciesList.EngName + " " + CultRes.StringsRes.ReportEnglish, 0);
            //_arrInts = PdfHelper.PdfTbRight("commNameFraRight", _arrInts, false, fispeciesList.FraName + " " + CultRes.StringsRes.ReportFrench, 0);
            //_arrInts = PdfHelper.PdfTbRight("commNameSpaRight", _arrInts, false, fispeciesList.PorName + " " + CultRes.StringsRes.ReportSpanish, 0);
            ...
            _arrInts = PdfHelper.PdfTbRight("currStatusRight", _arrInts, false, fispeciesList.Valid.ToString(), 0);
            _arrInts[1] += _arrInts[9] - 3; //Distance to next TextBox
                                            //-----------------------------------------------------------
            ...
            _arrInts = PdfHelper.PdfTbRight("recordRight", _arrInts, false, Convert.ToString(fispeciesList.UpdaterDate, CultureInfo.InvariantCulture), 0);
            _arrInts[1] += _arrInts[9] - 3; //Distance to next TextBox
                                            //-------------------------------------------------------------
            _arrInts = PdfHelper.PdfTbMoveLeft("infoLeft", _arrInts, false, CultRes.StringsRes.ReportInfo, 0);
            //_arrInts = PdfHelper.PdfTbMtRight("infoRight", _arrInts, fispeciesList.Info);
            _arrInts[1] += _arrInts[9] - 3; //Distance to next TextBox
                                            //-------------------------------------------------------
            _arrInts = PdfHelper.PdfTbMoveLeft("memoLeft", _arrInts, false, CultRes.StringsRes.ReportMemo, 0);
            //_arrInts = PdfHelper.PdfTbMtRight("memoRight", _arrInts, fispeciesList.Memo);
            _arrInts[1] += _arrInts[9]; //Distance to next TextBox
        }
        ...
        private static void AddFiSpeciesHierarchyList(PdfDocument pdf, Tbl69FiSpecies fispeciesList)
        {
            ...
            var textResult = PdfHelper.NamesAuthorsForeignNamesViewChange(txtName, fispeciesList.Subspecies,
                fispeciesList.Divers, fispeciesList.Author, fispeciesList.AuthorYear, fispeciesList.Importer, fispeciesList.ImportingYear);

            _arrInts = PdfHelper.PdfTbMtRight("fispeciesRight", _arrInts, textResult);

            _arrInts[1] += _arrInts[9] + 2; //Distance to next TextBox
        }
        private static void AddFiSpeciesSubHierarchyList(PdfDocument pdf, Tbl69FiSpecies fispeciesList)
        {
            _page = pdf.Pages[_arrInts[6]];

            _arrInts = PdfHelper.PdfTbMoveLeft("fispeciesLeft", _arrInts, false, CultRes.StringsRes.Subspecies, 0);
        ...
        private static void AddNamesChildrenList(PdfDocument pdf, ObservableCollection<Tbl78Name> namesList)
        {
            _page = pdf.Pages[_arrInts[6]];
            ...
            foreach (var t in namesList)
            {
                ...
                _arrInts = PdfHelper.PdfTbMoveLeft("nameLeft" + _z1, _arrInts, false, CultRes.StringsRes.Name, 0);
