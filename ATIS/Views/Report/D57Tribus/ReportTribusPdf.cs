...
//    ReportTribusPdf Skriptdatum:  07.01.2021  10:32    
...
namespace ATIS.Ui.Views.Report.D57Tribus
{
    ...
    public class ReportTribusPdf : ViewModelBase
    {
...

        {
            ...
            _tribusSingleList = ExtCrud.GetTribusSingleByTribusId<Tbl57Tribus>(id);
            ...
            try
            {
                ...
                AddTribusHaeder(pdf, _tribusSingleList);
                AddTribusTaxoNomenList(pdf, _tribusSingleList, _regnumSingleList);
        ...
        private static void AddTribusHaeder(PdfDocument pdf, Tbl57Tribus tribusList)
        {
            ...
            _arrInts = PdfHelper.PdfTbBoldLeft("tribusName", _arrInts, true, textAusgabeNameAuthor, 2);
        ...
        private static void AddTribusTaxoNomenList(PdfDocument pdf, Tbl57Tribus tribusList, Tbl03Regnum regnumList)

        {
            ...
            _arrInts = PdfHelper.PdfTbRight("rankRight", _arrInts, false, CultRes.StringsRes.Tribus, 0);
            //------------------------------------------------------
