...
//    ReportInfratribusPdf Skriptdatum:  07.01.2021  10:32    

namespace ATIS.Ui.Views.Report.D63Infratribus
{
    ...
    public class ReportInfratribusPdf : ViewModelBase
    {
...

        {
            ...
            _infratribusSingleList = ExtCrud.GetInfratribusSingleByInfratribusId<Tbl63Infratribus>(id);
            ...
            //Children
            var genussesList = ExtCrud.GetGenussesCollectionFromInfratribusIdOrderBy<Tbl66Genus>(id);

            //------------------------------------------------------   
            var expertsList = ExtCrud.GetReferenceExpertsCollectionFromInfratribusIdAndRefAuthorIdIsNullAndRefSourceIdIsNullOrderBy<Tbl90Reference>(id);
            var sourcesList = ExtCrud.GetReferenceSourcesCollectionFromInfratribusIdAndRefAuthorIdIsNullAndRefExpertIdIsNullOrderBy<Tbl90Reference>(id);
            var authorsList = ExtCrud.GetReferenceAuthorsCollectionFromInfratribusIdAndRefSourceIdIsNullAndRefExpertIdIsNullOrderBy<Tbl90Reference>(id);
            var commentsList = ExtCrud.GetCommentsCollectionFromInfratribusIdOrderBy<Tbl93Comment>(id);
            ...
            try
            {
                ...
                AddInfratribusHaeder(pdf, _infratribusSingleList);
                AddInfratribusTaxoNomenList(pdf, _infratribusSingleList, _regnumSingleList);
                ...
                if (genussesList.Count != 0)
                    AddGenussesChildrenList(pdf, genussesList);
        ...
        private static void AddInfratribusHaeder(PdfDocument pdf, Tbl63Infratribus infratribusList)
        {
            ...
            _arrInts = PdfHelper.PdfTbBoldLeft("infratribusName", _arrInts, true, textAusgabeNameAuthor, 2);
        ...
        private static void AddInfratribusTaxoNomenList(PdfDocument pdf, Tbl63Infratribus infratribusList, Tbl03Regnum regnumList)

        {
            ...
            _arrInts = PdfHelper.PdfTbRight("rankRight", _arrInts, false, CultRes.StringsRes.Infratribus, 0);
            //------------------------------------------------------
        ...
        private static void AddGenussesChildrenList(PdfDocument pdf, ObservableCollection<Tbl66Genus> genussesList)
        {
            _page = pdf.Pages[_arrInts[6]];
