...
//    ReportSubordoPdf Skriptdatum:  07.01.2021  10:32    
...
namespace ATIS.Ui.Views.Report.D36Subordo
{
    ...
    public class ReportSubordoPdf : ViewModelBase
    {
...

        {
            ...
            //Children
            var infraordosList = ExtCrud.GetInfraordosCollectionFromSubordoIdOrderBy<Tbl39Infraordo>(id);

            //------------------------------------------------------   
            var expertsList = ExtCrud.GetReferenceExpertsCollectionFromSubordoIdAndRefAuthorIdIsNullAndRefSourceIdIsNullOrderBy<Tbl90Reference>(id);
            var sourcesList = ExtCrud.GetReferenceSourcesCollectionFromSubordoIdAndRefAuthorIdIsNullAndRefExpertIdIsNullOrderBy<Tbl90Reference>(id);
            var authorsList = ExtCrud.GetReferenceAuthorsCollectionFromSubordoIdAndRefSourceIdIsNullAndRefExpertIdIsNullOrderBy<Tbl90Reference>(id);
            var commentsList = ExtCrud.GetCommentsCollectionFromSubordoIdOrderBy<Tbl93Comment>(id);
            ...
            try
            {
                ...
                AddSubordoHaeder(pdf, _subordoSingleList);
                AddSubordoTaxoNomenList(pdf, _subordoSingleList, _regnumSingleList);
        ...
        private static void AddSubordoHaeder(PdfDocument pdf, Tbl36Subordo subordoList)
        {
            ...
            _arrInts = PdfHelper.PdfTbBoldLeft("subordoName", _arrInts, true, textAusgabeNameAuthor, 2);
        ...
        private static void AddSubordoTaxoNomenList(PdfDocument pdf, Tbl36Subordo subordoList, Tbl03Regnum regnumList)

        {
            ...
            _arrInts = PdfHelper.PdfTbRight("rankRight", _arrInts, false, CultRes.StringsRes.Subordo, 0);
            //------------------------------------------------------
