...
//  ReportOrdoWindow.xaml.cs Skriptdatum:  07.01.2021  10:32     

namespace ATIS.Ui.Views.Report.D33Ordo
{

    /// <summary>
    /// Interactionslogic for ReportOrdoWindow.xaml
    /// </summary>
    public partial class ReportOrdoWindow : MetroWindow
    {

        public ReportOrdoWindow(int un, string tab)
        {
