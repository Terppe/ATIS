...
//    ReportOrdoPdf Skriptdatum:  07.01.2021  10:32    
...
namespace ATIS.Ui.Views.Report.D33Ordo
{
    ...
    public class ReportOrdoPdf : ViewModelBase
    {
...

        {
            ...
            _ordoSingleList = ExtCrud.GetOrdoSingleByOrdoId<Tbl33Ordo>(id);
            ...
            try
            {
                ...
                AddOrdoHaeder(pdf, _ordoSingleList);
                AddOrdoTaxoNomenList(pdf, _ordoSingleList, _regnumSingleList);
        ...
        private static void AddOrdoHaeder(PdfDocument pdf, Tbl33Ordo ordoList)
        {
            ...
            _arrInts = PdfHelper.PdfTbBoldLeft("ordoName", _arrInts, true, textAusgabeNameAuthor, 2);
        ...
        private static void AddOrdoTaxoNomenList(PdfDocument pdf, Tbl33Ordo ordoList, Tbl03Regnum regnumList)

        {
            ...
            _arrInts = PdfHelper.PdfTbRight("rankRight", _arrInts, false, CultRes.StringsRes.Ordo, 0);
            //------------------------------------------------------
