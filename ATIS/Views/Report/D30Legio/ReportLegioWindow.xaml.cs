...
//  ReportLegioWindow.xaml.cs Skriptdatum:  07.01.2021  10:32     

namespace ATIS.Ui.Views.Report.D30Legio
{

    /// <summary>
    /// Interactionslogic for ReportLegioWindow.xaml
    /// </summary>
    public partial class ReportLegioWindow : MetroWindow
    {

        public ReportLegioWindow(int un, string tab)
        {
