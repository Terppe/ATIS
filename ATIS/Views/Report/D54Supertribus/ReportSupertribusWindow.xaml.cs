...
//  ReportSupertribusWindow.xaml.cs Skriptdatum:  07.01.2021  10:32     

namespace ATIS.Ui.Views.Report.D54Supertribus
{

    /// <summary>
    /// Interactionslogic for ReportSupertribusWindow.xaml
    /// </summary>
    public partial class ReportSupertribusWindow : MetroWindow
    {

        public ReportSupertribusWindow(int un, string tab)
        {
