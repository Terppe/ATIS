...
//    ReportInfraclassPdf Skriptdatum:  07.01.2021  18:32    
...
namespace ATIS.Ui.Views.Report.D27Infraclass
{
    ...
    public class ReportInfraclassPdf : ViewModelBase
    {
...

        {
            ...
            _infraclassSingleList = ExtCrud.GetInfraclassSingleByInfraclassId<Tbl27Infraclass>(id);
            ...
            try
            {
                ...
                AddInfraclassHaeder(pdf, _infraclassSingleList);
                AddInfraclassTaxoNomenList(pdf, _infraclassSingleList, _regnumSingleList);
        ...
        private static void AddInfraclassHaeder(PdfDocument pdf, Tbl27Infraclass infraclassList)
        {
            ...
            _arrInts = PdfHelper.PdfTbBoldLeft("infraclassName", _arrInts, true, textAusgabeNameAuthor, 2);
        ...
        private static void AddInfraclassTaxoNomenList(PdfDocument pdf, Tbl27Infraclass infraclassList, Tbl03Regnum regnumList)
        {
            _page = pdf.Pages[_arrInts[6]];
            ...
            _arrInts = PdfHelper.PdfTbRight("rankRight", _arrInts, false, CultRes.StringsRes.Infraclass, 0);
            //------------------------------------------------------
