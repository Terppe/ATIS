...
//    ReportPlSpeciesPdf Skriptdatum:  07.01.2021  12:32    

namespace ATIS.Ui.Views.Report.D72PlSpeciesSub
{

    public class ReportPlSpeciesSubPdf : ViewModelBase
    {
        ...
        private static void AddPlSpeciesHaeder(PdfDocument pdf, Tbl72PlSpecies plspeciesList)
        {
            ...
            _arrInts = PdfHelper.PdfTbBoldLeft("countId", _arrInts, false, CultRes.StringsRes.ReportTaxonomicId + plspeciesList.CountId, 0);
        ...
        private static void AddPlSpeciesTaxoNomenList(PdfDocument pdf, Tbl72PlSpecies plspeciesList, Tbl03Regnum regnumList)
        {
            ...
            //------------------------------------------------------
            //_arrInts = PdfHelper.PdfTbMtRight("synonymRight", _arrInts, plspeciesList.Synonym);
            _arrInts[1] += _arrInts[9]; //Distance to next TextBox
            //--------------------------------------------------------------
            _arrInts = PdfHelper.PdfTbMoveLeft("commNameLeft", _arrInts, false, CultRes.StringsRes.ReportCommonNames, 0);
            //---------------------------------------------------------------
            //_arrInts = PdfHelper.PdfTbRight("commNameGerRight", _arrInts, false, plspeciesList.GerName + " " + CultRes.StringsRes.ReportGerman, 0);
            //_arrInts = PdfHelper.PdfTbRight("commNameEngRight", _arrInts, false, plspeciesList.EngName + " " + CultRes.StringsRes.ReportEnglish, 0);
            //_arrInts = PdfHelper.PdfTbRight("commNameFraRight", _arrInts, false, plspeciesList.FraName + " " + CultRes.StringsRes.ReportFrench, 0);
            //_arrInts = PdfHelper.PdfTbRight("commNameSpaRight", _arrInts, false, plspeciesList.PorName + " " + CultRes.StringsRes.ReportSpanish, 0);
            ...
            _arrInts = PdfHelper.PdfTbRight("currStatusRight", _arrInts, false, plspeciesList.Valid.ToString(), 0);
            _arrInts[1] += _arrInts[9] - 3; //Distance to next TextBox
            //-----------------------------------------------------------
            ...
            _arrInts = PdfHelper.PdfTbRight("recordRight", _arrInts, false, Convert.ToString(plspeciesList.UpdaterDate, CultureInfo.InvariantCulture), 0);
            _arrInts[1] += _arrInts[9] - 3; //Distance to next TextBox
            //-------------------------------------------------------------
            _arrInts = PdfHelper.PdfTbMoveLeft("infoLeft", _arrInts, false, CultRes.StringsRes.ReportInfo, 0);
            //_arrInts = PdfHelper.PdfTbMtRight("infoRight", _arrInts, plspeciesList.Info);
            _arrInts[1] += _arrInts[9] - 3; //Distance to next TextBox
            //-------------------------------------------------------
            _arrInts = PdfHelper.PdfTbMoveLeft("memoLeft", _arrInts, false, CultRes.StringsRes.ReportMemo, 0);
            //_arrInts = PdfHelper.PdfTbMtRight("memoRight", _arrInts, plspeciesList.Memo);
            _arrInts[1] += _arrInts[9]; //Distance to next TextBox
        }
        ...
        private static void AddPlSpeciesHierarchyList(PdfDocument pdf, Tbl72PlSpecies plspeciesList)
        {
            _page = pdf.Pages[_arrInts[6]];
