...
//    ReportSuperfamilyPdf Skriptdatum:  07.01.2021  10:32    

namespace ATIS.Ui.Views.Report.D42Superfamily
{
    ...
    public class ReportSuperfamilyPdf : ViewModelBase
    {
...

        {
            ...
            _superfamilySingleList = ExtCrud.GetSuperfamilySingleBySuperfamilyId<Tbl42Superfamily>(id);
            ...
            //Children
            var familysList = ExtCrud.GetFamiliesCollectionFromSuperfamilyIdOrderBy<Tbl45Family>(id);

            //------------------------------------------------------   
            var expertsList = ExtCrud.GetReferenceExpertsCollectionFromSuperfamilyIdAndRefAuthorIdIsNullAndRefSourceIdIsNullOrderBy<Tbl90Reference>(id);
            var sourcesList = ExtCrud.GetReferenceSourcesCollectionFromSuperfamilyIdAndRefAuthorIdIsNullAndRefExpertIdIsNullOrderBy<Tbl90Reference>(id);
            var authorsList = ExtCrud.GetReferenceAuthorsCollectionFromSuperfamilyIdAndRefSourceIdIsNullAndRefExpertIdIsNullOrderBy<Tbl90Reference>(id);
            var commentsList = ExtCrud.GetCommentsCollectionFromSuperfamilyIdOrderBy<Tbl93Comment>(id);
            ...
            try
            {
                ...
                AddSuperfamilyHaeder(pdf, _superfamilySingleList);
                AddSuperfamilyTaxoNomenList(pdf, _superfamilySingleList, _regnumSingleList);
        ...
        private static void AddSuperfamilyHaeder(PdfDocument pdf, Tbl42Superfamily superfamilyList)
        {
            ...
            _arrInts = PdfHelper.PdfTbBoldLeft("superfamilyName", _arrInts, true, textAusgabeNameAuthor, 2);
        ...
        private static void AddSuperfamilyTaxoNomenList(PdfDocument pdf, Tbl42Superfamily superfamilyList, Tbl03Regnum regnumList)

        {
            ...
            _arrInts = PdfHelper.PdfTbRight("rankRight", _arrInts, false, CultRes.StringsRes.Superfamily, 0);
            //------------------------------------------------------
