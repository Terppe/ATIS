...
//    ReportSubfamilyPdf Skriptdatum:  07.01.2021  10:32    
...
namespace ATIS.Ui.Views.Report.D48Subfamily
{
    ...
    public class ReportSubfamilyPdf : ViewModelBase
    {
...

        {
            ...
            _subfamilySingleList = ExtCrud.GetSubfamilySingleBySubfamilyId<Tbl48Subfamily>(id);
            ...
            try
            {
                ...
                AddSubfamilyHaeder(pdf, _subfamilySingleList);
                AddSubfamilyTaxoNomenList(pdf, _subfamilySingleList, _regnumSingleList);
        ...
        private static void AddSubfamilyHaeder(PdfDocument pdf, Tbl48Subfamily subfamilyList)
        {
            ...
            _arrInts = PdfHelper.PdfTbBoldLeft("subfamilyName", _arrInts, true, textAusgabeNameAuthor, 2);
        ...
        private static void AddSubfamilyTaxoNomenList(PdfDocument pdf, Tbl48Subfamily subfamilyList, Tbl03Regnum regnumList)

        {
            ...
            _arrInts = PdfHelper.PdfTbRight("rankRight", _arrInts, false, CultRes.StringsRes.Subfamily, 0);
            //------------------------------------------------------
