...
//  ReportFamilyWindow.xaml.cs Skriptdatum:  07.01.2021  10:32     

namespace ATIS.Ui.Views.Report.D45Family
{

    /// <summary>
    /// Interactionslogic for ReportFamilyWindow.xaml
    /// </summary>
    public partial class ReportFamilyWindow : MetroWindow
    {

        public ReportFamilyWindow(int un, string tab)
        {
