...
//    ReportFamilyPdf Skriptdatum:  07.01.2021  10:32    
...
namespace ATIS.Ui.Views.Report.D45Family
{
    ...
    public class ReportFamilyPdf : ViewModelBase
    {
...

        {
            ...
            _familySingleList = ExtCrud.GetFamilySingleByFamilyId<Tbl45Family>(id);
            ...
            //Children
            var subfamilysList = ExtCrud.GetSubfamiliesCollectionFromFamilyIdOrderBy<Tbl48Subfamily>(id);

            //------------------------------------------------------   
            var expertsList = ExtCrud.GetReferenceExpertsCollectionFromFamilyIdAndRefAuthorIdIsNullAndRefSourceIdIsNullOrderBy<Tbl90Reference>(id);
            var sourcesList = ExtCrud.GetReferenceSourcesCollectionFromFamilyIdAndRefAuthorIdIsNullAndRefExpertIdIsNullOrderBy<Tbl90Reference>(id);
            var authorsList = ExtCrud.GetReferenceAuthorsCollectionFromFamilyIdAndRefSourceIdIsNullAndRefExpertIdIsNullOrderBy<Tbl90Reference>(id);
            var commentsList = ExtCrud.GetCommentsCollectionFromFamilyIdOrderBy<Tbl93Comment>(id);
            ...
            try
            {
                ...
                AddFamilyHaeder(pdf, _familySingleList);
                AddFamilyTaxoNomenList(pdf, _familySingleList, _regnumSingleList);
        ...
        private static void AddFamilyHaeder(PdfDocument pdf, Tbl45Family familyList)
        {
            ...
            _arrInts = PdfHelper.PdfTbBoldLeft("familyName", _arrInts, true, textAusgabeNameAuthor, 2);
        ...
        private static void AddFamilyTaxoNomenList(PdfDocument pdf, Tbl45Family familyList, Tbl03Regnum regnumList)

        {
            ...
            _arrInts = PdfHelper.PdfTbRight("rankRight", _arrInts, false, CultRes.StringsRes.Family, 0);
            //------------------------------------------------------
